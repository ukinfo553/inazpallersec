...
//-------------------POPup
if(isset($_POST['contactpopSubmit']))
{
// Submitted form data
$fullname = $_POST['pop_fullname'];
$email    = $_POST['pop_email'];
$mobile   = $_POST['pop_phone'];
$company  = $_POST['pop_company'];
//$purpose  = $_POST['pop_purpose'];
$country  = $_POST['pop_country'];
$message  = $_POST['pop_message'];
$pagename = $_POST['pagename'];
$cdate    = date('d-M-Y');

$subject  = "POPUP ".$pagename."[".$cdate."]";
$mailbody ='<table width="100%" border="0">
			  <tr><td>Name:&nbsp;</td><td>'.$fullname.'</td></tr>
			  <tr><td>Email&nbsp;</td><td>'.$email.'</td></tr>
			  <tr><td>Mobile&nbsp;</td><td>'.$mobile.'</td></tr>
