...
<body>
  ...
  <section class="banner p-md-0">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="item">
            <h1><span style="color:var(--red);">Preserve, Protect, Prevail</span>
            ...
            <button type="button" class="button model-form" data-modal-header="know more">know more</button>
          </div>
        </div>
        <!-- <div class="col-lg-6">
          <div class="item">
  ...
  <!--service sec start-->
  <?php include "infile/service.php" ?>
  <!--service sec end-->

  <!--trusted cleint start-->
  <?php include "infile/clients.php" ?>
  <!--trusted client end-->
  ...
  <section class="p-0">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="fs-28 text-dark fw-bold f-raleway text-center">
            Industry Expertise
          </div>
      ...
      <div class="row g-3 g-md-4 mt-0">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item p-md-3 p-2 bg-grey border-grey border-radius-10 h-100 d-flex flex-column justify-content-between">
            ...
            <img src="assets/image/industries/government.svg" alt="Banking" width="35" height="35" class="d-block img-fluid ms-auto mt-md-3 mt-2">
          </div>
        </div>
        <!--col start-->
        <div class="col-lg-4 col-md-6">
          <div class="item p-md-3 p-2 bg-grey border-grey border-radius-10 h-100 d-flex flex-column justify-content-between">
            ...
            <img src="assets/image/home/industry-expertise/manufacturing.svg" alt="Manufacturing" width="35" height="35" class="d-block img-fluid ms-auto mt-md-3 mt-2">
          </div>
        </div>
        <!--col start-->
        <div class="col-lg-4 col-md-6">
          <div class="item p-md-3 p-2 bg-grey border-grey border-radius-10 h-100 d-flex flex-column justify-content-between">
            ...
            <img src="assets/image/home/industry-expertise/Oil-Gas.svg" alt="Oil and Gas" width="35" height="35" class="d-block img-fluid ms-auto mt-md-3 mt-2">
          </div>
        </div>
        <!--col start-->
        <div class="col-lg-4 col-md-6">
          <div class="item p-md-3 p-2 bg-grey border-grey border-radius-10 h-100 d-flex flex-column justify-content-between">
            ...
            <img src="assets/image/home/industry-expertise/Insurance.svg" alt="Insurance" width="35" height="35" class="d-block img-fluid ms-auto mt-md-3 mt-2">
          </div>
        </div>
        <!--col start-->
        <div class="col-lg-4 col-md-6">
          <div class="item p-md-3 p-2 bg-grey border-grey border-radius-10 h-100 d-flex flex-column justify-content-between">
            ...
            <img src="assets/image/home/industry-expertise/Public-Services.svg" alt="Public Services" width="35" height="35" class="d-block img-fluid ms-auto mt-md-3 mt-2">
          </div>
        </div>
        <!--col start-->
        <div class="col-lg-4 col-md-6">
          <div class="item p-md-3 p-2 bg-grey border-grey border-radius-10 h-100 d-flex flex-column justify-content-between">
            ...
            <img src="assets/image/home/industry-expertise/Healthcare.svg" alt="Healthcare" width="35" height="35" class="d-block img-fluid ms-auto mt-md-3 mt-2">
          </div>
        </div>
      </div>
    </div>
