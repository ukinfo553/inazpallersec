...
require_once(dirname(__DIR__, 1).'/phpmailer/class.phpmailer.php');
 
/*  function ip_details_amp($IPaddress) 
{
...
return $details = json_decode(file_get_contents("https://www.infosectrain.com/api/ip/".$ip.""));
  ...
  function curl_trip_amp($url,$fields_string){
...
if(!$mail2->Send()) {
 ...
 //return 'Sucess';
  return json_encode(array('successmsg'=>'success'));
