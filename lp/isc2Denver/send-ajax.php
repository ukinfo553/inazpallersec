...
$email_subject = "New Enquiry from "$me_code." ".$me_others." Landing Page";
...
$mail->AddAddress("sheena.g@infosectrain.com");

//$mail->AddAddress("sales@infosectrain.com");

$mail->AddCC("tabir.a@infosectrain.com");
