...
<head>
    ...
    <title>CISSP Certification Training - Bengaluru</title>
    ...
    <main>
        ...
        <section class="banner-sec">
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7">
                        <div class="item">
                            <h3>Join the CISSP <span style="color:var(--red);">Classroom Training in Bengaluru</span>
                            </h3>
                            <h1>Certified Information Systems Security Professional</h1>
                            ...
                            <div class="d-flex flex-column flex-md-row banner-highlights">
                                ...
                                <div>
                                    <span>$154,889+</span>
                                    <p>Avg. Salary Information Security Managers</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-lg-block">
                        <div class="item">
                            <img src="assets/images/banner-img-three.webp" fetchPriority="high"
                                alt="CISSP Online Training by InfosecTrain" width="788" height="788">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    ...
                                    <p>54-Hour Classroom Training in Bengaluru</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                            ...
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <br>
                                        <a href="<?php echo $brochureLink; ?>" download" target="_blank"
                                            title="Download Brochure" class="cta-button">Download
                                            Brochure</a>
                                    </div>
                                </div>
                                <!--/ faq item /-->
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 style="text-align: center;margin-top: 16px;">Classroom Training in Bengaluru</h3>
                    </div>
                    <div class="col-12">
                        <?php
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Immerse in <strong>scenario-based learning</strong> across 8 CISSP domains</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of CISSP Certification Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            ...
                            <picture>
                                <source media="(min-width:768px)" width="723" height="246"
                                    srcset="assets/images/benifits/benefits-desktop.webp">
                                <img src="assets/images/benifits/benefits-mobile.webp" width="320" height="345"
                                    alt="Benefits of CISSP Online Training  Certification">
                            </picture>
                        </div>
                    </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Very good training delivered by the trainer. Covering all the CISSP topics in detail
                                without loosing the focus on certification.
                            </p>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar.png"
                                            alt="NISHIKANTH NANDIRAJU" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            NISHIKANTH NANDIRAJU
                                        </h3>
                                        <span>Bengaluru</span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Excellent trainer! Provided all the CISSP content in easy layman terms. Most of the
                                examples provided in the training can be related with my project and ability to map the
                                missing dots. Thank you InfosecTrain for such an amazing experience!
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar.png"
                                            width="250" height="250" alt="Gopalakrishnan Palraj">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Gopalakrishnan Palraj
                                        </h3>
                                        <span>Bengaluru</span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Knowledgeable and well driven training session. This will help me with CISSP & my work.
                                I am more confident about the concepts and now have the positive mindset to give the
                                exam. He was on time every day for our classroom training stuck to his commitments and
                                ensured the objective of the course was met without any compromises
                            </p>
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar.png"
                                            width="250" height="250" alt="Amita Devadiga">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Amita Devadiga
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Firstly its an amazing team at InfosecTrain. Support team made everything comfortable.
                                Trainer is most kind and humble human being, it is an amazing combination of knowledge
                                and kindness. He ensured the
                                objective of the course was met without any compromises.I feel his training passion and
                                experience are adding great value to the sessions. We were kept active and ensured what
                                is needed was provided without an ask. Thank you so much for everything, appreciate the
                                professionalism throughout the days.
                            </p>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="CISSP Training Bengaluru" id="me_others_footer"
                                    name="me_others">
