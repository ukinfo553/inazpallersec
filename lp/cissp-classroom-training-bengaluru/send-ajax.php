...
$email_subject = "New Enquiry from CISSP Classroom Bengaluru Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-prepare-for-cissp-exam-in-2023/" target="_blank">How To Prepare For CISSP Exam</a></li>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/M6ptJGRUa7s?si=BQlNHmjCLPTbPJsy" target="_blank">Mastering the CISSP Mindset: Top 10 Tips for Success!</a></li>
					...
					<tr>
                        ...
                        <ul>
                            ...
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/grc-online-training/"  target="_blank">GRC (Governance, Risk and Compliance) Hands-on</a> </li>
                        </ul>
						</td>
					</tr>
<tr>
    <td style="padding:0 24px;">
        <a href="https://www.infosectrain.com/pages/download/CISSP_Certification_Exam_Preparation_Guide_v2.pdf" target="_blank"
            ...
            Download CISSP Preparation Guide
        </a>
    </td>
</tr>
                    '.$email_footer.'
...
return array($result,$last);
 ...
 $data = array(
    ...
    'page_type' => 'CISSP Classroom Bengaluru',
