...
<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-kali-linux-tools/" target="_blank">Top Kali Linux Tools For 2024</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/what-is-network-penetration-testing/" target="_blank">What Is Network Penetration Testing?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-identify-vulnerable-third-party-software/" target="_blank">How To Identify Vulnerable Third-Party Software?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/difference-between-penetration-testing-and-vulnerability-assessment/" target="_blank">Difference Between Penetration Testing And Vulnerability Assessment</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
                        ...
                        <ul>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/eIdVtCQSa3s?si=DwbNGxbIeV7VQzbG">Advanced Penetration Testing</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/J8NSE8cAxQs?si=U-xsi6LRsInIHHyD">Mastering the Art of Web Advanced Penetration Testing</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/_0okxNWuqyU?si=2eaGmTp5CTUfR5N2">Top Penetration Testing Interview Questions and Answers</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/TS7Di0dx7DU?si=AI_ssEV0qcc_sbND">Web Application Penetration Testing</a></li>
                    </ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
    <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/artificial-intelligence-ai-for-cyber-security-professionals-training/">AI-Powered Cybersecurity Training</a></li>
    ...
    <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/soc-analyst-training/">SOC Analyst Training</a></li>
    <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/advanced-threat-hunting-and-digital-forensics-and-incident-response-training/">Advanced Cyber Threat Hunting and DFIR Training</a></li>
</ul>
