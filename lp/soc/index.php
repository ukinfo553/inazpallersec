                    ...
                    <div class="col-lg-5 col-md-6 d-none d-lg-block">
                        <div class="item">
                            <img src="assets/images/banner-v3.webp" fetchPriority="high"
                                alt="SOC Analyst by InfosecTrain" width="400" height="400">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="course-details">
                            <div class="course-tools d-flex flex-column justify-content-start align-items-start">
                                ...
                                <img src="assets/images/SOC-Analysts-tools.webp" alt="SOC Tools"
                                    style="max-width:100%;margin:24px 0;">
                            </div>
                            <div class="course-overview">
                                <h2>SOC Analyst - An Overview</h2>
                                <p>
                                    The SOC (Security Operations Center) Analyst custom training course from
                                    InfosecTrain equips participants with essential skills to excel in modern
                                    cybersecurity. Covering foundational principles, advanced frameworks, and practical
                                    expertise, this program prepares participants for real-world security challenges.
                                </p>
                            </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of a Security Operations Expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                This SOC Analyst training is outstanding. The instructor's delivery is excellent, and as
                                a beginner, I found it incredibly valuable for learning cybersecurity fundamentals.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Sahaya-Seelan.png"
                                            alt="Sahaya Seelan" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Sahaya Seelan
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The SOC Analyst Hands-on Training covered all the essential fundamentals and tools I was
                                looking for. The practical, hands-on examples provided great insight into the
                                functionality of core SOC tools. I also appreciated the recorded sessions and shared
                                documents.
                            </p>
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Douglas-Amorim.png"
                                            alt=" Douglas Amorim Pereira de Arruda " width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
