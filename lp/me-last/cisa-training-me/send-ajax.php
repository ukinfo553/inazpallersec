                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/frequently-asked-questions-in-a-cisa-certified-role-interview/" target="_blank">Frequently Asked Questions in a CISA Certified Role Interview</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/exploring-how-cisa-certification-can-enhance-your-it-security-career/" target="_blank">Exploring how CISA Certification can Enhance Your IT Security Career</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/a-recruiters-perspective-on-why-you-should-get-cisa-certified/" target="_blank">A Recruiter"s Perspective on Why You Should Get CISA Certified</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/understanding-the-concepts-of-gantt-chart-and-critical-path-methodology-cpm/"  target="_blank">Understanding the Concepts of Gantt Chart and Critical Path Methodology (CPM)</a> </li>
							</ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=FKsTODDoS1k" target="_blank">ISACA CISA 2019 vs 2024</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=EAD7rPV745o" target="_blank">Secrets to Effective Auditing</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=dmNfEqfneBc" target="_blank">CISA Exam Tips, Tricks & Certification Benefits</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=WkWWhgqZW9Q" target="_blank">How to Pass CISA in the First Attempt</a> </li>
							</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/crisc-certification-training/"  target="_blank">Certified in Risk and Information Systems Control (CRISC) </a> </li>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/information-systems-auditor-online-training/"  target="_blank">Information Systems Auditor Training (Practical Hands-on)</a> </li>
							</ul>
						</td>
					</tr>
<tr>
    <td style="padding:0 24px;">
        <a href="https://www.infosectrain.com/pages/download/how_to_become_an_IT_Auditor.pdf" target="_blank"
            ...
            Download CISA Preparation Guide
        </a>
    </td>
</tr>
                    '.$email_footer.'
