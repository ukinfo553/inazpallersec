            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3>Get on Top of the League with</h3>
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-img.webp" fetchPriority="high"
                                alt="CISSP Online Training by InfosecTrain" width="284" height="327">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <br>
                                        <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/cissp-course.pdf"
                                            target="_blank" title="Download Brochure" class="cta-button">Download
                                            Brochure</a>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Thank you trainers for your dedication and patience in explaining the concepts. Also,
                                the way you spend extra days to cover the topics satisfactorily for the students is
                                great. Good job, InfosecTrain, and all the best to all the students. A big thanks to the
                                Infosec team.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                knowledge. I liked that the course notes and PowerPoint slides were really useful,
                                making it easier to understand textbooks and adding more information that textbooks
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The training session was up to the mark and focused on the exam point of view. These
                                were good informative sessions that helped enhance the overall view towards the IT
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The trainers are amazing. Before joining the course, I tried learning from videos online
                                but didn’t understand 5% of CISSP concepts. After getting training from InfosecTrain, I
                                learned and cleared almost every doubt regarding CISSP. Now, I feel very confident to
                                attempt CISSP after completing this training. I thank my trainer from the bottom of my
