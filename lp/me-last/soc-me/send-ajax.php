...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "SOC Analyst Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/all-about-network-security-its-essentials/" target="_blank">All About Network Security & Its Essentials</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/the-top-five-takeaways-from-our-soc-analyst-course-why-are-we-different/" target="_blank">The Top Five Takeaways From Our SOC Analyst Course: Why Are We Different?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-identify-vulnerable-third-party-software/" target="_blank">Top 25 SOC Analyst Interview Questions That You Should Know</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/soc-analyst-job-profile-skills-certifications-and-salary/" target="_blank">SOC Analyst Job Profile, Skills, Certifications, And Salary.</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
						<td style="color: #414547; padding-left: 24px;padding-top:10px;font-family: Arial, Helvetica, sans-serif;font-size: 18px;">
							<strong>Learn on YouTube</strong>
						</td>
					</tr>
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        ...
                        <ul>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/playlist?list=PLOWdy-NBQHJuVjAvbQTMKfL-BCpSxH-fe">SOC Interview Questions and Answers</a></li>
						<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=rTxWW004CD4">Security Operations Center (SOC) Fundamentals Training</a></li>
						<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=8jpMU2spfaA">SOC Analyst Roadmap: Your Complete Career Guide</a></li>
                    </ul>
						</td>
					</tr>
					<tr>
						<td style="color: #414547; padding-left: 24px;padding-top:10px;font-family: Arial, Helvetica, sans-serif;font-size: 18px;">
							<strong>Our Recommended Courses and Certification</strong>
						</td>
					</tr>
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/certified-ethical-hacker-ceh-training/">Certified Ethical Hacker CEH (v12)</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/comptia-security/">CompTIA Security+ (Plus)</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/threat-hunting-training/">Threat Hunting Professional</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/advanced-penetration-testing-online-training-course/">Advanced Penetration Testing </a></li>
                    </ul>
						</td>
					</tr>
					...
					<tr>
						<td style="color: #414547; padding-left: 24px;padding-top:10px;font-family: Arial, Helvetica, sans-serif;font-size: 18px;">
							<strong>Test Your Tech Skills With our Free Mock Tests?</strong>
						</td>
					</tr>
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/practice-tests/free-soc-analyst-l1-practice-tests">SOC Analyst L1 practice test</a></li>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/practice-tests/free-soc-analyst-l2-practice-tests">SOC Analyst L2 practice test</a></li>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/practice-tests/free-soc-analyst-l3-practice-tests">SOC Analyst L3 practice test</a></li>
...
<tr>
    <td style="padding:0 24px;">
        <a href="https://www.infosectrain.com/pages/download/SOC_Preparation_Guide.pdf" target="_blank"
            style="font-size: 12px; background: #ff1046; padding: 10px 20px; color: #ffffff; text-decoration: none;font-family: Arial, Helvetica, sans-serif;">
            Download SOC Preparation Guide
        </a>
    </td>
</tr>
...
//$mail->Port = 465; // or 587
    ...
    $mail->SetFrom("sales@infosectrain.com", 'InfosecTrain');
    $mail->Subject = $email_subject;
    $mail->Body = $email_body;
    $mail->AddAddress("sales@infosectrain.com");
    // $mail->AddBCC('utsaw.kumar@infosectrain.com');
...
//$mail2->Port = 465; // or 587
        ...
        $mail2->SetFrom("sales@infosectrain.com", 'InfosecTrain');
