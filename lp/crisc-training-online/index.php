...
<head>
    ...
    <title>CRISC Certification Training Course | CRISC Online Training</title>
    <meta name="description"
        content="Become Certified in Risk and Information Systems Control.This CRISC Certification Online Training Prep Course delivered by InfosecTrain, Book your slot Now!">
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-6 col-lg-2 cl-xl-3">
                    <a href="https://www.infosectrain.com/courses/crisc-certification-training/">
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3>Stay One Step Ahead of Real World Threats</h3>
                            <h1>ISACA CRISC Online Training</h1>
                            <h3>Certified in Risk & Information Systems Control</h3>
                            <div class="d-flex flex-column flex-md-row banner-highlights">
                                ...
                                <div>
                                    <span>$151,000+</span>
                                    <p>Avg Annual Salary of CRISC Certified Professionals</p>
                                </div>
                            </div>
                            ...
                            <img src="assets/images/review-mob-img.png" alt="CRISC Online Training Course Review"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-v2.webp" fetchPriority="high"
                                alt="CRISC Online Training by InfosecTrain" width="400" height="400">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.svg"
                                        alt="CRISC Online Training Course Highlights" width="45" height="45">
                                    <p>32-Hour Instructor-led Online Training</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/isaca-premium.svg"
                                        alt="CRISC Online Training Course Highlights" width="45" height="45">
                                    <p>ISACA Premium Training Partner</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/practical-approch.svg"
                                        alt="CRISC Online Training Course Highlights" width="45" height="45">
                                    <p>Learn with Practical Approach</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/customer-service.svg"
                                        alt="CRISC Online Training Course Highlights" width="45" height="45">
                                    <p>Extended Post-Training Support</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/Satisfaction-Guaranteed.webp" width="433"
                                    height="190" alt="CRISC Online Training Course Highlights">
                            </div>
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>CRISC Certification - An Overview</h2>
                                <p>
                                    <strong>Certified in Risk & Information Systems Control</strong>
                                    or CRISC Certification is the latest and the most valuable credential available to
                                    evaluate the information systems control and risk management proficiency of an IT
                                    professional. Those who earn CRISC help enterprises understand business risks and
                                    have the technical knowledge to implement appropriate IS controls.
                                </p>
                            </div>
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        <strong> DOMAIN 1 (26%) </strong>
                                        <p>&nbsp;</p>
                                        <strong>A: ORGANIZATIONAL GOVERNANCE</strong>
                                        <ul>
                                            <li>Organizational Strategy, Goals, and Objectives</li>
                                            <li>Organizational Structure, Roles and Responsibilities</li>
                                            <li>Organizational Culture</li>
                                            <li>Policies and Standards</li>
                                            <li>Business Processes</li>
                                            <li>Organizational Assets</li>
                                        </ul>
                                        <p>&nbsp;</p>
                                        <strong>B: RISK GOVERNANCE</strong>
                                        <ul>
                                            <li>Enterprise Risk Management and Risk Management Framework</li>
                                            <li>Three Lines of Defense</li>
                                            <li>Risk Profile</li>
                                            <li>Risk Appetite and Risk Tolerance</li>
                                            <li>Legal, Regulatory and Contractual Requirements</li>
                                            <li>Professional Ethics of Risk Management</li>
                                        </ul>
                                        <p>&nbsp;</p>
                                        <strong> DOMAIN 2 (20%)</strong>
                                        <p>&nbsp;</p>
                                        <strong>A: IT RISK IDENTIFICATION</strong>
                                        <ul>
                                            <li>Risk Events (e.g., contributing conditions, loss result)</li>
                                            <li>Threat Modelling and Threat Landscape</li>
                                            <li>Vulnerability and Control Deficiency Analysis (e.g., root cause
                                                analysis)</li>
                                            <li>Risk Scenario Development</li>
                                        </ul>
                                        <p>&nbsp;</p>
                                        <strong>B: IT RISK ANALYSIS AND EVALUATION</strong>
                                        <ul>
                                        ...
                                        <p>&nbsp;</p>
                                        <strong> DOMAIN 3 (32%)</strong>
                                        <p>&nbsp;</p>
                                        <strong>A: RISK RESPONSE AND REPORTING A: RISK RESPONSE</strong>
                                        <ul>
                                            <li>Risk Treatment / Risk Response Options</li>
                                            <li>Risk and Control Ownership</li>
                                            <li>Third-Party Risk Management</li>
                                            <li>Issue, Finding and Exception Management</li>
                                            <li>Management of Emerging Risk</li>
                                        </ul>
                                        <p>&nbsp;</p>
                                        <strong>B: CONTROL DESIGN AND IMPLEMENTATION</strong>
                                        <ul>
                                            <li>Control Types, Standards and Frameworks</li>
                                            <li>Control Design, Selection and Analysis</li>
                                            <li>Control Implementation</li>
                                            <li>Control Testing and Effectiveness Evaluation</li>
                                        </ul>
                                        <p>&nbsp;</p>
                                        <strong>C: RISK MONITORING AND REPORTING</strong>
                                        <ul>
                                            <li>Risk Treatment Plans</li>
                                            <li>Data Collection, Aggregation, Analysis and Validation</li>
                                            <li>Risk and Control Monitoring Techniques</li>
                                            <li>Risk and Control Reporting Techniques (heatmap, scorecards,
                                                dashboards)</li>
                                            <li>Key Performance Indicators</li>
                                            <li>Key Risk Indicators (KRIs)</li>
                                            <li>Key Control Indicators (KCIs)</li>
                                        </ul>
                                        <p>&nbsp;</p>
                                        <strong> DOMAIN 4 (22%)</strong>
                                        <p>&nbsp;</p>
                                        <strong>A: INFORMATION TECHNOLOGY PRINCIPLES</strong>
                                        <ul>
                                            <li>Enterprise Architecture</li>
                                            <li>IT Operations Management (e.g., change management, IT assets,
                                                problems, incidents)</li>
                                            <li>Project Management</li>
                                            <li>Disaster Recovery Management (DRM)</li>
                                            <li>Data Lifecycle Management</li>
                                            <li>System Development Life Cycle (SDLC)</li>
                                            <li>Emerging Technologies</li>
                                        </ul>
                                        <p>&nbsp;</p>
                                        <strong>B: INFORMATION SECURITY PRINCIPLES</strong>
                                        <ul>
                                            <li>Information Security Concepts, Frameworks and Standards</li>
                                            <li>Information Security Awareness Training</li>
                                            <li>Business Continuity Management</li>
                                            <li>Data Privacy and Data Protection Principles</li>
                                        </ul>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>Identify the IT risk management strategy in support of business
                                                objectives and alignment with the Enterprise Risk Management (ERM)
                                                strategy.</li>
                                            <li>Analyze and evaluate IT risk to determine the likelihood and impact on
                                                business objectives to enable risk-based decision making.</li>
                                            <li>Determine risk response options and evaluate their efficiency and
                                                effectiveness to manage risk in alignment with business objectives.</li>
                                            <li>Continuously monitor and report on IT risk and controls to relevant
                                                stakeholders to ensure the continued efficiency and effectiveness of the
                                                IT risk management strategy and its alignment with business objectives.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            ...
                                            <li><strong>Exam language:</strong>English, French, German, Hebrew, Italian,
                                                Japanese, Korean, Spanish, Turkish, Chinese</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            ...
                                            <li>Risk and Control Monitoring and Reporting</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>CEOs/CFOs</li>
                                            <li>Chief Audit Executives</li>
                                            <li>Audit Partners/Heads</li>
                                            <li>CIOs/CISOs</li>
                                            <li>Chief Compliance/Privacy/Risk Officers</li>
                                            <li>Security Managers/Directors/Consultants</li>
                                            <li>IT Directors/Managers/Consultants</li>
                                            <li>Audit Directors/Managers/Consultant</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                ...
                                <img src="assets/images/corporate-training-mob.webp" width="364" height="301"
                                    alt="CRISC Online Training  Corporate Training"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                CRISC | CISSP-ISSAP | CGRC | CCSP | CSSLP | CCISO | CISM | CISA | CGEIT | CIPM | CIPPE |
                                CDPSE
                            </div>
                            <div class="summary">
                        ...
                        <div class="swiper-slide item">
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2024/04/ashwimi.png"
                                        alt="Khalid|InfosecTrain Instructor">
                                </div>
                                <div class="avtar-data">
                                    <div class="avtar-name">
                                        Khalid
                            ...
                            <div class="designation">
                                CRISC | CISM | CISA | ISO 27001 Lead Implementer | CC | ITIL V4 Foundation | PMP | ITIL
                                Intermediate – Service Operations | Network+ | A+
                            </div>
                            <div class="summary">Khalid Duduke has over twenty years of experience as an IT Management
                                professional in various sectors such as Telecom, Banking, and Government organizations
                                in the Middle East. He has a solid understanding of IT Project Management, Service
                                Operation, Delivery, and Audit/Compliance.</div>
                        </div>
                        <!--/ col end /-->
                        ...
                        <div class="swiper-slide item">
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2024/04/ashwimi.png"
                                        alt="KK SINGH|InfosecTrain Instructor">
                                </div>
                                <div class="avtar-data">
                                    <div class="avtar-name">
                                        KK SINGH
                            ...
                            <div class="designation">
                                CRISC | C|CISO | CISSP | CCSP | CISM | CISA | CCSK | CCAK | CDPSE | CEH | RHCSA | GRCA |
                                GRCP | CPP | PSP | PCI | AZ-900 | GDPR
                            </div>
                            <div class="summary">
                                With over 18 years of experience in cybersecurity, KK specializes in malware analysis,
                                enterprise incident response, vulnerability research, and governance risk & compliance.
                                He has mentored numerous professionals toward their certification goals and possesses
                                deep expertise in analyzing security events, responding to incidents, and managing cyber
                                threat intelligence.
                            </div>
                        </div>
                        <!--/ col end /-->
                        ...
                        <div class="swiper-slide item">
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2024/04/ashwimi.png"
                                        alt="JEEVAN|InfosecTrain Instructor">
                                </div>
                                <div class="avtar-data">
                                    <div class="avtar-name">
                                        JEEVAN
                            ...
                            <div class="designation">
                                CRISC | CISA | CISM | CISSP | ECSA | CGEIT | CEH
                            </div>
                            <div class="summary">With 8+ years of experience as an IT Information Security Analyst,
                                Jeevan also possesses expertise in IT SOX compliance, proficiency in General IT
                                Controls, Business Continuity Management, Application Controls and performing SOC1 and
                                SOC2 reviews.</div>
                        </div>
                        <!--/ col end /-->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Immerse in <strong>scenario-based learning</strong> across domains</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Updated curriculum</strong> aligned with the latest updates</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of CRISC Certification Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of CRISC Online Training">
                            </div>
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                    alt="Benefits of CRISC Online Training  Certification">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of a Risk Management & IT Governance expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average salary range for different CRISC profiles</h3>
                            <picture>
                                ...
                                <img src="assets/images/benifits/benefits-security-plus-mob.webp" width="640"
                                    height="473" alt="Benefits of CRISC Online Training  Certification">
                            </picture>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                I have pursued CISSP CRISC and CISM from InfosecTrain. InfosecTrain is my default option
                                when I think about any cybersecurity certification. The Trainer’s dedication and
                                sincerity towards his classes is something
                                that inspires me a lot personally. You will get 100 percent from InfosecTrain for
                                whichever course you want to pursue. Especially the trainers are outstanding.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/CRISC-1-150x150.jpg"
                                            alt="Waseem Akram Fareed" width="250" height="250" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Waseem Akram Fareed
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                I completed my CRISC training from InfosecTrain and I must say the session was really
                                helpful. The examples given by the trainer to make the concepts clear helped the
                                participants to remember topics very well.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/CRISC-5-150x150.jpg"
                                            width="250" height="250" alt="Shubha Ilame" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Shubha Ilame
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                I liked how the CRISC training was conducted and the way the trainer taught. Relevant
                                examples and scenarios were shared by the trainer during the training session. Thank you
                                so much, InfosecTrain.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/CRISC-3-150x150.jpg"
                                            width="250" height="250" alt="Swapnil Sopan Surkule" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Swapnil Sopan Surkule
                                        </h3>
                                        <span>India</span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                It was a nice session that I had with InfosecTrain. The trainer extended his support in
                                understanding the concept not only for the certification but also for the entire domain.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/08/sachin-150x150.jpg"
                                            width="250" height="250" alt="Sachin M" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Sachin M
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The CRISC workshop session through InfosecTrain was exceptional! The trainer’s teaching
                                style combined expertise with an engaging approach making complex concepts easily
                                understandable. The session was insightful,
                                interactive, and immensely beneficial for enhancing CRISC knowledge. Highly recommended!
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/CRISC-4-150x150.jpg"
                                            width="250" height="250" alt="Saif Sayed" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Saif Sayed
            ...
            <div class="container">
                <div class="row justify-content-center">
                                ...
                                <div class="overlay" id="overlay">
                                    <div class="play-button" onClick="playVideo()" id="playButton">
                                        <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                            alt="CRISC Online Training Success Story">
                                    </div>
                                </div>
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.png" alt="CRISC Online Training Success Story"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item active open">
                                <h3 class="faq-title"><span class="title">What are the eligibility requirements for
                                        CRISC Certification?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <ul>
                                        <li>Pass the CRISC Exam within the last 5 years.</li>
                                        <li>Work experience must be gained within the 10-year period preceding the
                                            application date for certification or within five years from the date of
                                            initially passing the exam.</li>
                                        <li>A minimum of three years of cumulative work experience as a CRISC
                                            professional across at least two of the four CRISC domains is compulsory.
                                        </li>
                                        <li>Of these two (2) required domains, one (1) must be in either Domain 1 or 2.
                                        </li>
                                        <li>Submit the CRISC Certification Application including Application Processing
                                            Fee.</li>
                                    </ul>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Do I need to apply for another exam voucher if
                                        I need to retake the exam?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Yes, but candidates do not need to go through the eligibility application process
                                        again.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Who is eligible to become CRISC Certified and
                                        what makes CRISC unique?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>IT professionals working to manage company risks and controls and have the
                                        required experience can apply for the certification. </p>
                                    <ul>
                                        <li>CRISC certification indicates expertise in identifying and managing
                                            enterprise IT risk and implementing and maintaining information systems
                                            controls.</li>
                                        <li>Gives access to the ISACA global community of knowledge, including the most
                                            current ideas regarding IT risk management.</li>
                                        <li>It enables the candidates to increase their value in the organization with
                                            expertise to manage IT risk.</li>
                                    </ul>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Can I take the CRISC, CISA, CISM and CGEIT
                                        exams in the same exam window?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <ul>
                                        <li>Yes, candidates are allowed to take one each of CRISC, CISA, CISM and CGEIT
                                            within the same window.</li>
                                        <li>Candidates may NOT take the same certification exam more than one time
                                            within a window.</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How is the CRISC exam scored?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>On 200-800 point scale, ISACA has set 450 as the passing mark for the exams.</p>
                                    <ul>
                                        <li>A scaled score is a conversion of the raw score on an exam to a common
                                            scale.</li>
                                        <li>Please note that the exam score is not based on an arithmetic or percent
                                            average. For example, if all 150 questions are answered correctly, the
                                            scaled score is 800, a perfect score; a scaled score of 200 is the lowest
                                            score possible when only a small number of questions are answered correctly.
                                        </li>
                                        <li>Scaled score of 450 or higher must be achieved to pass the exam.</li>
                                        <li>A score of 450 represents a minimum consistent standard of knowledge as
                                            established for the exam by the respective ISACA Certification Committee.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the requirements to maintain CRISC
                                        Certification? What does CRISCs continuing professional education policy
                                        require?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>On 200-800 point scale, ISACA has set 450 as the passing mark for the exams.</p>
                                    <ul>
                                        <li>Maintaining your CRISC Certification means maintaining an adequate level of
                                            current knowledge and proficiency in the field of information systems audit,
                                            control and security.</li>
                                        <li>The CRISC CPE policy requires the attainment of CPE hours over an annual and
                                            three-year certification period. CRISCs must comply with the following
                                            requirements to retain certification:</li>
                                        <li>Earn and report an annual minimum of twenty (20) CPE hours. These hours must
                                            be appropriate to the currency or advancement of the CRISC’s knowledge or
                                            ability to perform CRISC-related tasks. The use of these hours towards
                                            meeting the CPE requirements for multiple ISACA certifications is
                                            permissible when the professional activity is applicable to satisfying the
                                            job-related knowledge of each certification.</li>
                                        <li>Earn and report a minimum of one hundred and twenty (120) CPE hours for a
                                            three-year reporting cycle period.</li>
                                        <li>Pay the CRISC annual maintenance fee</li>
                                        <li>Comply with the annual CPE audit if selected</li>
                                        <li>Comply with ISACA's Code of Professional Ethics</li>
                                        <li>Abide by ISACA's IT auditing standards</li>
                                    </ul>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Is there any waiver for 3years experience
                                        required for CRISC Certification?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>On 200-800 point scale, ISACA has set 450 as the passing mark for the exams.</p>
                                    <p>No, there are no substitutions or experience waivers.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                        </div>
