...
$courseID = 30773;  // Change this to the specific course ID for different pages
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/customer-service.svg"
                                        alt="CRISC Online Training Course Highlights" width="45" height="45">
                                    <p>Extended Post-Training Support Till Exam</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
...
<!-- Privacy Policy Checkbox -->
        ...
        <?php if (!empty($faq)) {
            ...
            $filteredFaq = array_filter($faq, function ($q) {
                return !empty($q['title']) || !empty($q['ans']);
            });

            if (!empty($filteredFaq)) { ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="faq-wrapper">
                                    <!--/ faq item start /-->
                                    <?php
                                    foreach (array_values($filteredFaq) as $index => $question) {
                                        $isOpen = $index === 0 ? 'open active' : '';
                                        $displayStyle = $index === 0 ? 'style="display: block;"' : '';

                                        echo '<div class="faq-item ' . $isOpen . '">';
                                        echo '    <h3 class="faq-title"><span class="title">' . htmlspecialchars($question['title']) . '</span><span class="right-icon"></span></h3>';
