                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-crisc-interview-questions/" target="_blank">Top CRISC Interview Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-clear-crisc-exam/" target="_blank">How to clear CRISC Exam</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/roadmap-for-crisc-exam/" target="_blank">Roadmap for CRISC EXAM</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/cism-vs-crisc/" target="_blank">CISM vs. CRISC</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
						<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=dhRH8xuZ4CI">How to Pass ISACA CRISC in First Attempt?</a></li>
						<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=oiOBhbRakQM">CRISC Exam Approach and Preparation</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/9AN8hmsztYY?si=3SU00OQCK-AvzeIH">CRISC Exam Interview Question Preparation</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/Pc29UlwWlgY?si=YeOUSnFUvuMSbaBR">CRISC - Introduction to IS Risk Management</a></li>
                        </ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/cism-training/">Certified Information Security Manager (CISM)</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/cisa-training/">Certified Information Systems Auditor (CISA)</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/cissp-training/">Certified Information Systems Security Professional (CISSP)</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/ccsp-training-online/">Certified Cloud Security Professional (CCSP)</a>
                                </li>
                            </ul>
