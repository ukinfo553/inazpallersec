                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <img src="assets/images/review-mob-img.png" alt="CIPP/E Course Review" width="636"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-img.webp" fetchPriority="high"
                                alt="CIPP/E Certification Training by InfosecTrain" width="400" height="400">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/exam-voucher.png"
                                        alt="CIPP/E Course Highlights" width="45" height="45">
                                    <p>8-Hour LMS (Mock Questions & DPDPA Foundation)</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                            ...
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <ul>
                                            <li><strong>Module 1</strong> - Introduction to European Data Protection
                                            </li>
                                            <li><strong>Module 2</strong> - European Data Protection Law and Regulation
                                            </li>
                                            <li><strong>Module 3</strong> - Compliance with European Data Protection Law
                                                and Regulation</li>
                                ...
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Pre-requisites</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <p> There are no prerequisites for this course. It is open to anyone looking to
                                            gain knowledge about privacy laws and build a career in Data Privacy.</p>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Conquer the CIPP/E certification & <strong>pass the exam in 1st attempt</strong> </p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Earn <strong>global recognition</strong> with IAPP CIPP/E certification</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of a privacy expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="CIPPE Training" id="me_others_footer" name="me_others">
...
<script>
    ...
    const calendardata = document.querySelectorAll('.row-hover .row-2:first-child td:first-child');
    calendardata.forEach(data => {
        ...
        if (data == null) {
            ...
            document.querySelector('.nextBatch span').innerText = data.textContent;
        }
    })
