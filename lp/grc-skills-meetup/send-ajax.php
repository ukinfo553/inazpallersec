...
$email_subject = "New Enquiry from GRC Skills Meetup Page";

$user_subject = "Ready to attend the GRC Skills Online Meetup? Stay Tuned!";
...
$mail->Username = "noreply@infosectrain.com";
$mail->Password = 'pwnv estq xjie xbhu';
