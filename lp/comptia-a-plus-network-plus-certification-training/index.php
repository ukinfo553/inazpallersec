...
$courseID = 47325;  // Change this to the specific course ID for different pages
...
<html lang="en">
    ...
    <head>
        ...
        <title>CompTIA A+ and Network+ Online Combo Training</title>
        <meta name="description"
            content="Enhance your IT skills with our CompTIA A+ and Network+ Online Combo Training. Learn essential tech and networking concepts to advance your career in IT."
        ...
        <style>
        .expert-sec .item .profile-desc .avtar {
            display: block;
        }
        </style>
    </head>
        ...
        <main>
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                <h3>Build the Skills to Fix, Connect, and Secure IT Systems</h3>
                                <h1>CompTIA A+ and Network+ Online Combo Training</h1>
                                <div class="d-flex flex-column flex-md-row banner-highlights">
                                    <div>
                                        <span>75% Increase</span>
                                        <p>in CompTIA A+ and Network+ Related Jobs</p>
                                    </div>
                                    <div>
                                        <span>$126,890</span>
                                        <p>Median Salary of Network Analyst</p>
                                    </div>
                                </div>
                                ...
                                <img src="assets/images/review-mob-img.png"
                                    alt="Combo A+-N+ Online Training Course Review" width="636" height="34"
                        ...
                        <div class="col-lg-5 col-md-6 d-none d-md-block">
                            <div class="item">
                                <img src="assets/images/banner-v2.webp" fetchPriority="high"
                                    alt="Combo A+-N+ Online Training by InfosecTrain" width="400" height="400">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/time.svg"
                                            alt="Combo A+-N+ Online Training Course Highlights" width="45" height="45">
                                        <p>48-Hour of Instructor-led Training</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/practical-approch.svg"
                                            alt="Combo A+-N+ Online Training Course Highlights" width="45" height="45">
                                        <p>Comprehensive A+ & Network+ Curriculum</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/isaca-premium.svg"
                                            alt="Combo A+-N+ Online Training Course Highlights" width="45" height="45">
                                        <p>Real-world IT Support and Networking Scenarios</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/batch.svg"
                                            alt="Combo A+-N+ Online Training Course Highlights" width="45" height="45">
                                        <p>Hands-on Practical Exercises & Labs</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/passed-rate.svg"
                                            alt="Combo A+-N+ Online Training Course Highlights" width="45" height="45">
                                        <p>Official CompTIA Courseware</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/customer-service.svg"
                                            alt="Combo A+-N+ Online Training Course Highlights" width="45" height="45">
                                        <p>Post Training Support and Career Guidance</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/certified-trainner.svg"
                                            alt="Combo A+-N+ Online Training Course Highlights" width="45" height="45">
                                        <p>Expert Mentorship and Industry Insights</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    <h2>CompTIA A+ and Network+ Online Combo Training - An Overview</h2>
                                    <p>This combo course has been specifically designed to provide you with a solid
                                        foundation in both IT support and networking. It empowers you with the essential
                                        skills to troubleshoot, maintain, and secure computer systems (A+) while also
                                        equipping you with in-depth networking knowledge for managing and optimizing
                                        network infrastructures (Network+). Starting from the basics of computer
                                        hardware and operating systems, the program progresses to cover networking
                                        concepts, protocols, and security fundamentals. By the end of this course,
                                        you’ll be well-prepared to handle diverse IT challenges and pursue
                                        certifications that open doors to various career opportunities.</p>
                                </div>
            ...
            <section class="training-calendar" id="training-calendar">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h2>CompTIA A+ and Network+ Online Combo Training Calendar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 d-none d-lg-block">
                            <img src="assets/images/training-calendar.webp" width="132" height="128"
                                alt="Combo A+-N+ Training Calendar" class="img-fluid">
                        </div>
        ...
        ?>
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    ...
                                    <img src="assets/images/corporate-training-mob.webp" width="364" height="301"
                                        alt="Combo A+-N+ Online Training  Corporate Training"
                        ...
                        <div class="swiper-wrapper" style="justify-content:center;">
                            ...
                            <div class="swiper-slide item">
                                <div class="profile-desc">
                                    <div class="avtar">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2021/02/ashish-150x150.png"
                                            alt="Ashish Dhyani|InfosecTrain Instructor">
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Master Core <strong>IT Support & Networking</strong> Skills in One Course</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Real-world use cases and <strong>strategic frameworks</strong></p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Get Ready for <strong>Dual Certifications</strong> in IT Support & Networking</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
            ...
            <section class="benefits-sec" id="benefits">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Benefits of CompTIA A+ and Network+ Online Combo Training</h2>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center benefits-row-two">
                        <div class="col-md-4">
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                                    <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                        alt="Benefits of Combo A+-N+ Online Training">
                                </div>
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                                    <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                        alt="Benefits of Combo A+-N+ Online Training  Certification">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p>Earn the status of Network Analyst</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                        ...
                        <div class="col-md-8">
                            <div class="benifits-item-two">
                                <h3>Average Salary Range for CompTIA A+ and Network+ Online Combo Training</h3>
                                <picture>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    ...
                                    and it benefitted me in learning all the modules and preparing for the exam.
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    I loved overall training! Trainer is very knowledebale, had clear understaing of all
                                    the topics covered. Loved the way he pays attention to details.
                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2025/05/Yogendra-Lanje.png"
                                                width="250" height="250" alt="Yogendra Lanje">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Yogendra Lanje
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">I had a great experience with the team. The training advisor was very
                                    supportive and the trainer explained the concepts clearly and effectively. The
                                    course was well-structured and has definitely enhanced my skills. Thank you for a
                                    wonderful learning experience InfosecTrain.</p>

                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2025/05/Saif-Ali.png"
                                                width="250" height="250" alt="Saif Ali">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Saif Ali
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2025/05/Akmal.m.png"
                                                width="250" height="250" alt="Akmal.m">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Akmal.m
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">The course helped me understand several domains I was unfamiliar with.
                                    The instructor was exceptionally skilled and confident in delivering the content.
                                </p>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar-150x150.png"
                                                width="250" height="250" alt="Prasanna Kalluri">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Prasanna Kalluri
                                    ...
                                    <div class="overlay" id="overlay">
                                        <div class="play-button" onClick="playVideo()" id="playButton">
                                            <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                                ...
                                                alt="Combo A+-N+ Online Training Success Story">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="success-item">
                                <img src="assets/images/certificate.webp" width="429" height="263"
                                    alt="Combo A+-N+ Online Training Success Story" class="d-block m-auto img-fluid">
                            </div>
