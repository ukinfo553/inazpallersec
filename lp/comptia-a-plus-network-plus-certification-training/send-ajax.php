                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/spoofing-mac-address-using-macchanger-tool-a-practical-guide/" target="_blank">Spoofing MAC Address Using Macchanger Tool: A Practical Guide</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/security-domain-2-threats-vulnerabilities-mitigations/" target="_blank">Security+ Domain 2: Threats, Vulnerabilities, & Mitigations</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/packet-sniffing-with-snort-a-practical-guide/" target="_blank">Packet Sniffing with Snort: A Practical Guide</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/mitigation-techniques-to-secure-enterprise/" target="_blank">Mitigation Techniques to Secure Enterprise</a></li>
							</ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=alVSQ7EvDdw" target="_blank">Mastering CISM: Thinking Like a Manager for CISM Success</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=AvLLnsfQfqU" target="_blank">CISM Exam: Strategies, Practice Tips & Key Benefits</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=UpIvTSS00HQ" target="_blank">Introduction to CISM</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=kGqFtA5Knjg" target="_blank">How to Prepare for the CISM Exam: Expert Advice & Insider Tips</a> </li>
															</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/comptia-datax-training/"  target="_blank">CompTIA DataX (Plus) Certification Training</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cloudnetx-certification-training/"  target="_blank">CompTIA CloudNetX Certification Training</a> </li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/comptia-datasys-certification-training/"  target="_blank">CompTIA DataSys+ (DS0-001) Certification Training</a></li>
                            </ul>
						</td>
					</tr>
