...
<head>
    ...
    <title>Certified Chief Information Security Officer (AWS Combo) Certification Training</title>
    <meta name="description"
        content="InfosecTrain offers a course on AWS Combo Certification Training, which will help students in learning how to manage an information security governance program.">
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-6 col-lg-2 cl-xl-3">
                    <a href="https://www.infosectrain.com/courses/aws-combo-course-training/">
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3 class="d-flex align-items-center">Master AWS Cloud Security</h3>
                            <h1>AWS Architect Associate + <br> Security Specialty</h1>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/Satisfaction-Guaranteed.webp" width="200"
                                    height="113" alt="AWS Combo Course Highlights">
                            </div>
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>AWS Architect + Security Training - An Overview</h2>
                                <p>This program has been specifically developed to provide you with a comprehensive
                                    knowledge of the AWS Security Architecture. It aims to empower you with the skills
                                    necessary to design, deploy, and manage security infrastructure on the AWS Cloud
                                    Platform. Starting from the basics of cloud computing, the program covers the
                                    essential AWS services architecture, particularly AWS Security.</p>
                            </div>
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        <strong>AWS Architect - Associate (SAA-C03)</strong>
                                        <ul>
                                        ...
                                        <strong>AWS Certified Security - Specialty (SCS-C02)</strong>
                                        <ul>
                                            ...
                                            <li>Management and Security Governance</li>
                                        </ul>
                                        <a href="https://www.infosectrain.com/wp-content/uploads/2020/11/AWS-Combo-1.pdf"
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>Understand the security controls for AWS environments and workloads.
                                            </li>
                                            <li>Understand security logging and monitoring capabilities.</li>
                                            <li>Able to design and implement Identity and Access Management
                                                architecture.</li>
                                            <li>Learn Encryption and Key Management for DAR and DIT.</li>
                                            <li>Manage Data retention and lifecycle management.</li>
                                            <li>Multi-account governance and organizational compliance.</li>
                                            <li>Threat detection and Incident response strategies.</li>
                                            <li>Vulnerability Management and Security Automation.</li>
                                            <li>Demonstrate your skills and working experience on AWS services.</li>
                                            <li>Learn the authentication of technical expertise to design, deploy and
                                                operate AWS applications.</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Exam Details</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <P>Since this is a combo course, there will be two different exams for AWS
                                            Certified Solutions Architect- Associate and AWS Certified Security –
                                            Specialty.</P>
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td width="150"><strong>Certification Name</strong></td>
                                                    <td width="330"><strong>AWS Certified Solutions Architect- Associate
                                                            (SAA-C03) </strong></td>
                                                    <td width="260"><strong>AWS Certified Security - Specialty
                                                            (SCS-C02)</strong></td>
                                                </tr>
                                                <tr>
                                                    <td width="150"><strong>Exam Format</strong></td>
                                                    <td width="150">Multiple Choice, Multiple Response</td>
                                                    <td width="400">Multiple Choice, Multiple Response</td>
                                                </tr>
                                                <tr>
                                                    <td width="150"><strong>Number of Questions</strong></td>
                                                    <td width="150">65</td>
                                                    <td width="400">65</td>
                                                </tr>
                                                <tr>
                                                    <td width="150"><strong>Exam Duration</strong></td>
                                                    <td width="150">130 minutes</td>
                                                    <td width="400">170 minutes</td>
                                                </tr>
                                                <tr>
                                                    <td width="150"><strong>Passing Score</strong></td>
                                                    <td width="150">720/1000</td>
                                                    <td width="400">750/1000</td>
                                                </tr>
                                                <tr>
                                                    <td width="150"><strong>Language </strong></td>
                                                    <td width="150">English, French, German, Italian, Japanese, Korean,
                                                        Portuguese, and Simplified Chinese</td>
                                                    <td width="400">English, French, German, Italian, Japanese, Korean,
                                                        Portuguese, Simplified Chinese, and Spanish.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>Knowledge of IT/Cyber Security concepts</li>
                                            <li>3+ years of IT experience in job roles related to System Administration,
                                                Security, Network Administrators, Operations/DevOps Engineers, etc.</li>
                                            <li>Basic understanding of Virtualization fundamentals and Virtualization
                                                concepts</li>
                                            <li>1+ years of experience in IT security domains</li>
                                            <li>Basic understanding of networking and OS concepts</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>Candidates with an understanding of IT security and Cybersecurity
                                                concepts.</li>
                                            <li>Professionals working as Solution Architects.</li>
                                            <li>Those who are working in cloud computing and security domains.</li>
                                            <li>Those who want to build their career in AWS Security Architecting</li>
                                            <li>Anyone interested in gaining the AWS Security Specialty Certification.
                                            </li>
                                            <li>Anyone wishing to enhance deep security knowledge related to AWS.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>AWS Combo Training Calendar</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <?php
                        $url = "https://www.infosectrain.com/api/33810/href_toscroll/free_demo";
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the skills</strong> required to ace AWS Cloud Security </p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of AWS Architect + Security Combo Training</h2>
                    </div>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                It was a very good class and I have learned a lot. The recorded sessions were also
                                great. Thank you so much for your support and assistance from the beginning to the end.

                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/St-Pierre-150x150.jpg"
                                            alt="Eric St-Pierre" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Eric St-Pierre
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                I enjoyed every bit of my training with InfosecTrain. The trainer was able to break to
                                course down very well for easy understanding. I will definitely take another course from
                                InfosecTrain.
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/Jude-150x150.jpg"
                                            width="250" height="250" alt="Jude Sarfo Debrah">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Jude Sarfo Debrah
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">The trainer’s mentorship in the AWS Security Specialty class was
                                outstanding. Expert guidance, timely responses, and a deep understanding of the subject
                                made the course highly beneficial.</p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/Anoop-150x150.jpg"
                                            width="250" height="250" alt="Anoop">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Anoop</h3>
                                        <span>India</span>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">The AWS training session was excellent! I liked how you tailored the
                                information to our particular requirements and offered useful advice and tactics that we
                                could use right away in our work.</p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/08/Anubhav-Sukla-150x150.jpg"
                                            width="250" height="250" alt="Mohammad Saud Reyaz">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Abhinav Shukla
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                The trainer has been wonderful and made the learning process very easy. He emphasized on
                                labs and covered all the topics even if he had to give extra time. Overall a great
                                learning experience.
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/05/Anu-150x150.jpg"
                                            width="250" height="250" alt="Mohammad Saud Reyaz">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.webp" width="429" height="263" alt="AWS Combo ertificate"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item active open">
                                <h3 class="faq-title"><span class="title">What are the prerequisites for the AWS Combo
                                        training course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>The prerequisites for the AWS Combo training course typically include:</p>
                                    <ul>
                                        <li>Knowledge of IT/Cyber Security Concepts</li>
                                        <li>More than a year of experience in IT security domains, preferably in job
                                            roles related to System Administration, Security, Network Administrators,
                                            Operations/DevOps Engineers, etc.</li>
                                        <li>Basic understanding of Virtualization fundamentals and Virtualization
                                            concepts</li>
                                        <li>Basic understanding of networking and OS concepts</li>
                                    </ul>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How long does the training course typically
                                        last?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>The AWS Combo training course is structured to be completed within a duration of
                                        approximately 60 hours.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Will I receive any certification upon
                                        completing the AWS Combo training course?</span><span class="right-icon"></span>
                                </h3>
                                <div class="faq-content">
                                    <p>Yes, upon completing the AWS Combo training course and clearing the certification
                                        exam, participants will receive certifications for both the Architect Associate
                                        and Security Specialty modules.</p>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the key topics covered in the
                                        Architect Associate module?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Following are the topics covered in the Architect Associate module:</p>
                                    <ul>
                                        <li><strong>Domain 1:</strong> Design Secure Architectures - 30%</li>
                                        <li><strong>Domain 2:</strong> Design Resilient Architectures - 26%</li>
                                        <li><strong>Domain 3:</strong> Design High-Performing Architectures - 24%</li>
                                        <li><strong>Domain 4:</strong> Design Cost-Optimized Architectures - 20%</li>
                                    </ul>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            ...
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the key topics covered in the
                                        Security Specialty module?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Following are the topics covered in the Security Specialty module:</p>
                                    <ul>
                                        <li><strong>Domain 1:</strong> Threat Detection and Incident Response - 14%</li>
                                        <li><strong>Domain 2:</strong> Security Logging and Monitoring - 18%</li>
                                        <li><strong>Domain 3:</strong> Infrastructure Security - 20%</li>
                                        <li><strong>Domain 4:</strong> Identity and Access Management - 16%</li>
                                        <li><strong>Domain 5:</strong> Data Protection - 18%</li>
                                        <li><strong>Daomin 6:</strong> Management and Security Governance - 14%</li>
                                    </ul>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Are there any hands-on exercises or labs
                                        included in the training course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Yes, along with the right kind of theoretical knowledge to achieve the
                                        certification, you will also receive hands-on experience working with cloud
                                        computing during this AWS combo training.</p>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How does this training course prepare
                                        participants for the AWS Architect Associate and Security Specialty
                                        exams?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Here's how the training course prepares participants for the exams:</p>
                                    <ul>
                                        <li>Comprehensive Coverage</li>
                                        <li>Expert instructors</li>
                                        <li>Hands-on labs and exercises</li>
                                        <li>Practice exams and mock assessments</li>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="AWS Combo" id="me_others_footer" name="me_others">
