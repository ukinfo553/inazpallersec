...
$email_subject = "AWS Combo LP Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            ...
                            <ul>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/best-backup-management-tools-on-cloud/">Best Backup Management Tools on Cloud in 2024</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/steps-for-implementing-dlp-in-the-cloud/">Steps for Implementing DLP in the Cloud</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/public-vs-private-cloud-security-whats-the-best-for-your-business/">Public vs. Private Cloud Security: What’s The Best for Your Business?</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/understanding-ec2-fundamentals-in-aws/">Understanding EC2 Fundamentals in AWS</a>
                                </li>
                            </ul>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/ccsp-training-online/">Certified Cloud Security Professional (CCSP)</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/comptia-security/">Certificate of Cloud Security Knowledge (CCSK)</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cloud-governance-security-training/">Advanced Cloud Security Governance</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/azure-security-combo-training/">Azure Administrator & Security (AZ-104 + AZ-500)</a></li>
                        </ul>
						</td>
					</tr>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp',
    'page_type' => 'AWS Combo (Architect + Security)',
    'name' => $me_name,
    'email' => $me_email,
    'phone' => $me_phone,
