...
$courseID = 42426;  // Change this to the specific course ID for different pages
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/skill-based-training.svg"
                                            alt="Advanced Cloud Security Governance Course Highlights" width="45"
                                            height="45">
                                        <p>Practice End-to-end Cloud Governance</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/customer-service.svg"
                                            alt="Advanced Cloud Security Governance Course Highlights" width="45"
                                            height="45">
                                        <p>Real World Industry Applications</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/certified-trainner.svg"
                                            alt="Advanced Cloud Security Governance Course Highlights" width="45"
                                            height="45">
                                        <p>Knowledge Transfer Guarantee</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    ...
                                    <p>
                                        The Advanced Cloud Security Governance Course is designed to provide
                                        participants
                                        with an in-depth understanding of the multifaceted nature of cloud security,
                                        including governance, risk management, identity management, data security, and
                                        much
                                    ...
                                    <ul>
                                        ...
                                        <li>Gain hands-on experience with real-world risk assessment and compliance
                                            auditing.</li>
                                        <li>Prepare for CCSK & CCAK certifications with an authorized CSA & ISACA
                                            partner.
                                        </li>
                        ...
                        <div class="swiper-wrapper justify-content-md-center align-content-stretch flex-wrap">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="designation">
                                    Cloud Audit | CCSP | CCSK | CCAK | AWS CS-S | AWS CAN–S | AWS CSA-P | AWS CDE-P |
                                    MCT |
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">The training session for the Advanced Cloud Security Governance course
                                    provided by InfosecTrain was very good. Thank you very much for the valuable
                                    instruction
                                    and guidance.</p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">It was a great learning experience with the Advanced Cloud Security
                                    Governance Course provided by InfosecTrain. The course was well-organized by the
                                    team
                                    and covered many good and new topics, which will certainly be beneficial for my
                                    career
                                    aspirations.</p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">The entire Advanced Cloud Security Governance course was very
                                    informative
                                    and detail-oriented, with all concepts explained through practical examples. The
                                    training at InfosecTrain was excellent, and the trainers were knowledgeable, making
                                    the
