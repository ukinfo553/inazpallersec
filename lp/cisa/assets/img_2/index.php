...
CISSP | CCSP | CSSLP | CRISC | CISM |  CISA | CGEIT</p>
					...
					<div class="box_coma">"</div>
					<p class="course_h">
					Ajit have an experience of more than 15+ years, He has acquired a wide experience in Cyber security courses ie CISA, CISM, CISSP, CCSP, Security+, SSCP. Handled a team of 100+ Consultants responsible for providing Security Services Delivery to Global Client.<br /></p>
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<p style=""> The training session was good. The examples provided during the training helped in better understanding of the concepts.  </p>
                        <h4 class="adv-ho">VISWESWARAIAH</h4>
                        <p class="adv-p"></p>
                    </div>
