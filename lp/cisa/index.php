        ...
        <div class="left_banner">
            <div class="b_test_box">
                ...
                <h1 class="e_hacker">
                   ...
                   <br>Online Training & Certification</h1>
				<h2 class="e_council">
				<ul>
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-lg-6">
              ...
              <img src="assets/img_2/CISAbanner2.jpg" width="100%" alt="" class="">
...
CISSP | CCSP | CSSLP | CRISC | CISM |  CISA | CGEIT</p>
					...
					<div class="box_coma">"</div>
					<p class="course_h">
					More than 20 years of experience with a rich and diverse training portfolio that includes Information Security, Cybersecurity, Network Security, and more. Saaz has conducted more than 500 training sessions for over 10,000 learners so far.
          </p>
                    <h4 class="adv-h" style="">Saaz Rai</h4>
                    <p class="adv-p text-capitalize mb-1 font-weight-bold">20 + years of experience</p>
                    <p class="adv-p">MCA | CISSP | CRISC | CCSP | CASP | CISA | CGEIT | CISM | PMP</p>
                    </div>
                    <div class="advisor_box">
					<div class="box_coma">"</div>
					<p class="course_h">
					Ajit is a great instructor for Network & Information Security Training, expert in content development of cybersecurity courses, adept at assessments, auditing and consulting.<br /></p>
                    <h4 class="adv-h" style="">Ajit</h4>
                    <p class="adv-p text-capitalize mb-1 font-weight-bold">15 + years of experience</p>
                    <p class="adv-p">CISSP | CISA | CISM | CRISC | CCSP | ITIL</p>
                    </div>
                </div>
            </div>
        </div>
...
<section id="profile_card">
    <div class="container" id="reviews">
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="https://www.infosectrain.com/my-admin/uploads-feedback/ummed%20meel%20ID%20Pyramid.png" alt=""  class="p_image">
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/gerald.jpg" alt="" class="p_image">
                          </div>
        ...
        <div class="item card">
          ...
          <div class="advisor_box">
           <div class="prof-img">
                <img src="https://www.infosectrain.com/my-admin/uploads-feedback/WhatsApp%20Image%202022-07-11%20at%2010.28.55%20AM.jpeg" alt="" class="p_image">
            </div>
...
<li><a href="https://www.infosectrain.com/contact-us/" class="text-white" target="_blank">Contact us</a></li>
			...
			<div class="col-12 col-md-3 mt-3 m-md-0">
                <div class="foot_con">
