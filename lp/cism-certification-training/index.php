                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-v2.webp" fetchPriority="high"
                                alt="CISM Online Training by InfosecTrain" width="400" height="400">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/practical-approch.svg"
                                        alt="CISM Online Training Course Highlights" width="45" height="45">
                                    <p>Post-Training Support Until Exam Day</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/customer-service.svg"
                                        alt="CISM Online Training Course Highlights" width="45" height="45">
                                    <p>Telegram Group for Practice Questions </p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/certified-trainner.svg"
                                        alt="CISM Online Training Course Highlights" width="45" height="45">
                                    <p>Official ISACA E-Review Manual</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/learning.svg"
                                        alt="CISM Online Training Course Highlights" width="45" height="45">
                                    <p>Online Test Simulation for Self-Assessment</p>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="faq-wrapper">
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                <p>CISM certification is a unique management-focused certification.
                                        It has been designed is for the individual who manages, designs, oversees
                                            and assesses an enterprise's information security.
                                        it validates your managerial, designing, overseeing skills and expertise.

                                        It brings the best opportunities for anyone in the infosec with an interest
                                            in the managerial aspects of information security, in contrast to the
                                            technical aspects.
                                        Any professional with the required experience can apply for the
                                            certification.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    ...
                                    <ul>
                                        <li>A US$50 application processing fee is required for all submissions.</li>
