...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "RSA Archer Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/common-use-cases-for-rsa-archer/" target="_blank">Common Use Cases for RSA Archer</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/features-of-rsa-archer/" target="_blank">Features of RSA Archer</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/key-differences-between-rsa-archer-and-servicenow/" target="_blank">Key Differences Between RSA Archer and ServiceNow</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/wBsZE7GTmhk?si=D7NVESR70X500h6P">What is Archer, Integrated Risk Management, RSA Archer Tools?</a></li>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=k1m8GoCqzT8">RSA Archer Tutorial For Beginners</a></li>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=MHk2iG-2VU0">Day 1 | Free GRC RSA Archer Administrator tutorial</a></li>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=8GD4xBkxezM">Day 2 | Free GRC RSA Archer Administrator tutorial</a></li>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=c4b-hAR_OF4	">Day 3 | Free GRC RSA Archer Administrator Videos</a></li>
						</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/grc-online-training/">GRC : (Governance, Risk and Compliance) Hands-on</a></li>

<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cgrc-training/">CGRC � Governance, Risk and Compliance Training</a></li>

<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cybersecurity-awareness-program/">Defend and Protect: Cybersecurity Awareness Training</a></li>

<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cyber-security-expert-training/">Cyber Security Expert Online Training</a></li>
...
<tr>
    <td style="padding:0 24px;">
        <a href="https://www.infosectrain.com/pages/download/achieving_GRC_excellence_white_paper.pdf" target="_blank"
            ...
            Download GRC Preparation Guide
        </a>
    </td>
</tr>
