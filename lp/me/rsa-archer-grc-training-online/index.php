...
<body>
    ...
    $api_id = 41425; // Define the API ID
    ...
    <main>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">The Right Path to Governance Risk & Compliance
                            </div>
            ...
            <div class="container-fluid container-lg">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/video-recording.svg" width="42" height="42"
                                        alt="">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    style="background: var(--acent-green);">
                                    <img src="assets/images/highlight-icon/cpe-certificate.svg" width="42" height="42"
                                        alt="">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h2 class="text-center text-md-start">RSA Archer Training - An Overview</h2>
                                <p class="my-3">
                            ...
                            <div class="col-12 mt-4">
                                <div class="accordion d-flex flex-column gap-4">
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <ul class="liststar">
                                                <li>
                                                    ...
                                                    along with RSA Archer resume samples. Take a free sample practice
                                                    test
                                                    before appearing in the certification to improve your chances of
                                                    scoring
                                                    high. Offer advanced and scenario-based interview questions. RSA
                                                    Archer
                                            ...
                                            <a href="https://www.infosectrain.com/wp-content/uploads/2023/05/RSA-Archer-Online-Training-Course.pdf"
                                                target="_blank" class="button d-inline-block mt-3">Download Brochure</a>
                                        </div>
                                    </div>
                                    <!--accordion-item start-->
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>Interactive and hands-on sessions to learn how to navigate the RSA
                                                    Archer system, create applications and dashboards, troubleshoot
                                                    issues,
                                                    and more.</li>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <p>There is no external exam for this RSA Archer course.</p>
                                        </div>
                                    </div>
                                    <!--accordion-item start-->
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <p>It is recommended to have some basic knowledge of GRC and business
                                                processes.</p>
                                        </div>
                                    </div>
                                    <!--accordion-item start-->
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                            <div class="col-12 available-batch">
                                <h2 class="text-center text-md-start">RSA Archer Training Calendar</h2>
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                            <div>
                                <img src="assets/images/form-banner.webp" width="357" height="204" alt="CIPP/E Training"
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    <div class="col-lg-4 col-md-6 pt-4 pt-md-0 ps-md-4">
                        <div class="d-flex flex-column align-items-center align-items-md-start gap-3">
                            <h2>RSA Archer Corporate Training</h2>
                            <p>Upskill Your Team on RSA Archer Training</p>
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="RSA Archer Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the skills</strong> required to ace RSA Archer</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container-fluid container-lg">
                <div class="row g-4 justify-content-center">
                    <div class="col-12">
                        <h2 class="text-center">Benefits of RSA Archer Certification</h2>
                    </div>
                </div>
                <div class="d-flex flex-lg-nowrap flex-wrap justify-content-center gap-4 my-4">
                    ...
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        <img src="assets/images/benifits/cybersecurity-expert.svg" width="24" height="24"
                            alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                        <p class="mb-0">Earn the status of a RSA Archer Expert</p>
                    </div>
                    <!--/ col start /-->
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                ...
                <div class="row g-4">
                    <div class="col-12 f-nunito fs-18 fw-bold text-dark text-center">
                        Average salary range for different RSA Archer profiles
                    </div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <!-- <div class="flex-shrink-0">
                                                <img src="https://www.infosectrain.com/wp-content/uploads/2024/08/Jay-Prakash.png"
                                                    alt="Muhammad Yasir Younus" width="250" height="250">
                                            </div> -->
                                            <div class="flex-grow-1">
                                                <h3>Muhammad Yasir Younus</h3>
                                                <span>Saudi Arabia</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The training course provided a solid introduction to RSA Archer as a tool,
                                        helping me understand its key functionalities and applications. The hands-on
                                        approach made it easier to grasp how Archer supports risk management and
                                        compliance. Overall, it was a valuable learning experience.
                                    </p>
                                </div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <!-- <div class="flex-shrink-0">
                                                <img src="https://www.infosectrain.com/wp-content/uploads/2024/08/Vinay-Soni.png"
                                                    alt="Vinay Soni" width="250" height="250">
                                            </div> -->
                                            <div class="flex-grow-1">
                                                <h3>MAHENDRAN NARAYANAN</h3>
                                                <span>Qatar</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The training was highly informative and well-structured, providing a clear and
                                        comprehensive understanding of RSA Archer’s capabilities. The sessions covered
                                        key functionalities in detail, offering practical insights into how the tool can
                                        be leveraged for risk management, compliance, and governance. The structured
                                        approach, combined with real-world examples, made complex concepts easier to
                                        grasp. Overall, the training was engaging, insightful, and instrumental in
                                        building confidence in using RSA Archer effectively.
                                    </p>
                                </div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <!-- <div class="flex-shrink-0">
                                                <img src="https://www.infosectrain.com/wp-content/uploads/2024/08/Manoj-Gupta.png"
                                                    alt="Manoj Gupta" width="250" height="250">
                                            </div> -->
                                            <div class="flex-grow-1">
                                                <h3>Harshada Sapre</h3>
                                                <span>UAE</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The entire experience with InfosecTrain was smooth, from the enrollment process
                                        to the training sessions. The team was very supportive, and the course content
                                        was well-organized, making it easier to follow and apply. I appreciate the
                                        seamless process and structured learning approach.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="flex-grow-1">
                                                <h3>Sudheer Reddy Settipalli Usannagari</h3>
                                                <span>Saudi Arabia</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        An excellent training session that effectively covered the core functionalities
                                        of RSA Archer. The content was insightful, and the delivery was engaging, making
                                        it easier to understand how the tool can be leveraged for governance, risk, and
                                        compliance.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion d-flex flex-column gap-4">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                <button
                                    ...
                                    <span>How do I become an RSA Archer?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What is Archer in RSA?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What is the salary of an RSA Archer
                                        Developer?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What is the role of an archer?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What is the skill of an Archer?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                                        Some of the common skills required for an Archer include:
                                    </p>
                                    <ul class="liststar">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>How does RSA Archer work?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What are the benefits of RSA Archer?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
