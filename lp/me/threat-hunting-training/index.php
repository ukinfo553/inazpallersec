                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/interview.svg" width="42" height="42" alt="">
                            ...
                            <div class="col-12 mt-4">
                                <div class="accordion d-flex flex-column gap-4">
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <ul class="liststar">
                                                ...
                                                <li>Hunt for Evidence of Adversary who has Breached the Perimeter</li>
                                            ...
                                            <ul class="liststar">
                                                <li>Learn about Windows built-in techniques abused for Lateral Movement
                                                </li>
                                                <li>Learn to scope your Hunt and Incident Response by tracking attacker
                                                    footprints</li>
                                            ...
                                            <ul class="liststar">
                                                <li>Hands-on analysis challenge to hunt threats and perform DFIR</li>
                                            ...
                                            <ul class="liststar">
                                                ...
                                                <li> Hands-on Hunting Report Writing with Hand off to Incident Response
                                                    Teams </li>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <p>
                                                There is no external exam for this Threat Hunting course. However, this
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>Comprehensive understanding of Information Security and its terms
                                                </li>
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="Advanced Threat Hunting Training Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="swiper myAdvisor">
                    <div class="swiper-wrapper justify-content-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="summary">
                                With over 9 years of experience, Madhukar excels in Security Research, IT practices, and
                                information security training, specializing in adversarial research, malware analysis,
                                and threat hunting. He has a strong background in Windows Active Directory security and
                                systems administration, transitioning into R&D to develop innovative threat hunting
                                platforms. His expertise encompasses adversary simulation, security analytics, detection
                                engineering, Digital Forensics and Incident Response (DFIR), and red and blue team
                                research. Madhukar is committed to continuous skill enhancement in offensive and
                                defensive security, malware analysis, and programming.
                            </div>
                        </div>
                        <!--/ col end /-->
                    </div>
                    ...
                    <div class="col-12">
                        <div class="accordion d-flex flex-column gap-4">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                ...
                                <div class="accordion-body">
                                    <p>
                                        ...
                                        attackers
                                        took or altered, and resolve issues. It also focuses on incident response and
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    class="accordion-header f-nunito fs-18 fw-bold p-3 d-flex align-items-center gap-3">
                                    <span>What are the prerequisites for enrolling in the DFIR Training course?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    class="accordion-header f-nunito fs-18 fw-bold p-3 d-flex align-items-center gap-3">
                                    <span>What certificate will I receive upon completing the Advanced Threat Hunting
                                        and DFIR Training?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    InfosecTrain provides you with a 20 CPE certificate of achievement after completion
                                    of this course.
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                ...
                                <div class="accordion-body">
                                    In order to ensure that organizations can protect themselves from cyber attacks, the
                                    Advanced Threat Hunting and DFIR Training is essential to determining the specifics
                                    of cyber incidents. This training will upskill your career and provide you with a
