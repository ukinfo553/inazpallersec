                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">Ace the World of Data Privacy</div>
                            <h1>IAPP - CIPP/E Certification Training Course Online</h1>
                            <div class="fs-18 f-nunito text-dark fw-bold">
                                Get Certified in IAPP's Most Popular Certification
            ...
            <div class="container-fluid container-lg">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/iapp-partner.svg" width="42" height="42"
                                        alt="">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/membership.svg" width="42" height="42"
                                        alt="">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    style="background: var(--acent-green);">
                                    <img src="assets/images/highlight-icon/lms-dpdpa.svg" width="42" height="42" alt="">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    style="background: var(--acent-red);">
                                    <img src="assets/images/highlight-icon/e-book.svg" width="42" height="42" alt="">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    style="background: var(--acent-yellow);">
                                    <img src="assets/images/highlight-icon/roadmap-to-dpdp.svg" width="42" height="42"
                                        alt="">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h2 class="text-center text-md-start">CIPP/E - An Overview</h2>
                                <p class="my-3">
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                            <div class="col-12 available-batch">
                                <h2 class="text-center text-md-start">CIPP/E Training Calendar</h2>
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    <div class="col-lg-4 col-md-6 pt-4 pt-md-0 ps-md-4">
                        <div class="d-flex flex-column align-items-center align-items-md-start gap-3">
                            <h2>CIPP/E Corporate Training</h2>
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="CIPP/E Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Get Immerse in <strong>scenario-based learning</strong></p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the CIPP/E certification &</strong> pass the exam in 1st attempt</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Updated curriculum</strong> aligned with IAPP certification</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/learning-schedule.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Choose our <strong>Flexible Learning</strong> schedule on weekdays or weekends</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container-fluid container-lg">
                <div class="row g-4 justify-content-center">
                    <div class="col-12">
                        <h2 class="text-center">Benefits of CIPP/E Certification</h2>
                    </div>
                </div>
                <div class="d-flex flex-lg-nowrap flex-wrap justify-content-center gap-4 my-4">
                    ...
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        <img src="assets/images/benifits/cybersecurity-expert.svg" width="24" height="24"
                            alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                        <p class="mb-0">Earn the status of a Data Privacy Expert</p>
                    </div>
                    <!--/ col start /-->
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                ...
                <div class="row g-4">
                    <div class="col-12 f-nunito fs-18 fw-bold text-dark text-center">
                        Average salary range for different CIPP/E profiles
                    </div>
                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Syed-Tariq-Mustafal.jpg"
                                    ...
                                    <p class="desc">
                                        The CIPP/E trainer is an experienced course instructor with in-depth knowledge
                                        of the subject matter. He is a very humble person and quite patient with
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Thasneem-Thahzeeb.png"
                                                    alt="Thasneem Thahzeeb" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Dr. Thasneem Thahzeeb</h3>
                                                <span>UAE</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The CIPP/E course was well-structured and informative. It provided a solid
                                        foundation in privacy laws and compliance. The sessions were engaging, and the
                                        instructor's clarity made the material easy to grasp. I learned a lot from this
                                        training.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Habinesh-Jothi.png"
                                                    alt="Habinesh Jothi" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Habinesh Jothi</h3>
                                                <span>UAE</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The training was extremely well-structured and provided a comprehensive
                                        breakdown of CIPP/E concepts. Each session was designed to ensure clarity,
                                        covering key principles in privacy laws, compliance, and data protection. The
                                        interactive discussions and real-world examples made the learning experience
                                        even more engaging. The course not only helped me understand complex topics but
                                        also gave me the confidence to apply this knowledge effectively. Overall, it was
                                        a highly valuable and enriching training program that exceeded my expectations.
                                    </p>
                                </div>
                            </div>
