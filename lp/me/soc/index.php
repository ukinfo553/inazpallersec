                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">Strengthening Cyber Defenses with the Power of
                                SOC</div>
            ...
            <div class="container-fluid container-lg">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/time.svg" width="42" height="42" alt="SOC Training Course Highlights">
                                    <p>48-Hour Instructor-led Online Training</p>
                                </div>
                            </div>
                            <!--col start-->
                            <div class="col-lg-3 col-6">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/interview.svg" width="42" height="42" alt="SOC Training Course Highlights">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/certified-trainners.svg" width="42"
                                        height="42" alt="SOC Training Course Highlights">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    style="background: var(--acent-orange);">
                                    <img src="assets/images/highlight-icon/learning.svg" width="42" height="42" alt="SOC Training Course Highlights">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h3 class="text-center text-md-start f-nunito">SOC Analyst Tools Covered</h3>
                                <img src="https://www.infosectrain.com/wp-content/uploads/2024/11/SOC-Analyst-tools.jpg"
                                    width="850" height="302" class="my-4 rounded d-block img-fluid m-auto" alt="SOC Course Tools">
                                <h2 class="text-center text-md-start">SOC Analyst - An Overview</h2>
                                <p class="my-3">
...
<li>Working on Information Security Role</li>
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                            <div class="col-12 available-batch">
                                <h2 class="text-center text-md-start">SOC Analyst Training Calendar</h2>
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                            <div>
                                <img src="assets/images/form-banner.webp" width="357" height="204"
                                    alt="SOC Training Training" class="w-100 h-auto d-block">
                            </div>
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    <div class="col-lg-4 col-md-6 pt-4 pt-md-0 ps-md-4">
                        <div class="d-flex flex-column align-items-center align-items-md-start gap-3">
                            <h2>SOC Analyst Corporate Training</h2>
                            <p>Upskill Your Entire Team on Security Operations</p>
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="SOC Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container-fluid container-lg">
                <div class="row g-4 justify-content-center">
                    <div class="col-12">
                        <h2 class="text-center">Benefits of SOC Training</h2>
                    </div>
                </div>
                <div class="d-flex flex-lg-nowrap flex-wrap justify-content-center gap-4 my-4">
                    ...
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        <img src="assets/images/benifits/cybersecurity-expert.svg" width="24" height="24"
                            alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                        <p class="mb-0">Earn the status of a Security Operations Expert</p>
                    </div>
                    <!--/ col start /-->
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Douglas-Amorim.png"
                                                    alt="Douglas Amorim Pereira de Arruda" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Douglas Amorim Pereira de Arruda</h3>
                                                <span>UAE</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The SOC Analyst Hands-on Training covered all the essential fundamentals and
                                        tools I was
                                        looking for. The practical, hands-on examples provided great insight into the
                                        functionality of core SOC tools. I also appreciated the recorded sessions and
                                        shared
                                        documents.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Sahaya-Seelan.png"
                                    ...
                                    <p class="desc">
                                        This SOC Analyst training is outstanding. The instructor's delivery is
                                        excellent, and as
                                        a beginner, I found it incredibly valuable for learning cybersecurity
                                        fundamentals.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Topiwala-Mahir.png"
                                                    alt="Topiwala Mahir Mo.idrish" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Topiwala Mahir Mo.idrish</h3>
                                                <span>Kuwait</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        This course is a great starting point for freshers looking to build a career as
                                        a SOC
                                        Analyst. The content starts from the basics and gradually builds up, making it
                                        accessible and engaging. The expert’s guidance was invaluable in helping us
                                        grasp
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Male.png" alt="Emad Hallab"
                                    ...
                                    <p class="desc">
                                        SOC Analyst course provided a truly exceptional learning experience. The
                                        concepts were
                                        explained clearly and concisely, making them easy to grasp. I genuinely enjoyed
                                        the
                                        course, and my understanding of SOC and security has improved remarkably.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Male.png" alt="Baby Jaison"
                                                    width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Baby Jaison</h3>
                                    ...
                                    <p class="desc">
                                        Informative and highly valuable SOC Analyst course for those new to
                                        cybersecurity.
