...
<body>
    ...
    <main>
                        ...
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div class="d-flex flex-md-row flex-column align-items-start gap-3">
                                ...
                                <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/CISSP_2024.pdf"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-3" width="16" height="17"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches" id="training-calendar">
                            <div class="col-12 available-batch">
                                ...
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
                                                <tr class="d-flex align-items-center flex-wrap flex-lg-nowrap">
                                                    <td>Batch Date</td>
                                                    <td>Batch Type</td>
                                                    <td>Training Mode</td>
                                                    <td>Batch Status</td>
                            ...
                            <div class="col-12 not-available-batch d-none">
                                ...
                                <button class="button modal-btn mt-4" modal-title="REQUEST A BATCH">REQUEST A BATCH</button>
                            </div>
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                            <div>
                                <img src="assets/images/form-banner.png" alt="" class="w-100 d-block">
                            </div>
                            <div class="d-flex flex-column gap-3 p-3">
                                ...
                                <p>Save your seat before the batch fills out!</p>
        ...
        <section class="learning-mode-sec pt-0">
            <div class="container">
                <div class="row g-4">
                    <div class="col-12">
        ...
        <section class="p-0">
            <div class="container">
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    <div class="col-lg-4 pt-4 pt-md-0 ps-md-4">
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3 rounded-4 p-3 mt-4"
                            style="background: var(--acent-yellow);">
        ...
        <!--<[reach us sec start]>-->
        <section class="reach-us pb-0" style="background: var(--acent-orange);">
            <div class="container">
    ...
    <section class="footer-fixed">
        ...
        <ul class="mobile-list">
            <!--/ li start /-->
            <li>
                <a href="javascript:void(0)" rel="nofollow" class="modal-btn" modal-title="Enquire Now">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 16" fill="none">
                        <g clip-path="url(#clip0_5863_213)">
                            <path
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="ajax-form d-flex flex-column gap-3">
                    ...
                    <input type="hidden" id="me_others_pop" name="me_others" value="">
