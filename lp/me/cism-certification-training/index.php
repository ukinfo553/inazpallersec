                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Farook-Mohamed-Salim.jpg"
                                    ...
                                    <p class="desc">
                                        InfosecTrain's CISM certification course was a standout experience. The
                                        trainer's insightful and dynamic presentation brought clarity to challenging
                                        concepts.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Shuhaib-Abubacker.jpg" width="250"
                                    ...
                                    <p class="desc">
                                        The CISM course was well-structured, making complex security concepts easy to
                                        understand. The training sessions were detailed and insightful, providing a
                                        strong foundation for IT security management. The expert instructor ensured
                                        clarity in every topic and addressed all queries with patience. Overall, it was
                                        an enriching experience that enhanced my understanding of risk management and
                                        governance.
                                    </p>
                                </div>
                                <!--/ col start /-->
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Nahyan-Almheiri.jpg" width="250"
                                    ...
                                    <p class="desc">
                                        The CISM certification course was both informative and well-structured. The
                                        mentor's exceptional approach made complex topics accessible and engaging.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Jacob-Joseph.jpg" width="250"
                                    ...
                                    <p class="desc">
                                        The trainer was exceptional in explaining every CISM module with clarity and
                                        patience. His expertise made the learning process seamless, breaking down
                                        difficult topics into digestible insights. The structured approach and
                                        real-world applications ensured that I understood security governance concepts
                                        effectively. This course is a fantastic opportunity for professionals aiming to
                                        clear the CISM exam or enhance their cybersecurity management skills. I'm
                                        grateful for the high-quality training provided by InfosecTrain.
                                    </p>
                                </div>
                            </div>
