                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">Achieve and Maintain ISO 27001 Compliance
                                With the Most Intensive</div>
                            <h1>ISO 27001:2022 Lead Auditor Training & Certification</h1>
            ...
            <div class="container-fluid container-lg">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/time.svg" width="42" height="42"
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/free-exam-retake.svg" width="42" height="42"
                                        alt="SOC Training Course Highlights">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    style="background: var(--acent-red);">
                                    <img src="assets/images/highlight-icon/mock-test.svg" width="42" height="42"
                                        alt="SOC Training Course Highlights">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    style="background: var(--acent-yellow);">
                                    <img src="assets/images/highlight-icon/support.svg" width="42" height="42"
                                        alt="SOC Training Course Highlights">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h2 class="text-center text-md-start">ISO 27001 Certification - An Overview</h2>
                                <p class="my-3">
                                    The ISO 27001 certification is a globally recognized standard that sets out the
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                            <div class="col-12 available-batch">
                                <h2 class="text-center text-md-start">ISO 27001 LA Training Calendar</h2>
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    <div class="col-lg-4 col-md-6 pt-4 pt-md-0 ps-md-4">
                        <div class="d-flex flex-column align-items-center align-items-md-start gap-3">
                            <h2>ISO 27001 LA Corporate Training</h2>
                            <p>Enhance your team's Lead Auditing skills</p>
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container-fluid container-lg">
                <div class="row g-4 justify-content-center">
                    <div class="col-12">
                        <h2 class="text-center">Benefits of ISO 27001 LA Training</h2>
                    </div>
                </div>
                <div class="d-flex flex-lg-nowrap flex-wrap justify-content-center gap-4 my-4">
                    ...
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        <img src="assets/images/benifits/cybersecurity-expert.svg" width="24" height="24"
                            alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                        <p class="mb-0">Earn the status of an ISMS audit expert</p>
                    </div>
                    <!--/ col start /-->
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide gladiators-item">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/ISO-27001-LA-5-150x150.jpg"
                                                    alt="Ajmal Nazir" width="250" height="250">
                                            </div>
                                    ...
                                    <p class="desc">
                                        Excellently run training, very impressive. The trainer was extremely thorough
                                        and knowledgeable. He explained
                                        all queries deeply and did not rush anything. It was ensured that everyone fully
                                        understood the concepts. I
                                        highly recommend Infosec Train.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/ISO-27001-LA-4-150x150.jpg"
                                                    alt="Harshada Sapre" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="desc">
                                        ...
                                        that I attended were interactive
                                        and easy to understand. Also, thanks to the support team for their prompt reply
                                        to queries. Thank you, InfosecTrain team.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="https://www.infosectrain.com/wp-content/uploads/2025/03/Umair-Siddiqui.jpg"
                                                    alt="Umair Siddiqui" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Umair Siddiqui</h3>
                                                <span>Saudi Arabia</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The ISO 27001 Lead Auditor course was an excellent learning experience. The
                                        instructor was insightful, empathetic, and dedicated to helping us achieve our
                                        goals. His ability to explain complex topics in a relatable way made the
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="https://www.infosectrain.com/wp-content/uploads/2025/03/Vipin-Raj-RC.jpg"
                                                    alt="Vipin Raj RC" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Vipin Raj RC</h3>
                                                <span>UAE</span>
                                    ...
                                    <p class="desc">
                                        Both the training advisor and the instructor were prompt in addressing questions
                                        and clarifying doubts throughout the course. The training provided an in-depth
                                        understanding of ISO 27001 auditing from an auditor's perspective, offering
                                        valuable knowledge that will benefit both my organization and my personal
                                        growth.
                                    </p>
                                </div>
                            </div>
