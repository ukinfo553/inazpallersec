...
$email_subject = "New Enquiry from CCISO Landing Page"; 
...
$user_body = '<table   class="" role="presentation"  border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr >
      <td style="padding: 20px 0 30px 0; ">
	   ...
	   <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style=" background:#F8F8F8; padding:56px;">
		  
	     <tr >
			<td >
			    <table align="left" border="0" cellpadding="0" cellspacing="0" width="493px" style=" background:#FFFFFF;">
		  
	            <tr>
			        <td >
					 <table align="left" border="0" cellpadding="0" cellspacing="0" width="493px" style=" border-bottom: 1px solid #cccccc;margin-bottom: 40px;">
					<tr>
			        <td >
				...
				<tr>
					...
					<ul><li><a href="https://www.infosectrain.com/blog/cciso-certification-guide/" target="_blank">CCISO Certification Guide </a></li>
  <li><a  href="https://www.infosectrain.com/blog/how-to-prepare-for-cciso/" target="_blank">HOW TO PREPARE FOR CCISO </a></li>
  ...
  <li><a href="https://www.infosectrain.com/blog/cciso-vs-cissp-choose-the-best-for-yourself/">CCISO Vs CISSP : Choose The Best For Yourself</a> </li>
  </ul>
				...
				<tr>
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align: left; font-size:14px;">
					<ul><li><a href="https://www.youtube.com/watch?v=PD2Y1dh5gag&feature=emb_title">Benefits Of CCISO Certification</a> </li>
  <li><a href="https://www.youtube.com/watch?v=AAVYONb7ICQ">Certified Chief Information Security Officer </a> </li>
  <li><a href="https://www.youtube.com/watch?v=l5fR19Ou0g8">What is a CISO? </a> </li>
  <li><a href="https://www.youtube.com/watch?v=FtTtnUzaZh0">Information Security Core Competencies</a> </li>
     </ul>
