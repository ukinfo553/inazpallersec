...
$email_subject = "New Enquiry from Red Team Expert Training Dubai Classroom Landing Page"; 
	     ...
	     <tr >
			<td >
				...
				<tr>
				  ...
				  <h2>View our Blog:</h2>
				<p>
					  <a style="color:#ff4444" href="https://www.infosectrain.com/blog/domain-1-security-and-risk-management/" target="_blank">Domain 1</a> | <a style="color:#ff4444" href="https://www.infosectrain.com/blog/domain-2-asset-security/" target="_blank">Domain 2</a> | <a style="color:#ff4444" href="https://www.infosectrain.com/blog/domain-3-security-architecture-and-engineering/" target="_blank">Domain 3</a>
					  <br> 
					  <br>
					  Download White Paper: <br>
					  <a style="color:#ff4444" href="https://www.infosectrain.com/HOW_TO_PREPARE_FOR_INFOSEC_DOMAIN_White_Paper.pdf" target="_blank">HOW TO PREPARE FOR INFOSEC DOMAIN’S BEST CERTIFICATIONS?</a>
					  <br>
					  <br>
					  ...
					  <br><br>
					  HOW TO PREPARE FOR CISSP: <a style="color:#ff4444" href="https://www.youtube.com/watch?v=UTexPGpJBMY&t" target="_blank">Click Here</a>
					  <br> 
					  </p>
				<br>
				    </td>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp', 
    'page_type' => 'Red Team Expert Dubai Classroom', 
    'name' => $me_name,
    'email' => $me_email, 
    'phone' => $me_phone, 
