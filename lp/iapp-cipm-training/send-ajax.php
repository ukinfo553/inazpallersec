...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "CIPM Landing Page";
            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=FokpPQX6wuM">Unlocking Career Opportunities: DPO Ready with a IAPP CIPM! </a></li>
							</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/european-privacy-training-cippe/">European Privacy Training - CIPP/E Online Training & Certification Course</a></li>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/data-protection-officer-training/">DPO Hands-on Training</a></li>
							</ul>
						</td>
					</tr>
