...
<body>
    ...
    <nav class="navbar navbar-expand-lg py-3">
        <div class="container">
            ...
            <button type="button" class="button2 ms-4 d-none" data-bs-toggle="modal" data-bs-target="#myModal">Get Free
                Demo</button>
        </div>
    </nav>
    <!--/ navbar end /-->
    <main>
        ...
        <header>
            <div class="container">
                <div class="row justify-content-end align-items-center">
                    ...
                    <div class="col-lg-8">
                        <div class="item">
                            <h1>Certified Information <br> Systems Security Professional</h1>
                            <p class="d-none d-md-block">Join the CISSP (2024) Certification Exam Preparation Training</p>
                            <p>Get on Top of the League <br class="d-md-none"> with CISSP New Version 2024 Certification</p>
                            <div class="d-flex align-items-start mt-2 mt-md-4">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#myModal">Get Free
                                    Demo</button>
                                    ...
                                    <div class="d-flex review-star flex-row mb-3 mt-md-0 ms-md-3">
                                        <div class="flex-shrink-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                                viewBox="0 0 32 32">
                                                <path fill="#00a264"
                                                    d="M22.859 27.427H4.573A4.571 4.571 0 0 0 9.141 32h13.714a4.572 4.572 0 0 0 4.573-4.573V8.656a.165.165 0 0 0-.167-.167h-4.24a.163.163 0 0 0-.161.167v18.776zm0-27.427a4.571 4.571 0 0 1 4.568 4.573H9.146v18.771a.171.171 0 0 1-.167.167h-4.24a.168.168 0 0 1-.167-.167V4.573A4.571 4.571 0 0 1 9.14 0h13.719z" />
                                            </svg>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-md-3">
                                            <h5>Glassdoor</h5>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-6 my-3 m-lg-0 border-left-0">
                        <img src="assets/img/icons/Time-Limit.webp" alt="Course Time" loading="lazy">
                        <div class="title">48-Hours</div>
                        <div class="sub-title">Course</div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-2 col-md-4 col-6 my-3 m-lg-0">
                        <img src="assets/img/icons/Training.webp" alt="Virtual Training" loading="lazy">
                        <div class="title">Virtual</div>
                        <div class="sub-title">Instructor-Led</div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-2 col-md-4 col-6 my-3 m-lg-0">
                        <img src="assets/img/icons/Test-Passed.webp" alt="Exam Practice" loading="lazy">
                        <div class="title">Full 8-Domain</div>
                        <div class="sub-title">Exam Practice</div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-2 col-md-4 col-6 my-3 m-lg-0">
                        <img src="assets/img/icons/Laptop.webp" alt="Online Test Simulation" loading="lazy">
                        <div class="title">Online</div>
                        <div class="sub-title">Test Simulation</div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-2 col-md-4 col-6 my-3 m-lg-0">
                        <img src="assets/img/icons/Medal.webp" alt="Exam Pass Rate" loading="lazy">
                        <div class="title">98%</div>
                        <div class="sub-title">Pass Rate</div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-2 col-md-4 col-6 my-3 m-lg-0">
                        <img src="assets/img/icons/technical-support.webp" alt="Training Support" loading="lazy">
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-6 col-md-6 mt-4 mt-md-0">
                        <div class="item">
                            ...
                            <p>The Certified Information Systems Security Professional (CISSP®) certification training
                                course offered by InfosecTrain is perfectly suited for individuals working in the field
                                of information security.</p>
                            <p> The latest version (2024) of CISSP enhances the participant’s understanding by covering
                                the critical elements of the 8 domains that comprise the Common Body of Knowledge
                                (CBK)®. This course aims to equip learners with both the technical and managerial
                                competencies required to design, architect, and oversee an organization’s security
                                framework in alignment with internationally accepted information security principles.
                            </p>
                        ...
                        <div class="card item-two px-3">
                            ...
                            <div class="card-body pb-4">
                                ...
                                <form method="post" action="" onSubmit="return val_demo_request(this.form);"
                                    ...
                                    <input type="text" name="me_message" id="me_message"
                                    ...
                                    <button type="submit" name="me_submited" id="me_submited">Request a
                                        Callback</button>
                                </form>
                            ...
                            <img src="assets/img/form-person.webp" alt="CISSP Training" loading="lazy"
                                class="form-person" />
                        </div>
                    </div>
                </div>
        ...
        <section class="tab-section pt-md-0 pb-5" id="course-details">
                    ...
                    <div class="tab-content accordion p-0" id="myTabContent">
                        ...
                        <div class="tab-pane fade accordion-item" id="objectives-tab-pane">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse d-md-block"
                                ...
                                <div class="accordion-body cdbody">
                                    <ul>
                                        <li class="star">Master core concepts of risk management, security governance,
                                            and compliance.</li>
                                        <li class="star">Understand the ethical and legal requirements impacting
                                            information security.</li>
                                        <li class="star">Learn to classify information and assets, ensuring appropriate
                                            protection.</li>
                                        <li class="star">Understand data security controls and asset retention.</li>
                                        <li class="star">Gain insights into secure design principles, engineering
                                            processes, and security models.</li>
                                        <li class="star">Apply cryptography and secure architecture solutions
                                            effectively.
                                        <li class="star">Develop skills in designing and protecting network security.
                                        </li>
                                        <li class="star">Manage secure network architecture and components.</li>
                                        <li class="star">Implement comprehensive IAM solutions, including access
                                            control, identity management, and authentication mechanisms.</li>
                                        <li class="star">Integrate third-party identity services and manage identities
                                            across different platforms.</li>
                                        <li class="star">Conduct assessments and testing of security systems to identify
                                            vulnerabilities.</li>
                                        <li class="star">Analyze and interpret test data to enhance security measures.
                                        </li>
                                        <li class="star">Understand operational security controls, incident management,
                                            and disaster recovery.</li>
                                        <li class="star">Support forensic investigations and understand the foundations
                                            of operational security.</li>
                                        <li class="star">Enforce security controls in software development environments.
                                        </li>
                                        <li class="star">Integrate security throughout the Software Development Life
                                            Cycle (SDLC).</li>
                        ...
                        <div class="tab-pane fade accordion-item" id="exams-details-tab-pane">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse d-md-block"
                                ...
                                <div class="accordion-body cdbody">
                                    <ul>
                                        <li class="star"><strong>Duration</strong> : 3 Hours</li>
                                        <li class="star"><strong>Number of questions</strong> : 150</li>
                                        ...
                                        <li class="star"><strong>Exam language</strong> : English, French, German,
                                            Brazilian, Portuguese, Spanish, Japanese, Simplified Chinese, Korean,
                        ...
                        <div class="tab-pane fade accordion-item" id="prerequisites-tab-pane">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse d-md-block"
                                ...
                                <div class="accordion-body cdbody">
                                    ...
                                    <ul>
                                        <li class="star">Have a minimum 5 years of cumulative paid full-time work
                                            experience in two or more of the 8 domains of the (ISC)² CISSP® Common Body
                                            of Knowledge (CBK)</li>
                                        <li class="star">One-year experience waiver can be earned with a 4-year college
                                            degree, or regional equivalent or additional credential from the (ISC)²
                                            approved list</li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="text-center mt-4 mt-md-5">
                <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/cissp-course.pdf"
                    target="_blank" download="cissp course content" class="brochureBtn">Download Course Brochure</a>
            </div>
        </section>
        <!--/ tab sec end /-->
                ...
                <div class="swiper mySwiper mt-4 pb-5">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide advisor-item">
                            ...
                            <p>CISSP-ISSAP | CGRC | CCSP | CSSLP | CCISO | CISM | CISA | CRISC | CGEIT | CIPM | CIPPE | CDPSE
                            </p>
                        </div>
                        <div class="swiper-slide advisor-item">
                            <h4>K K Singh</h4>
                            <p>18+ Years of Experience</p>
                            <p>CISSP | CCSP | CISM | CRISC | CISA | CCSK | CCAK | CEH | RHCSA</p>
                        </div>
                        <div class="swiper-slide advisor-item">
                            <h4>Prashant</h4>
                            <p>17+ Years of Experience</p>
                            <p>CISSP | CCSP | C|EH | CPISI</p>
                        </div>
                        <div class="swiper-slide advisor-item">
                            <h4>Venkatesh</h4>
                            <p>17+ Years of Experience</p>
                            <p>Cybersecurity Chapter Leader</p>
                        </div>
                        <div class="swiper-slide advisor-item">
                            <h4>Sujay</h4>
                            <p>15+ Years of Experience</p>
                            <p>CISSP | CSOA | CCSP | ISO 27001 Lead Auditor | ITIL v3</p>
                        </div>
                        <div class="swiper-slide advisor-item">
                            <h4>Biswadip</h4>
                            <p>10+ Years of Experience</p>
                            <p>CISSP | ISO/IEC 27001 | AZ-900 | CCNP | CHFI</p>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-6 mt-4">
                        <div class="item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 44 50"
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mt-4">
                        <div class="item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 39 49"
                                fill="none" class="hoverable">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 mt-4">
                        <picture>
                            <source media="(min-width:768px)" srcset="assets/img/benifits.webp" alt="cissp benifits"
                                loading="lazy" class="img-fluid m-auto d-block">
                ...
                <div class="swiper myGladiators mt-4 py-5">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <img src="assets/img/SureshKumarC.webp" alt="Suresh Kumar" loading="lazy">
                            <h4>Suresh Kumar C</h4>
                            <span>United Arab Emirates</span>
                            <img src="assets/img/icons/review.webp" alt="review" loading="lazy">
                            <p>
                                It was a great experience to get my training from InfosecTrain. The trainer was
                                accommodating and warm throughout the training sessions and a well knowledgeable person.
                                He explained the concepts in simple terms and delivered the course in easy and an
                                understandable manner. Any day it will be a delight to attend trainings at InfosecTrain.
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <img src="assets/img/Gokul-Govindan.webp" alt="Gokul Govindan" loading="lazy">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <img src="assets/img/zuber.webp" alt="Sayed Zuber" loading="lazy">
                            <h4>Sayed Zuber</h4>
                            <span>india</span>
                            <img src="assets/img/icons/review.webp" alt="review" loading="lazy">
                            <p>
                                The trainers are amazing. Before joining the course, I had tried learning from videos
                                online but did't understand 5% of CISSP Concept . After getting training from
                                InfosecTrain I learned and cleared almost every doubt reagrding CISSP .. Now I feel very
                                confident to attempt CISSP after completing this training . I thank my trainer from the
                                bottom of my heart for giving such wonderful training and clearing a lot of concepts.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <img src="assets/img/Namith-Devraj.webp" alt="Namith Devraj" loading="lazy">
                            <h4>Namith Devraj</h4>
                            <span>india</span>
                            <img src="assets/img/icons/review.webp" alt="review" loading="lazy">
                            <p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <img src="assets/img/Rafi.webp" alt="Mohamed Rafi" loading="lazy">
                            <h4>Mohamed Rafi</h4>
                            <span>Kuwait</span>
                            <img src="assets/img/icons/review.webp" alt="review" loading="lazy">
                            <p>
                                ...
                                I liked the trainer's quick response. The course at InfosecTrain has surpassed my
                                expectations.
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <img src="assets/img/Reema-Patil.webp" alt="Reema Patil" loading="lazy">
                            <h4>Reema Patil</h4>
                            <span>india</span>
                            <img src="assets/img/icons/review.webp" alt="review" loading="lazy">
                            <p>
                        ...
                        <div class="accordion" id="myAccordion">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading1">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse"
                                        data-bs-target="#collapse1"> What is CISSP certification?</button>
                                </h2>
                                <div id="collapse1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body faqbody">
                                        <p>
                                            ...
                                            certification is a globally recognized credential in the field of
                                            information security. It is designed for IT professionals who wish to
                                            demonstrate their expertise in designing, implementing, and managing a
                                            best-in-class cybersecurity program. The certification is offered by (ISC)²,
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading2">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse2">How can I prepare for the CISSP exam?</button>
                                </h2>
                                <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>
                                            Preparing for the CISSP exam can be a comprehensive process. Here's a
                                            condensed guide with key pointers to help you get ready for the exam:

                                        </p>
                                        <ul>
                                            <li class="star">Make a study plan</li>
                                            <li class="star">Join study groups for collaboration</li>
                                            <li class="star">Prioritize understanding over memorization</li>
                                            <li class="star">Regularly practice with mock exams</li>
                                            <li class="star">Ensure materials are current with the exam outline</li>
                                            <li class="star">Enroll in structured learning</li>
                                            <li class="star">Study with the <strong>Official (ISC)² CISSP CBK
                                                    Reference</strong> and Study Guide</li>
                                            <li class="star">Simplify concepts with <strong>CISSP For Dummies</strong>
                                            </li>
                                            <li class="star">Take <strong>Official (ISC)² Practice Tests.</strong></li>
                                            <li class="star">Use <strong>Boson Practice Exams</strong> for simulation.
                                            </li>
                                            <li class="star">Read <strong>How To Think Like A Manager</strong> for the
                                                <strong>CISSP Exam</strong> for strategy.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading3">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse3">What are the prerequisites for CISSP certification?

                                    </button>
                                </h2>
                                <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>To apply for the CISSP® course certification, you need to:
                                        ...
                                        <ul>
                                            ...
                                            <li class="star">Have a minimum of 5 years of cumulative paid full-time work
                                                experience in two or more of the 8 domains of the (ISC)² CISSP® Common
                                                Body of Knowledge (CBK).</li>
                                            <li class="star">A one-year experience waiver can be earned with a 4-year
                                                college degree, regional equivalent, or additional credential from the
                                                (ISC)² approved list.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading4">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse4">How many attempts do I have to pass the CISSP
                                        exam?</button>
                                </h2>
                                <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>
                                            (ISC)² does not limit the number of times you can attempt the CISSP exam,
                                            but there are waiting periods between attempts. Typically, you must wait 30
                                            days after your first failed attempt and 90 days after subsequent failed
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading5">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse5">What is the passing score for the CISSP
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading6">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse6">What are CPEs?</button>
                                </h2>
                                <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>
                                            Continuing Professional Education (CPE) credits are required to maintain
                                            your CISSP certification. CISSP holders must earn and report a minimum of 40
                                            CPE credits per year and a total of 120 CPE credits over the three-year
                                            certification cycle.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading7">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse7">Is the CISSP exam difficult to pass?</button>
                                </h2>
                                <div id="collapse7" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>
                                            The CISSP exam is widely recognized for its rigorous assessment of a
                                            candidate's understanding across the broad spectrum of information security
                                            topics, demanding a deep and comprehensive knowledge of its eight domains.
                                            While it poses a significant challenge, dedicated and well-prepared
                                            candidates can navigate its complexities successfully with the right
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading8">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse8">How long is the CISSP certification valid
                                        for?</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading9">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse9">What are the career prospects after CISSP
                                ...
                                <div id="collapse9" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>
                                            ...
                                            positions in information security, such as:</p>
                                        <ul>
                                            <li class="star">Chief Information Security Officer (CISO)
                                            <li class="star">Security Manager</li>
                                            <li class="star">IT Director/Manager</li>
                                            <li class="star">Security Auditor</li>
                                            <li class="star">Security Architect</li>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading10">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        data-bs-target="#collapse10">Can I take the CISSP exam online or at a testing
                                        center?</button>
                                </h2>
                                <div id="collapse10" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>
                                            The CISSP exam is available at authorized Pearson VUE testing centers
                                            worldwide. (ISC)² does not offer the CISSP exam in an online format that can
                                            be taken remotely.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading11">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                        ...
                                        How long does it take to prepare for the CISSP exam?</button>
                                </h2>
                                <div id="collapse11" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                    <div class="accordion-body faqbody">
                                        <p>
                                            Preparation time varies by individual, depending on background, experience,
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-6">
                        <a href="https://api.whatsapp.com/send?phone=918767256840&amp;text=Hi" target="_blank"
                            class="item justify-content-lg-center">
                    ...
                    <div class="col-lg-4 col-md-6 my-4 my-md-0">
                        <div class="item justify-content-lg-center d-flex">
                            ...
                            <div>
                                <span class="fw-bold"> <a href="tel:1800-843-7890" target="_blank"
                                        class="text-white text-decoration-none">1800-843-7890 (IN)</a></span>
                                <span class="fw-bold"> <a href="tel:+16572211127" target="_blank"
                                        class="text-white text-decoration-none">+1 657-221-1127 (USA)</a></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
