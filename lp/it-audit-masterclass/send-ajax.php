...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from Hands-On IT Audit Skills to Lead & Scale Page";
            ...
            <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:0 0 8px 0; font-family:Arial, Helvetica, sans-serif; font-weight:700; font-size:24px; line-height:1.3; color:#111827;">
                  Hands-On IT Audit Skills to Lead & Scale
                </td>
              </tr>
              <tr>
                <td style="padding:0 0 12px 0; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.6; color:#374151;">
                  <img src="https://www.infosectrain.com/wp-content/uploads/mail_images/eventmail_cal.png" alt="" style="vertical-align:middle; border:0;">&nbsp;29-30 November 2025
                  &nbsp;&nbsp;
            ...
            <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="50%" valign="top" style="padding:12px; text-align:center;">
                  <img src="https://www.infosectrain.com/wp-content/uploads/2025/10/aarti.png" alt="Speaker 1" width="80" height="80" style="display:block; margin:0 auto; border-radius:50%; border:0; width:80px; height:80px;">
                  ...
                  <div style="font-family:Arial, Helvetica, sans-serif; font-weight:700; font-size:16px; color:#111827; padding-top:6px;">Aarti</div>
<div style="font-family:Arial, Helvetica, sans-serif; font-weight:700; font-size:10px; color:#FF1046; letter-spacing:.08em; text-transform:uppercase; padding-top:8px;">17+ Years of Experience</div>
                  <div style="font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:1.6; color:#4B5563; padding-top:4px;">CISA | CSX | CISM | CIA (Part 1) | CCAK | Cloud Compliance | Risk & Audit Specialist</div>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td align="center" style="padding:0 24px 12px 24px;">
            ...
            <![endif]-->
            <!--[if !mso]><!-- -->
            <a href="https://zoom.us/j/97295527436?pwd=kyLVUAc8CXmF8BgsR8N5atvZk42MTJ.1" target="_blank"
            ...
            <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="background:#F3F4F6; border-radius:6px;">
              <tr>
                <td style="padding:12px 14px; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:1.6; color:#111827;">
                  <strong>Link:</strong> <a href="https://zoom.us/j/97295527436?pwd=kyLVUAc8CXmF8BgsR8N5atvZk42MTJ.1" target="_blank" style="color:#FF1046; text-decoration:underline;">https://zoom.us/j/97295527436?pwd=kyLVUAc8CXmF8BgsR8N5atvZk42MTJ.1</a><br>
                  <strong>Password:</strong> 474795
                </td>
              </tr>
            </table>
          </td>
    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td style="padding:6px 8px 0 0;">
          <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Hands-On%20IT%20Audit%3A%20Skills%20to%20Lead%20%26%20Scale&details=Webinar%20link%3A%20https%3A%2F%2Fzoom.us%2Fj%2F97295527436%3Fpwd%3DkyLVUAc8CXmF8BgsR8N5atvZk42MTJ.1%0APasscode%3A%20474795%0AEvent%20page%3A%20https%3A%2F%2Fwww.infosectrain.com%2Fpages%2Flp%2Fit-audit-masterclass%2F&location=Online&dates=20251129T133000Z%2F20251129T173000Z"
             target="_blank"
        ...
        <td style="padding:6px 8px 0 0;">
          <a href="https://outlook.live.com/calendar/0/deeplink/compose?rru=addevent&subject=Hands-On%20IT%20Audit%3A%20Skills%20to%20Lead%20%26%20Scale&body=Webinar%20link%3A%20https%3A%2F%2Fzoom.us%2Fj%2F97295527436%3Fpwd%3DkyLVUAc8CXmF8BgsR8N5atvZk42MTJ.1%0APasscode%3A%20474795%0AEvent%20page%3A%20https%3A%2F%2Fwww.infosectrain.com%2Fpages%2Flp%2Fit-audit-masterclass%2F&location=Online&startdt=2025-11-29T19%3A00%3A00&enddt=2025-11-29T23%3A00%3A00"
             target="_blank"
             style="display:inline-block; background:#EBEBEB; color:#232020; font-family:Arial, Helvetica, sans-serif; font-size:14px; padding:8px 16px; border-radius:6px;">
            Outlook.com
          </a>
        ...
        <td style="padding:6px 0 0 0;">
          <a href="https://calendar.yahoo.com/?v=60&title=Hands-On%20IT%20Audit%3A%20Skills%20to%20Lead%20%26%20Scale&desc=Webinar%20link%3A%20https%3A%2F%2Fzoom.us%2Fj%2F97295527436%3Fpwd%3DkyLVUAc8CXmF8BgsR8N5atvZk42MTJ.1%0APasscode%3A%20474795%0AEvent%20page%3A%20https%3A%2F%2Fwww.infosectrain.com%2Fpages%2Flp%2Fit-audit-masterclass%2F&in_loc=Online&st=20251129T190000&et=20251129T230000"
             target="_blank"
             style="display:inline-block; background:#EBEBEB; color:#232020; font-family:Arial, Helvetica, sans-serif; font-size:14px; padding:8px 16px; border-radius:6px;">
            Yahoo
          </a>
    ...
    <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #E6E8EB;">
      ...
      <tr>
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:1.7; color:#374151; padding-top:6px;">
          <div style="font-weight:700; color:#111827; margin-top:4px;">Day 1 (4-Hour Session)</div>
          <ul style="margin:8px 0 12px 18px; padding:0; list-style-type:disc; list-style-position:outside;">
            <li>Laying the Foundation (7 PM to 11)</li>
          </ul>

          <div style="font-weight:700; color:#111827; margin-top:4px;">Day 2 (4-Hour Session)</div>
          <ul style="margin:8px 0 0 18px; padding:0; list-style-type:disc; list-style-position:outside;">
            <li>Scaling Audit Skill (7 PM – 11 PM)</li>
          </ul>
        </td>
      </tr>
    </table>
...
';
    ...
    $data = array(
        ...
        'page_type' => 'Hands-On IT Audit Skills to Lead & Scale',
