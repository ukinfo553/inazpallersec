...
if (isset($_POST['me_submited'])) {
    ...
    $me_pagetype = $me_pagetype;
    /*if($me_others == "Talk to Our Expert" || $me_others == "Enroll Now" ||
       $me_others == "" || $me_others == "1-TO-1 TRAINING" ||
       $me_others == "ONLINE TRAINING" || $me_others == "CORPORATE TRAINING" ||
       $me_others == "Corparate Training" || $me_others == "Get in touch" || $me_others == "Get Free Demo")*/
    if ($me_pagetype != "") {
        $page_type = $me_pagetype;
    } else {
        $page_type = "GRC";
    ...
    $email_subject = "Governance, Risk & Compliance Training";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                ...
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/best-practices-for-grc-framework/" target="_blank">Best Practices for GRC Framework</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/attributes-to-look-for-in-a-grc-platform/" target="_blank">Attributes to Look for in a GRC Platform</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/grc-interview-questions/" target="_blank">Governance, Risk, and Compliance (GRC) Interview Questions</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/_S4t9S5N4Ts?si=dTviXqI8wN7gMaQq">Career in GRC and Find Your Path to Success</a>
                                </li>
                                <li>
