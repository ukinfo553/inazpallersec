...
$email_subject = "New Enquiry from CISA Dubai Classroom Landing Page"; 
...
$user_body = '<table   class="" role="presentation"  border="0" cellpadding="0" cellspacing="0" width="100%">
	   ...
	   <table align="center" border="0" cellpadding="0" cellspacing="0" width="700" style=" background:#F8F8F8; padding:56px;">
	     ...
	     <tr >
			<td >
				...
				<ul><li><a  href="https://www.infosectrain.com/blog/cisa-job-practice-old-vs-new/" target="_blank">CISA Job Practice (Old vs New)</a></li>
				 <a href="https://www.infosectrain.com/blog/cisa-certification-how-to-prepare-for-the-exam/" target="_blank">CISA Certification : How To Prepare For The Exam?</a></li>
				</ul>	  <br> <br>
  ...
  <li><a href="https://www.infosectrain.com/courses/ceh-v11-certification-training/">EC-COUNCIL CEH V11 </a> </li>
  <li><a href="https://www.infosectrain.com/courses/comptia-security-syo-601-training/">COMPTIA SECURITY+ </a> </li>
     </ul>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp', 
    'page_type' => 'CISA Dubai Classroom', 
    'name' => $me_name,
    'email' => $me_email, 
    'phone' => $me_phone, 
