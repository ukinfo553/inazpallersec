...
$courseID = 30768;  // Change this to the specific course ID for different pages
...
<head>
    ...
    <title>CCSP Training & Certification Course</title>
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3 class="d-none d-lg-block">Become A Certified Cloud Security Professional</h3>
                            <h1>CCSP Training & Certification Course</h1>
                            ...
                            <div class="d-flex flex-row banner-highlights">
                                ...
                                <div>
                                    <span> $149,000</span>
                                    <p>Median Salary of Cloud Security Professionals</p>
                                </div>
                            </div>
                            ...
                            <img src="assets/images/review-mob-img.png" alt="CCSP Training Course Review"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/CCSP ME Course-BANNER.webp" fetchPriority="high"
                                alt="CCSP ME Course-BANNER" width="400" height="400">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.svg"
                                        alt="CCSP Training Course Highlights" width="45" height="45">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/customer-service.svg"
                                        alt="CCSP Training Course Highlights" width="45" height="45">
                                    <p>Learn Better with Flash Cards & Mind Maps</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                            ...
                            <div class="item-footer d-flex">
                                <img src="assets/images/highlight-icon/100-satisfaction.webp"
                                    alt="CCSP Training Course Highlights" width="150" height="150">
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                Cloud Audit | CCSP | CCSK | CCAK | AWS CS-S | AWS CAN–S | AWS CSA-P | AWS CDE-P | MCT | CCAK | Azure Adv. Architect & Security | GCP PCA | GCP PCSE | CEH | RHCE | AIGP
                            </div>
                            <div class="summary">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Regular assessments</strong>,knowledge checks and case studies</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the exam</strong> and achieve success with 98% Success Rate</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of CCSP Training</h2>
                    </div>
                </div>
                        ...
                        <div class="benifits-item-two">
                            ...
                            <picture>
                                <source media="(min-width:768px)" width="1472" height="486"
                                    srcset="assets/images/benifits/benefits-CCSP.webp">
                                <img src="assets/images/benifits/benefits-CCSP-mob.webp" width="640" height="473"
                                    alt="Benefits of CCSP  Certification">
                            </picture>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                                ...
                                <div class="overlay" id="overlay">
                                    <div class="play-button" onClick="playVideo()" id="playButton">
                                        <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                            alt="CCSP Success Story" width="150" height="150">
                                    </div>
                                </div>
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.webp" alt="CCSP Success Story"
