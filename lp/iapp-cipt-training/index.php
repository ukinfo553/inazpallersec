...
<head>
    ...
    <title>Master Data Privacy in Tech: CIPT Certification Course Online</title>
    <meta name="description"
        content="The CIPT Certification Training Course equips you to build robust privacy frameworks. This in-demand course teaches you how to integrate privacy into your daily work.">
...
<body>
    ...
    $brochureLink = json_decode(file_get_contents("https://www.infosectrain.com/api/brochure_byid.php?id=39514"), true)[0]['brochure'] ?? null;
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3 class="d-none d-lg-block">Ace the World of Data Privacy</h3>
                            <h1>IAPP - CIPT Certification Training</h1>
                            <h3>
                            ...
                            <div class="button-sec">
                                <button class="cta-button modal-btn" title="Talk to Our Expert"
                                    modal-title="TALK TO OUR EXPERT">Talk to Our
                                    Expert</button>
                                <a href="<?php echo $brochureLink; ?>" target="_blank" class="cta-button">Download
                                    Brochure</a>
                            </div>
                            <img src="assets/images/review-mob-img.png" alt="CIPT Course Review" width="636" height="34"
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.png" alt="CIPT Course Highlights"
                                        width="45" height="45">
                                ...
                                <div class="col-highlights">
                                    ...
                                    <p>8-Hour LMS Training (Includes Mock Questions & DPDPA Foundation) </p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/instructor.png" alt="CIPT Course Highlights"
                                        width="45" height="45">
                                    <p>IAPP Certified Instructors</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/membership.png" alt="CIPT Course Highlights"
                                        width="45" height="45">
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/e-book.png" alt="CIPT Course Highlights"
                                        width="45" height="45">
                                    <p>IAPP e-Book & Notes</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/cipt-logo.png" width="543" height="112"
                                    alt="CIPT Course Highlights">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>CIPT - An Overview</h2>
                                <p>
                                    The CIPT certification course equips you with the skills to design and implement a
                                    comprehensive privacy structure. This online training program gives you a deeper
                                    understanding of how privacy integrates with technology. After completing the
                                    training, you can incorporate privacy practices into your work and help businesses
                                    create effective strategies, policies, and processes that keep data secure while
                                    allowing them to leverage valuable information for business success.
                                </p>
                            </div>
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        <p><strong>Module 1: Foundational Principles of Privacy in Technology</strong>
                                        </p>
                                        <ul>
                                            <li>Understand foundational concepts of embedding privacy through privacy by
                                                design and value-sensitive design</li>
                                            <li>Learn the data life cycle and common privacy risk models and frameworks
                                            </li>
                                        </ul>
                                        <p><strong>Module 2: The Role of the Technology Professional in Privacy</strong>
                                        </p>
                                        <ul>
                                            <li>Grasp privacy fundamentals relevant to technology professionals</li>
                                            <li>Understand the role of a privacy technologist in compliance and
                                                stakeholder privacy expectations</li>
                                            <li>Explore the connection between privacy and security</li>
                                        </ul>
                                        <p><strong>Module 3: Privacy Threats and Violations</strong></p>
                                        <ul>
                                            <li>Identify privacy risks at different stages of the data life cycle</li>
                                            <li>Learn how software security mitigates privacy threats</li>
                                            <li>Recognize the privacy impacts of behavioral advertising, cyberbullying,
                                                and social engineering</li>
                                        </ul>
                                        <p><strong>Module 4: Technical Measures and Privacy-Enhancing
                                                Technologies</strong></p>
                                        <ul>
                                            <li>Explore strategies to enhance privacy throughout the data life cycle
                                            </li>
                                            <li>Learn about identity and access management, authentication, encryption,
                                                and data aggregation</li>
                                            <li>Understand best practices for collection and use of personal information
                                            </li>
                                        </ul>
                                        <p><strong>Module 5: Privacy-by-Design Methodology</strong></p>
                                        <ul>
                                            <li>Understand the process and methodology of privacy-by-design</li>
                                            <li>Learn how to maintain ongoing vigilance when implementing privacy by
                                                design</li>
                                        </ul>
                                        <p><strong>Module 6: Privacy Engineering</strong></p>
                                        <ul>
                                            <li>Discover the role and objectives of privacy engineering within
                                                organizations</li>
                                            <li>Learn about privacy design patterns and software privacy risks</li>
                                        </ul>
                                        <p><strong>Module 7: Technology Challenges for Privacy</strong></p>
                                        <ul>
                                            <li>Identify unique privacy challenges in online environments</li>
                                            <li>Understand issues related to automated decision making, tracking,
                                                surveillance, anthropomorphism, ubiquitous computing, and mobile social
                                                computing</li>
                                        </ul>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <p>
                                            <strong>Upon successful completion of the course, participants will be able
                                                to:</strong>
                                        </p>
                                        <ul>
                                            <li>Understand critical privacy concepts and best practices relevant to IT
                                            </li>
                                            <li>Recognize consumer privacy expectations and organizational
                                                responsibilities</li>
                                            <li>Integrate privacy into IT products and services early to reduce costs,
                                                improve accuracy, and accelerate time to market</li>
                                            <li>Develop and implement privacy policies for data collection and transfer
                                            </li>
                                            <li>Identify and address privacy challenges specific to the Internet of
                                                Things (IoT)</li>
                                            <li>Communicate privacy concerns effectively with stakeholders across
                                                management, development, marketing, and legal teams</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            ...
                                            <li>
                                                <p><strong>Number of Questions:</strong> 90 out of which 75 are scored
                                                </p>
                                            </li>
                                            <li>
                                ...
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Pre-requisites</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <p>The CIPT certification has no set requirements.</p>
                                ...
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Target Audience</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <p><strong>The training is ideal for:</strong></p>
                                        <ul>
                                            ...
                                            <li>Anyone involved with data protection processes and programs</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>CIPT Training Calendar</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <?php
                        $url = "https://www.infosectrain.com/api/39514/href_toscroll/free_demo";
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Conquer the CIPT certification & <strong>pass the exam in 1st attempt</strong> </p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Earn <strong>global recognition</strong> with IAPP CIPT certification</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Updated curriculum aligned with IAPP certification</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of CIPT Certification</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of a Data Privacy</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            ...
                            <picture>
                                ...
                                <img src="assets/images/benifits/benefits-mobile.webp" width="960" height="796"
                                    alt="Benefits of CIPT Certification">
                            </picture>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/04/Shahid-Muzafar-Kanji.jpg"
                                            alt="Shahid Muzafar Kanji" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Team Infosectrain, it was a pleasure interacting with your entire team starting with the
                                supporting team. The trainers for the CIPT course were top-notch, and it was a golden
                                opportunity. A month well invested. Hope to come back soon for further certification.
                                Thanks a ton!
                            </p>
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/04/Vinay-Kumar-Yedurmane-Nagaraj.jpg"
                                            width="250" height="250" alt="Vinay Kumar Yedurmane Nagaraj">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Vinay Kumar Yedurmane Nagaraj
                                        </h3>
                                        <span>India</span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The CIPT course at Infosectrain provided highly informative training sessions, led by
                                exceptionally knowledgeable and skilled trainers.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/04/Karthikeyan.jpg"
                                            width="250" height="250" alt="Karthikeyan A">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Karthikeyan A
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item active open">
                                <h3 class="faq-title"><span class="title">What is CIPT?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        The Certified Information Privacy Technologist certification is developed by
                                        International Association of Privacy Professionals (IAPP) to examine the
                                        knowledge of privacy-related concerns and procedures in relation to the
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Is CIPT certification worth it?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Employers who recognise the value of data privacy to their business, profit
                                        fairly from the CIPT certification. So, the CIPT certification is a good add on
                                        to your resume.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title"> How many questions are there in the CIPT
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What is the duration of the CIPT
                                        exam?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>The duration for the CIPT exam is 150 minutes.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How can I schedule the CIPT exam?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        This exam, like all IAPP exams, can be taken either virtually from your home or
                                        office, or in-person at a test center, and must be completed within one year of
                                        purchase. In-person testers can choose from over 6,000 Pearson VUE test centers
                                        across the globe.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="CIPT Training" id="me_others_footer" name="me_others">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // get next batch data for banner view code start
        const startDate = [...document.querySelectorAll('.table_training .row-2')]
            .find(data => data.querySelector('.column-6[data-label="Batch Status"]').textContent.trim() === '[ Open ]')
            ?.querySelector('.column-1[data-label="Start Date"]').textContent.trim();

        if (startDate) {
            document.querySelector('.nextBatch span').innerText = startDate;
        } else {
            document.querySelector('.nextBatch').style.display = 'none';
        }
        // get next batch data for banner view code end
    });
