...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from Secure Intelligence Summit 2026 Page";

    $user_subject = "Ready to attend the Secure Intelligence Summit 2026 Stay Tuned!";
        ...
        <tr>
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<p>Looking forward to your enthusiastic participation. See you at the session!</p>
                        </td>
                    </tr>
...
';
    ...
    $data = array(
        ...
        'page_type' => 'Secure Intelligence Summit 2026',
