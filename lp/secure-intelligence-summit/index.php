                            ...
                            <div class="snapshot d-flex flex-column gap-4">
                                <div class="curriculum">
                                    <div class="d-flex flex-column gap-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <g clip-path="url(#clip0_34092_3392)">
                                                <path d="M12.3333 16H3.66666C1.64253 15.9978 0.00221875 14.3575 0 12.3333V3.66666C0.00221875 1.64253 1.64253 0.00221875 3.66666 0H12.3333C14.3575 0.00221875 15.9978 1.64253 16 3.66666V12.3333C15.9978 14.3575 14.3575 15.9978 12.3333 16ZM3.66666 2C2.74619 2 2 2.74619 2 3.66666V12.3333C2 13.2538 2.74619 14 3.66666 14H12.3333C13.2538 14 14 13.2538 14 12.3333V3.66666C14 2.74619 13.2538 2 12.3333 2H3.66666Z" fill="#FFB956" />
                                                <path d="M6.4445 11.8575C6.02381 11.8577 5.6205 11.6897 5.3245 11.3908L3.33316 9.4028C2.9425 9.01239 2.94231 8.37923 3.33272 7.98858C3.33288 7.98842 3.33303 7.98827 3.33316 7.98811C3.72366 7.59773 4.35666 7.59773 4.74716 7.98811L6.4445 9.68477L11.2525 4.87677C11.643 4.48639 12.276 4.48639 12.6665 4.87677C13.0572 5.26717 13.0573 5.90033 12.6669 6.29098C12.6668 6.29114 12.6666 6.2913 12.6665 6.29142L7.56384 11.3941C7.26753 11.6918 6.8645 11.8586 6.4445 11.8575Z" fill="#FFB956" />
                                            </g>
                                            <defs>
                                                <clipPath id="clip0_34092_3392">
                                                    <rect width="16" height="16" fill="white" />
                                                </clipPath>
                                            </defs>
                                        </svg>
...
background: rgba(13, 18, 176, 0.60);">
                                    ...
                                    <form method="post" class="ajax-form d-flex flex-column gap-3">
                                        ...
                                        <div style="border: 1px solid white;border-radius: 8px;background-color: white;">
                                            ...
                                            <input type="tel" name="me_phone" class="me_phone form-control"
                                                placeholder="Mobile" id="me_phone" required style="width:68%;border-radius: 0px;border: none;outline: none;">
    ...
    <script>
        const couponInput = document.querySelector(".me_message");
        const payBtnSpan = document.querySelector(".form-control-btn span");
        ...
        couponInput.addEventListener("input", function() {
            ...
            if (enteredCode === validCoupon) {
                ...
                payBtnSpan.innerHTML = ` ₹${discountedPrice}`;
            } else {
                payBtnSpan.innerHTML = ` ₹${originalPrice}`;
            }
        });
    </script>
