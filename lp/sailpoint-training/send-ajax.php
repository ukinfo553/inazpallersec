...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "Sailpoint IdentityIQ Implementation Landing Page";
            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        ...
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/what-is-the-sailpoint-identity-hub/" target="_blank">Best SailPoint Interview Question</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/best-sailpoint-interview-question/" target="_blank">Top SailPoint Interview Questions That You Should Definitely Know</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/the-benefits-of-sailpoint/" target="_blank">Top Benefits Of SailPoint</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-learn-sailpoint/" target="_blank">How To Learn Sailpoint?</a></li>
                        </ul>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/4qp0E9oOeWQ?si=OJODc6oe89k-wHny">Unlocking SailPoint Identity IQ Common Interview Questions and Answers</a></li>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
                                ...
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/comptia-security/" target="_blank">CompTIA Security+ (Plus)</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cyberark-training/" target="_blank">CyberArk Training</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/cisa-training/" target="_blank">Certified Information Systems Auditor (CISA)</a></li>
                            </ul>
...
';
    ...
    $data = array(
        'site_name' => 'lp',
        'page_type' => 'Sailpoint IdentityIQ Implementation',
        'name' => $me_name,
        'email' => $me_email,
        'phone' => $me_phone,
