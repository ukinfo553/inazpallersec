...
<head>
    ...
    <title>Sailpoint IIQ Implementation &amp; Developer Exam Prep online Training</title>
    <meta name="description"
        content="InfosecTrain provides Sailpoint Implementation &amp; Developer Online Training has been especially designed to offer job oriented SailPoint IdentityIQ training.">
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3>
                                Take Your IAM Skills to the Next Level
                            </h3>
                            <h1>SailPoint Identity IQ Exam <br> Prep Training (v8.4)</h1>
                            <div class="d-flex flex-row banner-highlights">
                                <div>
                                    <span>75% Global</span>
                                    <p>Adoption Rate of SailPoint</p>
                                </div>
                                <div>
                                    <span>$131,047</span>
                                    <p>Avg Salary of SailPoint Solution Architect</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-v2.webp" fetchPriority="high"
                                alt="Sailpoint IdentityIQ Implementation by InfosecTrain" width="400" height="400">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.png"
                                        alt="Sailpoint IdentityIQ Implementation Course Highlights" width="45"
                                        height="45">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/practical-session.svg"
                                        alt="Sailpoint IdentityIQ Implementation Course Highlights" width="45"
                                        height="45">
                                    <p>Overview of CyberArk, Hitachi ID, OKTA</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/certified-trainners.svg"
                                        alt="Sailpoint IdentityIQ Implementation Course Highlights" width="45"
                                        height="45">
                                    <p>Get Hands-on with Latest v8.4</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/satisfaction-guranted.png" width="75" height="75"
                                    alt="Sailpoint IdentityIQ Implementation Course Highlights">
                                <img src="assets/images/highlight-icon/infosectrain-stamp.png" width="75" height="75"
                                    alt="Sailpoint IdentityIQ Implementation Course Highlights">
                            </div>
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>SailPoint Training - An Overview</h2>
                                <p>
                                    SailPoint is a leading provider in the global Identity and Access Management (IAM)
                                    sector, holding the largest market share and driving strong demand for professionals
                                    proficient in its software. Our SailPoint IdentityIQ Implementation & Development
                                    training program provides comprehensive, foundational knowledge essential for
                                    administering, implementing, and developing within the SailPoint IdentityIQ and
                                    Access Management platform. This training is delivered for the latest SailPoint
                                    IdentityIQ version 8.4, ensuring participants gain expertise in the most up-to-date
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                ...
                                <img src="assets/images/corporate-training-mob.png" width="364" height="301"
                                    alt="Sailpoint IdentityIQ Implementation Corporate Training"
                ...
                <div class="swiper myAdvisor">
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="summary">
                                Over 10+ years of experience as an IT professional with focus in Information Security
                                and 4+ years exclusive experience in SailPoint IIQ Development and Administration,
                                Shaikh has delivered more than 300 Hours of Sailpoint IIQ Training to various corporate
                                clients, including audience from countries such as India, Singapore, USA, Mexico,
                                Canada.
                            </div>
                        </div>
                        <!--/ col start /-->
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the skills</strong> required to ace Identity and Access Management</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of SailPoint IAM Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of Sailpoint IdentityIQ Implementation">
                            </div>
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                    alt="Benefits of Sailpoint IdentityIQ Implementation Certification">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of a SailPoint IAM expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average Salary Range for SailPoint IAM Profiles</h3>
                            <picture>
                                <source media="(min-width:768px)" width="1472" height="486"
                                    srcset="assets/images/benifits/benefits-sailpoint-desk.webp">
                                <img src="assets/images/benifits/benefits-sailpoint-mob.webp" width="640" height="473"
                                    alt="Benefits of Sailpoint IdentityIQ Implementation Certification">
                            </picture>
                        </div>
                    </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                I am totally satisfied with this Sailpoint course that I attended. The trainer’s way of
                                teaching was excellent. He clarified all the doubts to make it more understandable.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/Sailpoint-4-150x150.jpg"
                                            alt="Sourabh-Maha" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Syed Talha Hussain</h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">The trainer taught us the Sailpoint topics clearly and explained each option
                                in detail. I am truly thankful to our trainer and the entire InfosecTrain team.</p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/Sailpoint-3-150x150.jpg"
                                            width="250" height="250" alt="Simon-Wilkinson">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Manikandan Sankaravel
                                        </h3>
                                        <span>India</span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Thanks a lot to the trainer for the explanation on each topic. His way of teaching was
                                exceptionally good. I would definitely recommend it to others as well.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/Sailpoint-5-150x150.jpg"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div
                        ...
                        <button class="cta-button modal-btn" title="Get In Touch">get in touch</button>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="Sailpoint IdentityIQ Implementation" id="me_others_footer"
                                    name="me_others">
...
<script>
    ...
    function playVideo() {
        ...
        var newVideoLink = 'https://www.youtube.com/embed/sLrcxlBQrXE?rel=0';
