...
$courseID = 30838;  // Change this to the specific course ID for different pages
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <img src="assets/images/review-mob-img.png" alt="CompTIA Security+ SY0-701 Course Review"
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.png"
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/security-plus-logo.png"
                                    alt="CEH Course Highlights">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                ...
                                <p>
                                    InfosecTrain's CompTIA Security+ SY0-701 course delivers a thorough and guided
                                    learning journey, led by experts in the field. The training encompasses five crucial
                                    domains essential for mastering information security. Participants will explore
                                    fundamental security concepts, threats, vulnerabilities, mitigations, security
                                    architecture, security operations, and security program management. </p>
                                <p>
                                    This comprehensive course integrates practical exercises and hands-on labs to
                                    enhance participants' skills, guaranteeing their readiness for the SY0-701
                                    certification exam. By immersing themselves in real-world scenarios, participants
                                    gain practical insights, ensuring a robust understanding and proficiency in the
                                    intricate landscape of information security.
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="summary">
                                ...
                                experience in Security Testing, Cloud Security, Threat Hunting and DevOps. He is adept
                                at designing tailored training programs and courseware on Security Solutions for various
                                organizations.
                            </div>
                        </div>
                        <!--/ col end /-->
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="summary">
                                10+ years of experience as an Information Security Consultant and Trainer in delivering
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="summary">
                                With over 7+ hands-on experience in Information Systems Management, OSINT,
                                cybersecurity, and GRC integration, Prerna provides tailored training to global
                                organizations, ensuring professionals meet industry standards and compliance. She excels
                                in security management, vulnerability assessments, and risk management, with a proven
                                track record of high exam success rates.
                            </div>
                        </div>
                        <!--/ col end /-->
                        <!--/ col start /-->
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of security-plus Certification" loading="lazy">
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <p>Get global recognition</p>
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            ...
                            <picture>
                                ...
                                <img src="assets/images/benifits/benefits-security-plus-mob.png" width="960"
                                    height="796" alt="Benefits of security-plus Certification" loading="lazy">
                            </picture>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                The CompTIA Security+ course content was very good. The instructor has thorough
                                knowledge regarding the course, and particularly, all the concepts were clear during the
                                class, which I really liked. Thank you so much.
                                <br><br><br>
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The Comptia Sec+ training session with InfosecTrain was good and the trainer’s knowledge
                                was awesome. I could clearly understand everything that he taught. I would definitely
                                recommend InfosecTrain to others.<br><br><br></p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">It was a pleasure to talk to the support team for coordinating the workshop
                                for Security+. She helped me in clarifying how the workshop works. The instructor helped
                                explain the topics related to cybersecurity in a visual manner as well.<br><br><br>
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                It gave me good, hands-on insights on pentesting, and the recordings shared by the
                                trainer are helping me to sync in the knowledge. Absolutely good course for the ones
                                planning to start their journey in cybersecurity.<br><br><br></p>
