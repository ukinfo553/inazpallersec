                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div class="fs-18 f-nunito text-dark fw-bold">
                                CISA Training Course Latest Edition</div>
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    <div class="col-lg-4 col-md-6 pt-4 pt-md-0 ps-md-4">
                        <div class="d-flex flex-column align-items-center align-items-md-start gap-3">
                            ...
                            <p>Upskill Your Team on Information Systems Auditing</p>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/assessment-practice.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Practice with case studies,<strong> flash cards, mind maps</strong> & quizzes</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide gladiators-item">
                                    ...
                                    <p class="desc">
                                        The course was great, and the instructor was extremely helpful. The CISA
                                        training covered all important aspects with practical examples, making it easier
                                        to retain information. The instructor’s patience and expertise enhanced the
                                        overall experience.
                                    </p>
                                </div>
