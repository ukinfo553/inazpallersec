...
<body>
    ...
    $api_id = 30771; // Define the API ID
                    ...
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <p>
                                    Our certification-focused CISA training course aligned with the latest 2024 update
                                    is designed to empower learners with all necessary knowledge and techniques to ace
                                    the CISA certification. The objective of this CISA 2024 certification training
                                ...
                                <div class="accordion d-flex flex-column gap-4">
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                <li>
                                                    <p>CISA Domain 1: Information System Auditing Process
                                                        <strong>(18%)</strong>
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>CISA Domain 2: Governance and Management of IT
                                                        <strong>(18%)</strong>
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>CISA Domain 3: Information Systems Acquisition, Development, and
                                                        Implementation <strong>(12%)</strong></p>
                                                </li>
                                                <li>
                                                    <p>CISA Domain 4: Information Systems Operations and Business
                                                        Resilience <strong>(26%)</strong></p>
                                                </li>
                                                <li>
                                                    <p>CISA Domain 5: Protection of Information Assets
                                                        <strong>(26%)</strong>
                                                    </p>
                                                </li>
                                            </ul>
                                            <a href="<?php echo $brochureLink; ?>" target="_blank" class="button download-btn mt-3 d-inline-block"
                                    style="background:var(--acent-red);border:1px solid var(--danger);color:var(--dark);">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-2" width="12" height="12"
                                        viewBox="0 0 16 17" fill="none">
                                        <g clip-path="url(#clip0_18618_896)">
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                <li>Gain insight into the purpose, scope, objectives, and tasks of
                                                    information systems and management.</li>
                                                <li>Formulate an approach for creating, implementing, and maintaining
                                                    effective systems audit and management programs.</li>
                                                <li>Understand information system security policies and procedures,
                                                    encompassing user access and rights management, system change
                                                    control, backup, disaster recovery, and system testing.</li>
                                                <li>Acquire knowledge of IS control structures and perform audit testing
                                                    and evaluation for information systems auditing.</li>
                                                <li>Explore the principles and analysis of risk assessment and
                                                    management.</li>
                                                <li>Acknowledge ethical considerations when conducting audits of
                                                    information systems.</li>
                                                <li>Assess both existing and new systems against CISA principles and
                                                    standards.</li>
                                                <li>Define audit objectives, craft audit approaches, and devise audit
                                                    plans.</li>
                                                <li>Grasp the audit process, prepare reports, and compile management
                                                    letters.</li>
                                                <li>Comprehend fundamental security concepts and strategies.</li>
                                                <li>Demonstrate optimal practices for ensuring business continuity and
                                                    disaster recovery.</li>
                                                <li>Evaluate procedures for data protection and information security
                                                    management.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>
                                                    <p><strong>Exam language</strong> : English, French, German, Hebrew,
                                                        Italian, Japanese, Korean, Spanish, Turkish, Chinese</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <p>
                                                A minimum of 5 years of professional information systems auditing,
                                                control, or security work experience (as described in the CISA job
                                                practice areas) is required for certification. Substitutions and waivers
                                                of such experience, to a maximum of 3 years, may be obtained as follows:
                                            </p>
                                            <ul class="liststar">
                                                <li>A maximum of 1 year of information systems experience or 1 year of
                                                    non-information security auditing experience can be substituted for
                                                    1 year of experience.</li>
                                                <li>60 to 120 completed university semester credit hours (the equivalent
                                                    of a 2-year or 4-year degree) not limited by the 10-year preceding
                                                    restriction can be substituted for 1 or 2 years, respectively, of
                                                    experience.</li>
                                                <li>A master's degree in information security or information technology
                                                    from an accredited university can be substituted for 1 year of
                                                    experience.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>Professionals who are auditors or working in an audit environment
                                                </li>
                                                <li>Professionals who are willing to make a career in information
                                                    systems auditing</li>
                                                <li>IT Managers</li>
                ...
                <div class="swiper myAdvisor">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                            Information Security & Risk Management | CISA | CRISC | CA | CS
                            </div>
                            <div class="summary">
                            Aswini is a finance professional turned information security and risk management expert with over 10 years of experience. A Certified Information Systems Auditor (CISA) and Certified in Risk and Information Systems Control (CRISC), she specializes in IT audits, GRC assessments, and financial risk management. With a strong foundation in finance and accounting, she brings a unique perspective to auditing and information security, making complex CISA concepts easy to understand. Aswini has mentored numerous aspirants for the CISA exam, leveraging her expertise to simplify intricate topics.
                            </div>
                        </div>
                        <!--/ col end /-->
                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/ZANEESH-NAUSHAD.jpg"
                                                    alt="ZANEESH NAUSHAD" width="250" height="250">
                                            </div>
                                    ...
                                    <p class="desc">
                                        The training was excellent and engaging. The CISA course structure was
                                        well-organized, making it easier to understand critical concepts. The sessions
                                        were interactive, and the trainer provided clear, detailed insights, keeping us
                                        engaged throughout.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Asma-Salem-Ali-Alyahyaee.jpg"
                                                    alt="Asma Salem Ali Alyahyaee" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Asma Salem Ali Alyahyaee
                                                </h3>
                                                <span>UAE</span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="desc">
                                        The CISA course was useful and informative. However, an 8-hour session during
                                        weekends felt quite long. A shorter format or weekday classes would make
                                        learning more efficient. Despite that, the expert trainer made the session
                                        engaging and insightful, covering all essential topics with clarity.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Siddiq-Mohamed-Mydeen.jpg"
                                                    alt="Siddiq Mohamed Mydeen" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Siddiq Mohamed Mydeen
                                                </h3>
                                                <span>UAE</span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="desc">
                                        Simply fantastic! The CISA training was well-organized and to the point. The
                                        expert trainer delivered the concepts clearly, making the learning experience
                                        valuable and effective. I feel more confident about taking the exam now.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Justin-Jude-Fernandes.jpg"
                                                    alt="Justin Jude Fernandes" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Justin Jude Fernandes
                                                </h3>
                                                <span>UAE</span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="desc">
                                        The expert trainer made CISA so interesting! The dedication to students was
                                        evident, ensuring that we understood every aspect of the course. The training
                                        was interactive, insightful, and well-structured, making learning an enjoyable
                                        experience.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Yousif-AlFahad.jpg"
                                                    alt="Yousif AlFahad" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Yousif AlFahad
                                    ...
                                    <p class="desc">
                                    The course was great, and the instructor was extremely helpful. The CISA training covered all important aspects with practical examples, making it easier to retain information. The instructor’s patience and expertise enhanced the overall experience.
                                    </p>
                                </div>
                        ...
                        <div class="accordion d-flex flex-column gap-4">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                <button
                                    ...
                                    <span>How long is the CISA Exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    The CISA examination is a four-hour (240 minutes) exam consisting of 150 multiple
                                    choice questions.
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Where can I take the CISA Exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar mb-3">
                                        <li>Computer-Based Testing Locations</li>
                                        <li>CISA exams are administered at 1,300 PSI locations across the world and in
                                            ten languages.</li>
                                    </ul>
                                    <p>
                                        Please visit <a href="www.isaca.org" target="_blank"
                                            class="fw-bold">www.isaca.org</a>
                                        examlocations for a complete list of the current exam sites. The list can keep
                                        changing as per addition of new PSI locations.
                                    </p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>When will I receive my exam results?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
                                        <li>Preliminary result (pass or not pass) is available on the screen immediately
                                            after the completion of your exam.</li>
                                        <li>Official score will be emailed and available online within 10 business days
                                            from the date that candidates take the exam.</li>
                                        <li>Successful candidates receive details on how to apply for certification.
                                        </li>
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Do I need to apply for another exam voucher if I need to retake the
                                        exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                                        <strong>Yes</strong>, but candidates do not need to go through the eligibility
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What are the eligibility requirements for CISA Certification?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
                                        <li>Pass the CISA Exam within the last 5 years.</li>
                                        <li>minimum of 5 years of professional work experience in information systems
                                            auditing, control or security.</li>
                                        <li>Substitutes to work experience may be applied for a maximum of 3 of the 5
                                            required years.</li>
                                        <li>Submit the CISA Certification Application including Application Processing
                                            Fee.</li>
                                    </ul>
                                    <p class="mt-3">
                                        For more information please visit
                                        <a href="https://www.isaca.org/credentialing/cisa/get-cisa-certified"
                                            target="_blank" class="fw-bold">here</a>
                                    </p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What qualifications are required to earn the CISA Certification?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
                                    ...
                                    <p class="mt-3">
                                        For more information please <a
                                            href="http://www.isaca.org/Certification/CISA-Certified-Information-Systems-Auditor/How-to-Become-Certified/Pages/default.aspx"
                                            target="_blank" class="fw-bold">visit</a> ISACA's CISA page
                                    </p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Who is eligible to become CISA Certified and what makes CISA unique?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                                        The Infosec domain is growing by leaps and bounds every day. The cisa®
                                        credential will help you in the following ways:
                                    </p>
                                    <ul class="liststar">
                                        <li>CISA certification is one of the most recognized credentials and acts as a
                                            global standard for Business Systems and Information technology for
                                            professional who audit, access and control data.</li>
                                        <li>It validates a candidate's proficiency, skills, experience, and knowledge
                                            including valid competency in managing vulnerabilities, ensuring compliance,
                                            instituting content and Information Security monitoring and Auditing job
                                            responsibilities.</li>
                                        <li>CISA exam tests the users understanding of the job practices more than
                                            theoretical knowledge.</li>
                                        <li>Anyone with a minimum five years of professional work experience in
                                            information systems, auditing, and/or security can take up the exam.</li>
                                    </ul>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>How much is the exam voucher?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
