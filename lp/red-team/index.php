...
$courseID =35609;  // Change this to the specific course ID for different pages
        ...
        <main>
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                <h3 class="d-none d-lg-block">Master Offensive Security with Real-World Red Teaming
                                    Tactics</h3>
                                <h1>Red Team Operations Professional Training</h1>
                                <!-- <h3>Prepare For CISSP Exam</h3> -->
                                <div class="d-flex flex-row banner-highlights">
                                    <div>
                                        <span> 79% Increase</span>
                                        <p>Red Team Related Jobs</p>
                                    </div>
                                    <div>
                                        <span>$124,816</span>
                                        <p>Median Salary of a Penetration Tester</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-5 col-md-6 d-none d-md-block">
                            <div class="item">
                                <img src="assets/images/Red-Team-BANNER.webp" fetchPriority="high"
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/time.svg"
                                            ...
                                            height="45">
                                        <p>60-Hour LIVE Instructor-led Training</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/isaca-premium.svg"
                                            alt="AI-Powered Cybersecurity Training Course Highlights" width="45"
                                            height="45">
                                        <p>Hands-on Labs with Realistic Attack Simulations</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/batch.svg"
                                            alt="AI-Powered Cybersecurity Training Course Highlights" width="45"
                                            height="45">
                                        <p>OSINT, Exploitation, Persistence, and Lateral Movement Exercises</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/customer-service.svg"
                                            alt="AI-Powered Cybersecurity Training Course Highlights" width="45"
                                            height="45">
                                        <p>Interview Preparation for Red Team Roles</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/certified-trainner.svg"
                                            alt="AI-Powered Cybersecurity Training Course Highlights" width="45"
                                            height="45">
                                        <p>Purple Team Collaboration Tips and Tradecraft Insights</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    <h2>Red Team Operations Professional Training- An Overview </h2>
                                    <p>The Red Team Operations Professional Training course by InfosecTrain blends
                                        theory and practical labs to help professionals master the art of red team
                                        operations while adhering to strict legal and ethical guidelines. Through
                                        structured modules, learners explore the entire red team engagement
                                        lifecycle—planning, exploitation, persistence, C2 operations, and advanced
                                        tradecraft. The program emphasizes real-world adversary emulation, operational
                                        security, and collaboration with blue teams, ensuring participants walk away
                                        with skills to execute impactful, stealthy, and professional red team
                                        engagements.</p>
                                </div>
            ...
            <section class="training-calendar" id="training-calendar">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Red Team Operations Professional Training Calendar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
        ...
        ?>
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    <source media="(min-width:768px)" width="1400" height="420"
                                        srcset="assets/images/Red-Team-corporate-training-web.webp">
                                    <img src="assets/images/Red-Team-corporate-training-mob.webp" width="364"
                                        height="301" alt="AI-Powered Cybersecurity"
                    ...
                    <div class="swiper myAdvisor">
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    Ashish is a cybersecurity and network security trainer with experience delivering
                                    30+ training programs annually to over 250 professionals globally. He has conducted
                                    internal and external vulnerability assessments, penetration testing, OSINT, cyber
                                    threat intelligence, and digital forensics. Known for a strong exam success rate, he
                                    customizes course content to align with current standards. Ashish has trained
                                    government and non-government clients in technologies like CCNA, CEH v11, Pentest+,
                                    Linux+, Microsoft Windows Server 2016, and more. He also guides professionals in
                                    network administration, troubleshooting, traffic analysis, and defense against
                                    network threats.
                                </div>
                            </div>
                            <!--/ col end /-->
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="designation">
                                    CISSP | CCSP | CSSLP | CEI | CEH Masters | CND | ECSA Masters | CHFI | CTIA | ECIH |
                                    CSA | LPT Masters | OSCP | OSEP | AI Security L1, L2, L3 | AI Ethical Hacking | AI
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/assessment-practice.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Learn end-to-end <strong>Red Team lifecycle</strong>with hands-on practice</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Understand <strong>legal, ethical, and operational</strong>security best practices.
                                </p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Gain expertise in<strong> OSINT, exploitation, persistence, and C2
                                        frameworks</strong></p>
                            </div>
                        </div>
                        <!--/ col start /-->
            ...
            <section class="benefits-sec" id="benefits">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Benefits of Red Team Operations Professional Training</h2>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center benefits-row-two">
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p>Earn the status of a Penetration Tester</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                        ...
                        <div class="col-md-8">
                            <div class="benifits-item-two">
                                <h3>Average Salary Range for Red Team Roles</h3>
                                <picture>
                                    <source media="(min-width:768px)" width="1472" height="486"
                                        srcset="assets/images/benifits/benefits-RedTeam-desktop.webp">
                                    <img src="assets/images/benifits/benefits-RedTeam-mobile.webp" width="640"
