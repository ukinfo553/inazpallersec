                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                ...
                                <img src="assets/images/review-mob-img.png"
                                    alt="AI-Powered Cybersecurity Training Course Review" width="636" height="34"
                        ...
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    ...
                                    <p>Artificial intelligence (AI) is now an essential component for many
                                        organizations, improving efficiency through automation and enhancing
                                        decision-making with advanced data analytics. Therefore, it becomes imperative
                                        for organizations to use Al responsibly and ethically. ISO/IEC 42001 helps
                                        organizations establish processes and controls to ensure responsible use and
                                        management of AI systems.</p>
                                    <p>The ISO/IEC 42001 Lead Auditor Training course is ideal for professionals aiming
                                        to stay competitive and equip them with the knowledge and skills to effectively
                                        audit an Artificial Intelligence Management System (AIMS). This course provides
                                        the expertise needed to navigate Al-influenced organizational frameworks
                                        effectively, preparing you to contribute to organizations’ success in this
                                        transformative era. Practical examples from relevant case studies are integrated
                                        throughout the training, providing real-world context and enhancing learning
                                        outcomes.</p>
                                    <p>Here’s what the ISO 42001 Lead Auditor Course will cover:
                                    <ul>
                                        <li>Introduction to the artificial intelligence management system and ISO/IEC
                                            42001</li>
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    ...
                                    <img src="assets/images/ISO-42001-LA-mob.png" width="364" height="301"
                                        alt="AI-Powered Cybersecurity" style="width: 100%;height: auto;display: block;">
                                </picture>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="swiper myAdvisor">
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    Sakthi T is a seasoned AI Governance and Information Security consultant with over
                                    23 years of experience across IT, privacy, and compliance domains. A certified ISO
                                    42001 Lead Auditor and Trainer, Sakthi specializes in implementing AI Governance
                                    frameworks, conducting audits, and enabling privacy-by-design in enterprise
                                    environments. With extensive experience in data protection, risk assessments, and
                                    privacy program leadership across sectors, he drives AI governance maturity through
                                    strategic consulting, regulatory alignment, and standards-based implementation.
                                </div>
                            </div>
                            <!--/ col end /-->
                        ...
                        <div class="col-md-8">
                            <div class="benifits-item-two">
                                ...
                                <picture>
                                    ...
                                    <img src="assets/images/benifits/benefits-ISO-42001-LA-mobile.png" width="640"
                                        height="473" alt="Benefits of AI-Powered Cybersecurity  Certification">
                                </picture>
                            </div>
                        </div>
                    </div>
