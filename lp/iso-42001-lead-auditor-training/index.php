...
$courseID =44420;  // Change this to the specific course ID for different pages
    ...
    <main>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <img src="assets/images/review-mob-img.png" alt="AI-Powered Cybersecurity Training Course Review"
                    ...
                    <div class="col-lg-8 col-md-6">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.svg"
                                        alt="AI-Powered Cybersecurity Training Course Highlights" width="45" height="45">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>ISO/IEC 42001 LA Training - An Overview</h2>
                                <p>Artificial intelligence (AI) is now an essential component for many organizations, improving efficiency through automation and enhancing decision-making with advanced data analytics. Therefore, it becomes imperative for organizations to use Al responsibly and ethically. ISO/IEC 42001 helps organizations establish processes and controls to ensure responsible use and management of AI systems.</p>
                                <p>The ISO/IEC 42001 Lead Auditor Training course is ideal for professionals aiming to stay competitive and equip them with the knowledge and skills to effectively audit an Artificial Intelligence Management System (AIMS). This course provides the expertise needed to navigate Al-influenced organizational frameworks effectively, preparing you to contribute to organizations’ success in this transformative era. Practical examples from relevant case studies are integrated throughout the training, providing real-world context and enhancing learning outcomes.</p>
                                <p>Here’s what the ISO 42001 Lead Auditor Course will cover:
                                    <ul>
                                        <li>Introduction to the artificial intelligence management system and ISO/IEC 42001</li>
                                        <li>Audit principles and the preparation for and initiation of an audit</li>
                                        <li>Conducting On-Site Audit Activities Based on Real-Time Simulations</li>
                                        <li>Concluding the Audit Process with Real-Time Simulations</li>
                                    </ul>
                                </p>
                            </div>
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>ISO/IEC 42001 LA Training Calendar</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 d-none d-lg-block">
                        <img src="assets/images/training-calendar.webp" width="132" height="128"
                            alt="AI-Powered Cybersecurity" class="img-fluid">
                    </div>
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                <source media="(min-width:768px)" width="1400" height="420"
                                    srcset="assets/images/ISO-42001-LA-corporate-training-web.png">
                                <img src="assets/images/ISO-42001-LA-mob.png" width="364" height="301"
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                AI Governance Consultant | ISO 42001 LA | Implementation expert
                            </div>
                            <div class="summary">
                                Sakthi T is a seasoned AI Governance and Information Security consultant with over 23 years of experience across IT, privacy, and compliance domains. A certified ISO 42001 Lead Auditor and Trainer, Sakthi specializes in implementing AI Governance frameworks, conducting audits, and enabling privacy-by-design in enterprise environments. With extensive experience in data protection, risk assessments, and privacy program leadership across sectors, he drives AI governance maturity through strategic consulting, regulatory alignment, and standards-based implementation.
                            </div>
                        </div>
                        <!--/ col end /-->
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Conquer the world of Lead Auditing<strong> with skillful mastery</strong></p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of ISO/IEC 42001 LA Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of AI-Powered Cybersecurity">
                            </div>
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                    alt="Benefits of AI-Powered Cybersecurity  Certification">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of Lead Auditor</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average Salary Range for ISO/IEC 42001 LA Role</h3>
                            <picture>
                                <source media="(min-width:768px)" width="1472" height="486"
                                    srcset="assets/images/benifits/benefits-ISO-42001-LA-desktop.png">
                                <img src="assets/images/benifits/benefits-ISO-42001-LA-mobile.png" width="640" height="473"
                                    alt="Benefits of AI-Powered Cybersecurity  Certification">
                            </picture>
                        </div>
                    </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The team is very approachable and always ready to help. Their timely support for ISO/IEC 42001 training the and clear communication made the entire learning process smooth and comfortable.
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Training was thoughtfully structured and easy to follow. The trainer made even the more complex parts of ISO/IEC 42001 feel approachable and relevant through examples and clear explanations.
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Really enjoyed the ISO/IEC 42001 training. The instructor explained everything in a simple and clear way, which made it easy to follow and understand. Overall, it was a smooth and informative experience.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The instructor demonstrated deep expertise and made learning ISO/IEC 42001 Lead Auditor Training highly engaging. Their mentorship approach helped clarify complex topics, making the course both insightful and interactive. Looking forward to more such sessions with InfosecTrain.
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The session provided a comprehensive understanding of AIMS 42001, with well-structured content and expert guidance. The trainer explained concepts in a practical manner, making learning seamless. InfosecTrain ensured a valuable and interactive experience.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                ...
                                <div class="overlay" id="overlay">
                                    <div class="play-button" onClick="playVideo()" id="playButton">
                                        <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                            alt="AI-Powered Cybersecurity Success Story" width="150" height="150">
                                    </div>
                                </div>
