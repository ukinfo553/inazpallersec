...
$email_subject = "New Enquiry from CISA Landing Page";
...
$user_body = '<table   class="" role="presentation"  border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<td >
				...
				<h1>Welcome to <br />the Infosec Train </h1>
				 ...
				 <tr>
					...
					<br />Our Training Advisor will get back to you in next two business days, for confirmation of your preferred training schedule.  </p>
				    <p>
					Please add our email Id (sales@infosectrain.com) to your contacts. This will help us to reach you and avoid landing in the junk folder due to over cautious filters.
					</p>
				...
				<tr>
				  ...
				  <h2>View our Blog:</h2>
				<p>
					  <a style="color:#ff4444" href="https://www.infosectrain.com/blog/cisa-job-practice-old-vs-new/" target="_blank">CISA Job Practice (Old vs New)</a> <br> <a style="color:#ff4444" href="https://www.infosectrain.com/blog/cisa-certification-how-to-prepare-for-the-exam/" target="_blank">CISA Certification : How To Prepare For The Exam?</a>
					  <br> <br>
					  What People Are Saying About InfosecTrain: <a style="color:#ff4444" href="https://www.infosectrain.com/customers-review/" target="_blank">Click Here</a>
					  <br> <br>
					  Download Whitepaper: <a style="color:#ff4444" href="https://www.infosectrain.com/pages/lp/cisa/White-paper_CISA_job_practice.pdf" target="_blank">Click Here</a>
					  </p>
				<br>
				    </td>
				</tr>
				...
				<h2>Understanding of the Domain 1:</h2>
  ...
  <li><a href="https://www.infosectrain.com/blog/cisa-domain-1-part-3-the-process-on-auditing-information-systems/">CISA DOMAIN 1  -  THE PROCESS ON AUDITING INFORMATION SYSTEMS (Part3) </a> </li>
			        ...
			        <td style="color: #414547; padding-left:24px;">
					<br>
				<h2>Understanding of the Domain 2:</h2>
					...
					<table width="100%" border="0" bordercolor="#CCCCCC" align="center">
						  <tr>
							<td>
							   ...
							   IND: 1800-843-7890 (Toll Free)<br /> US: +1 657-722-11127  UAE: +971 564 23 6252
							   <br />
