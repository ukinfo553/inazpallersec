...
$courseID = 43195;  // Change this to the specific course ID for different pages
...
<html lang="en">
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                <img src=" assets/images/skill-up-.gif" alt="#" style="width: 200px;">
                        ...
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    ...
                                    <p>
                                        InfosecTrain’s GRC Training Course explores Governance, Risk, and Compliance
                                        (GRC)
                                        essentials in information security. Combining theory with practical exercises,
                                        it
                                        covers the CIA Triad, governance frameworks (COSO, COBIT), security policy
                                        creation,
                                        legal compliance, and risk management. Participants engage in case studies and
                                        hands-on tasks to learn about implementing security controls, risk assessment,
                                        and
                                        GRC plan development, equipping them for effective organizational GRC
                                        integration.
                                    </p>
                                </div>
                    ...
                    <div class="swiper myAdvisor">
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    Core expertise as a GRC specialist with extensive experience in assisting
                                    organizations
                    ...
                    <div class="swiper myGladiators">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The GRC Course provided by InfosecTrain featured a highly knowledgeable trainer, and
                                    it
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The GRC Course sessions provided by InfosecTrain were good. The content was
                                    informative,
                                    and the delivery was effective, contributing to a positive learning experience.</p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    I enjoyed the past 1 and a half months during the GRC Course provided by
                                    InfosecTrain.
                                    The trainer was excellent, ensuring that I was consistently learning new and
                                    valuable
                                    information. His patience in addressing our questions until we were satisfied was
                                    commendable. Thank you so much for the sessions!
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The GRC (Governance, Risk & Compliance) Hands-on Online Training at InfosecTrain was
                                    an
                                    excellent course with a highly knowledgeable trainer. The sessions were interactive
                                    and
                                    engaging, making complex concepts easy to understand. InfosecTrain's commitment to
                                    providing top-notch training and expertise truly shines through in this
                                    comprehensive
                                    course.
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The GRC (Governance, Risk & Compliance) Hands-on Online Training at InfosecTrain was
                                    outstanding, with a knowledgeable and engaging instructor who delivered the material
                                    clearly and concisely. InfosecTrain's expert trainers and their real-world
                                    experience
                                    added significant value, making the course highly informative and interactive.
                                </p>
                        ...
                        <div class="col-md-6">
                            <div class="item-two">
                                ...
                                <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                    ...
                                    <input type="hidden" value="DevSecOps Training" id="me_others_footer"
                                        name="me_others">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const startDate = [...document.querySelectorAll('.table_training .row-2')]
            .find(data => data.querySelector('.column-6[data-label="Batch Status"]').textContent.trim() ===
                '[ Open ]')
    ...
    summaries.forEach((elem) => {
        ...
        elem.innerHTML =
            `${truncatedText}<span class="dots">...</span><span class="hidden-text">${hiddenText}</span> <span class="read-more">Read More</span>`;
