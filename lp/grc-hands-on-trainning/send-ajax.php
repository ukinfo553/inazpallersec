...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "GRC-Hands-On Trainning New LP";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/importance-of-governance-risk-and-compliance/" target="_blank">Importance Of Governance, Risk, And Compliance</a></li>
                                ...
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/what-is-archer-integrated-risk-management-irm/" target="_blank">What Is Archer Integrated Risk Management (IRM)?</a></li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/_S4t9S5N4Ts?si=hhzN7cnVhgepDPeR">Career in GRC and Find Your Path to Success</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=k1m8GoCqzT8">What is GRC Archer?</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=s3UiAhdiq58">What is GRC (Governance, Risk, and Compliance)?</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=6m8doOt9ZK0">Introduction of GRC NIST Practical</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=itUpszXmyoM">The GRC Framework: A Practical Guide to GRC</a>
                                </li>
                            </ul>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cgrc-training/">CGRC - Governance, Risk and Compliance Training</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/rsa-archer-training/">GRC RSA Archer Online Training</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/information-systems-auditor-online-training/">Information Systems Auditor Training (Practical Hands-on)</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/pci-data-security-standard-training-course/">PCI-DSS (Payment Card Industry Data Security Standard) Implementation Online Training</a>
                                </li>
                            </ul>
...
';
    ...
    $data = array(
        'site_name' => 'lp',
        'page_type' => 'GRC Hands on Trainning',
        'name' => $me_name,
        'email' => $me_email,
        'phone' => $me_phone,
