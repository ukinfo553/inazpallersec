...
<html lang="en">
    ...
    <head>
        ...
        <title>CGRC Certified in Governance, Risk &amp; Compliance Training (Formerly CAP)</title>
        <meta name="description"
            content="Get trained from InfosecTrain in Certified Governance, Risk and Compliance (CGRC) Training (formerly CAP) to build your GRC expertise for various risk management frameworks.">
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                <h3>Master Governance, Risk, and Compliance with</h3>
                                <h1>CGRC Training Course</h1>
                                <div class="d-flex flex-column flex-md-row banner-highlights">
                                    <div>
                                        <span>72% Increase</span>
                                        <p>in Cyber Security Jobs</p>
                                    </div>
                                    <div>
                                        <span> $110,393</span>
                                        <p>Median Salary of Compliance Officers </p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-5 col-md-6 d-none d-md-block">
                            <div class="item">
                                <img src="assets/images/banner-v2.webp" fetchPriority="high"
                                    alt="CGRC Online Training by InfosecTrain" width="400" height="400">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="highlights-sec">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/time.svg"
                                            alt="CGRC Online Training Course Highlights" width="45" height="45">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/certified-trainner.svg"
                                            alt="CGRC Online Training Course Highlights" width="45" height="45">
                                        <p>Certified Trainer (18+ Years Experience)</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                ...
                                <div class="item-footer d-flex">
                                    <img src="assets/images/highlight-icon/100-satisfaction.webp"
                                        alt="CISA Online Training Course Highlights" width="150" height="150">
                                    <img src="assets/images/highlight-icon/money-back.webp"
                                        alt="CISA Online Training Course Highlights" width="150">
                                </div>
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    <h2>CGRC Training - An Overview </h2>
                                    <p>
                                        The CGRC: Certified in Governance, Risk, and Compliance (CGRC) Training Course,
                                        formerly recognized as the Certified Authorization Professional (CAP), offered
                                        by
                                        InfosecTrain, is designed to elevate your expertise in security and privacy
                                        governance, risk management, and regulatory compliance. This comprehensive
                                        updated
                                        program provides the tools and knowledge to effectively align security and
                                        privacy
                                        practices with organizational goals, empowering informed decision-making across
                                        critical areas such as data security, compliance management, and supply chain
                                        risk
                                        mitigation.
                                    </p>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 d-none d-lg-block">
                            <img src="assets/images/training-calendar.png" width="132" height="128"
                                alt="CGRC Training Calendar" class="img-fluid">
                        </div>
        ...
        ?>
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    ...
                                    <img src="assets/images/corporate-training-mob.webp" width="364" height="301"
                                        alt="CGRC Online Training  Corporate Training"
                        ...
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    ...
                                    A distinguished Information Security professional with comprehensive knowledge
                                    across
                                    all domains of Information Security. Expertise ranges from Vulnerability Assessment
                                    &
                                    Penetration Testing to Application Security, and encompasses Security Solutions as
                                    well
                            ...
                            <div class="swiper-slide item">
                                <div class="profile-desc">
                                    <div class="avtar">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar.png"
                                            alt="Mani|InfosecTrain Instructor">
                                    </div>
                                    <div class="avtar-data">
                                        <div class="avtar-name">
                                            MANI
                                ...
                                <div class="designation">
                                    CGRC | ISSAP | CCSP | CISSP | CCISO | AWS Architect Associate | AWS Security
                                    Specialty | CEH | ECSA
                                </div>
                                <div class="summary">
                                    Mani is an accomplished Information Security Consultant and Certified Instructor
                                    with over 16 years of experience in cybersecurity, risk management, and enterprise
                                    compliance. He specializes in GRC frameworks, data protection, and IBM Security
                                    Guardium administration. Known for delivering high-impact solutions and
                                    client-focused training, Mani brings deep technical expertise across cloud, network,
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                ...
                                <p>Learn from certified trainers with<strong> 18+ years of experience </strong></p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>100% <strong>Job Assistance.</strong></p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
            ...
            <section class="benefits-sec" id="benefits">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Benefits of CGRC Certification Training</h2>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center benefits-row-two">
                        <div class="col-md-4">
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                                    <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                        alt="Benefits of CGRC Online Training">
                                </div>
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                                    <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                        alt="Benefits of CGRC Online Training  Certification">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p>Earn the status of CGRC expert</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                        ...
                        <div class="col-md-8">
                            <div class="benifits-item-two">
                                <h3>Average salary range for different CGRC profiles</h3>
                                <picture>
                    ...
                    <div class="swiper myGladiators">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    Every aspect of the training was well-organized, from structured content to
                                    insightful
                                    discussions. The trainer shared practical applications of CGRC concepts, making the
                                    learning process seamless. Their ability to simplify complex topics while
                                    maintaining
                                    depth was commendable. The course provided valuable industry insights, enhancing my
                                    confidence in applying the knowledge gained. This has been a rewarding experience,
                                    and
                                    I'm completely satisfied with the training received.
                                </p>

                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2025/03/Mohamed-Ismail-Mustafa-Mohamed.png"
                                                alt="Mohamed Ismail Mustafa Mohamed" width="250" height="250">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Mohamed Ismail Mustafa Mohamed
                                            </h3>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The course exceeded my expectations, providing a well-rounded and engaging learning
                                    experience. The trainer's expertise was evident, making the CGRC sessions both
                                    informative and interactive. Each topic was covered in depth with real-world
                                    applications, helping to solidify key concepts. The structured approach and clear
                                    explanations made a significant impact. I'm highly satisfied with the training and
                                    look
                                    forward to exploring more learning opportunities in the future.
                                </p>

                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2025/03/Imran-A-Qureshi.png"
                                                width="250" height="250" alt="Imran A Qureshi">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Imran A Qureshi
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The depth of knowledge shared throughout the sessions was remarkable. The trainer
                                    explained CGRC concepts with clarity, ensuring each topic was covered
                                    comprehensively.
                                    Their expertise in the field was evident, making learning both effective and
                                    enjoyable.
                                    Real-world examples helped connect theoretical knowledge to practical applications.
                                    This
                                    course has strengthened my understanding and provided a solid foundation. I truly
                                    appreciate the effort put into making this training so impactful.
                                </p>

                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2025/03/Pankaj-Bhatt.png"
                                                width="250" height="250" alt="Pankaj Bhatt">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Pankaj Bhatt
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The training sessions were incredibly well-structured, with the trainer
                                    demonstrating
                                    deep expertise and a passion for teaching. Their insights and practical examples
                                    made
                                    even the most complex CGRC concepts easy to grasp. The support and guidance
                                    throughout
                                    the course were invaluable, making this a highly enriching experience. I truly
                                    appreciate the effort put into delivering such detailed and insightful training,
                                    which
                                    has significantly enhanced my understanding.
                                </p>

                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2025/03/Vijayakumar-T.-T.png"
                                                width="250" height="250" alt="Vijayakumar T. T.">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>
                                                Vijayakumar T. T.
                ...
                <div class="container">
                    <div class="row justify-content-center">
                                    ...
                                    <div class="overlay" id="overlay">
                                        <div class="play-button" onClick="playVideo()" id="playButton">
                                            <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                                alt="CGRC Online Training Success Story">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="success-item">
                                <img src="assets/images/certificate.png" alt="CGRC Online Training Success Story"
