...
$email_subject = "New Enquiry from Splunk Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-splunk-interview-questions-prepare-for-success/" target="_blank">Top Splunk Interview Questions: Prepare for Success</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/ibm-qradar-vs-splunk-siem/" target="_blank">IBM QRadar vs. Splunk SIEM</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/why-choose-splunk-practical-approach-training-with-infosectrain/" target="_blank">Why Choose Splunk Practical Approach Training with InfosecTrain?</a></li>
							</ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=oexq7zHGP9M" target="_blank">What Is Splunk?</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=6LirfgH5_8c" target="_blank">Why to Learn Splunk?</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=cgCcqYfUP6A" target="_blank">SOC Analyst Roles and Responsibilities</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=C18tndlFyqs" target="_blank">What Operations Carried out in Splunk?</a> </li>
							</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/soc-analyst-training/"  target="_blank">SOC Analyst Training</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/advanced-penetration-testing-online-training-course/"  target="_blank">Advanced Penetration Testing (APT) Training</a> </li>
