...
$courseID = 48152;  // Change this to the specific course ID for different pages
...
<html lang="en">
    ...
    <head>
        ...
        <title>Agentic AI Training for Non-Tech</title>
        ...
        <main>
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                <h3 class="d-none d-lg-block">Automate, Simplify, and Supercharge Your Workflows</h3>
                                <h1>Agentic AI Training for Non-Tech</h1>
                                <!-- <h3>Prepare For CISSP Exam</h3> -->
                                <div class="d-flex flex-row banner-highlights">
                                    <div>
                                        <span> 84% Increase in Agentic AI</span>
                                        <p>Related Jobs</p>
                                    </div>
                                    <div>
                                        <span>$159,405</span>
                                        <p>Median Salary of an AI Product Manager</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-5 col-md-6 d-none d-md-block">
                            <div class="item">
                                <img src="assets/images/Agentic-AI-Training-Non-Tech-BANNER.webp" fetchPriority="high"
                                    alt="Agentic AI Training for Non-Tech" width="400" height="400">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/video-recording.svg"
                                            alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                            height="45">
                                        <p>Learn from Experienced Experts</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/isaca-premium.svg"
                                            alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                            height="45">
                                        <p>Hands-on projects with real-world use cases</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/batch.svg"
                                            alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                            height="45">
                                        <p>Understand AI ethics, risks, and safety measures</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/passed-rate.svg"
                                            alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                            height="45">
                                        <p>End-to-end AI agent implementation in a practical business scenario</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/customer-service.svg"
                                            alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                            height="45">
                                        <p>Ready-to-use AI workflows for immediate implementation</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/certified-trainner.svg"
                                            alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                            height="45">
                                        <p>Building AI agents for HR, marketing, finance, and operations</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    <h2>Agentic AI Training for Non-Tech- An Overview</h2>
                                    <p>The Agentic AI Training for Non-Tech by InfosecTrain is a hands-on program
                                        designed for business professionals, managers, and non-technical users who want
                                        to leverage AI without coding. This Agentic AI Course introduces the
                                        fundamentals of AI agents and autonomous AI systems, helping participants
                                        understand how to automate routine tasks and improve business workflows. Through
                                        hands-on exercises with no-code AI tools, you'll learn to design, build, and
                                        deploy AI agents for applications in HR, marketing, finance, operations, and
                                        more. By the end of this training, you'll be able to implement AI automation
                                        effectively, enhance productivity, and make smarter business decisions.</p>
                                </div>
            ...
            <?php if (!empty($courseID)): ?>
                <section class="training-calendar" id="training-calendar">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h2>Agentic AI Training for Non-Tech Calendar</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    <source media="(min-width:768px)" width="1400" height="420"
                                        srcset="assets/images/Agentic-AI-Training-Non-Tech-corporate-training-web.webp">
                                    <img src="assets/images/Agentic-AI-Training-Non-Tech-corporate-training-mob.webp"
                        ...
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="designation">
                                    AI/ML | Generative AI | CSM | Business Analysis | Cybersecurity | Agile | Data
                                    Science
                                </div>
                                <div class="summary">
                                    ohit Krishnan is an AI/ML and Business Analysis trainer with 5+ years of experience
                                    delivering corporate programs, academic workshops, and hands-on mentoring. He
                                    specializes in simplifying complex concepts across Generative AI, Cybersecurity, and
                                    Business Analysis while designing industry-aligned learning paths. Rohit has trained
                                    professionals across leading institutions, guided real-world projects, and created
                                    domain-specific AI+BA modules. With a strong blend of technology, strategy, and
                                    teaching expertise, he enables learners to gain practical, job-ready skills.
                                </div>
                            </div>
                            <!--/ col end /-->
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Prepare with <strong>hands-on projects</strong> and no-code AI tools</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Immerse in <strong>real-world business</strong> workflow automation scenarios</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
            ...
            <section class="benefits-sec" id="benefits">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Benefits of Agentic AI Training for Non-Tech Training</h2>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center benefits-row-two">
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p>Earn the status of an AI Product Manager</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                        ...
                        <div class="col-md-8">
                            <div class="benifits-item-two">
                                <h3>Average Salary Range for Agentic AI for Non-Tech Roles</h3>
                                <picture>
                                    <source media="(min-width:768px)" width="1472" height="486"
                                        srcset="assets/images/benifits/Agentic-AI-Training-Non-Tech-desktop.webp">
                                    <img src="assets/images/benifits/benefits-Agentic-AI-Training-Non-Tech-mobile.webp"
