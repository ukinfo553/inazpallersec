...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from Agentic AI Training for Non-Tech Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/centralized-vs-federated-vs-decentralized-ai-governance/" target="_blank">Centralized vs. Federated vs. Decentralized AI Governance</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/types-of-artificial-intelligence-ai-systems/" target="_blank">Types of Artificial Intelligence (AI) Systems</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/ai-auditing-tools-and-techniques/" target="_blank">AI Auditing Tools and Techniques</a></li>
                    ...
                    <tr>                        <td style="color: #414547; padding-left: 24px;padding-top:10px;font-family: Arial, Helvetica, sans-serif;font-size: 18px;">
                        ...
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/prompt-engineering-training/"  target="_blank"> AI Prompt Engineering Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/basic-ai-skills-training/"  target="_blank"> AI Skills Mastery Program</a> </li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/agentic-ai-training-for-tech/"  target="_blank"> Agentic AI for Tech Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/artificial-intelligence-ai-for-cyber-security-professionals-training/"  target="_blank"> AI-Powered Cybersecurity Training Course Online</a> </li>
                        </ul>                        </td>
                    </tr>
                    ' . $email_footer . '
                </table>
...
';
    ...
    $data = array(
        ...
        'page_type' => 'Agentic AI Training for Non-Tech',
