        ...
        <div class="banner container">
            <div class="row align-items-center">
                <div class="bannerContent">
                    ...
                    <h1> <span>CISSP Exam Prep Training</span> <br> With <span>98%</span> Pass Rate</h1>
                </div>
                <div class="bannerImg">
...
gettraning_Cal($url);
   ...
   ?>
        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="advisor-item">
                    ...
                    <div class="adis_exp">15+ Years Experienced</div>
                    <div class="advisor-degree">
                ...
                <div class="advisor-item">
                    <h4>Prashant</h4>
                    <div class="adis_exp">10+ Years Experienced</div>
                    <div class="advisor-degree">
                        CISSP, CCSP, C|EH & CPISI
                    </div>
                    <p>
                        10+ years of hands on experience on auditing application’s controls, identifying breaches on policies/controls, communicating gaps and risk associated to the business and providing solution in accordance of the policy to the stakeholders
                    </p>
                </div>
                <div class="advisor-item">
                    <h4>Ajit</h4>
                    <div class="adis_exp">15+ Years Experienced</div>
                    <div class="advisor-degree">CISSP | CISA | CISM | CRISC | CCSP | ITIL</div>
                    <p>
                        15+ years of experience & Associated with InfosecTrain as a Trainer and specialized for CISA, CISM and CISSP courses. Taken approx. 150+ Classroom and
                        Virtual Classroom Trainings and trained 1000+ Professionals across the globe
                    </p>
                </div>
                <div class="advisor-item">
                    <h4>Manikandan N</h4>
                    <div class="adis_exp">12+ Years Experienced</div>
                    <div class="advisor-degree">CISSP, CCSP, AWS Architect, CEH</div>
                    <p>
                        He brings 12+ years of hands-on experience on various technologies, ISMS, Risk Management and GRC compliance domains to best use in his trainings, his trainings are highly interactive and filled with relevant examples.
                    </p>
                </div>
            </div>
        </div>
    ...
    <!--about sec start-->
    <section class="aboutsec" id="overview">
        <div class="container">
            <div class="row">
                <div class="about">
                    <h3>About CISSP</h3>
    ...
    <!--syllabus sec-->
    <section class="syllabussec">
        <h3>Get familiar with our online CISSP exam prep training syllabus.</h3>
        <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/InfosecTrain_CISSP_Course_Content.pdf" target="_blank" class="downloadBtn">Download Syllabus
            <img src="assests/images/download.png" alt="download" width="20" valign="middle"/>
        </a>
    </section>
    <!--syllabus sec end-->
    <!--benifits sec start-->
    ...
    <section class="py-5 footer-contact">
            <div class="container container-one">
                <div class="row align-items-center">
                    <div class="item">
                        <img src="assests/images/cissp-gladiators.webp" alt="cissp-gladiators" loading="lazy" class="img-fluid mx-auto d-block">
                    </div>
                    <div class="item">
                            <h3>
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);" id="demo_me_phone_f_footer">
                                <input type="text" name="me_name" id="me_name_footer" placeholder="Your Name *">
                                <input type="email" name="me_email" id="me_email_footer" placeholder="Email-Address *">
                                <input type="number" name="me_phone" id="me_phone_footer" placeholder="Phone Number">

                                <input type="hidden" value="<?php echo BASE_URL; ?>thank-you.php" id="me_redirect_footer">
                                <input type="hidden" value="CISSP Certification Training" id="me_others_footer" name="me_others">
                                ...
                                <div class="loading_w hide" id="loading_w_footer">
                                    ...
                                    style="width:32px; margin: 15px auto auto auto;display:block;">
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="item-two">
                        <a href="https://api.whatsapp.com/send?phone=16572211127&text=Hi" target="_blank" class="justify-content-lg-center">
                            <img src="assests/images/icon/WhatsApp.webp" alt="whatsapp" loading="lazy">
                            <span>+1-6572211127</span>
                        </a>
                    </div>
                    <div class="item-two">
                        <a href="tel:+16572211127" target="_blank" class="justify-content-lg-center">
                            <img src="assests/images/icon/Phone.webp" alt="whatsapp" loading="lazy">
                            <span>+1-6572211127 (USA)</span>
                        </a>
                    </div>
                    <div class="item-two">
                        <a href="mailto:sales@infosectrain.com" target="_blank" class="item justify-content-lg-center">
                            <img src="assests/images/icon/Email.webp" alt="whatsapp" loading="lazy">
    ...
    <footer>
        <div class="container">
            ...
            <div class="row" style="padding-bottom: 40px;">
                <div class="footer_item" style="width:100%;padding:20px 0;text-align:end;">
                    <p style="font-size:13px;">© <?php echo date("Y");?> - Infosec Train. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer>
