...
$email_subject = "CISSP Certification Training Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-prepare-for-cissp-exam-in-2023/" target="_blank">How To Prepare For CISSP Exam in 2023</a></li>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/whats-new-in-cissp/" target="_blank">What"s New in CISSP?</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-become-a-cissp-expert/" target="_blank">How to Become a CISSP Expert?</a></li>
							</ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=r7KN8SI1exs" target="_blank">CISSP or CISM: Which is right for you?</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=HRHe7GKkbpw" target="_blank">CISSP Exam Preparation 2023</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=G2KM4aGnlqk" target="_blank">CISSP Question and Answer Practice</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=IdwJFQfH-GA" target="_blank">How to Prepare for CISSP Domain 1</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=_cmqc_E9--o" target="_blank">How to Prepare for CISSP Exam </a></li>
							</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/ccsp-certification-training/" target="_blank">Certified Cloud Security Professional (CCSP)</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cap-certification-training/" target="_blank">Certified Authorization Professional (CAP) </a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/sscp-certification-training/" target="_blank">Systems Security Certified Practitioner (SSCP) </a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cissp-issap-certification-training/" target="_blank">CISSP-ISSAP Training</a></li>
							</ul>
						</td>
					</tr>
