...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "CYSA Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/interview-questions-for-cybersecurity-analyst-in-2023/" target="_blank">Interview Questions for Cybersecurity Analyst</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/soc-analyst-vs-penetration-tester/" target="_blank">SOC Analyst Vs. Penetration Tester</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/soc-scenario-based-interview-questions/" target="_blank">SOC Scenario-Based Interview Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-security-measures-in-soc/" target="_blank">Top Security Measures in SOC </a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/soc-analyst-training/">SOC Analyst Hands-on Training</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/advanced-penetration-testing-online-training-course/">Advanced Penetration Testing Training</a></li>
                        ...
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/information-systems-implementer-training/">ISO 27001 Practical Implementation Training</a></li>
                    </ul>
						</td>
					</tr>
