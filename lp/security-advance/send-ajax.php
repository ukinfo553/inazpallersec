			        ...
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul><li><a href="https://www.infosectrain.com/blog/comptia-security-sy0-601-domain-1-attacks-threats-and-vulnerabilities/" target="_blank">Domain 1: Attacks, Threats, and Vulnerabilities  </a></li>
  <li><a  href="https://www.infosectrain.com/blog/comptia-security-sy0-601-domain-2-architecture-and-design/" target="_blank">Domain 2: Architecture and Design  </a></li>
  <li><a  href="https://www.infosectrain.com/blog/comptia-security-sy0-601-domain-3-implementation/" target="_blank">Domain 3: Implementation </a></li>
  <li><a href="https://www.infosectrain.com/blog/how-to-prepare-for-comptia-security-sy0-601-examination/">How to Prepare for CompTIA Security+ SY0-601 Examination? </a> </li>
</ul>
				...
				<tr>
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul><li><a href="https://www.youtube.com/watch?v=6HwWSujsv3I">Day 1 - Security+ Boot camp</a> </li>
  <li><a href="https://www.youtube.com/watch?v=sYNNNkSu7kQ">Day 2 - Security+ Boot camp </a> </li>
  <li><a href="https://www.youtube.com/watch?v=Edosrg0uL4s">How to Prepare CompTIA Security+ 601</a> </li>
  <li><a href="https://www.youtube.com/watch?v=qA48Ez3SYwA">Benefits of CompTIA Security+ SYO-601?</a> </li>
</ul>
							</td>
						  </tr>
                      </table>
