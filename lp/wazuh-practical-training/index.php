...
$courseID = 48676;  // Change this to the specific course ID for different pages
...
<head>
    ...
    <title>Wazuh Practical Training</title>
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3 class="d-none d-lg-block">Hands-on SIEM & XDR SOC Training</h3>
                            <h1>Wazuh Practical Training</h1>
                            <!-- <h3>Prepare For CISSP Exam</h3> -->
                            <div class="d-flex flex-row banner-highlights">
                                <div>
                                    <span>88% Increase in Wazuh</span>
                                    <p>Related Jobs</p>
                                </div>
                                <div>
                                    <span>$145,000</span>
                                    <p>Median Salary of a Detection Engineer</p>
                                </div>
                            </div>
                            ...
                            <img src="assets/images/review-mob-img.png" alt="wazuh training"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/Wazuh-Practical Training-BANNER.webp"
                                fetchPriority="high" alt="wazuh training" width="400"
                                height="400">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>32-Hour Instructor-led Training</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/video-recording.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>Real-World Detection Engineering & Alert Tuning</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/isaca-premium.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>Live Wazuh Environment with Attack Simulation</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/batch.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>SOC Analyst Workflows & Investigation Techniques</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/passed-rate.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>Custom Decoder & Rule Development</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/customer-service.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>Endpoint Telemetry, Active Response & Automation</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/certified-trainner.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>Vulnerability Detection & Compliance Monitoring</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/learning.svg"
                                        alt="wazuh training Course Highlights" width="45"
                                        height="45">
                                    <p>Recorded Sessions & Post-Training Support</p>
                                </div>
                            </div>
                            <div class="item-footer d-flex">
                                <img src="assets/images/highlight-icon/100-satisfaction.webp"
                                    alt="wazuh training Course Highlights" width="100"
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>Wazuh Practical Training- An Overview</h2>
                                <p>InfosecTrain's Wazuh Hands-on Online Training is designed for professionals responsible for monitoring, detecting, and responding to security threats using SIEM and XDR technologies.
        ...
        <?php if (!empty($courseID)): ?>
            <section class="training-calendar" id="training-calendar">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Wazuh Practical Training Calendar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 d-none d-lg-block">
                            <img src="assets/images/training-calendar.webp" width="132" height="128"
                                alt="wazuh training" class="img-fluid">
                        </div>
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                <source media="(min-width:768px)" width="1400" height="420"
                                    srcset="assets/images/Wazuh-Practical-Training-corporate-training-web.png">
                                <img src="assets/images/Wazuh-Practical-Training-corporate-training-mob.png"
                                    width="364" height="301" alt="wazuh training"
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                Senior Information Security Engineer | DFIR, Threat Hunting & Intel | CHFI | eTHP | DCPLA | CTIA | ECIH | CND | CCSE
                            </div>
                            <div class="summary">
                                Urvesh is a Senior Information Security Engineer with 6+ years of hands-on experience in designing, deploying, and managing advanced security operations. He specializes in Wazuh-based SIEM/XDR implementation, detection engineering, threat hunting, SOAR workflows, and DFIR. Urvesh has architected SOC solutions from the ground up, integrating threat intelligence and compliance monitoring across hybrid environments. He has also trained over 300 corporate professionals in multiple information security domains, sharing expertise in detection, response, and security automation.
                            </div>
                        </div>
                        <!--/ col end /-->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Operate Wazuh as a full <strong>SIEM & XDR platform</strong></p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Perform <strong>SOC alert triage </strong>and investigations</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Monitor endpoints using <strong>Windows & Linux telemetry</strong></p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of Wazuh Practical Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of wazuh training">
                            </div>
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of a SIEM Engineer</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average Salary Range for Wazuh Roles</h3>
                            <picture>
                                <source media="(min-width:768px)" width="1472" height="486"
                                    srcset="assets/images/benifits/benefits-Wazuh-Practical-Training-desktop.png">
                                <img src="assets/images/benifits/benefits-Wazuh-Practical-Training-mobile.png"
                                    width="640" height="473" alt="Benefits of wazuh training">
                            </picture>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="overlay" id="overlay">
                                    <div class="play-button" onClick="playVideo()" id="playButton">
                                        <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                            alt="wazuh training Success Story" width="150"
                                            height="150">
                                    </div>
                                </div>
