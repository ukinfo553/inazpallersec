...
<head>
    ...
    <title>Certified Ethical Hacker (CEH v13) AI Training</title>
    <meta name="description"
        content="Get Certified Ethical Hacker (CEH v13) AI Certification Training with InfosecTrain. Master ethical hacking, AI tools, and boost your cybersecurity career now!" />
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700;900&display=swap" defer />
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Nunito+Sans:opsz,wght@6..12,400;6..12,500;6..12,600;6..12,700&display=swap" defer />
    <!--/ style link end /-->
    <!-- Google Tag Manager -->
    <script>
        setTimeout(function () {
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3>Your Path to Cybersecurity Excellence</h3>
                            <h1>Certified Ethical Hacker v13 <br>CEH Certification Training</h1>
                            ...
                            <div class="button-sec">
                                ...
                                <a href="https://www.infosectrain.com/wp-content/uploads/2024/10/CEH-v13.pdf"
                                    target="_blank" class="cta-button" title="Download Brochure">Download Brochure</a>
                            </div>
                            <img src="assets/images/review-mob-img.png" alt="CEH Course Review" width="636" height="34"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-v2.webp" fetchPriority="high"
                                alt="CEH Certification Training by InfosecTrain" width="400" height="400">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.png" alt="CEH Course Highlights"
                                        width="45" height="45">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/training-partner.png"
                                        alt="CEH Course Highlights" width="45" height="45">
                                    <p>EC-Council Authorized Partner</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/computer1.png" alt="CEH Course Highlights"
                                        width="45" height="45">
                                    <p>Median Salary of Cybersecurity Professionals</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/passed.png" alt="CEH Course Highlights"
                                        width="45" height="45">
                                    <p>98% Pass Rate</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/qualification.png"
                                        alt="CEH Course Highlights" width="45" height="45">
                                    <p>CEI Certified Trainers</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/learning.png" alt="CEH Course Highlights"
                                        width="45" height="45">
                                    <p>Scenario-based Learning </p>
                                </div>
                            </div>
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/CEH-logo.webp" width="430" height="112" alt="CEH Course Highlights">
                                <div class="col-lg-12"><span style="font-size:10px;">* If you're not satisfied with your
                                        training on Day 1, get a refund or enroll in a different course.</span></div>
                            </div>
                        </div>
                        <!--<[ highlights-sec end ]>-->
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>CEH - An Overview</h2>
                                <p>
                                    The EC-Council’s Certified Ethical Hacker (CEH v13) Training program will enhance
                                    your knowledge of essential security fundamentals. Certified Ethical Hacker (CEH
                                    v13) certification course is one of the most sought-after security qualifications in
                                    the world. This internationally recognized security course validates your ability to
                                    discover weaknesses in the organization’s network infrastructure and aids in the
                                    effective combat of cyber-attacks.</p>
                                <p>
                                    The C|EH v13 program is a specialized, one-of-a-kind training program that teaches
                                    everything about ethical hacking with hands-on training, labs, assessment, a mock
                                    engagement (practice), and a global hacking competition.
                            ...
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <ul>
                                            ...
                                            <li>Network Scanning Countermeasures</li>
                                        </ul>

                                        <strong>Module 4: Enumeration</strong>
                                        <ul>
                                        ...
                                        <strong>Module 5: Vulnerability Analysis</strong>
                                        <ul>
                                            <li>Vulnerability Assessment Concepts</li>
                                            <li>Vulnerability Scoring Systems and Databases</li>
                                        ...
                                        <strong>Module 6: System Hacking</strong>
                                        <ul>
                                        ...
                                        <strong>Module 7: Malware Threats</strong>
                                        <ul>
                                            <li>Malware Concepts</li>
                                            <li>APT Concepts</li>
                                            <li>Trojan Concepts</li>
                                            <li>Viruses and Worms</li>
                                            <li>Fileless Malware Concepts</li>
                                            <li>AI-based Malware Concepts</li>
                                            <li>Malware Countermeasures</li>
                                            <li>Anti-Malware Software</li>
                                        </ul>

                                        <strong>Module 8: Sniffing</strong>
                                        <ul>
                                        ...
                                        <strong>Module 9: Social Engineering</strong>
                                        <ul>
                                            <li>Social Engineering Concepts</li>
                                            <li>Human-based Social Engineering Techniques</li>
                                            <li>Computer-based Social Engineering Techniques</li>
                                            <li>Mobile-based Social Engineering Techniques</li>
                                            <li>Social Engineering Countermeasures</li>
                                        </ul>

                                        <strong>Module 10: Denial-of-Service</strong>
                                        <ul>
                                            <li>DoS/DDoS Concepts</li>
                                            <li>Botnets</li>
                                            <li>DDoS Case Study</li>
                                            <li>DoS/DDoS Attack Techniques</li>
                                            <li>DoS/DDoS Attack Countermeasures</li>
                                        </ul>

                                        <strong>Module 11: Session Hijacking</strong>
                                        <ul>
                                        ...
                                        <strong>Module 12: Evading IDS, Firewalls, and Honeypots</strong>
                                        <ul>
                                            <li>Intrusion Detection/Prevention System (IDS/IPS) Concepts</li>
                                            <li>Firewall Concepts</li>
                                            <li>IDS, IPS, and Firewall Solutions</li>
                                            <li>Evading IDS/Firewalls</li>
                                            <li>Evading NAC and Endpoint Security</li>
                                            <li>IDS/Firewall Evading Tools</li>
                                            <li>Honeypot Concepts</li>
                                            <li>IDS/Firewall Evasion Countermeasures</li>
                                        </ul>

                                        <strong>Module 13: Hacking Web Servers</strong>
                                        <ul>
                                            <li>Web Server Concepts</li>
                                            <li>Web Server Attacks</li>
                                            <li>Web Server Attack Methodology</li>
                                            <li>Web Server Attack Countermeasures</li>
                                            <li>Patch Management</li>
                                        </ul>

                                        <strong>Module 14: Hacking Web Applications</strong>
                                        <ul>
                                            <li>Web Application Concepts</li>
                                            <li>Web Application Threats</li>
                                            <li>Web Application Hacking Methodology</li>
                                            <li>Web API and Webhooks</li>
                                            <li>Web Application Security</li>
                                        </ul>

                                        <strong>Module 15: SQL Injections</strong>
                                        <ul>
                                        ...
                                        <strong>Module 16: Hacking Wireless Networks</strong>
                                        <ul>
                                            <li>Wireless Concepts</li>
                                            <li>Wireless Encryption</li>
                                            <li>Wireless Threats</li>
                                            <li>Wireless Hacking Methodology</li>
                                            <li>Wireless Attack Countermeasures</li>
                                        </ul>

                                        <strong>Module 17: Hacking Mobile Platforms</strong>
                                        <ul>
                                            <li>Mobile Platform Attack Vectors</li>
                                            <li>Hacking Android OS</li>
                                            <li>Hacking iOS</li>
                                            <li>Mobile Device Management</li>
                                            <li>Mobile Security Guidelines</li>
                                            <li>Mobile Security Tools</li>
                                        </ul>

                                        <strong>Module 18: IoT Hacking & OT Hacking</strong>
                                        <ul>
                                            <li>IoT Hacking</li>
                                            <li>IoT Concepts and Attacks</li>
                                            <li>IoT Hacking Methodology</li>
                                            <li>OT Hacking</li>
                                        </ul>

                                        <strong>Module 19: Cloud Computing</strong>
                                        <ul>
                                            <li>Cloud Computing Concepts</li>
                                            <li>Container Technology</li>
                                            <li>Serverless Computing</li>
                                            <li>Cloud Hacking</li>
                                            <li>Cloud Hacking Methodology</li>
                                            <li>AWS Hacking</li>
                                            <li>Microsoft Azure Hacking</li>
                                            <li>Google Cloud Hacking</li>
                                            <li>Container Hacking</li>
                                            <li>Cloud Security</li>
                                        </ul>

                                        <strong>Module 20: Cryptography</strong>
                                        <ul>
                                            <li>Cryptography Concepts and Encryption Algorithms</li>
                                            <li>Applications of Cryptography</li>
                                            <li>Cryptanalysis</li>
                                            <li>Cryptography Attack Countermeasures</li>
                                        </ul>
                                ...
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">CEH Tools Covered</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content"  style="height: 400px;overflow-y: scroll;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Winrtgen</li>
                                                    <li>pwdump7</li>
                                                    <li>Tanium Endpoint Management</li>
                                                </ul>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <ul>
                                                    <li>AndroRAT</li>
                                                    <li>PhoneSploit-Pro</li>
                                                    <li>LOIC</li>
                                                </ul>

                                                <strong>IoT and OT Tools</strong>
                                                <ul>
                                                    <li>Bevywise IoT Simulator</li>
                                                </ul>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <ul>
                                            <li>Ethical hacking fundamentals, cyber kill chain concepts, an overview of
                                                information security and security measures with AI-enhanced threat
                                                detection and response.</li>
                                            <li>Concepts, methodologies, and tools of footprinting using AI for
                                                automated information gathering and reconnaissance.</li>
                                            <li>Concepts of vulnerability assessment, its categories and strategies, and
                                                AI-driven exposure to technologies used in the industry.</li>
                                            <li>Social engineering concepts and terminologies, including identity theft,
                                                impersonation, insider threats, social engineering techniques, and
                                                AI-based countermeasures.</li>
                                            <li>Operational Technology (OT) essentials, threats, attack methodologies,
                                                and AI-powered attack prevention.</li>
                                            <li>Recognizing vulnerabilities in IoT and ensuring the safety of IoT
                                                devices using AI-based security solutions.</li>
                                            <li>Encryption algorithms, Public Key Infrastructure (PKI), cryptographic
                                                attacks, cryptanalysis, and enhanced cryptographic defense.</li>
                                            <li>Cloud computing, threats and security, AI-driven container technology,
                                                and serverless computing security measures.</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>C|EH v13 (MCQ Exam)</td>
                                                    <td>C|EH v13 (Practical Exam)</td>
                                                </tr>
                                                <tr>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <p>
                                            Basic understanding of network essentials and core concepts, including
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <ul>
                                            ...
                                            <li>Information Security Auditors</li>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide item">
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2023/12/abhishek.png"
                                        alt="Ashish Rawat|InfosecTrain Instructor">
                                </div>
                                <div class="avtar-data">
                                    <div class="avtar-name">
                                    Ashish Rawat
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Get immersed in scenario-based learning</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Updated curriculum</strong> aligned with CEH version 13</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/learning-schedule.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Choose our <strong>Flexible Learning schedule</strong> on weekdays or weekends</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of CEH Certification</h2>
                    </div>
                </div>
                <div class="row align-items-center benefits-row-two">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of ceh Certification" loading="lazy">
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            ...
                            <picture>
                                <source media="(min-width:768px)" width="1074" height="390"
                                    srcset="assets/images/benifits/benefits-desk.webp">
                                <img src="assets/images/benifits/benefits-mob.webp" width="510" height="452"
                                    alt="Benefits of ceh Certification" loading="lazy">
                            </picture>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/05/Aditya-Vivek-Kulkarni.jpg"
                                            alt="Aditya Vivek Kulkarni" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/05/Nizamuddin-ck.jpg"
                                            width="250" height="250" alt="Nizamuddin ck">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Nizamuddin ck
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/05/Fernando-Guerra.jpg"
                                            width="250" height="250" alt="Fernando Guerra">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                           Fernando Guerra
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/05/Dr-Surya-Prakash-Okhrabo.jpg"
                                            width="250" height="250" alt="Dr Surya Prakash Okhrabo">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/05/Shivam-Chandra.jpg"
                                            width="250" height="250" alt="Shivam Chandra">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Shivam Chandra
                ...
                <div class="row align-items-center row-two">
                        ...
                        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/samipan-das.webp" width="896" height="462"
                                        alt="CEH Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/pranay-paliwal.webp" width="896" height="462"
                                        alt="CEH Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/jyothi-balachandra.webp" width="896"
                    ...
                    <div class="col-lg-6">
                        <div thumbsSlider="" class="swiper mySwiper3" style="width: 100%;">
                            <div class="swiper-wrapper justify-content-between">
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/samipan.webp" width="192" height="200"
                                        alt="CEH Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Pranay.webp" width="192" height="200"
                                        alt="CEH Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Jyothi.webp" width="192" height="200"
                                        alt="CEH Success Story" />
                                </div>
                            </div>
                            <div class="d-flex justify-content-center align-items-center navigation">
                        ...
                        <div class="success-rate">
                            <img src="assets/images/success-rate.png" alt="CIPPE Training Certification Success Rate"
                                width="1088" height="136">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What is the CEH v13 course?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        The Certified Ethical Hacker course from the EC-Council will improve your
                                        understanding of key security principles. This version introduces advanced
                                        ethical hacking techniques, including AI-powered tools for automated threat
                                        detection, vulnerability scanning, and penetration testing. This course enables
                                        you to think like a hacker and provides the skills to protect your
                                        infrastructure. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How does CEH v13 differ from v12?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        CEH v13 introduces AI-powered tools, enhanced cloud and IoT security, and new
                                        attack vectors, reflecting the latest industry trends and real-world
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Which is the best ethical hacking
                                        certification?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        EC-Councils Certified Ethical Hacker (C|EH v13) program is one of the most
                                        prestigious certifications in the cybersecurity field. For two decades, it has
                                        held the top choice in the world for ethical hacking certification, and numerous
                                        firms have consistently placed it first. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the prerequisites for doing CEH
                                        certification?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        To pursue CEH certification you must have a basic understanding of networking
                                        essentials and core concepts, including server and network components. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What is the qualification for an Ethical
                                        Hacker?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        It is recommended to have a bachelors degree in Computer Science or related
                                        discipline. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How many questions are on the CEH
                                        exam?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        There are 125 questions in the CEH objective exam and 20 questions in the
                                        practical exam. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What is the pass rate for CEH?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        The passing score is 60%-80% in the CEH objective exam and 70% in the practical
                                        exam. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Who can register for this CEH Certification
                                        training course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        This course is suitable for Security Analysts, System Administrators, Network
                                        Administrators, Network and Security Engineers, Cyber Security Managers,
                                        Information Security Auditors, Security Professionals or anyone who is
                                        interested in becoming an Ethical Hacker. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the career opportunities after
                                        CEH?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                    </p>
                                    <p>Career opportunities after CEH:</p>
                                    <ul>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How long is the CEH v13 Certification training
                                        course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        The CEH course is a comprehensive training program spanning 40 hours. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Where can I enroll in the CEH Certification
                                        training course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                    </p>
                                    <p>Enroll in the CEH Certification Training at InfosecTrain:</p>
                                    <ul>
                                        <li>
                                            <p>
                                                Visit the InfosecTrain website, <a href="https://www.infosectrain.com/"
                                                    target="_blank">www.infosectrain.com</a>, and
                                                navigate the CEH Certification training page.
                                            </p>
                                        </li>
                                        <li>Fill out the registration form.</li>
                                        <li>You will get a confirmation email with further instructions.</li>
                                        <li>Book your free demo with Expert.</li>
                                    </ul>
                                    <p>You can also directly drop mail with your requirements at
                                        <strong>sales@infosectrain.com</strong>
                                    </p>
                                    <p></p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="CEH v13 Training" id="me_others_footer" name="me_others">
