...
$courseID = 47980;  // Change this to the specific course ID for different pages
...
<html lang="en">
    ...
    <head>
        ...
        <title>AI Governance Training</title>
        <meta name="description"
            content="InfosecTrain provides AI goverance certification Online training Courses to manage &amp; secure data, applications, Infrastructure in the cloud using best practices. Enroll Now">
        ...
        <main>
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                <h3 class="d-none d-lg-block">Build ethical, secure, and future-ready AI systems.</h3>
                                <h1>AI Governance Training</h1>
                                <!-- <h3>Prepare For CISSP Exam</h3> -->
                                <div class="d-flex flex-row banner-highlights">
                                    <div>
                                        <span>95% Increased</span>
                                        <p>Demand for AI Governance professionals</p>
                                    </div>
                                    <div>
                                        <span> $280,000</span>
                                        <p>Avg Salary of AI Governance Professionals</p>
                                    </div>
                                </div>
                                ...
                                <img src="assets/images/review-mob-img.png" alt="AI goverance Training Course Review"
                        ...
                        <div class="col-lg-5 col-md-6 d-none d-md-block">
                            <div class="item">
                                <img src="assets/images/AI-governance-BANNER.webp" fetchPriority="high"
                                    alt="AI goverance ME Course-BANNER" width="400" height="400">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="highlights-sec">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/time.svg"
                                            alt="AI goverance Training Course Highlights" width="45" height="45">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/customer-service.svg"
                                            alt="AI goverance Training Course Highlights" width="45" height="45">
                                        <p>Telegram Support Group Until Exam</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                ...
                                <div class="item-footer d-flex">
                                    <img src="assets/images/highlight-icon/100-satisfaction.webp"
                                        alt="AI goverance Training Course Highlights" width="150" height="150">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    <h2>AI Governance Training- An Overview</h2>
                                    <p>AI Governance is a strategic framework that defines the processes, policies, and
                                        controls organizations use to manage, monitor, and guide the responsible use of
                                        Artificial Intelligence. It helps ensure AI systems are ethical, secure,
                                        transparent, and compliant with legal and regulatory requirements. By aligning
                                        AI initiatives with organizational objectives, AI governance enables businesses
                                        to mitigate risks, enhance accountability, and maximize the value of AI
                                        technologies while fostering trust and long-term sustainability.</p>
                                    <!-- <p>Through hands-on exercises, case studies, and industry-relevant scenarios, learners gain practical experience to tackle real-world challenges. Designed for IT Professionals, Cybersecurity Specialists, Data Engineers, and enthusiasts, the course provides learners a competitive edge to master advanced AI technologies to safeguard digital ecosystems effectively and sustainably.</p> -->
                                </div>
            ...
            <section class="training-calendar" id="training-calendar">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>AI Governance Courses Training Calendar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 d-none d-lg-block">
                            <img src="assets/images/training-calendar.webp" width="132" height="128" alt="AI goverance"
                                class="img-fluid">
                        </div>
        ...
        ?>
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    <source media="(min-width:768px)" width="1400" height="420"
                                        srcset="assets/images/AI-governance-corporate-training-web.webp">
                                    <img src="assets/images/AI-governance-corporate-training-mob.webp" width="364"
                                        height="301" alt="AI goverance"
                        ...
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="designation">
                                    Cloud Audit | AI goverance | CCSK | CCAK | AWS CS-S | AWS CAN–S | AWS CSA-P | AWS
                                    CDE-P |
                                    MCT | CCAK | Azure Adv. Architect & Security | GCP PCA | GCP PCSE | CEH | RHCE |
                                    AIGP
                                </div>
                                <div class="summary">
                                    ...
                                    Performing as an Enterprise Cloud Security Architect, Cloud GRC Expert, Auditor
                                    &amp; Cloud Migration Strategist for over 15 years and served over 60+ enterprises
                                    worldwide.
                                </div>
                            </div>
                            <!--/ col end /-->
                            ...
                            <div class="designation">
                                Corporate Trainer | CISO | AI goverance | CISSP | ISO 42001 | ISO 27001 | CTO | CSOA
                            </div>
                            <div class="summary">
                                Sujay is a cybersecurity and cloud security expert with over 25 years of experience in
                                enterprise security, risk management, and compliance. As a AI goverance, CISSP, and ISO 42001
                            ...
                            <div class="designation">
                                C|CISO | CISSP | AI goverance | CISM | CRISC | CISA | CCSK | CCAK | CDPSE | CEH | RHCSA | GRCA |
                                GRCP |
                            ...
                            <div class="designation">
                                Cybersecurity Expert | CISSP | CSSLP | CSEP | AZ 500 | AWS Certified Security |
                                Certified Scrum Master
                            </div>
                            <div class="summary">
                                Venkatesh has amassed an impressive 17-year career leading and driving cybersecurity
                                efforts in digital systems engineering. His extensive experience speaks volumes about
                            ...
                            <div class="designation">
                                GRCP | ISSAP | AI goverance | CISSP | CCISO | AWS Architect Associate | AWS Security Specialty |
                                CEH | ECSA
                            </div>
                            <div class="summary">
                            ...
                            <div class="designation">
                                CISSP | AI goverance | C|EH | CPISI
                            </div>
                            <div class="summary">
                                14+ years of experience as a seasoned Information Security professional with hands-on
                                experience in auditing application’s controls, identifying breaches in
                                policies/controls, communicating gaps and risks associated with the business and
                                providing solutions to the stakeholders.
                            </div>
                        </div> -->
                            <!--/ col end /-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                ...
                                <p><strong>Learn from certified</strong> trainers and industry experts</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/assessment-practice.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Practice with labs<strong>, regular assessments, and case studies</strong></p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p><strong>Immerse in scenario-based learning</strong></p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/price-list.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p><strong>Best Quality Training with Best Price Guarantee</strong></p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p><strong>Conquer AI Governance </strong>with highly applicable skills</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Prepare to excel with mock tests, exam tips, and <strong>real-world examples</strong>
                                </p>
                            </div>
                        </div>
                        <!--/ col start /-->
            ...
            <section class="benefits-sec" id="benefits">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Benefits of AI Governance Training</h2>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center benefits-row-two">
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                                    <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                        alt="Benefits of AI goverance  Certification">
                                </div>
                                <div class="flex-grow-1 ms-3">
                        ...
                        <div class="col-md-8">
                            <div class="benifits-item-two">
                                <h3>Average Salary Range for AI Governance Roles</h3>
                                <picture>
                                    <source media="(min-width:768px)" width="1472" height="486"
                                        srcset="assets/images/benifits/benefits-AI-governance-desktop.webp">
                                    <img src="assets/images/benifits/benefits-AI-governance-mobile.webp" width="640"
                                        height="473" alt="Benefits of AI goverance  Certification">
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper myGladiators">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    I appreciate the AI goverance course trainer for engaging sessions throughout the
                                    week. The
                                    best part was the revision of the past modules whenever we jumped on the new module.
                                    It was great to have some time for the question and answer sessions. Along with all
                                    this, the best part was the concepts were being discussed in real example
                                    demonstrations.
                                ...
                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/AI goverance-6-150x150.jpg"
                                                alt="Abhinav Pathak" width="250" height="250">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    Enjoyed the course! The AI goverance trainer is very experienced and dedicated to
                                    delivering
                                    the best. As part of the training, he ensured that the training objective was met
                                    while keeping the exam preparation in mind at the same time.
                                </p>
                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/AI goverance-5-150x150.jpg"
                                                alt="Faruk Ahmed" width="250" height="250">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>Faruk Ahmed</h3>
                                            <span>India</span>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The AI goverance training at InfosecTrain was good, and the trainer&#8217;s ability
                                    to
                                    explain complicated topics in a simple manner was very good. He was able to explain
                                    concepts and left no room for doubt.
                                </p>
                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/AI goverance-4-150x150.jpg"
                                                alt="Swati Suman" width="250" height="250">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>Swati Suman</h3>
                                            <span>India</span>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    It was a very good AI goverance training session. The instructor is one of the best
                                    in the
                                ...
                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/AI goverance-3-150x150.jpg"
                                                alt="Sandipan Chaudhuri" width="250" height="250">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>Sandipan Chaudhuri</h3>
                                            <span>India</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    I found the AI goverance training to be highly valuable and wanted to express my
                                    gratitude
                                    for the comprehensive and well-structured program. The concepts were explained in an
                                    easy to understand language. The trainer made all efforts to make sure we had our
                                    concentration on his sessions and kept us engaged.

                                </p>
                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/AI goverance-2-150x150.jpg"
                                                alt="Anish Ayyappan" width="250" height="250">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>Anish Ayyappan</h3>
                                            <span>India</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    Excellent AI goverance training with highly professional communication from the
                                    support team
                                    (prompt delivery of all recordings). Would highly recommend InfosecTrain. Thanks a
                                    ton.
                                </p>
                                <div class="profile">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/AI goverance-1-150x150.jpg"
                                                alt="Lubin Abdul Khader" width="250" height="250">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h3>Lubin Abdul Khader</h3>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                                    ...
                                    <div class="overlay" id="overlay">
                                        <div class="play-button" onClick="playVideo()" id="playButton">
                                            <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                                alt="AI goverance Success Story" width="150" height="150">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="success-item">
                                <img src="assets/images/certificate.webp" alt="AI goverance Success Story"
