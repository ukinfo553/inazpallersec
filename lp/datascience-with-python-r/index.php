...
<head>
<meta charset="utf-8">
<meta name="description" content="Data Science with Python & R Certification course">
<meta name="author" content="Infosec Train">
<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
<title>Data Science with Python & R Certification course</title>
      ...
      <div class="col-12 col-md-6 col-lg-6 col-xl-8">
        <div class="left_banner">
            <div class="b_test_box">
                ...
                <h1 class="e_hacker">
				<a href="#" class="bannerf_a">DATA SCIENCE</a></h1>
				<h1 class="e_hacker">
				<a href="#" class="bannerf_a">WITH PYTHON & R</a></h1>
				
                <h2 class="e_council">
				<a href="#" class="bannerf_a2">Online Training</a></h2>
				<h2 class="e_council">
				<ul>
				<li>60 hours of Instructor Led training </li> 
				...
				<img src="assets/img_2/Group 8392@2x.png"  width="100%"/>
            </div>
        </div>
      </div>
...
<section id="coursecontent">
    <div class="container">
        <div class="row">
            <div class="col-12">               
               <h2 class="package-heading">Data Science Training Includes</h2>
            </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">Data Science Course Content</h2>
      </div>
    </div>
...
<!-- Tabs content -->
	  ...
	  <a href="https://www.infosectrain.com/wp-content/uploads/2021/11/Data_Science_with_python_and_r_Course_Content.pdf" target="_blank"><img src="assets/img_2/Download_Syllabus.svg" width="100%" alt="" class=""></a></div>
...
According to a report by the U.S. Bureau of Labor Statistics, Data Science jobs are going to increase by about 28% through 2026. The strong skill sets imparted via this program will help you to take advantage of unique opportunities with excellent pay-grades while solving complex business problems via data-driven decisions. Confidently use top tools and practices to mine, visualize and interpret Data with the help of this Data Science with Python & R course.
      ...
      <section id="section2" role="tabpanel" aria-labelledby="tab2" class="tabs-panel js-tabs-panel">
        ...
        <div class="content" aria-hidden="true">
		 ...
		 <p> Our Data Science Master Bootcamp with Python & R is a comprehensive program taught by Industry-experts which covers the fundamentals basics as well as top programming languages in Data Science & Machine Learning.</p>

<p>In this data science online course, You will learn the following:</p>
<ul class="ulclass">
<li>Building basics on Python and R programming language</li>
<li>Installing, Configuring & Using Anaconda & R Studio</li>
<li>Learn about Population & Data Sampling</li>
<li>Explore Probability for Data Science</li>
<li>Get an Introduction to Machine Learning</li>
<li>Learn about Data Visualization with Interpretation</li>
<li>Explore Deep Learning & neural Networks</li>
</ul>
<p>And much more!</p>

<p>Join the Data Revolution & craft a winning professional career with this A to Z Data Science program from InfoSecTrain.</p>
  ...
  <li>Introduction to Python & R</li>
  <li>Basics of Python & R</li>
  <li>Types of Characteristics</li>
  <li>Types of Data</li>
  <li>Methods of Sampling</li>
  <li>Measure Central Tendency</li>
  <li>Measure of Dispersion</li>
  <li>Moments, Skewness & Kurtosis</li>
  <li>Correlation Analysis</li>
  <li>Probability</li>
  <li>Testing of Hypothesis</li>
  <li>Test for Population Mean</li>
  <li>Central Limit Theorem</li>
  <li>Paired t-Test</li>
  <li>Test for Goodness of Fit</li>
  <li>Analysis of Variance (ANOVA)</li>
  <li>Introduction to Machine Learning</li>
  <li>Data Visualisation with interpretation </li>
  <li>Regression Analysis</li>
  <li>Dimensionality Reduction Technique</li>
  <li>Clustering Analysis</li>
  <li>Association Rule & Recommendation System</li>
  <li>Introduction to Neural Network & Deep Learning</li>
  <li>Parameter & Hyper parameter</li>
  ...
  <li>Recurrent Neural Network (RNN)</li>
	  ...
	  <section id="section4" role="tabpanel" aria-labelledby="tab4" class="tabs-panel js-tabs-panel">
        ...
        <div class="content" aria-hidden="true">
         <div class="tab_content">
		 <ul class="ulclass">
		 <li> Anyone who willing to learn Machine Learning from Scratch to Professional Level</li>
  <li>Students and Working Professional</li>
</ul></div>
        </div>
      </section>
	  <section id="section5" role="tabpanel" aria-labelledby="tab5" class="tabs-panel js-tabs-panel">
        ...
        <div class="content" aria-hidden="true">
		 ...
		 <li>Beginner in Python & R Programming</li>
		<li>Ready to Learn Passionately</li>
		 </ul>
		   </div>
        </div>
      </section>
	  ...
	  <a href="https://www.infosectrain.com/wp-content/uploads/2021/11/Data_Science_with_python_and_r_Course_Content.pdf" target="_blank"><img src="assets/img_2/Download_Syllabus.svg" alt="" class="" style="width:200px;"></a></div>
...
<section id="table_section">
    ...
    <div  class="container" id="benefits">
        <div class="row">
            <div class="col-12">
               <h2 class="package-heading">Data Science Training Calendar</h2>
...
<?php
$url = "https://www.infosectrain.com/api/36765/href_toscroll/free_demo";
    ...
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">Career Benefits</h2>
		  <img src="assets/img_2/CareerBenefits.png" width="100%" alt="" class="">
      </div>
    </div>
