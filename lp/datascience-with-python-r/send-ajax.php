...
$email_subject = "New Enquiry from Data Science with Python & R Certification  Landing Page"; 
			        ...
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul><li><a href="https://www.infosectrain.com/blog/top-data-science-tools-that-you-should-learn-in-2022/" target="_blank">Top Data Science Tools That You Should Learn In 2022 </a></li>
  <li><a  href="https://www.infosectrain.com/blog/kickstart-a-powerful-career-in-data-science/" target="_blank">Kickstart A Powerful Career In Data Science </a></li>
  <li><a  href="https://www.infosectrain.com/blog/top-cybersecurity-trends-to-keep-track-of-in-2021/" target="_blank">Top Cybersecurity Trends to Keep Track of in 2021</a></li>
</ul>
			        ...
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul>
							<li><a href="https://www.youtube.com/watch?v=pD8YM2kea4M">What is Data Science? Why to learn Data Science?</a> </li>
  <li><a href="https://www.youtube.com/watch?v=sYNNNkSu7kQ"> What is Hypothesis Testing  </a> </li>
  <li><a href="https://www.youtube.com/watch?v=YS_sJTZlieM">Introduction To Python </a> </li>
</ul>
							</td>
						  </tr>					  
                      </table>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp', 
    'page_type' => 'Data Science with Python & R', 
    'name' => $me_name,
    'email' => $me_email, 
    'phone' => $me_phone, 
