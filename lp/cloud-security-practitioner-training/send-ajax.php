...
$email_subject = "Cloud Security Practitioner Training Landing Page"; 
	   ...
	   <table align="center" border="0" cellpadding="0" cellspacing="0" width="700" style=" background:#F8F8F8; padding:56px;">
	     ...
	     <tr >
			<td >
				...
				<ul><li><a href="https://www.infosectrain.com/blog/all-about-cloud-security-practitioner-course-from-infosectrain/">All About Cloud Security Practitioner Course from InfosecTrain</a></li>
				<li><a href="https://www.infosectrain.com/blog/how-to-build-a-successful-career-in-cloud-auditing-in-2023/">How to Build a Successful Career in Cloud Auditing in 2023?</a></li>
				<li><a href="https://www.infosectrain.com/blog/top-cybersecurity-courses/">Top Cybersecurity Courses to Choose in Your Country </a></li>
				<li><a href="https://www.infosectrain.com/blog/cloud-practitioner-interview-questions/">Cloud Practitioner Interview Questions </a></li>
     </ul> 
     <h2>Get in Touch on Youtube:</h2>
				<ul><li><a href="https://www.youtube.com/watch?v=ovTI8b8W2TY">Learn Cloud Security Practitioner Training Course By Rishabh</a> </li>
				<li><a href="https://www.youtube.com/watch?v=QElFJi4tNMU">What is Cloud Security Practitioner? </a> </li>
				<li><a href="https://www.youtube.com/watch?v=N9be0jCL6HY">Become Expert in Cloud Security Practitioner </a> </li>
     </ul>
				    </td>
				</tr>
				<tr>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp', 
    'page_type' => 'Cloud Security Practitioner', 
    'name' => $me_name,
    'email' => $me_email, 
    'phone' => $me_phone, 
