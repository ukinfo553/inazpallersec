        ...
        <section class="banner-sec">
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7">
                        <div class="item">
                            <h3>Join the CISSP <span style="color:var(--red);">Classroom Training in Hyderabad</span>
                            </h3>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                missing dots. Thank you InfosecTrain for such an amazing experience at Hyderabad
                                classroom training!
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                exam. He was on time every day for our classroom training at Hyderabad, stuck to his
                                commitments and ensured the objective of the course was met without any compromises
                            </p>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="CISSP Training Hyderabad" id="me_others_footer"
                                    name="me_others">
