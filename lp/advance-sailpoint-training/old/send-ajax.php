	   ...
	   <table align="center" border="0" cellpadding="0" cellspacing="0" width="700" style=" background:#F8F8F8; padding:56px;">
	     ...
	     <tr >
			<td >
				...
				<br><br>
				 SailPoint Online Training Demo: <a style="color:#ff4444" href="https://www.youtube.com/watch?v=4m4yihNb6Po&t" target="_blank">Click Here</a>
				 <br> <br>
				    </td>
				</tr>
				<tr>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp', 
    'page_type' => 'Sailpoint IdentityIQ', 
    'name' => $me_name,
    'email' => $me_email, 
    'phone' => $me_phone, 
