...
$email_subject = "New Enquiry from Cloud Security Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/cloud-data-lifecycle/" target="_blank">Cloud Data Lifecycle</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/what-is-the-amazon-quantum-ledger-database/" target="_blank">What is the Amazon Quantum Ledger Database?</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-cloud-platforms/" target="_blank">Top Cloud Platforms to Watch Out in 2024</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/why-cloud-security-governance-training-course-with-infosectrain/"  target="_blank">Why Cloud Security Governance Training Course with InfosecTrain?</a> </li>
							</ul>
                        </td>
                    </tr>
                    <tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=2A6OMWRGuPU" target="_blank">Cloud Security Interview Questions and Answers </a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=2x9ytiouo6c" target="_blank">Cloud Security Fundamentals</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=kdvVt4Khr9Q" target="_blank">Cloud Security Engineer Interview Questions & Answers</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=-LARByXkIz4" target="_blank">Benefits of Cloud Security</a> </li>
							</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/azure-sentinel-training/"  		target="_blank">Microsoft Sentinel</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cloud-security-practitioner-training/"  target="_blank">Cloud Security Practitioner</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/sc-200-exam-training/"  target="_blank">Microsoft Security Operations Analyst</a> </li>
							</ul>
						</td>
					</tr>
...
return array($result,$last);
 ...
 $data = array(
    ...
    'page_type' => 'Cloud Security Training',
