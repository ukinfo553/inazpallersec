        ...
        <div class="row">
            <div class="col-12">
                <div class="advisor_box_con">
					...
					<p class="pt20">
					Srikanth served as a corporate trainer & Consultant with nearly 4+ years of experience across the diverse industry.  Hands-on experience on Exploit techniques like social engineering, client-side attacks, Virus & backdoors
					</p>
                        <h4 class="adv-h">Srikanth Rendla</h4>
                        <p class="adv-p">CEH |  Network+ | A+ | Sec+ | Azure |</p>
                    </div>
                    <div class="advisor_box">
					<img src="assets/img_2/adviso_2.png"  width="61">
					<p class="pt20">
					Sanyam served as a corporate trainer & Consultant with nearly 5+ years of experience across the diverse industry. Delivering more than 30+ training programs yearly, with 250+ professionals overall.<br /><br /></p>
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<p class="wordof_p">
				Training and Trainer was good. The session were interactive and knowledgeable. Thanks to InfosecTrain
					</p>
          ...
          <div class="advisor_box">
           <div class="prof-img">
                            <img src="assets/img_2/sujesh.png" alt="" class="p_image">                          </div>
          <p class="wordof_p">
         Basic info conveyed in a good manner. Appreciate the effort of the trainer and best wishes. Thanks to InfosecTrain
          </p>
                        <h4 class="adv-ho">Sujesh Punnapully</h4>
                        <p class="adv-p">CompTIA Security+ | Oman</p>
                    </div>
