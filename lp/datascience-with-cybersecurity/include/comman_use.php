...
define("BASE_URL", "https://www.infosectrain.com/pages/lp/datascience-with-cybersecurity/");
//define("BASE_URL", "https://localhost/infosectrain.com/lp/security-plus-training/");
