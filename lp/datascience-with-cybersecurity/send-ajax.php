...
$email_subject = "New Enquiry from Cybersecurity Data Science Training Course Landing Page"; 
			        ...
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul>
							<li><a href="https://www.infosectrain.com/blog/cybersecurity-vs-data-science-a-roadmap/" target="_blank">Cybersecurity vs. Data Science: A Roadmap </a></li>
  							<li><a  href="https://www.infosectrain.com/blog/top-it-security-certifications-for-2022/" target="_blank">Top IT Security Certifications for 2022 </a></li>
  							<li><a  href="https://www.infosectrain.com/blog/starting-a-career-in-cyber-security/" target="_blank">Starting a career in Cyber Security in 2022 </a></li>
							</ul>
			        ...
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul>
							<li><a href="https://www.youtube.com/watch?v=Adau0KDVJjA">Data Science for Cyber Security </a> </li>
  							<li><a href="https://www.youtube.com/watch?v=EIQOTS3hkvw">What is cyber security</a> </li>
  							<li><a href="https://www.youtube.com/watch?v=q5JG6pEtmMw">Why Cyber security is Important</a> </li>
</ul>
							</td>
						  </tr>					  
                      </table>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp', 
    'page_type' => 'Cybersecurity Data Science Training Course', 
    'name' => $me_name,
    'email' => $me_email, 
    'phone' => $me_phone, 
