...
$courseID = 47025;  // Change this to the specific course ID for different pages
...
<head>
    ...
    <title>Advanced in AI Security Management (AAISM) Certification Training</title>
    <meta name="description"
        content="Agentic AI for Non-Tech Training by InfosecTrain helps professionals understand, apply, and manage AI agents without coding bridging business and innovation.">
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <div class="d-flex flex-row banner-highlights">
                                <div>
                                    <span>86% Increase in AI Security</span>
                                    <p>Management Jobs</p>
                                </div>
                                <div>
                                    <span>$152,773</span>
                                    <p>Median Salary of an AI Security Manager</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/Advanced-AI-Security-Management-Certification-Training-BANNER.webp"
                    ...
                    <div class="col-lg-8 col-md-6">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/video-recording.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>First AI-Security Management Credential</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/isaca-premium.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>Designed for CISSP/CISM holders</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/batch.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>Combines AI + Risk Governance</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/passed-rate.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>Aligns with ISO 17024 Standards</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/learning.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>Access to Post-Course Mentorship, Community & Recorded Sessions</p>
                                </div>
                            </div>
                            <div class="item-footer d-flex">

                                <img src="assets/images/isaca.png"
                                    alt="Agentic AI Training for Non-Tech Course Highlights" width="300"
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>Advanced in AI Security Management (AAISM) Certification Training - An Overview
                                </h2>
                                <p>The ISACA Advanced in AI Security Management™ (AAISM) is the first-of-its-kind
                                    certification purpose-built for experienced security leaders navigating the
                                    intersection of artificial intelligence and cybersecurity. Tailored for CISM or
                                    CISSP-certified professionals, AAISM validates the ability to assess, implement,
                                    and govern secure AI solutions across the enterprise. As AI adoption
                                    accelerates, this certification positions you to lead confidently through
                                    evolving threat landscapes, regulatory changes, and organizational
                                    transformation. Grounded in established security management best practices and
                                    aligned with ISO 17024 standards, AAISM empowers professionals to transition
                                    from reactive security oversight to strategic AI-driven leadership.</p>
                            </div>
        ...
        <?php if (!empty($courseID)): ?>
            <section class="training-calendar" id="training-calendar">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Advanced in AI Security Management (AAISM) Certification Training Calendar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <!-- <div class="d-flex">
                                                <select class="course-form-control form-control" id="contry_phone7"
                                                    name="contry_phone7" onchange="phone_contryside()"
                                                    style="width:62%;border-radius: 5px 0 0 5px;border-right:none;">
                                                    <option value="+91">IN [+91]</option>
                                                    <option value="+93">
                                                        AF [+93]
                                                    </option>
                                                ...
                                                <input type="tel" class="course-form-control form-control"
                                                    id="contry_phone72" name="contry_phone72"
                                                    placeholder="Enter Your Phone No." onkeyup="phone_contryside()"
                                                    style="width:100%;border-radius: 0 5px 5px 0;">

                                                <input type="hidden" class="course-form-control" id="me_phone"
                                                    name="me_phone" placeholder="Enter your phone no." value="">
                                            </div> -->
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                <source media="(min-width:768px)" width="1400" height="420"
                                    srcset="assets/images/Advanced-AI-Security-Management-Certification-Training-corporate-training-web.webp">
                                <img src="assets/images/Advanced-AI-Security-Management-Certification-Training-corporate-training-mob.webp"
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                AAIA | CISSP | CCSP | CISM | CRISC | CISA | CCSK | CCAK | CDPSE | CEH | C|CISO RHCSA
                                | GRCA | GRCP | CPP | PSP | PCI | AZ-900 | GDPR
                            </div>
                            <div class="summary">
                                With over 22 years of experience in cybersecurity, KK specializes in malware
                                analysis, enterprise incident response, vulnerability research, and governance, risk
                                & compliance. He has mentored numerous professionals toward their certification
                                goals and possesses deep expertise in analyzing security events, responding to
                                incidents, and managing cyber threat intelligence.
                            </div>
                        </div>
                        <!--/ col end /-->
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Learn from <strong>ISACA-certified</strong> AI security experts</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Prepare with <strong>ISO-aligned</strong> governance frameworks</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Gain <strong>career guidance and mentorship</strong> from industry experts</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of Advanced in AI Security Management (AAISM) Certification Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of an AI Security Manager</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average Salary Range for AI Security Management Roles</h3>
                            <picture>
                                <source media="(min-width:768px)" width="1472" height="486"
                                    srcset="assets/images/benifits/Advanced-AI-Security-Management-Certification-Training-benefits--desktop.webp">
                                <img src="assets/images/benifits/Advanced-AI-Security-Management-Certification-Training-benefits-mob.webp"
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The training was thorough and impeccable. It helped me greatly in strengthening a couple of domains that were my weak points and also provided a broader understanding of information security in general. The detailed classes, along with real-time examples, made the learning highly interactive and effective.

                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2026/01/ShanuNayya.jpeg"
                                            alt="Shanu Nayyar" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Shanu Nayyar</h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The sessions are highly interactive and the trainer is very supportive throughout. The course has progressed smoothly, with a strong focus on clarity and understanding. The trainer ensures each topic is explained thoroughly.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2026/01/AhmedMahmoo.jpeg"
                                            alt="Ahmed Mahmood" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Ahmed Mahmood</h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The instructor's mastery over the subjects and topics is truly outstanding! The way he handles queries is nothing short of commendable. His patience and calm demeanour ensure that every single one of our questions and doubts is thoroughly addressed before moving on to new topics.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2026/01/PrateekDwived.jpeg"
                                            alt="Prateek Dwivedi" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Prateek Dwivedi</h3>
                                        <span>India</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Very informative session. Instructor was very knowledge and patient in clearing all student queries.

                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2026/01/MacbethVa.jpeg"
                                            alt="Macbeth Vaz" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Macbeth Vaz</h3>
                                        <span>Canada</span>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The course was great and the instructor has shared great insights through this course. It has been a great learning journey!
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2026/01/NirajKuma.jpeg"
                                            alt="Niraj Kumar" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Niraj Kumar</h3>
                                        <span>India</span>
