...
$email_subject = "New Enquiry from CRISC Landing Page";
            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=ODVrTueycr8" target="_blank">What Is CRISC? | Who Needs CRISC ? & It"s Benefits</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=Xa7wFotwfOY" target="_blank">How To Prepare For CRISC Exam ? CRISC Exam Structure And Preparation</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=DeYCqgU2pvI" target="_blank">How to clear CRISC Exam? | How to prepare for CRISC Exam?</a> </li>
							</ul>
						</td>
					</tr>
					<tr>
