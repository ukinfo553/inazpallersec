...
$email_subject = "CCSK PLUS Landing Page";
	   ...
	   <table align="center" border="0" cellpadding="0" cellspacing="0" width="700" style=" background:#F8F8F8; padding:56px;">
	     ...
	     <tr >
			<td >
				...
				<ul>
				<li><a href="https://www.infosectrain.com/blog/how-to-secure-the-hybrid-cloud/"> How to Secure the Hybrid Cloud?</a></li>
				<li><a href="https://www.infosectrain.com/blog/what-is-a-load-balancer-in-cloud-computing/"> What is a Load Balancer in Cloud Computing?</a></li>
				<li><a href="https://www.infosectrain.com/blog/real-world-applications-of-cloud-computing/"> Real-World Applications of Cloud Computing</a></li>
				<li><a href="https://www.infosectrain.com/blog/what-is-aws-rds/"> What is AWS RDS?</a></li>
				</ul>
     <h2>Get in Touch on Youtube:</h2>
				<ul>
				<li><a href="https://youtu.be/cDqpT3qtYAQ">How to Start Career in Cloud Computing</a> </li>
				</ul>
				    </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<ul>
    					...
    					<li><a href="https://www.infosectrain.com/courses/cloud-security-fundamentals-knowledge-training/">Cloud Security Fundamentals Knowledge</a> </li>
