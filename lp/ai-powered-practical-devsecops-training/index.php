...
$courseID = 42111;  // Change this to the specific course ID for different pages
...
<head>
    ...
    <title>AI-Powered Practical DevSecOps Training</title>
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <div class="d-flex flex-row banner-highlights">
                                <div>
                                    <span>92% Increase</span>
                                    <p>in DevSecOps Related Jobs</p>
                                </div>
                                <div>
                                    <span>$177,000</span>
                                    <p>Median Salary of a DevSecOps Manager</p>
                                </div>
                            </div>
                            <div class="nextBatch">
                                Next Batch Starts
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    ...
                                    <p>45-Hour LIVE Instructor-Led Training</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/practical-approch.svg"
                                        alt="AIGP Training Course Highlights" width="45" height="45">
                                    <p>Scenario-based Practical Approach</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/practical-approch.svg"
                                        alt="AIGP Training Course Highlights" width="45" height="45">
                                    <p>6+ Intermediate Learning Projects Covered</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/membership.svg"
                                        alt="AIGP Training Course Highlights" width="45" height="45">
                                    <p>Hands-on Projects for Each Tool</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>AI-Powered Practical DevSecOps Training- An Overview</h2>
                                <p>
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                <?php if (!empty($courseID)): ?>
                    <div class="row">
                        <div class="col-12">
                            <h2>AI-Powered Practical DevSecOps Training Calendar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                Sr. DevSecOps Expert | AWS | GCP | CKA | AZ-400 | Terrafor
                            </div>
                            <div class="summary">
                                Santhosh is a seasoned DevSecOps engineer with 16+ years of experience in securing CI/CD pipelines, automating infrastructure with Terraform, and deploying applications across AWS, Azure, and GCP. Recognized for his achievements as an AWSronaut and Golden Kubestronaut, he brings a proven record of expertise and excellence in cloud and DevSecOps domains. He integrates security controls into DevOps workflows using tools like SonarQube, Git, and Prometheus. Skilled in Kubernetes and cloud-native security, he drives secure, scalable, and compliant deployments while mentoring teams on DevSecOps best practices
                            </div>
                        </div>
                        <!--/ col end /-->
                    </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of a DevSecOps Manager</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
