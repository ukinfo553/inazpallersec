...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from AI-Powered Practical DevSecOps Training Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-become-a-devsecops-engineer" target="_blank">How to Become a DevSecOps Engineer in 2025?</a></li>
                                ...
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/is-a-devsecops-career-right-for-you-in-2024" target="_blank">Is a DevSecOps Career Right for You in 2025?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/what-is-compliance-in-devsecops" target="_blank">What is Compliance in DevSecOps?</a></li>                          </ul>
                        </td>                    </tr>
                    <tr>                        <td style="color: #414547; padding-left: 24px;padding-top:10px;font-family: Arial, Helvetica, sans-serif;font-size: 18px;">
                        ...
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/grc-online-training"  target="_blank">GRC Hands-on Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;"https://www.infosectrain.com/courses/azure-security-combo-training"  target="_blank">Azure Administrator & Security (AZ-104 + AZ-500) Training</a> </li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/aws-combo-course-training"  target="_blank">AWS Architecture Foundation & AWS Security Speciality Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/ccsp-certification-training"  target="_blank"> CCSP Training & Certification Course</a> </li>
                        </ul>                        </td>
                    </tr>
                    ' . $email_footer . '
                </table>
...
';
    ...
    $data = array(
        ...
        'page_type' => 'AI-Powered Practical DevSecOps Training',
