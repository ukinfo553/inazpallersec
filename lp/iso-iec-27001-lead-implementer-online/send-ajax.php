...
$email_subject = "ISO 27001:2022 Lead Implementer Landing Page";
            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/iso27001la/">ISO/IEC 27001:2022 Lead Auditor</a></li>
...
<tr>
    <td style="padding:0 24px;">
        <a href="https://www.infosectrain.com/pages/download/how_to_become_an_IT_Auditor.pdf" target="_blank"
            ...
            Download ISO LI Preparation Guide
        </a>
    </td>
</tr>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp',
    'page_type' => 'ISO 27001:2022 Lead Implementer',
    'name' => $me_name,
    'email' => $me_email,
    'phone' => $me_phone,
