                        ...
                        <div class="col-lg-5 col-md-6 d-none d-md-block">
                            <div class="item">
                                <img src="assets/images/banner.png" fetchPriority="high"
                                    alt="ISO 27001:2022 Lead Implementer Training by InfosecTrain" width="800"
                                    height="521">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/time.png"
                                            alt="ISO 27001:2022 Lead Implementer Course Highlights" width="45"
                                            height="45">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    ...
                                    <p>ISO/IEC 27001 Lead Implementer Training is an intensive course that enables
                                        participants to develop the necessary expertise to support an organization in
                                        implementing and managing an Information Security Management System (ISMS) based
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    ...
                                    <img src="assets/images/corporate-training-mob.png" width="364" height="301"
                                        alt="ISO 27001:2022 Lead Implementer Corporate Training"
                    ...
                    <div class="swiper myAdvisor">
                        <div class="swiper-wrapper d-flex justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    25+ years of experience as an IT Information Security Analyst with a rich and
                                    diverse portfolio in fields like Facility Operations, Mission Critical Building
                                    Operations, Safety, Security, Process Implementation, Information Security, Risk
                                    Management, Operational Excellence, Auditing, Training & Mentoring.
                                </div>
                            </div>
                            <!--/ col end /-->
                            <!--/ col start /-->
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    10+ years of experience as an Information Security Consultant and Trainer in
                                    delivering training to government and non-government organizations around the globe
                                    on different Information security verticals.
                                </div>
                            </div>
                            <!--/ col end /-->
                            ...
                            <div class="benifits-item-two">
                                ...
                                <picture>
                                    ...
                                    <img src="assets/images/benifits/benefits-security-plus-mob.png" width="640"
                                        height="473" alt="Benefits of ISO 27001:2022 Lead Implementer Certification">
                                </picture>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    ...
                                    knowledgeable. He explained all queries deeply and did not rush anything. It was
                                    ensured that everyone full understood the concepts. I highly recommend Infosec
                                    Train.
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The ISO 27001 Lead Implementer trainings has been delivered in a very strategic and
                                    structured manner and our trainer was very knowledgeable on the subject.
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    ...
                                    though I have some experience in implementing ISO there were a lot of unknowns to me
                                    and the sessions helped to cover those.
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    ...
                                    The trainer has taken every effort in conveying all knowledge related to ISO 27001.
                                    I have been able to understand concepts based on his teaching methods. The classes
                                    were interactive and any queries raised were duly answered with explanations.
                                    Overall, I enjoyed the past few weeks if the course. Thanks to the Infosec team.
                                </p>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div
                            ...
                            <button class="success-certificate-btn cta-button modal-btn button2"
                                title="Get in touch">get in touch</button>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-md-6">
                            <div class="item-two">
                                ...
                                <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                    ...
                                    <input type="hidden" value="ISO 27001:2022 Lead Implementer Training"
