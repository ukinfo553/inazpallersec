...
<head>
    ...
    <title>Certified Chief Information Security Officer (CCISO) Certification Training</title>
    <meta name="description"
        content="InfosecTrain offers a course on CCISO Certification Training, which will help students in learning how to manage an information security governance program.">
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-6 col-lg-2 cl-xl-3">
                    <a href="https://www.infosectrain.com/courses/cciso-certification-online-training/">
    ...
    <main>
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.svg" alt="CCISO Course Highlights"
                                        width="45" height="45">
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/batch.svg" alt="CCISO Course Highlights"
                                        width="45" height="45">
                                    <p>Flexible Schedule</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/Blended-Learning.svg"
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/learning.svg" alt="CCISO Course Highlights"
                                        width="45" height="45">
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                ...
                                <img src="assets/images/corporate-training-mob.webp" width="364" height="301"
                                    alt="CCISO Corporate Training" style="width: 100%;height: auto;display: block;">
                            </picture>
                        </a>
                    </div>
                </div>
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of CCISO Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of an Information Security expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average Salary Range for CCISO Profiles </h3>
                            <picture>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/01/YUOSOF-150x150.jpg"
                                            alt="Yuosof Radi" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                        Yuosof Radi
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/01/Anbu_Selvan-150x150.jpg"
                                            width="250" height="250" alt="Anbu Selvan Chellappa Nadar ">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">Excellent domain knowledge learning at a good pace. Very responsive.</p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/08/Hatim-Lokat-150x150.jpg"
                                            width="250" height="250" alt="Hatim Lokat">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                        Hatim Lokat
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/08/Saud-Reyaz-150x150.jpg"
