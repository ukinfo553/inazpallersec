...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "CCISO Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-15-chief-information-security-officer-ciso-interview-questions/" target="_blank">Top 15 Chief Information Security Officer (CISO) Interview Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-trending-cybersecurity-jobs/" target="_blank">Top Trending Cybersecurity Jobs in 2024</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-reasons-to-explore-a-career-in-cybersecurity/" target="_blank">Top Reasons to Explore a Career in Cybersecurity</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/career-path-for-cybersecurity/" target="_blank">Career Path For Cybersecurity</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
                        ...
                        <ul>
                            ...
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/cissp-training/">Certified Information Systems Security Professional (CISSP)</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/pages/lp/cism-training/">Certified Information Security Manager (CISM)</a></li>
                        </ul>
						</td>
					</tr>
