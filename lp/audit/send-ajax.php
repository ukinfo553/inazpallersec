...
$email_subject = "New Enquiry from Audit and Compliance Training Page";
            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/career-scope-of-iso-27001-certification/" target="_blank">Career Scope of ISO 27001 Certification</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/common-interview-questions-for-iso-27001/"  target="_blank">Common Interview Questions for ISO 27001</a> </li>
							</ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/iso22301li/"  target="_blank">ISO 22301 Lead Implementer Certification Training | PECB</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/iso22301la/"  target="_blank">ISO 22301 Lead Auditor Certification Training | PECB</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/iso20000f/"  target="_blank">ISO/IEC 20000 Foundation Online Training & Certification | PECB</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/iso20001li/"  target="_blank">ISO/IEC 20000 (ITSM) Lead Implementer Online Training & Certification | PECB</a> </li>
							</ul>
						</td>
					</tr>
...
return array($result,$last);
 ...
 $data = array(
    ...
    'page_type' => 'Audit and Compliance Training',
