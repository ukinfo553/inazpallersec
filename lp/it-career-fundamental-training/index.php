...
<head>
    ...
    <title>IT Career Fundamental Training</title>
    <meta name="description"
        content="Master IT Career Fundamental Training Now! Level up your skills with Practical IT Career Fundamental Training Training by InfosecTrain. Join the cybersecurity revolution!">
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3>Kickstart Your Tech Career</h3>
                            <h1>IT Career Starter Kit</h1>
                            <h3>Cybersecurity | Cloud | Pentesting</h3>
                            <div class="d-flex flex-column flex-md-row banner-highlights">
                                <!-- <div>
                                    <span>37% Increase</span>
                                    <p>in IT Career Fundamental Training Jobs till 2030</p>
                                </div> -->
                                <div>
                                    <img src="assets/images/price-tag.webp" alt="course price" width="308" height="108">
                                </div>
                            </div>
                            ...
                            <img src="assets/images/review-mob-img.png" alt="IT Career Fundamental Training Online Training Course Review"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-img.webp" fetchPriority="high"
                                alt="IT Career Fundamental Training Online Training by InfosecTrain" width="800" height="521">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.svg"
                                        alt="IT Career Fundamental Training Online Training Course Highlights" width="45" height="45">
                                    <p>36 Hours LIVE Instructor-led Training</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/practical-approch.svg"
                                        alt="IT Career Fundamental Training Online Training Course Highlights" width="45" height="45">
                                    <p>Highly Interactive Sessions</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/online-learning.svg"
                                        alt="IT Career Fundamental Training Online Training Course Highlights" width="45" height="45">
                                    <p>Foundation Courses</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/scenario-based-learning.svg"
                                        alt="IT Career Fundamental Training Online Training Course Highlights" width="45" height="45">
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/trainning-support.svg"
                                        alt="IT Career Fundamental Training Online Training Course Highlights" width="45" height="45">
                            ...
                            <div class="item-footer d-flex">
                                <img src="assets/images/highlight-icon/100-satisfaction.webp"
                                    alt="IT Career Fundamental Training Online Training Course Highlights" width="150" height="150">
                                <img src="assets/images/highlight-icon/money-back.webp"
                                    alt="IT Career Fundamental Training Online Training Course Highlights" width="150">
                                <!-- <img src="assets/images/highlight-icon/infosectrain-gif.gif" alt="IT Career Fundamental Training Online Training Course Highlights"> -->
                            </div>
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>IT Career Starter Kit - An Overview</h2>
                                <p>
                                    <strong>Boost Your Career Prospects:</strong> With the IT industry constantly
                                    evolving, professionals
                                    with diverse skill sets are in high demand. Our IT Career Starter Kit equips you
                                    with the knowledge and skills to stand out in the job market and kickstart your tech
                                    career.
                                </p>
                                <p>
                                    <strong>Limited Time Offer:</strong> Don't miss this opportunity to invest in your
                                    future! Enroll now
                                    and save 50% on your IT Career Starter Kit.
                                </p>
                            </div>
                            <div class="course-outline">
                                <!-- col start /-->
                                <div class="item">
                                    <div class="title">Cyber Security Foundation</div>
                                    <div class="sub-title">Master the fundamentals of cybersecurity with ISC2 CC</div>
                                    <!-- <div class="time">16 Hours (8 Days)</div> -->
                                    <div class="batch">Upcoming Batch</div>
                                    <div class="date">Aug 5,6,7,8,12,13,20,21 | Weekday
                                        08:00 - 10:00 PM IST (Evening)</div>
                                    <div class="price">
                                        <span>₹ <del>5999</del> 2999 + Taxes</span>
                                        <span>$ <del>99</del> 49</span>
                                    </div>
                                    <div class="broucher">
                                        <a href="https://www.infosectrain.com/wp-content/uploads/2024/05/Certified_in_Cybersecurity_CC_Online_Training-Courses.pdf" target="_blank">Download Brochure</a>
                                    </div>
                                    <div class="enroll">
                                        <button class="modal-btn" title="Certified in Cybersecurity (CC)">enroll now</button>
                                    </div>
                                </div>
                                <!-- col start /-->
                                <div class="item">
                                    <div class="title">AWS Cloud Foundation</div>
                                    <div class="sub-title">Gain proficiency in AWS Fundamentals in just 10 hours</div>
                                    <div class="batch">Upcoming Batch</div>
                                    <div class="date">Aug 22,26,27,28,29 | Weekday
                                        08:00 - 10:00 PM IST (Evening)</div>
                                    <div class="price">
                                        <span>₹ <del>5999</del> 3999 + Taxes</span>
                                        <span>$ <del>99</del> 49</span>
                                    </div>
                                    <div class="broucher">
                                        <a href="https://www.infosectrain.com/wp-content/uploads/2024/07/AWS-Cloud-Foundation.pdf" target="_blank">Download Brochure</a>
                                    </div>
                                    <div class="enroll">
                                        <button class="modal-btn" title="AWS Cloud Foundation">enroll now</button>
                                    </div>
                                </div>
                                <!-- col start /-->
                                <div class="item">
                                    <div class="title">Pentesting Foundation</div>
                                    <div class="sub-title">Learn the essentials of ethical hacking and penetration testing</div>
                                    <div class="batch">Upcoming Batch</div>
                                    <div class="date">Sep 2,3,4,5,9 | Weekday
                                        08:00 - 10:00 PM IST (Evening)</div>
                                    <div class="price">
                                        <span>₹ <del>5999</del> 3999 + Taxes</span>
                                        <span>$ <del>99</del> 49</span>
                                    ...
                                    <div class="broucher">
                                        <a href="https://www.infosectrain.com/wp-content/uploads/2024/07/Pentesting-Foundation.pdf" target="_blank">Download Brochure</a>
                                    </div>
                                    <div class="enroll">
                                        <button class="modal-btn" title="Pentesting Foundation">enroll now</button>
                                    </div>
                                </div>
                            </div>

                            <div class="starter-kit modal-btn" title="IT Carrer starter kit">
                                <picture>
                                    <source media="(min-width:768px)" width="1106" height="453" srcset="assets/images/courses/starterkit-desktop.webp">
                                    <img src="assets/images/courses/starterkit-mobile.webp" width="525" height="600" alt="IT Career Fundamental Training Online Training  Corporate Training" style="width: 100%;height: auto;display: block;" loading="lazy">
                                </picture>
                            </div>
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content course-objective">
                                        <ul>
                                            <li> <strong>Cybersecurity Essentials</strong>
                                                <ul>
                                                    <li>Understand the cyber threat landscape</li>
                                                    <li>Master basic security protocols and best practices</li>
                                                    <li>Learn to identify and mitigate common vulnerabilities</li>
                                                </ul>
                                            </li>
                                            <li> <strong>Cloud Computing Fundamentals</strong>
                                                <ul>
                                                    <li>Explore major cloud platforms</li>
                                                    <li>Understand cloud architecture and deployment models</li>
                                                    <li>Learn basic cloud security and management techniques</li>
                                                </ul>
                                            </li>
                                            <li> <strong>Penetration Testing Basics</strong>
                                                <ul>
                                                    <li>Discover the mindset of ethical hackers</li>
                                                    <li>Learn essential pentesting tools and methodologies</li>
                                                    <li>Understand how to identify and exploit system weaknesses</li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            ...
                                            <li>Current IT professionals</li>
                        ...
                        <div class="form-item sticky-section" id="free_demo">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request(this.form);"
                                ...
                                <select class="form-control" id="me_course" name="me_course">
                                        <option value="IT Career Fundamental Training">Select Course</option>
                                        <option value="Certified in Cybersecurity (CC)">Certified in Cybersecurity (CC)</option>
                                        <option value="AWS Cloud Foundation">AWS Cloud Foundation</option>
                                        <option value="Pentesting Foundation">Pentesting Foundation</option>
                                </select>
                                ...
                                <div class="loading_w hide" id="loading_w">
                                    <img src="https://www.infosectrain.com/pages/lp/cism-training/assets/img/loader.gif"
                                        loading="lazy" class="d-block" style="margin:15px auto;">
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="swiper myAdvisor">
                    <div class="swiper-wrapper">
                            ...
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2021/02/ashish.png"
                                        alt="Ashish|InfosecTrain Instructor">
                                </div>
                                <div class="avtar-data">
                                    <div class="avtar-name">
                                    Ashish
                        ...
                        <div class="swiper-slide item">
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2023/02/sanyam-negi.png"
                            ...
                            <div class="summary">
                            Information Security Consultant & Trainer with over 10+  years of hands-on experience,Specializations in Security Testing, Cloud Security, Security Operations Center, Threat Hunting and DevOps
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the world  </strong>of IT with highly relevant skills</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Updated curriculum</strong> aligned with the latest trends</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/learning-schedule.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Choose <strong> Flexible Learning</strong> options including Weekday Batches</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of IT Career Fundamental Training Certification Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of IT Career Fundamental Training Online Training">
                            </div>
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                    alt="Benefits of IT Career Fundamental Training Online Training  Certification">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of an expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average salary range for different IT Career Fundamental Training profiles</h3>
                            <picture>
                                <source media="(min-width:768px)" width="1472" height="486"
                                    srcset="assets/images/benifits/benefits-starterkit.webp">
                                <img src="assets/images/benifits/benefits-starterkit-mobile.webp" width="640"
                                    height="473" alt="Benefits of IT Career Fundamental Training Online Training  Certification">
                            </picture>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            when I think about any cybersecurity certification. The trainer's dedication and sincerity
                            towards his classes is something that inspires me a lot personally. You will get 100 percent
                            from InfosecTrain for whichever course you want to pursue. Especially the trainers are
                            outstanding.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                            The trainer was very good, with good knowledge and skills to share, and he handled the
                            session with patience. I really enjoyed the training. Selecting InfosecTrain is always a
                            good choice for me. The sales team is very supportive and helped me on this journey.</p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/01/Fuzail-Ahmed-Lohare.png"
                                            width="250" height="250" alt="Fuzail Ahmed Lohare">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                        Fuzail Ahmed Lohare
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                            The trainer is a great presenter/tutor and teaches in a relaxing manner. His sense of humor
                            and honesty about the task ahead for the newbie help make the challenging subject matter
                            accessible. Thank you very much! I had been looking forward to this workshop for weeks, and
                            it exceeded my expectations! I have learned a lot.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            Very detailed and organized training, as always, by the best instructors at InfosecTrain.
                            Will come back for more courses after completing my certification.
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/01/Jatin-Tandon.png"
                                            width="250" height="250" alt="Jatin Tandon">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                        Jatin Tandon
            ...
            <div class="container">
                <div class="row justify-content-center">
                                ...
                                <div class="overlay" id="overlay">
                                    <div class="play-button" onClick="playVideo()" id="playButton">
                                        <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                            alt="IT Career Fundamental Training Online Training Success Story">
                                    </div>
                                </div>
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.png" alt="IT Career Fundamental Training Online Training Success Story"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item active open">
                                <h3 class="faq-title"><span class="title">Do I need prior IT experience to enroll in this course?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        No prior IT experience is required. This starter kit is designed for beginners and career switchers looking to enter the IT and cybersecurity field.
                                    </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How long do I have access to the course materials?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>You'll have access to the recorded sessions and course materials for 6 months after the course completion date.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Is there a certificate upon completion of the IT Career Starter Kit?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                    Yes, you'll receive a certificate of completion for each individual course (Cybersecurity, AWS Cloud, and Pentesting) as well as an overall IT Career Starter Kit certificate.
                                    </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Can I attend the classes if I miss a live session? </span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Yes, all sessions are recorded and made available to you, so you can catch up on any missed classes at your convenience.</p>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What kind of job roles will I be prepared for after completing this course? </span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                    This course prepares you for entry-level positions in cybersecurity, cloud computing, and ethical hacking. Some potential roles include Junior Security Analyst, Cloud Support Associate, and Junior Penetration Tester.
                                    </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Is there any hands-on practice included in the course? </span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Yes, the course includes scenario-based learning, labs, and practical exercises to give you hands-on experience in all three areas: cybersecurity, cloud computing, and penetration testing.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="" onSubmit="return val_demo_request_pop(this.form);"
                    ...
                    <select class="form-control" id="me_course_pop" name="me_course">
                                        <option value="IT Career Fundamental Training">Select Course</option>
                                        <option value="Certified in Cybersecurity (CC)">Certified in Cybersecurity (CC)</option>
                                        <option value="AWS Cloud Foundation">AWS Cloud Foundation</option>
                                        <option value="Pentesting Foundation">Pentesting Foundation</option>
                    ...
                    <div class="loading_w hide" id="loading_w_pop">
                        <img src="<?php echo BASE_URL; ?>assets/images/loader.gif" class="d-block" style="margin:15px auto;"/>
                    </div>
                </form>
            </div>
        </div>
