...
<head>
    ...
    <title>CISSP Certification Training - Dubai</title>
        ...
        <section class="banner-sec">
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7">
                        <div class="item">
                            <h3>Join the CISSP <span style="color:var(--red);">Classroom Training in Dubai</span></h3>
                            ...
                            <div class="button-sec">
                                ...
                                <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/CISSP_2024.pdf" target="_blank" class="cta-button" title="Download Brochure">Download Brochure</a>
                            </div>
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    ...
                                    <p>54-Hour Classroom Training in Dubai</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 style="text-align: center;margin-top: 16px;">Classroom Training in Dubai</h3>
                    </div>
                    <div class="col-12">
                        <?php
                        ...
                        <div class="benifits-item-two">
                            ...
                            <picture>
                                <source media="(min-width:768px)" width="726" height="246"
                                    srcset="assets/images/benifits/benefits-cissp-desktop.png">
                                <img src="assets/images/benifits/benefits-cissp-mobile.png" width="320" height="345"
                                    alt="Benefits of CISSP Online Training  Certification">
                            </picture>
                        </div>
                    </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Thank you trainers for your dedication and patients to explain the concepts. Also the
                                way you spend extra days to cover the topics satisfactorily for the students is great.
                                Good job Infosec Train and all the very best to all the students. A big thanks to
                                InfosecTeam.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                knowledge. I liked that the course notes and powerpoint slides are really useful since
                                they make it easier to understand textbooks and include more information which the
                                textbooks lack sometimes. I liked the trainer’s quick response. The course at Infosec
                                Train has surpassed my expectations. Overall I found it effective and I enjoyed it.
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The training session was up to the mark and focused towards exam point of view. These
                                were good informative sessions which helped enhance overall view towards IT Information
                                security domain.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                online but did’t understand 5% of CISSP Concept . After getting training from Infosec
                                Train I learned and cleared almost every doubt reagrding CISSP .. Now I feel very
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="CISSP Training Dubai" id="me_others_footer" name="me_others">
