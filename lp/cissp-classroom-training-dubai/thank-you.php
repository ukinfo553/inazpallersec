        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                <div class="thankyou--card-item">
                    ...
                    <a href="https://www.infosectrain.com/blog/cissp-2024-domains-navigating-the-latest-updates/"
            ...
            <div class="col-lg-3 col-6">
                <div class="thankyou--card-item">
                    ...
                    <a href="https://www.infosectrain.com/blog/cissp-2021-vs-new-cissp-2024/" target="_blank">CHECK
                        NOW</a>
                </div>
            </div>
            <!--/card end /-->
            ...
            <div class="col-lg-3 col-6">
                <div class="thankyou--card-item">
                    <h4>Top CISSP 2024 Exam Practice Questions and Answers</h4>
                    <a href="https://www.infosectrain.com/blog/free-cissp-exam-questions-answers/" target="_blank">CHECK
                        NOW</a>
                </div>
            </div>
            <!--/card end /-->
            ...
            <div class="col-lg-3 col-6">
                <div class="thankyou--card-item">
                    <h4>CISSP 2024 Domain 1 Series: Key Concepts – CIA Triad</h4>
                    <a href="https://www.infosectrain.com/blog/cissp-2024-domain-1-series-key-concepts-cia-triad/"
                        target="_blank">CHECK NOW</a>
                </div>
            </div>
            <!--/card end /-->
