...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from Cybersecurity Awareness Program Page";

    $user_subject = "Ready to attend the Cybersecurity Awareness Program Stay Tuned!";
...
';
    ...
    $data = array(
        ...
        'page_type' => 'Cybersecurity Awareness Program',
