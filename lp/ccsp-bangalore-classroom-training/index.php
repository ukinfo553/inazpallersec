            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7">
                        <div class="item">
                            <h3>
                                Join the CCSP <span style="color:var(--red);">Classroom Training in Bangalore</span>
                            </h3>
                            <h1>
                            ...
                            <div class="button-sec">
                                ...
                                <a href="<?php echo $brochureLink; ?>"
                                    target="_blank" title="Download Brochure" class="cta-button">Download Brochure</a>
                            </div>
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    ...
                                    <p>40-Hour Classroom Training in Bangalore</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 style="text-align: center;margin-top: 16px;">Classroom Training in Bangalore</h3>
                    </div>
                    <div class="col-12">
                        <?php
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Immerse in <strong>scenario-based learning</strong> across 8 CCSP domains</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
