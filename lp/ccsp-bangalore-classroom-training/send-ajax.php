...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from CCSP Classroom Bangalore Landing Page";
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								...
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=6tqqX2e6Yxs" target="_blank">How to Ace  CCSP Exam in First Try</a></li>
							</ul>
						</td>
					</tr>
					<tr>
...
';
    ...
    $data = array(
        ...
        'page_type' => 'CCSP Classroom Bangalore',
