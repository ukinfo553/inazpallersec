...
<head>
    ...
    <title>Advanced Web Application Penetration Testing (AWAPT)Training</title>
    <meta name="description"
        content="Master advanced web app penetration testing with InfosecTrain. Learn real-world attack techniques, tools, and defenses from expert trainers.">
...
<body>
    ...
    <main>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <h1>Advanced Web Application Penetration Testing (AWAPT) Training</h1>
                            <div class="d-flex flex-row banner-highlights">
                                <div>
                                    <span>32% Increase </span>
                                    <p>in Cybersecurity Jobs</p>
                                </div>
                                <div>
                                    <span>$112,634 </span>
                                    <p>Median Salary of Pen Tester </p>
                                </div>
                            </div>
                            <div class="nextBatch" style="font-weight: bold;">
                                Next Batch Starts
                            ...
                            <img src="assets/images/review-mob-img.png" alt="AWAPT Course Review" width="636"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-v3.webp" fetchPriority="high" alt="AWAPT by InfosecTrain"
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/time.svg" alt="AWAPT Course Highlights"
                                        width="45" height="45">
                                    <p>32-Hour LIVE Instructor-led Training </p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/protection.svg" alt="AWAPT Course Highlights"
                                        width="45" height="45">
                                    <p>Vulnerable Web Server Practice Labs</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/interactive.svg"
                                        alt="AWAPT Course Highlights" width="45" height="45">
                                    <p>Real-time Simulations</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/Hands-on Exposure.svg"
                                        alt="AWAPT Course Highlights" width="45" height="45">
                                    <p>Interview Preparation & Career Guidance</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/support.svg" alt="AWAPT Course Highlights"
                                        width="45" height="45">
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/learning.svg" alt="AWAPT Course Highlights"
                                        width="45" height="45">
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/Satisfaction-Guaranteed.png" width="209"
                                    height="95" alt="AWAPT Course Highlights">
                            </div>
                        ...
                        <div class="course-details">
                            <div class="course-tools d-flex flex-column justify-content-start align-items-start">
                                <h3>Tools Covered</h3>
                                <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Advanced-Web-Application-Penetration-Testing-AWAPT-Training-tools.jpg"
                                    alt="AWAPT Tools" style="max-width:100%;margin:24px 0;" loading="lazy">
                            </div>
                            <div class="course-overview">
                                <h2>AWAPT Certification Training - An Overview </h2>
                                <p>Web applications are the backbone of modern businesses and are often the target of
                                    sophisticated attacks. As web applications continue to evolve, so do the threats.
                                    This
                                    course will provide the expertise needed to assess, exploit, and ultimately defend
                                    web applications against these ever-growing threats. Whether you are a Developer,
                                    Penetration Tester, Security Consultant, or aspiring Ethical Hacker, this course is
                                    designed to tackle the challenges of modern web security.
                                </p>
                                <p>
                                    This comprehensive course is designed to equip cybersecurity professionals with
                                    advanced skills in Web Application Penetration Testing. Participants will gain
                                    hands-
                                    on experience in detecting the attack surface, perform the attack, and mitigating
                                    web threats using the latest tools and techniques. Through practical labs and
                                    real-world scenarios, learners will develop the expertise needed to effectively
                                    protect and
                                    defend their organizations from sophisticated Web attacks.
                            ...
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        <h3>1. Introduction to Web Penetration Testing</h3>
                                        <ul>
                                            <li>Fundamentals of web application penetration testing.</li>
                                            <li>Importance of securing modern web applications.</li>
                                            <li>Testing Methodologies: Explore Black Box, White Box, and Grey Box
                                                testing approaches.</li>
                                        </ul>

                                        <h3>2. Understanding HTTP and Web Technologies</h3>
                                        <ul>
                                            <li>HTTP communication and protocols.</li>
                                            <li>HTTP request/response headers and their significance.</li>
                                            <li>Practical demo: Analyzing HTTP communication with Wireshark and Netcat.
                                            </li>
                                            <li>Deep dive into HTTP methods, verbs, and status codes.</li>
                                            <li>HTTP verb tampering with Nmap and Metasploit.</li>
                                            <li>HTTP/HTTPS comparison and TLS/SSL handshake.</li>
                                        </ul>

                                        <h3>3. Deep Dive into Web Penetration Labs and Advanced Traffic Interception
                                        </h3>
                                        <ul>
                                            <li>Understanding of the web penetration lab setup and Kali Linux OS
                                                functionalities.</li>
                                            <li>Setting up and configuring Burp Suite for HTTP/HTTPS traffic
                                                interception.</li>
                                            <li>Understanding target scope and creating project files.</li>
                                            <li>Burp Suite tools: Dashboard, Proxy, Intruder, Repeater, Scanner,
                                                Collaborator, and Extender.</li>
                                            <li>Configuring SSL/TLS certificates for secure interception.</li>
                                            <li>Advanced traffic manipulation and injection using Burp Suite.</li>
                                        </ul>

                                        <h3>4. Information Gathering and Reconnaissance</h3>
                                        <ul>
                                            <li>Passive and active reconnaissance techniques.</li>
                                            <li>Extracting application endpoints, technologies, and server
                                                configurations.</li>
                                            <li>Tools for vulnerability scanning: Nmap, Nikto, etc.</li>
                                            <li>Techniques to identify hidden endpoints and sensitive data.</li>
                                            <li>Exploiting version disclosure vulnerabilities.</li>
                                        </ul>

                                        <h3>5. Fuzzing, Brute Force, and Dictionary Attacks</h3>
                                        <ul>
                                            <li>Parameter fuzzing techniques to discover hidden vulnerabilities.</li>
                                            <li>Directory brute-forcing using Gobuster and FFUF.</li>
                                            <li>Password brute-forcing with Hydra and dictionary attacks.</li>
                                            <li>Cracking hashed passwords using John the Ripper and Hashcat.</li>
                                            <li>Authentication bypass using advanced SQL injection techniques.</li>
                                        </ul>

                                        <h3>6. HTTP Cache Exploitation</h3>
                                        <ul>
                                            <li>Understanding private vs. public cache mechanisms.</li>
                                            <li>Exploiting HTTP response cache headers.</li>
                                            <li>HTTP parameter pollution and smuggling attacks.</li>
                                            <li>HTTP cache deception techniques and demonstrations.</li>
                                        </ul>

                                        <h3>7. HTTP Session Management</h3>
                                        <ul>
                                            <li>HTTP basic authentication and session cookies.</li>
                                            <li>Understanding cookie attributes: Secure, HttpOnly, and SameSite.</li>
                                            <li>Exploiting session fixation and session hijacking vulnerabilities.</li>
                                            <li>Advanced MITM (Man-in-the-Middle) attack scenarios.</li>
                                            <li>Session management best practices for security.</li>
                                        </ul>

                                        <h3>8. Same-Origin Policy (SOP): The Core of Web Security</h3>
                                        <ul>
                                            <li>Fundamentals of SOP and cross-domain requests.</li>
                                            <li>Understand the working of URL and Browser.</li>
                                            <li>Browser handling of JavaScript, frames, windows, and sites.</li>
                                            <li>Limitations of SOP and common bypass techniques (JSONP).</li>
                                            <li>CORS misconfigurations and CSRF attack exploitation.</li>
                                            <li>Advanced CORS attack scenarios and mitigation techniques.</li>
                                        </ul>

                                        <h3>9. File Upload Vulnerabilities</h3>
                                        <ul>
                                            <li>Understanding malicious file upload vulnerabilities.</li>
                                            <li>Exploiting file upload functions to bypass restrictions.</li>
                                            <li>Local File Inclusion (LFI) and Remote File Inclusion (RFI) attacks.</li>
                                            <li>Practical demos: Web shells using Netcat, Python, and PHP.</li>
                                            <li>Remote Code Execution (RCE) via LFI/RFI exploitation.</li>
                                            <li>Null-byte extension bypass techniques.</li>
                                            <li>Mitigation.</li>
                                        </ul>

                                        <h3>10. SQL Injection Exploitation</h3>
                                        <ul>
                                            <li>Understanding SQL queries and three-tier architecture.</li>
                                            <li>In-band, blind, time-based, and second-order SQL injection techniques.
                                            </li>
                                            <li>Exploiting SQL injection to extract sensitive data.</li>
                                            <li>Advanced SQLMap usage for database exploitation.</li>
                                            <li>Real-world SQL injection scenarios and mitigation techniques.</li>
                                        </ul>

                                        <h3>11. Cross-Site Scripting (XSS)</h3>
                                        <ul>
                                            <li>Types of XSS: Stored, Reflected, and DOM-based attacks.</li>
                                            <li>Session hijacking and cookie theft using XSS.</li>
                                            <li>Exploiting XSS vulnerabilities with BeEF framework.</li>
                                            <li>XSS bypass techniques for modern web defenses.</li>
                                            <li>Effective mitigation strategies against XSS.</li>
                                        </ul>

                                        <h3>12. Indirect Object Reference (IDOR)</h3>
                                        <ul>
                                            <li>Privilege escalation in web applications.</li>
                                            <li>Understanding horizontal and vertical privilege escalation.</li>
                                            <li>Exploiting IDOR in files, APIs, and databases.</li>
                                            <li>Advanced IDOR attack techniques and Mitigation.</li>
                                        </ul>

                                        <h3>13. Server-Side Request Forgery (SSRF)</h3>
                                        <ul>
                                            <li>Identifying SSRF vulnerabilities in web applications.</li>
                                            <li>Exploiting blind SSRF vulnerabilities for data exfiltration.</li>
                                            <li>Escalating SSRF to Remote Code Execution (RCE).</li>
                                            <li>Mitigation techniques for SSRF vulnerabilities.</li>
                                        </ul>

                                        <h3>14. Path and Directory Traversal</h3>
                                        <ul>
                                            <li>Discovering and exploiting path traversal vulnerabilities.</li>
                                            <li>Advanced techniques for bypassing path restrictions and filters.</li>
                                            <li>Real-world directory traversal attack scenarios.</li>
                                        </ul>

                                        <h3>15. Command Injection</h3>
                                        <ul>
                                            <li>Identifying and exploiting basic command injection vulnerabilities.</li>
                                            <li>Discovering blind and asynchronous blind command injection attacks.</li>
                                            <li>Using Burp Collaborator for advanced exploitation.</li>
                                            <li>Real-world command injection and mitigation.</li>
                                        </ul>

                                        <h3>16. XML Injection and XXE Attacks</h3>
                                        <ul>
                                            <li>Understanding XML structure and DTDs (Document Type Definitions).</li>
                                            <li>Exploiting XXE vulnerabilities and triggering OOB resource interactions.
                                            </li>
                                            <li>XML injection scenarios and mitigation techniques.</li>
                                        </ul>

                                        <h3>17. Bonus: Web Penetration Testing Report</h3>
                                        <ul>
                                            <li>Understanding OWASP Top 10 framework.</li>
                                            <li>Scoring vulnerabilities using CVSS (Common Vulnerability Scoring
                                                System).</li>
                                            <li>Crafting professional penetration testing reports.</li>
                                            <li>Proof of Concept (PoC) creation and documentation.</li>
                                            <li>Presenting findings to stakeholders effectively.</li>
                                        </ul>
                                        <h3 style="color:var(--red);">Bonus Content</h3>
                                        <ul>
                                            <li>Interview Preparation and Guidance</li>
                                            <li>Vulnerable web server Lab for practice</li>
                                            <li>Cheat sheet for various attacks like SQL Injection, XSS Injection, XML,
                                                etc</li>
                                            <li>Custom built list/ repos of openly available resources</li>
                                        </ul>
                                        <h3>System Requirements</h3>

                                        <h4>1. Hardware:</h4>
                                        <ul>
                                            <li><strong>CPU:</strong> Intel i5/i7 or AMD Ryzen 5/7 (Quad-core or better)
                                            </li>
                                            <li><strong>RAM:</strong> 8 GB (minimum), 16 GB (recommended)</li>
                                            <li><strong>Storage:</strong> 50 GB SSD (minimum), 250 GB (recommended)</li>
                                        </ul>

                                        <h4>2. Software:</h4>
                                        <ul>
                                            <li><strong>Host OS:</strong> Kali Linux (recommended), Windows 10/11, or
                                                Ubuntu</li>
                                            <li><strong>VM software:</strong> VMware Workstation or VirtualBox</li>
                                            <li><strong>Essential tools:</strong> Burp Suite, Kali Linux</li>
                                        </ul>
                                ...
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Course Objectives</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <p>Upon successful completion of the training, participants will be able to:</p>
                                        <ul>
                                            <li>Understand the principles of web application security and the importance
                                                of securing web technologies.</li>
                                            <li>Be proficient in using Kali Linux and its powerful tools for penetration
                                                testing.</li>
                                            <li>Gain hands-on experience with vulnerable applications to simulate
                                                real-world web security attacks.</li>
                                            <li>Automate the penetration testing workflow using tools like Burp Suite
                                                and Nikto for vulnerability scanning.</li>
                                            <li>Master HTTP methods (GET, POST, PUT, DELETE) and understand their role
                                                in vulnerability exploitation.</li>
                                            <li>Read &amp; Analyze Headers, Requests, and Responses: Learn to analyze
                                                web traffic and headers to uncover hidden vulnerabilities and sensitive
                                                data.</li>
                                            <li>Understand the principles of web cache and related attack techniques.
                                            </li>
                                            <li>Learn how to manipulate cookies for session hijacking and unauthorized
                                                access.</li>
                                            <li>Learn to identify and exploit insecure file upload mechanisms that allow
                                                attackers to upload malicious files (e.g., web shells).</li>
                                            <li>Understand how to exploit Cross-Site Request Forgery (CSRF)
                                                vulnerabilities to perform unauthorized actions.</li>
                                            <li>Focus on serious vulnerabilities such as SQL Injection, Cross-site
                                                Scripting (XSS), XML External Entity (XXE) attacks, Remote Command
                                                Execution (RCE), identifying load balancers, and more.</li>
                                            <li>Learn how to secure web applications by following industry standards
                                                such as the OWASP Top 10 and implementing best practices.</li>
                                            <li>Master techniques for preventing SQL injection, XSS, and other injection
                                                attacks by using input validation and output encoding.</li>
                                            <li>Implement robust session handling and authentication techniques,
                                                including multi-factor authentication (MFA) and secure cookie
                                                management.</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>Basic understanding of web technologies (HTTP, HTML, JavaScript, etc.).
                                            </li>
                                            <li>Basic understanding of Linux and Windows.</li>
                                            <li>Basic understanding of databases and networking.</li>
                                            <li>Knowledge of programming languages like Python, Java, or PHP is
                                                beneficial. (optional)</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <ul>
                                            ...
                                            <li>Security Consultants/Cybersecurity Professionals</li>
                    ...
                    <div class="col-12">
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                ...
                                <img src="assets/images/corporate-training-mob.webp" width="364" height="301"
                                    alt="AWAPT Corporate Training" style="width: 100%;height: auto;display: block;">
                            </picture>
                        </a>
                    </div>
                </div>
        ...
        <section class="expert-sec">
            <div class="container">
                ...
                <div class="swiper myAdvisor swiper-initialized swiper-horizontal swiper-backface-hidden">
                    <div class="swiper-wrapper justify-content-md-center align-content-stretch flex-wrap"
                        id="swiper-wrapper-f3b5e66f4dbece35" aria-live="polite">
                        <!--/ col start /-->
                        <div class="swiper-slide item swiper-slide-active" role="group" aria-label="1 / 1"
                            style="width: 432px;">
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2021/02/ashish.png"
                                        alt="RANJU BANDRAL|InfosecTrain Instructor" loading="lazy" />
                                </div>
                            ...
                            <div class="summary">
                                Ranju Bandral is a cybersecurity expert with over a decade of experience in Web & Mobile
                                Application Security, DevSecOps, and Threat Hunting. He has designed and implemented
                                large-scale security programs, including breach detection solutions, and specializes in
                                VAPT, WAF integration, and security automation.
                            </div>
                        </div>
                        <!--/ col start /-->
                    </div>
                    <div class="d-flex justify-content-center align-items-center navigation">
                        <div class="swiper-button-prev swiper-button-disabled swiper-button-lock" tabindex="-1"
                            role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-f3b5e66f4dbece35"
                            aria-disabled="true">
                        ...
                        <div class="swiper-button-next swiper-button-disabled swiper-button-lock" tabindex="-1"
                            role="button" aria-label="Next slide" aria-controls="swiper-wrapper-f3b5e66f4dbece35"
                            aria-disabled="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 18 16"
                                fill="none">
                                <path
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/assessment-practice.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Immerse in <strong>scenario-based learning </strong></p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the world of web application penetration testing</strong> with skillful
                                mastery </p>
                        </div>
                    </div>
                    <!--/ col start /-->
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of AWAPT Training </h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of Threat Hunting">
                            </div>
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                    alt="Benefits of AWAPT Certification">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of Pen Tester</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average salary range for different Penetration Testing profiles</h3>
                            <picture>
                                ...
                                <img src="assets/images/benifits/benefits-security-plus-mob.webp" width="640"
                                    height="473" alt="Benefits of AWAPT Certification">
                            </picture>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The Advanced Penetration Testing course was great. I would like to thank InfosecTrain
                                for the valuable course with experience and skills from the trainer. It was a very
                                well-structured course. I learned very professional tools in the cyber security field
                                through this course. The trainer was excellent. I would definitely come back to
                                InfosecTrain for more training.
                            </p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/APT-1-150x150.jpg"
                                            alt="Moussodji Ikapi Valery" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">I completed the Advanced Penetration Testing course at InfosecTrain and I
                                must say it was a very good training. I will definitely take up more courses in the
                                future. Thanks for such a great session!</p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/APT-2-150x150.jpg"
                                            width="250" height="250" alt="Shomayle Faruqui">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Shomayle Faruqui
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The Advanced Penetration Testing was a good course. The trainer had great knowledge and
                                made us understand the course in the best possible way. Thanks a lot for such an
                                insightful training.
                            </p>
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/APT-4-150x150.jpg"
                                            width="250" height="250" alt="Vinit Jhalani">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Vinit Jhalani
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">The Advanced Penetration Testing course from InfosecTrain gave me a really
                                good understanding of the cybersecurity domain and understanding of tools needed for
                                testing. It was a great course.</p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/02/APT-3-150x150.jpg"
                                            width="250" height="250" alt="Sadashivuni Sushant">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Sadashivuni Sushant
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.png" width="429" height="263" alt="AWAPT certificate"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What is Advanced Web Application Penetration
                                        Testing (AWAPT) Training?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        AWAPT is an expert-level course designed to equip professionals with advanced
                                        techniques to identify, exploit, and mitigate complex web application
                                        vulnerabilities. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Who should take the Advanced Web Application
                                        Penetration Testing Course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                    </p>
                                    <p>This course is ideal for:</p>
                            ...
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the prerequisites for enrolling in
                                        Advanced Web Application Penetration Testing online Training?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                    </p>
                                    <ul>
                                        <li>Basic understanding of web technologies (HTTP, HTML, JavaScript, etc.).</li>
                                        <li>Basic understanding of Linux and Windows.</li>
                                        <li>Basic understanding of Database and Networking.</li>
                                        <li>Knowledge of programming languages like Python, Java, or PHP is beneficial.
                                            (optional)</li>
                                    </ul>
                                    <p></p>
                                </div>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Is the Advanced Web Application Penetration
                                        Testing (AWAPT) Training available online?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What will I learn in the Advanced Web
                                        Application Penetration Testing Course?</span><span class="right-icon"></span>
                                </h3>
                                <div class="faq-content">
                                    <p>
                                        Participants will master advanced attack techniques including XSS, SQLi, IDOR,
                                        SSRF, and more, with hands-on labs, reporting strategies, and real-world
                                        exploitation scenarios. </p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                        </div>
        ...
        <section class="reach-us">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="item">
                            <img src="assets/images/reach-us.png" width="1090" height="576" alt="Reach Us"
                                class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="AWAPT" id="me_others_footer" name="me_others">
    ...
    <section class="footer-fixed">
        ...
        <ul class="mobile-list">
            <!--/ li start /-->
            <li>
                <a href="javascript:void(0)" rel="nofollow" class="modal-btn" title="Enquiry Now">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 16" fill="none">
                        <g clip-path="url(#clip0_5863_213)">
                            <path
