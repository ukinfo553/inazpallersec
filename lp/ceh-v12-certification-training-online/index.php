...
<head>
    ...
    <meta name="description" content="Certified Ethical Hacker
CEH Certification Training This in-demand course teaches you how to integrate privacy into your daily work.">
...
<body>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <h1>Certified Ethical Hacker <br>CEH Certification Training</h1>
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/ceh-banner.webp" fetchPriority="high"
                                alt="CEH Certification Training by InfosecTrain" width="800" height="521">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/CEH-logo.png" alt="CEH Course Highlights">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                ...
                                <p>
                                    The EC-Council’s Certified Ethical Hacker (CEH v12) Training program will enhance
                                    your knowledge of essential security fundamentals. Certified Ethical Hacker (CEH
                                    v12) certification course is one of the most sought-after security qualifications in
                                ...
                                <p>
                                    The C|EH v12 program is a specialized, one-of-a-kind training program that teaches
                            ...
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <ul>
                                                    <li class="star"><strong>01</strong> - Introduction to Ethical
                                                        Hacking</li>
                                                    <li class="star"><strong>02</strong> - Foot Printing and
                                                        Reconnaissance</li>
                                                    <li class="star"><strong>03</strong> - Scanning Networks</li>
                                                    <li class="star"><strong>04</strong> - Enumeration</li>
                                                    <li class="star"><strong>05</strong> - Vulnerability Analysis</li>
                                                    <li class="star"><strong>06</strong> - System Hacking</li>
                                                    <li class="star"><strong>07</strong> - Malware Threats</li>
                                                    <li class="star"><strong>08</strong> - Sniffing</li>
                                                    <li class="star"><strong>09</strong> - Social Engineering</li>
                                                    <li class="star"><strong>10</strong> - Denial of service</li>

                                                </ul>
                                            </div>
                                            <div class="col-lg-6">
                                                <ul>
                                                    <li class="star"><strong>11</strong> - Session Hijacking</li>
                                                    <li class="star"><strong>12</strong> - Evading IDS, Firewalls, and
                                                        Honeypots</li>
                                                    <li class="star"><strong>13</strong> - Hacking Web Servers</li>
                                                    <li class="star"><strong>14</strong> - Hacking Web Applications</li>
                                                    <li class="star"><strong>15</strong> - SQL Injections</li>
                                                    <li class="star"><strong>16</strong> - Hacking Wireless Networks
                                                    </li>
                                                    <li class="star"><strong>17</strong> - Hacking Mobile Platforms</li>
                                                    <li class="star"><strong>18</strong> - IoT Hacking and OT Hacking
                                                    </li>
                                                    <li class="star"><strong>19</strong> - Cloud Computing</li>
                                                    <li class="star"><strong>20</strong> - Cryptography</li>

                                                </ul>
                                            </div>
                                        </div>
                                        <a href="https://www.infosectrain.com/wp-content/uploads/2022/09/certified-ethical-hacker-cehv12_course_content.pdf"
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <ul>
  <li class="star">Ethical hacking fundamentals, cyber kill chain concepts, an overview of information security and security measures.</li>
  <li class="star">Concepts, methodologies, and tools of Footprinting.</li>
  <li class="star">Concepts of vulnerability assessment, its categories and strategies, and first-hand exposure to the technologies used in industry.</li>
  ...
  <li class="star">Operational Technology (OT) essentials, threats, attack methodologies, and attack prevention.</li>
  ...
  <li class="star">Cloud computing, threats and security, essentials of container technology, and serverless computing</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                ...
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Pre-Requisites</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <p>Basic understanding of network essentials and core concepts, including server
                                            and network components. </p>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide item">
                            <div class="profile-desc">
                                <div class="avtar">
                                    <img src="https://www.infosectrain.com/wp-content/uploads/2021/06/Yogender.png"
                                        alt="YOGENDER|InfosecTrain Instructor" loading="lazy" />
                                </div>
                            ...
                            <div class="summary">
                                Delivering more than 30+ training programs yearly, with 250+ professionals
                                overall.Performed Internal and External Vulnerability Assessment & Penetration Test.
                            </div>
                        </div>
                        <!--/ col start /-->
                        <!--/ col start /-->
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Updated curriculum aligned with CEH version 12</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            ...
                            <picture>
                                <source media="(min-width:768px)" width="1400" height="385"
                                    srcset="assets/images/benifits/benefits-ceh-desk.png">
                                <img src="assets/images/benifits/benefits-ceh-mob.png" width="960" height="796"
                                    alt="Benefits of ceh Certification" loading="lazy">
                            </picture>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                The trainer was very knowledged person. He explained everything in detail so that it was
                                easy to understand. Overall it was a great learning.
                                <br><br><br><br><br><br>
                            </p>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/05/Gourang-Gir-150x150.jpg"
                                            alt="Gourang Gir" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Gourang Gir
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                ...
                                The trainer is a great presenter/tutor and teaches in a relaxing manner. His sense of
                                humor and honesty about the task ahead for the newbie help make the challenging subject
                                matter accessible. Thank you very much! I had been looking forward to this workshop for
                                weeks, and it exceeded my expectations! I have learned a lot.<br><br>
                            </p>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/05/Rudraram-Sai-150x150.jpg"
                                            width="250" height="250" alt="Rudraram Sai Kiran">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The course work was satisfactory. Trainer made sure to explain
                                everything.<br><br><br><br><br><br><br><br>
                            </p>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/07/aneena-150x150.jpg"
                                            width="250" height="250" alt=" Aneena Merin Mathew">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Aneena Merin Mathew
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The trainer has a methodical approach and great hands on experience. He was able to
                                explain the topic at granular level. Really enjoyed CEH sessions with Infosec
                                Train.<br><br><br><br><br><br></p>

                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2023/07/sachin-kode-150x150.jpg"
                                            width="250" height="250" alt="Sachin Kode">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Sachin Kode
                        ...
                        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/samipan-das.png" width="896" height="462"
                                        alt="CEH Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/pranay-paliwal.png" width="896" height="462"
                                        alt="CEH Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                    ...
                    <div class="col-lg-6">
                        <div thumbsSlider="" class="swiper mySwiper3" style="width: 100%;">
                            <div class="swiper-wrapper justify-content-between">
                                ...
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Pranay.png" width="192" height="200"
                                        alt="CEH Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Jyothi.png" width="192" height="200"
                                        alt="CEH Success Story" />
                                </div>
                            </div>
                            <div class="d-flex justify-content-center align-items-center navigation">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item active open">
                                <h3 class="faq-title"><span class="title">What is the CEH (Certified Ethical Hacker)
                                        course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                                        The Certified Ethical Hacker (CEH v12) course from EC-Council will improve your understanding of key security principles. This course covers topics like MITRE ATT&CK Framework, the Diamond Model of Intrusion Analysis, fog computing, edge computing, grid computing, and so much more. This course enables you to think like a hacker and provide you the skills to protect your infrastructure.
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How long do you need to study for the CEH
                                        exam?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Well, it depends on person to person. If you have proper guidance, stick to your
                                        schedule, and use relevant resources, then 1 month is sufficient for good
                                        results.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        EC-Council’s Certified Ethical Hacker (C|EH v12) program is one of the most
                                        prestigious certifications in the cybersecurity field. For 20 years, it has held
                                        the top spot in the world for ethical hacking certification, and many firms have
                                        consistently placed it first.
                            ...
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the prerequisites for doing CEH
                                        certification?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>In order to pursue CEH certification, you must have a basic understanding of
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        It is recommended to have a bachelor’s degree in Computer Science or related
                                        discipline.
                                    </p>
                                </div>
                            </div>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Who can register for this CEH Ethical Hacking
                                        course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                ...
                                <input type="hidden" value="CEH v12 Training" id="me_others_footer" name="me_others">
                            ...
                            <div class="loading_w hide" id="loading_w_footer"><img
                                    src="https://www.infosectrain.com/pages/lp/cism-training/assets/img/loader.gif" />
                            </div>
                        </div>
                    </div>
                </div>
