...
$courseID = 46875;  // Change this to the specific course ID for different pages
...
<head>
    ...
    <title>Advanced in AI Audit (AAIA) Certification Training</title>
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3 class="d-none d-lg-block">Master the Future of Auditing with Advanced AI Audit
                                Certification</h3>
                            <h1>Advanced in AI Audit (AAIA) Certification Training</h1>
                            <!-- <h3>Prepare For CISSP Exam</h3> -->
                            <div class="d-flex flex-row banner-highlights">
                                <div>
                                    <span> 88% Increase in AI Audit </span>
                                    <p>Related Jobs</p>
                                </div>
                                <div>
                                    <span>$135,000</span>
                                    <p>Median Salary of an AI Audit Manager</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/video-recording.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>Authorized ISACA Training Partner</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/isaca-premium.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>First-ever dedicated AI Audit Certification</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/batch.svg"
                                        alt="Agentic AI Training for Non-Tech Course Highlights" width="45"
                                        height="45">
                                    <p>Covers the Full AI Audit Lifecycle</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>Advanced in AI Audit (AAIA) Certification Training - An Overview</h2>
                                <p>The AAIA Certification Training is designed for IT audit professionals. It’s
                                    built to give participants the precise knowledge and practical skills they need
                                    to audit artificial intelligence systems effectively. This course guides
                                    participants through the full AI audit lifecycle. The course covers everything
                                    from AI governance and risk management to understanding AI operations and
                                    applying specific auditing tools and techniques. The emphasis is entirely on
                                    hands-on application, so participants can confidently design, execute, and
                                    manage AI-driven audits that meet stringent standards for ethics, security, and
                                    compliance.</p>
                            </div>
        ...
        <?php if (!empty($courseID)): ?>
            <section class="training-calendar" id="training-calendar">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Advanced in AI Audit (AAIA) Certification Training Calendar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Authorized <strong>ISACA Partner</strong> delivering AAIA-aligned training</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Expert instructors</strong> with deep AI audit experience</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of Advanced in AI Audit (AAIA) Certification Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of an AI Audit Manager</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average Salary Range for AI Audit Roles</h3>
                            <picture>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The trainer was very informative and shared extensive industry insights and real-life experiences on the practical application of AI Audit.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar-150x150.png"
                                            alt="Venkata Karanam" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Venkata Karanam</h3>
                                        <span>Australia</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The AAIA sessions were well prepared, and the training materials were clear, structured, and easy to follow.
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar-150x150.png"
                                            alt="Alvin Sharm" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Alvin Sharm</h3>
                                        <span>India</span>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The AAIA session was overall very good, informative, and provided practical insights that enhanced my understanding of the topic.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/female-avatar-150x150.png"
                                            alt="Poonam P Paryanee" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Poonam P Paryanee</h3>
                                        <span>India</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Excellent course with a highly skilled trainer. The AAIA sessions were conducted in great detail, ensuring clear understanding of all concepts.

                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2026/01/JayantAnilMarath.jpeg"
                                            alt="Jayant Anil Marathe" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Jayant Anil Marathe</h3>
                                        <span>India</span>
                                    </div>
                                </div>
                            </div>
