                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner.webp" fetchPriority="high"
                                alt="Advanced Penetration Testing by InfosecTrain" width="284" height="327">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="course-details">
                            <div class="course-tools d-flex flex-column justify-content-start align-items-start">
                                <h3>Tools Covered</h3>
                                <img src="https://www.infosectrain.com/wp-content/uploads/2025/02/APT-tools.jpg"
                                    alt="Advanced Penetration Testing Tools" style="max-width:100%;margin:24px 0;"
                                    loading="lazy">
                            </div>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The class was really good. The instructor gave us confidence and delivered the content
                                in an impactful and easy-to-understand manner.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/testimonial/Akmal.m.png" width="250" height="250"
                                            alt="Akmal.m">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Akmal.m</h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/testimonial/MohmadSohel-Haradwala.png" width="250"
                                            height="250" alt="MohmadSohel Haradwala">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>MohmadSohel Haradwala</h3>
                                        <span>Kuwait</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/testimonial/Majid-Hamid.png" width="250" height="250"
                                            alt="Majid Hamid">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Majid Hamid</h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Thanks to the instructor for their excellent teaching and subject knowledge. The entire
                                training was both enjoyable and enriching.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/testimonial/Laiju-Kodippadi-Lakshmanan.png" width="250"
                                            height="250" alt="Laiju Kodippadi Lakshmanan">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Thanks to the support team. The training provided an excellent walkthrough of the key
                                concepts.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
