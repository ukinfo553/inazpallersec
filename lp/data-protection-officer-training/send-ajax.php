...
$email_subject = "Data Protection Officer Landing Page";
            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        ...
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/privacy-concerns-on-social-media-platforms/">Privacy Concerns On Social Media Platforms</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/data-privacy-in-the-quantum-computing-era/">Data Privacy In The Quantum Computing Era</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/roles-and-responsibilities-of-a-data-protection-officer/">Roles and Responsibilities of a Data Protection Officer</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/why-do-employees-need-data-privacy-training/">Why Do Employees Need Data Privacy Training?</a></li>
                        </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=I6_CE8-k_yg">Explore the Different Types of Privacy</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=lJRc7Ad7idE">What is Data Privacy?</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/qEZtQZ5qxZ0?si=3PcqsEO1LiVcs9FI">Introduction to Data Privacy</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/PEV59CHA_04?si=HBnqGpgrYjhMSfzj">Data Privacy vs. Data Security</a></li>
                        </ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/european-privacy-training-cippe/">European Privacy (CIPP/E) Training</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/certified-information-privacy-manager-cipm-training/">Certified Information Privacy Manager (CIPM) Training</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/certified-information-privacy-technologist-cipt-training/">Certified Information Privacy Technologist (CIPT) Training</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/aigp-training/">IAPP AIGP Certification Training</a></li>
							</ul>
						</td>
					</tr>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp',
    'page_type' => 'Data Protection Officer (DPO)',
    'name' => $me_name,
    'email' => $me_email,
    'phone' => $me_phone,
