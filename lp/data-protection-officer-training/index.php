...
$courseID = 41268;  // Change this to the specific course ID for different pages
...
<html lang="en">
    ...
    ?> -->
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-6 col-lg-10 col-xl-9 d-flex justify-content-end">
                        ...
                        <ul class="sidenav">
                            ...
                            <li>
                                <a href="#meet-instructor">Meet Our Instructor</a>
                            </li>
                            <li>
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7">
                            <div class="item">
                                <h3>
                                    Become a Guardian of the Digital Galaxy
                                </h3>
                                <h1>
                                ...
                                <div class="d-flex flex-row banner-highlights">
                                    <div>
                                        ...
                                        <p>Facing Data Privacy Skills Gap
                                    ...
                                    <div>
                                        ...
                                        <p>Avg Salary of Privacy Officers

                                        </p>
                                    </div>
                                </div>
                                <div class="nextBatch">Next Batch Starts <span></span></div>
                                ...
                                <img src="assets/images/review-mob-img.png" alt="AIGP Course Review" width="636"
                                    height="34" fetchpriority="high" class="review-img" loading="lazy">
                            </div>
                        </div>
                        <!--/ col start /-->
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/video-recording.svg"
                                            alt="Data Protection Officer Course Highlights" width="45" height="45">
                                        <p>Customized Hands-on Training</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/career-path.svg"
                                            alt="Data Protection Officer Course Highlights" width="45" height="45">
                                        <p>In-depth Reference Materials</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/certified-trainners.svg"
                                            alt="Data Protection Officer Course Highlights" width="45" height="45">
                                        <p>Focuses on Real-world Applications</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/Case-Studies.svg"
                                            alt="Data Protection Officer Course Highlights" width="45" height="45">
                                        <p>Case Studies & LIVE Exercises</p>
                                    </div>
                                    <!--<[ highlights item start ]>-->
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/Tailored-Curriculum.svg"
                                            alt="Data Protection Officer Course Highlights" width="45" height="45">
                                        <p>Covers GDPR and DPDP Act Compliance</p>
                                    </div>
                                </div>
                                <div class="item-footer">
                                    <img src="assets/images/satisfaction-guranted.png" width="84" height="75"
                                        alt="Data Protection Officer Course Highlights">
                                    <img src="assets/images/highlight-icon/infosectrain-stamp.png" width="84"
                                        height="75" alt="Data Protection Officer Course Highlights">
                                </div>
                            </div>
                            <!--<[ highlights-sec end ]>-->
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    ...
                                    <p>
                                        The Data Protection Officer (DPO) Hands-on training | DPDPA and GDPR course,
                                        tailored
                                        around the India Digital Personal Data Protection (DPDP) Act and GDPR, equips
                                        professionals with essential knowledge and skills for effective data protection
                                        and
                                        privacy management. Starting with an overview of the DPDP Act, its history,
                                        applicability, and key principles, the course progresses through data privacy
                                        governance, focusing on developing a strategic framework and implementing
                                        Privacy by
                                        Design.
                                    </p>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 d-none d-lg-block">
                            <img src="assets/images/training-calendar.png" width="132" height="128"
                                alt="Training Calendar" class="img-fluid">
                        </div>
        ...
        ?>
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    ...
                                    <img src="assets/images/corporate-training-mob.png" width="364" height="301"
                                        alt="Data Protection Officer Corporate Training"
            ...
            <!--<[expert sec start]>-->
            <section class="expert-sec" id="meet-instructor">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="swiper myAdvisor">
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    14+ years of experience as a core cyber security, Information Security and Data
                                    Privacy
                                    expert. He holds various top industry certifications which reinforce his quality and
                                    knowledge in these areas. He is a passionate teacher and mentor, his training
                                    sessions
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p><strong>Conquer the skill </strong> and achieve success in the world of data privacy
                                </p>
                            </div>
                        </div>
                        <!--/ col start /-->
                            ...
                            <div class="benifits-item-two">
                                ...
                                <picture>
                                    ...
                                    <img src="assets/images/benifits/benefits-security-plus-mob.png" width="640"
                                        height="473" alt="Benefits of Data Protection Officer Certification">
                                </picture>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper myGladiators">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">The DPO course was highly informative, and mentor's teaching style made
                                    the
                                    content easy to grasp. His expertise as a coach is evident, ensuring participants
                                    get
                                    the most value from each session.</p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    My training advisor went above and beyond to accommodate my requests, which added
                                    tremendous value. This DPO course exceeded my expectations. We got the best trainer
                                    and
                                    I’m looking forward to his CIPM and CIPPE sessions.
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">This DPO course refreshed my CIPP/E knowledge and helped me learn about
                                    DPDPA India. The trainer addressed all queries with patience, and practical examples
                                    were invaluable. </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">We got an outstanding trainer. His deep knowledge of data protection
                                    laws,
                                    combined with his clear explanations, made complex topics of DPO accessible. An
                                    invaluable experience for anyone in the field.</p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The DPO course content was comprehensive, well-organized, and incredibly relevant to
                                    today’s data protection laws. Mentor's ability to break down complex concepts made
                                    it an
                                    informative and practical learning experience.
                                </p>
                        ...
                        <div class="col-md-6">
                            <div class="item-two">
                                ...
                                <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                    ...
                                    <input type="hidden" value="Data Protection Officer Training" id="me_others_footer"
                                        name="me_others">
