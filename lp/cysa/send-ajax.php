...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from CompTIA CYSA+  Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/comptia-cysa-domain-1-threat-and-vulnerability-management/" target="_blank">Domain 1: Threat And Vulnerability Management </a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-prepare-for-the-comptia-cysa-certification-exam/" target="_blank">How To Prepare For The CompTIA CySA+ Certification Exam </a></li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/the-history-and-relevance-of-comptia-cysa-certification-and-its-career-benefits/" target="_blank">
                                        The History And Relevance Of CompTIA CYSA+ Certification And Its Career Benefits
                                    </a>
                                </li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/advantages-of-cysa-certification/">Advantages Of CySA+ Certification </a></li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr style="padding-top: 20px;">
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=6T--6ZCdahg">CompTIA CySA+ By Bharat</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=50R6jy_2eTo">CompTIA CySA+ Exam Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=t2CEyIhAdsQ">Cyber Security Intelligence - CYSA PART 1 </a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=5p02aqwpw4Y">CompTIA CySA+</a></li>
                            </ul>
                        </td>
                    </tr>
