...
<head>
<meta charset="utf-8">
<meta name="description" content="CompTIA CYSA+ Training and Certification course">
<meta name="author" content="Infosec Train">
<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
<title>CompTIA CYSA+ Training and Certification course</title>
...
<header id="header" class="nav-transparent"> 
      ...
      <div class="col-12 col-md-6 col-lg-6 col-xl-8">
        <div class="left_banner">
            <div class="b_test_box">
                <h1 class="b_com">Become an expert in</h1>
                <h1 class="e_hacker">
				<a href="#" class="bannerf_a">CompTIA CySA+</a></h1>
                <h2 class="e_council">
				<a href="#" class="bannerf_a2">Training and Certification course</a></h2>
				<h2 class="e_council">
				<ul>
				<li>40 hours of instructor-led training</li> 
				<li>CompTIA CySA+ Online test engine</li> 
  ...
  <option selected="selected" value="">Your Country</option>
    ...
    <option value="Other">Other</option>
                ...
                <input type="hidden"   value="CompTIA CySA+" id="me_others" name="me_others"  > 
...
<section id="coursecontent">
    <div class="container">
        <div class="row">
            <div class="col-12">               
               <h2 class="package-heading">CompTIA CySA+ Training Includes</h2>
            </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">CompTIA CySA+ Course Content / Exam(s)</h2>
      </div>
    </div>
        ...
        <div class="content" aria-hidden="false">
         <div  class="tab_content"> 
            <img src="assets/img_2/camptia.png" align="right"  style="width:120px;" class="d-inline-block ml-3">
                       <p>
CompTIA CySA+ Certification Training provided by InfosecTrain is a cybersecurity analyst certification that helps to apply analytics in the network to detect cybersecurity threats in the environment. The behavioural analytical skills identifies and detect the combat malware and secure and protect the applications and systems in an organization. InfosecTrain training makes the participants highly efficient in gaining knowledge on covering the advanced persistent threats and configure and use the threat-detection tools.
...
<li>The CompTia CYSA+ certification focuses on defense through incident detection and intermediate levels of cyber security.</li>
<li>Firewalls and analytics-based approach to be applied in an organization</li>
<li>Perform Data analysis and interpret the results to identify threats, risks, security alerts and vulnerabilities in an organization.</li>
<li>Configuring , deploying and using threat-detection tools</li>
<li>Validation of intermediate level security skills and knowledge.</li>
<li>Knowledge on Threat and Vulnerability management</li>
<li>Cyber Incident Response AND Security Architect information.</li>
<li>Explaining relations between different framework and policies, and understanding the controls and procedures.</li>
</ul>
	  ...
	  <section id="section4" role="tabpanel" aria-labelledby="tab4" class="tabs-panel js-tabs-panel">
        ...
        <div class="content" aria-hidden="true">
         <div class="tab_content"><ul class="ulclass"><li>Network and security professionals</li>
<li>Cybersecurity engineers</li>
<li>Network Architect</li>
<li>Information Security Engineers</li>
</ul></div>
        </div>
      </section>
...
<li>Network and security knowledge</li>
<li>Minimum 3 to 4 years of experience in the field of information security or related area.</li>
</ul>
		 </div>
        </div>
      </section>
...
<td>English and Japanese</td>
		 ...
		 <!--<ul class="ulclass"><li>Duration:  90 Minutes</li><li>Number of questions: 90 questions per exame</li><li>Pass score: 750 (on a scale of 100-900)</li><li>Type: Multiple choice and performance-based</li></ul>-->
...
<section id="table_section">
    ...
    <div  class="container" id="benefits">
        <div class="row">
            <div class="col-12">
               <h2 class="package-heading">CompTIA CySA+ Training Calendar</h2>
            </div>
        </div>
...
<?php
$url = "https://www.infosectrain.com/api/30840/href_toscroll/free_demo";
...
<section id="fastfacts_section">
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">Career opportunities In CompTIA CySA+</h2>
      </div>
    </div>
    
    <!-- <div class="row">
     <div class="col-md-12">
				 <img src="assets/img_2/CySA-plus-career-opportunities.jpg" alt="Career opportunities CompTIA CySA+" class="img-fluid"/>
		 </div>
    </div> -->
    <div class="row d-none d-md-block">
     <div class="col-md-12">
				 <div id="career_oppor" class="owl-carousel owl-theme owl-loaded owl-drag" >
				  <div class="item"  ><img src="assets/img_2/slide1.webp" alt="Cyber Security Jobs" class="img-fluid"> </div>
				   <div class="item"  > <img src="assets/img_2/slide2.webp" class="img-fluid" alt="Cyber Security Jobs"> </div>
				   <div class="item" > <img src="assets/img_2/slide3.webp" class="img-fluid" alt="Cyber Security Jobs"> </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="advisor_box_con">
                    <!------------
                    <div class="advisor_box text-center">
					
                        <img src="https://www.infosectrain.com/wp-content/uploads/2020/07/Bharat-web-150x150.png" alt="Bharat Mutha|infosectrain" class="img-fluid mb-3 d-block mx-auto">
                        <h4 class="adv-h">Bharat Mutha</h4>
                        <h5>10+ years of experience</h5>
                        <p class="adv-p">Senior Information Security Consultant & Trainer</p>
                        <p>
                    ...
                    <div class="advisor_box text-center">
					            <img src="https://www.infosectrain.com/wp-content/uploads/2020/09/Rishabh-150x150.jpg" style="border-radius: 50%;"  alt="Rishabh Kotiyal|infosectrain" class="img-fluid mb-3 d-block mx-auto">
                      <h4 class="adv-h">Rishabh Kotiyal</h4>
                      <h5>10+ years of experience</h5>
                      <p class="adv-p">Cloud Security Consultant & Trainer</p>
					            <p>
...
<section id="coursess22">
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">What Skills Will You Learn?
        </h2>
      </div>
    </div>
...
<section id="profile_card">
    <div class="container" id="reviews">
        ...
        <div class="row m-0">
            <div class="col-12 profile_card_carousel owl-carousel owl-theme wow fadeInUp">
                    <div class="item card">
					<div class="advisor_box">
					<div class="prof-img">
              <img src="https://www.infosectrain.com/wp-content/uploads/2023/01/Jagan-Purushothaman-150x150.jpg" alt="Jagan Purushothaman|infosectrain"  class="p_image d-block mx-auto mb-3">                    </div>
              <h4 class="adv-ho text-center">Jagan Purushothaman</h4>
              <p class="wordof_p text-center">
			          The trainer was very knowledgeable. He extended his efforts and showed us more practical things so that we can be focused on the course.  
					    </p>
					...
					<div class="advisor_box">
					<div class="prof-img">
                    <img src="https://www.infosectrain.com/wp-content/uploads/2023/01/Mayur-150x150.jpg" alt="Mayur Manjal|infosectrain" class="p_image d-block mx-auto mb-3">
                  </div>
                    <h4 class="adv-ho text-center">Mayur Manjal</h4>
                    <p class="wordof_p  text-center">
                    Thanks to Trainer for his time and efforts, where you started from the scratch and explained concepts in simple terms , building the foundations bit by bit by covered all the topics.
                    </p>
					...
					<div class="advisor_box">
					 <div class="prof-img">
                    <img src="https://www.infosectrain.com/wp-content/uploads/2023/01/Priya-150x150.jpg" alt="Priya Abuj|infosectrain" class="p_image d-block mx-auto mb-3">
            </div>
            <h4 class="adv-ho text-center">Priya Abuj </h4>
					<p class="wordof_p text-center">
             
    The trainer delivered very good sessions which obviously gives very good idea about theoretical as well as practical knowledge. 
					</p>
    ...
    <div class="container">
        ...
        <div class="row mt-4 wow fadeInUp">
            ...
            <div class="col-md-6 col-lg-3 mt-md-0 mt-4">
                <div class="c_box">
                    <a href="https://www.infosectrain.com/pages/lp/network-security-training/" class="link_box" target="_blank">
...
<li><a href="https://www.infosectrain.com/contact-us/" class="text-white" target="_blank">Contact us</a></li>
      ...
      <div class="col-12 col-md-6 col-lg-3">
           ...
           <p class="foot_p">99 Wall Street #599 New York, NY 10005, United States</p>
                    <p class="foot_p"><a href="tel:+1657-221-1127" class="text-white"><img src="assets/img_2/call.svg" /> +1657-221-1127 (USA)</a></p>
                </div>
