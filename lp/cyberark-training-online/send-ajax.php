...
$email_subject = "CyberArk Training Landing Page";
            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                ...
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/whats-new-in-ibm-qradar-siem/" target="_blank">What’s new in IBM QRadar SIEM?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-become-a-security-system-engineer/" target="_blank">How to become a Security System Engineer?</a></li>
                            </ul>                    
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/eVL5jrdOo6c?si=9yawi41idpsIf0-x">What is CyberArk | CyberArk Full Introduction | InfosecTrain</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/cvUtXxe8zS0?si=o7U8-ojBdIX_UbRY">CyberArk Basic to Advanced | What is CyberArk? | InfosecTrain</a></li>
                        </ul>                    
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/sailpoint-training/">SailPoint IdentityIQ Implementation & Developer</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cissp-certification-training/">Certified Information Systems Security Professional(CISSP)</a></li>
							</ul>
						</td>
					</tr>
