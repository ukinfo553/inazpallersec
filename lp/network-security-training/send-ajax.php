...
$email_subject = "Network Security Training Landing Page"; 
	   ...
	   <table align="center" border="0" cellpadding="0" cellspacing="0" width="700" style=" background:#F8F8F8; padding:56px;">
	     ...
	     <tr >
			<td >
				...
				<ul><li><a href="https://www.infosectrain.com/blog/types-of-firewalls-in-network-security/">Types of Firewalls in Network Security</a></li>
				<li><a href="https://www.infosectrain.com/blog/what-is-a-network-security-administrator/">What is a Network Security Administrator?</a></li>
				<li><a href="https://www.infosectrain.com/blog/types-of-network-security-attacks/">Types of Network Security Attacks </a></li>
				<li><a href="https://www.infosectrain.com/blog/cloud-security-vs-network-security/">Cloud Security vs. Network Security </a></li>
				
     </ul> 
     <h2>Get in Touch on Youtube:</h2>
				<ul><li><a href="https://www.youtube.com/watch?v=bxuXlNRWHg0">Basics Of Network Security</a> </li>
				<li><a href="https://www.youtube.com/watch?v=FTjrKkGBHaE">What is Network Security?</a> </li>
				<li><a href="https://www.youtube.com/watch?v=A52VaF7knl0">Technical Network Security </a> </li>
				<li><a href="https://www.youtube.com/watch?v=Nj5EvlSJxVY">General Security & Network Security</a> </li>
     </ul>
				    </td>
				</tr>
				<tr>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp', 
    'page_type' => 'Network Security Training', 
    'name' => $me_name,
    'email' => $me_email, 
    'phone' => $me_phone, 
