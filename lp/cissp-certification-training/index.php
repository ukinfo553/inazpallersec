    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3 class="d-none d-lg-block">Get on Top of the League with</h3>
                            <h1>CISSP Certification Training Course</h1>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    ...
                                    <p>48-Hour LIVE Instructor-led Training</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                ...
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/isaca-premium.svg"
                                        alt="CISSP Online Training Course Highlights" width="45" height="45">
                                    <p>Full 8-Domain Exam Practice</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                ...
                                <p>The Certified Information Systems Security Professional (CISSP®) certification
                                ...
                                <p>The latest version (2024) of CISSP enhances the participant’s understanding by
                                    covering the critical elements of the 8 domains that comprise the Common Body of
                                    Knowledge (CBK)®. This course aims to equip learners with both the technical and
                                    managerial competencies required to design, architect, and oversee an organization’s
                                    security framework in alignment with internationally accepted information security
                                    principles.</p>
                            </div>
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        ...
                                        <p>Understand and apply security, governance and compliance, risk management and
                                            legal/regulatory requirements that pertain to information security in an
                                            organization.</p>
                                        <br>
                                        <h3>Domain 2:</h3>
                                        <strong>Asset Security (10%)</strong>
                                        <p>Manage data life cycle and security controls to provision resources securely
                                            in an organization.</p>
                                        <br>
                                        <h3>Domain 3:</h3>
                                        <strong>Security Architecture and Engineering (13%)</strong>
                                        <p>Assess and mitigate vulnerabilities in security architectures by implementing
                                            cryptographic solutions and site/facility security controls</p>
                                        <br>
                                        <h3>Domain 4:</h3>
                                        <strong>Communication and Network Security (13%)</strong>
                                        <p>Assess and implement secure design principles and communication channels</p>
                                        <br>
                                        <h3>Domain 5:</h3>
                                        <strong>Identity and Access Management (IAM) (13%)</strong>
                                        <p>Manage identification and authentication of people, devices and services</p>
                                        <br>
                                        <h3>Domain 6:</h3>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            ...
                                            <li>
                                                <p><strong>Exam language</strong>: English, French, German, Brazilian,
                                                    Portuguese, Spanish, Japanese, Simplified Chinese, Korean, Visually
                                                    Impaired</p>
                                            </li>
                                            <li>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Immerse in <strong>scenario-based learning</strong> across all CISSP domains</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer your goal </strong>and achieve success with 98% Pass Rate</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Updated curriculum</strong> aligned with the latest CISSP 2024 </p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of CISSP Certification</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of CISSP expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average salary range for different CISSP profiles</h3>
                            <picture>
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                InfosecTrain's CISSP training was excellent! The instructor was highly knowledgeable and
                                patient, explaining complex CISSP concepts in a way that was easy to understand. They
                                effectively clarified doubts and answered all questions during the session, making the
                                learning experience smooth and engaging.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Suja-Maskey.png"
                                            alt="Suja Maskey" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Suja Maskey</h3>
                                        <span>Canada</span>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Overall, I am very satisfied with all aspects of the CISSP training by InfosecTrain. The
                                trainer was highly knowledgeable, approachable, and genuinely passionate about helping
                                others. A great learning experience!
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/partab-Hirani.png"
                                            alt="Partab Hirani" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Partab Hirani</h3>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The CISSP training by InfoSecTrain was excellent. The instructor demonstrated a deep
                                understanding of the material and answered all questions clearly and thoroughly.
                                Explanations were concise and easy to follow, making complex topics much more
                                digestible. The class was highly engaging, and the quiz questions provided were
                                particularly helpful in reinforcing key concepts and preparing us for the exam. I would
                                highly recommend this course to others.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Arshad-Azeem.png"
                                            alt="Arshad Azeem" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Arshad Azeem</h3>
                                        <span>Australia</span>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                Thank you, InfosecTrain, for an excellent CISSP training session! The entire class was
                                insightful and engaging, making the learning experience truly enjoyable. Looking forward
                                to applying this knowledge in the cybersecurity domain!
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Laiju-Kodippadi-Lakshmanan.png"
                                            alt="Laiju Kodippadi Lakshmanan" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                This is an exceptionally well-structured course that helped me tremendously in clearing
                                my doubts. I highly recommend InfosecTrain's CISSP Training for anyone looking to deepen
                                their understanding of cybersecurity.
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Anirban-Das.png"
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                InfosecTrain's CISSP Training simplifies complex concepts, making learning easy and
                                effective. The support provided throughout the training ensures a smooth learning
                                experience. Highly recommended for CISSP aspirants!
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2025/04/Humaid-Abdullah-Ali-Alabdouli.png"
                                            alt="Humaid Abdullah Ali Alabdouli" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Humaid Abdullah Ali Alabdouli</h3>
                                        <span>UAE</span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                                ...
                                <div class="overlay" id="overlay">
                                    <div class="play-button" onClick="playVideo()" id="playButton">
                                        <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                            alt="CISSP Online Training Success Story" width="150" height="150">
                                    </div>
                                </div>
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.webp" alt="CISSP Online Training Success Story"
