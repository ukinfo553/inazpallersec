...
$email_subject = "Advance Identity and Access Management Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/cyberark-scenario-based-interview-questions/" target="_blank">CyberArk Scenario Based Interview Questions</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-does-cyberark-work-for-pam/" target="_blank">How Does CyberArk Work For PAM?</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/sailpoint-vs-cyberark/" target="_blank">SailPoint vs. CyberArk</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/cyberark-interview-questions-and-answers/" target="_blank">CyberArk Interview Questions and Answers for 2022</a></li>
							</ul>
                        </td>
                    </tr>
                    <tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=eVL5jrdOo6c" target="_blank">What is CyberArk | CyberArk Full Introduction</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=cvUtXxe8zS0" target="_blank">CyberArk Basic to Advanced | What is CyberArk?</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=IothLhyI61Q" target="_blank">IAM & SailPoint Career Guide | IAM Role in Organization Information Security</a></li>
							</ul>
						</td>
					</tr>
					<tr>
...
return array($result,$last);
 ...
 $data = array(
    'site_name' => 'lp',
    'page_type' => 'Identity and Access Management',
    'name' => $me_name,
    'email' => $me_email,
    'phone' => $me_phone,
