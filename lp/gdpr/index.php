...
<head>
<meta charset="utf-8">
<meta name="description" content="General Data Protection Regulation Foundation Training ">
<meta name="author" content="Infosec Train">
<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
<title>General Data Protection Regulation Foundation Training</title>
...
<header id="header" class="nav-transparent"> 
        ...
        <div class="left_banner">
            <div class="b_test_box">
               <!-- <h1 class="b_com">Cloud computing is estimated to grow at a rate of <strong>6.5 times</strong> <br>annually and its demand will grow by <strong>24% through 2021</strong></h1>-->
                <h1 class="e_hacker">GDPR CDPO <br />Certification Training</h1>
               <!-- <h2 class="e_council"> Certification Training</h2>-->
                <h2 class="e_council">
				<ul>
		       <li>32 hours of instructor-led training</li>
          <li> Certified & Experienced Trainers</li>
          <li> Post Training Support</li>
          <li> PECB Authorized Training Partner</li>
		        </ul>
				</h2>
				<img src="assets/img_2/pecb.png" />
            </div>
        </div>
      </div>
  ...
  <option selected="selected" value=" ">Your Country</option>
    ...
    <option value="Other">Other</option>
                ...
                <input type="hidden"   value="General Data Protection Regulation Foundation (GDPR)" id="me_others" name="me_others"  > 
...
<section id="coursecontent">
    <div class="container">
        <div class="row">
            <div class="col-12">               
               <h2 class="package-heading">GDPR Training Includes</h2>
            </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6 mt-lg-0 mt-4">
			...
			<div class="certification_box">
                        ...
                        <p class="adv-p">32 hours of instructor <br />led training</p>
            </div>
			</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">GDPR Course Content / Exam(s)</h2>
      </div>
    </div>
    ...
    <section class="accordion-tabs js-tabs" data-tabs-allowed="true" data-breakpoint="640" data-start-collapsed="true">
      <ul role="tablist" class="tabs-tab-list">
          ...
          <li role="presentation"><a id="tab3" href="#section3" role="tab" aria-controls="section3" class="tabs-trigger js-tabs-trigger">Course Outline</a></li>
      ...
      <section id="section1" role="tabpanel" aria-labelledby="tab1" class="tabs-panel js-tabs-panel" tabindex="0">
        ...
        <div class="content" aria-hidden="false">
         <div  class="tab_content"> 
            <img src="assets/img_2/Certification-Logosgdpr.png" align="right" class="d-inline-block ml-3">
                       <p>The GDPR Foundation training allows you to study the essential elements to execute and manage the framework of compliance concerning personal data protection. All through this training course, you will be able to comprehend the fundamental principles of privacy and get acquainted with the role of the Data Protection Officer.</p>

<p>After the course completion, you can sit for the examination and apply for the credential of a ‘PECB Certified GDPR Foundation.’ The certificate of PECB Foundation depicts that you have understood the underlying methodologies, framework, requirements, and management approach.</p>
					  </div>
        </div>
      </section>

      <section id="section3" role="tabpanel" aria-labelledby="tab3" class="tabs-panel js-tabs-panel">
        <div class="accordion-trigger js-accordion-trigger" aria-controls="section3" aria-expanded="false" tabindex="0">Course Outline <div class="accordion-trigger-icon"><span class="label--open">Open</span><span class="label--close">Close</span><svg aria-hidden="true" focusable="false" viewBox="0 0 20 20">
            <rect class="vert" height="18" width="2" fill="currentColor" y="1" x="9"></rect>
            <rect height="2" width="18" fill="currentColor" y="9" x="1"></rect>
          </svg></div></div>
        <div class="content" aria-hidden="true">
          <div  class="tab_content"> 
<ul class="ulclass">
  <li>Introduction  to the General Data Protection Regulation (GDPR)&nbsp;</li>
  <li>Introduction to GDPR and Data Protection Principles</li>
  <li>The General Data Protection Regulation requirements </li>
  <li>Introduction to the GDPR concepts and principles&nbsp;</li>
  <li>Designation of the DPO and analysis of the GDPR compliance  program</li>
  <li>DPO operations</li>
  <li>Monitoring and continual improvement of GDPR compliance</li>
  <li>Certification exam</li>
	  ...
	  <section id="section4" role="tabpanel" aria-labelledby="tab4" class="tabs-panel js-tabs-panel">
        ...
        <div class="content" aria-hidden="true">
         <div class="tab_content">
<ul class="ulclass">
<li>Individuals interested in gaining   knowledge about the chief principles of privacy</li>
  <li>Individuals seeking to pursue a  career in the field of Data Protection</li>
  <li>Individuals engaged in  Information Security and Personal Data Protection</li>
	  ...
	  <section id="section5" role="tabpanel" aria-labelledby="tab5" class="tabs-panel js-tabs-panel">
        ...
        <div class="content" aria-hidden="true">
         <div class="tab_content"><p>A candidate must have a fundamental understanding of the GDPR and primary knowledge of the present data protection legal requirements.</p>  </div>
        </div>
      </section>
	  <section id="section6" role="tabpanel" aria-labelledby="tab6" class="tabs-panel js-tabs-panel">
        ...
        <div class="content" aria-hidden="true">
         <div class="tab_content"> 
			<p>
			The examination of the ‘PECB Certified GDPR Foundation’ thoroughly meets the needs and requirements of the PECB Exam and Certification Program (ECP). The domain of competence covered in the exam includes the basic concepts and principles of the General Data Protection Regulation (GDRP).
			</p>
			</div>
        </div>
      </section>
...
<section id="table_section">
    ...
    <div  class="container" id="benefits">
        <div class="row">
            <div class="col-12">
               <h2 class="package-heading">GDPR Training Calendar</h2>
            </div>
        </div>
...
<?php
$url = "https://www.infosectrain.com/api/30831/href_toscroll/free_demo";
...
<?php /*?><section id="coursess">
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">Benefits of Being GDPR-Certified</h2>
      </div>
    </div>
...
<?php /*?><section id="fastfacts_section">
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        ...
        <div class="row" s>
			...
			<center>
                <div class="advisor_box_con">
					...
					A data center management expert with extensive hands on experience of implementation of ISO 27001, ISO 22301 standards for TIER III data centers. He has trained more than 1000 students till date from top IT, Banking and Finance, Telecom and other sectors from countries such as India, Philippines, Singapore, USA, UK, Cambodia, Vietnam, UAE, Saudi Arabia, Tanzania, Senegal and many more.
A renowned trainer conducting training programs/workshops based on experiential learning and interactive discussions and activities. He also conducts audits and implementation of ISO Management Systems – ISMS, QMS, BCMS, EnMS and OHSAS. He is a certified Lead Auditor.
					</p>
                        <h4 class="adv-h">Rajesh</h4>
                        <p class="adv-p">CDCP | CDPO | CISA | ISO 27001 Lead Auditor | ISO 22301 Lead Auditor</p>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/munish-3-150x150.jpg" alt=""  class="p_image">
                            
                    </div>
					<p style="">
					     
   The way he teaches, the way he clears concepts.. you can feel the difference. Trainer dropped down to my level of understanding and then pulled me up! That is not what a “just teacher” does. Trainer never showed...
					</p>
                        <h4 class="adv-ho">Munish</h4>
					...
					<div class="advisor_box">
					<div class="prof-img">
                             <img src="assets/img_2/ramakrishnan.jpg" alt=""  class="p_image">
                          </div>
					<p style="">
				     
   It was a great experience in terms of gaining knowledge from an expert; Trainer's intension is beyond the scope, what we generally get from the ...
					</p>
                        <h4 class="adv-ho">  Ramakrishnan </h4>
					...
					<div class="advisor_box">
					 <div class="prof-img">
                           <img src="assets/img_2/neelima.jpg" alt=""  class="p_image">
                           
                          </div>
					<p style="">
					     
   Hi Team, Firstly I would like to say thanks to trainer. It was an awesome experience by reviewing again the our courses. Interactive session with lot of concepts add on.
					</p>
                        <h4 class="adv-ho"> Neelima Kant </h4>
					...
					<div class="advisor_box">
					 <div class="prof-img">
                           <img src="assets/img_2/jatin.jpg" alt=""  class="p_image">
                           
                          </div>
					<p style="">
					     
  It was awesome bootcamp and i learned a lot from the course. I would love to attend more bootcamps to sharpen my skills and increase my knowledge. I would like to recommend this course to my colleagues and friends as it gives lot of knowledge for the one who wants to pursue this as career.
					</p>
                        <h4 class="adv-ho">Jatin Dhruva</h4>
