...
$user_body = '<table   class="" role="presentation"  border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <td style="padding: 20px 0 30px 0; ">
				...
				<tr>
					...
					<br />Our Training Advisor will get back to you in shortly, for confirmation of your preferred training schedule.</p>
			        ...
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul><li><a href="https://www.infosectrain.com/blog/an-overall-vision-of-general-data-protection-regulation-gdpr/" target="_blank">An Overall vision of General Data Protection Regulation (GDPR)</a></li>
  <li><a  href="https://www.infosectrain.com/blog/ccpa-vs-gdpr/" target="_blank">CCPA vs GDPR</a></li>
  <li><a  href="https://www.infosectrain.com/blog/why-is-the-international-business-community-talking-about-general-data-protection-regulation-gdpr/" target="_blank">Why Is The International Business Community Talking About General Data Protection Regulation (GDPR)? </a></li>
  </ul>
							</td>
						  </tr>					  
                      </table>
				...
				<h2>Our Recommended Youtube Videos:</h2>
				...
				<tr>
			        <td style="color: #414547; padding-left:24px;padding-right:24px;text-align:left; font-size:14px;">
						...
						<table width="100%" border="0" bordercolor="#CCCCCC" align="left">
						  <tr style="padding-top:20px;">
							<td>
							<ul><li><a href="https://www.youtube.com/watch?v=WX1bCH2BpmU">Introduction to the GDPR</a> </li>
  <li><a href="https://www.youtube.com/watch?v=eaeBD8gEuqo">What is GDPR in Details</a> </li>
  <li><a href="https://www.youtube.com/watch?v=z0WNrvFFMr8">Privacy and data protection</a> </li>
  <li><a href="https://www.youtube.com/watch?v=qCm6BXq6QFQ">Webinar on GDPR Challenges & Quick Wins </a> </li>
  </ul>
							</td>
						  </tr>					  
                      </table>
