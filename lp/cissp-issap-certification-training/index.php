...
<head>
    ...
    <meta name="description"
        content="Enroll Now ISSAP Certification Online Training Course by InfosecTrain.Take your CISSP to the next level by earning your ISSAP concentration. Get Now Offer">
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3>Master Security Architecture</h3>
                            <h1>ISSAP Certification Training</h1>
                            <h3>(Information Systems Security Architecture Professional)</h3>
                            ...
                            <div class="button-sec">
                                ...
                                <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/CISSP-ISSAP_Course_Content_v1.pdf"
                                    target="_blank" class="cta-button" title="Download Brochure">Download Brochure</a>
                            </div>
                            <img src="assets/images/review-mob-img.png" alt="ISSAP Online Training Course Review"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner-img.webp" fetchPriority="high"
                                alt="ISSAP Online Training by InfosecTrain" width="885" height="662">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>ISSAP Training - An Overview</h2>
                                <p>
                            ...
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>
                                                <p>
                                                <strong>Domain 1:</strong> Architect for Governance, Compliance and Risk
                                                Management <strong>(17%)</strong>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                <strong>Domain 2:</strong> Security Architecture Modeling
                                                <strong>(15%)</strong>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                <strong>Domain 3:</strong> Infrastructure Security Architecture
                                                <strong>(21%)</strong>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                <strong>Domain 4:</strong> Identity and Access Management (IAM)
                                                Architecture <strong>(16%)</strong>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                <strong>Domain 5:</strong> Architect for Application Security
                                                <strong>(13%)&nbsp;</strong>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                <strong>Domain 6:</strong> Security Operations Architecture
                                                <strong>(18%)</strong>
                                                </p>
                                            </li>
                                        </ul>
                                ...
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Course Objectives</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <p>ISSAP certification exam helps you acquire across the board understanding of:
                                        </p>
                                        <ul>
                                            <li>Core concepts of access control systems, techniques, and access
                                                management architecture</li>
                                            <li>Communications and network architecture, considerations for security
                                            ...
                                            <li>Physical security considerations, requirement assessment, and solution
                                                evaluation</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <p>
                                            ...
                                            full-time experience in one or more of the six domains of the current ISSAP
                                            Exam Outline.
                                        </p>
                                        <strong style="color:var(--red);">Or:</strong>
                                        <p>
                                            Candidates must have a minimum of seven years cumulative, full-time
                                            experience in two or more of the domains of the current ISSAP Exam Outline.
                                            Earning a post-secondary degree (bachelors or masters) in computer science,
                                            information technology (IT) or related fields or an additional credential
                                            from the ISC2 approved list may satisfy one year of the required experience.
                                            Part-time work and internships may also count towards the experience
                                            requirement.
                                        </p>
                                    </div>
                                </div>
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <?php
                        $url = "https://www.infosectrain.com/api/30769/href_toscroll/free_demo";
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 d-none d-lg-block">
                        <img src="assets/images/training-calendar.webp" width="132" height="128"
                            alt="ISSAP Training Calendar" class="img-fluid">
                    </div>
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                ...
                                <img src="assets/images/corporate-training-mob.webp" width="364" height="301"
                                    alt="ISSAP Online Training  Corporate Training"
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                GRCP | ISSAP | CCSP | CISSP | CCISO | AWS Architect Associate | AWS Security Specialty |
                                CEH | ECSA
                            </div>
                            <div class="summary">
                                Mani has over 16 years of hands-on experience in various technologies, specializing in
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/exam.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p><strong>Conquer the ISSAP exam</strong>in the first attempt</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of ISSAP Certification</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                    alt="Benefits of ISSAP Online Training">
                            </div>
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                                <img src="assets/images/benifits/earning.svg" width="22" height="22"
                                    alt="Benefits of ISSAP Online Training  Certification">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of Security Architechture Expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average salary range for different ISSAP profiles</h3>
                            <picture>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/09/Mohammed-Faizuddin-Siddiqui.jpg"
                                            width="250" height="250" alt="Mohammed Faizuddin Siddiqui">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/09/Muhammad-Akther.jpg"
                                            width="250" height="250" alt="Muhammad Akther">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>
                                            Muhammad Akther
                                ...
                                <div class="overlay" id="overlay">
                                    <div class="play-button" onClick="playVideo()" id="playButton">
                                        <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                            width="150" height="150" alt="ISSAP Online Training Success Story">
                                    </div>
                                </div>
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.webp" width="429" height="263"
                                alt="ISSAP Online Training Success Story" class="d-block m-auto img-fluid">
                        </div>
