...
<body>
    ...
    $api_id = 30764; // Define the API ID
    ...
    <main>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">Get on Top of the League with</div>
                            <h1>CISSP Certification Training </h1>
                    ...
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <p>
                                    The latest version (2024) of CISSP enhances the participant’s understanding by
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <a href="<?php echo $brochureLink; ?>" target="_blank"
                                                class="button download-btn d-inline-block"
                                                style="background:var(--acent-red);border:1px solid var(--danger);color:var(--dark);">
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                            <div>
                                <img src="assets/images/form-banner.webp" width="536" height="204" alt="CISSP Training"
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    <div class="col-lg-4 col-md-6 pt-4 pt-md-0 ps-md-4">
                        <div class="d-flex flex-column align-items-center align-items-md-start gap-3">
                            <h2>CISSP Corporate Training</h2>
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="CISSP Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Amruta.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Cornelius-Okudzeto.webp" width="896"
                                        height="462" alt="Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Anil-Gangwani.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Akshay.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Akhil-Verma.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div thumbsSlider="" class="swiper mySwiper3" style="width: 100%;">
                            <div class="swiper-wrapper justify-content-between">
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/amruta1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Cornelius-Okudzeto1.webp" width="192"
                                        height="200" alt="Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Anil-Gangwani1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Akshay1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Akhil-Verma1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                            </div>
                            <div class="d-none d-md-flex justify-content-center align-items-center navigation">
            ...
            <div class="container-fluid container-lg">
                ...
                <div class="row g-4">
                    <div class="col-12 f-nunito fs-18 fw-bold text-dark text-center">
                        Average salary range for different CISSP profiles
                    </div>

                    <div class="col-lg-6 col-md-6">
                        <img src="assets/images/benifits/benefits.webp" alt="Course Benefits" width="1126" height="529"
                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Suja-Maskey.png"
                                    ...
                                    <p class="desc">
                                        InfosecTrain's CISSP training was excellent! The instructor was highly
                                        knowledgeable and patient, explaining complex CISSP concepts in a way that was
                                        easy to understand. They effectively clarified doubts and answered all questions
                                        during the session, making the learning experience smooth and engaging.
                                    </p>
                                </div>
                                <!--/ col start /-->
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Arshad-Azeem.png" alt="Arshad Azeem"
                                    ...
                                    <p class="desc">
                                        The CISSP training by InfoSecTrain was excellent. The instructor demonstrated a
                                        deep understanding of the material and answered all questions clearly and
                                        thoroughly. Explanations were concise and easy to follow, making complex topics
                                        much more digestible. The class was highly engaging, and the quiz questions
                                        provided were particularly helpful in reinforcing key concepts and preparing us
                                        for the exam. I would highly recommend this course to others.
                                    </p>
                                </div>
                                <!--/ col start /-->
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/partab-Hirani.png"
                                    ...
                                    <p class="desc">
                                        Overall, I am very satisfied with all aspects of the CISSP training by
                                        InfosecTrain. The trainer was highly knowledgeable, approachable, and genuinely
                                        passionate about helping others. A great learning experience!
                                    </p>
                                </div>
                                <!--/ col start /-->
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Ujval-Mutyala.png"
                                                    alt="Ujval Mutyala" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Ujval Mutyala
                                    ...
                                    <p class="desc">
                                        InfoSecTrain's CISSP Training helped me gain a comprehensive understanding of
                                        key security concepts, including risk management, security architecture,
                                        cryptography, and incident response. The course fosters critical thinking and
                                        real-world application of security practices, enabling professionals to
                                        effectively design, implement, and manage secure systems.
                                    </p>
                                </div>
                                <!--/ col start /-->
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/Sai-Ram-Pavan-Prasad-Prabhala.png"
                                                    width="250" height="250" alt="Sai Ram Pavan Prasad Prabhala">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Sai Ram Pavan Prasad Prabhala
                                                </h3>
                                                <span>United States</span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="desc">
                                        The CISSP training at InfosecTrain helped me gain the knowledge and confidence
                                        needed to appear for the exam. It is also a great course for anyone looking to
                                        learn best practices in Information Security. The sessions were engaging and
                                        informative, with clear explanations of complex topics, making the learning
