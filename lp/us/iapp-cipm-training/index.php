...
<body>
    ...
    <main>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">Establish Your Privacy Expertise</div>
            ...
            <div class="container-fluid container-lg">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h2 class="text-center text-md-start">CIPM - An Overview</h2>
                                <p class="my-3">
                                ...
                                <div class="accordion d-flex flex-column gap-4">
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                <li>
                                                    <p><strong>Module 1</strong> - Introduction to privacy program
                                                        management</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 2</strong> - Privacy governance</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 3</strong> - Applicable laws and regulations</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 4</strong> - Data assessments</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 5</strong> - Policies</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 6</strong> - Data subject rights</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 7</strong> - Training and awareness</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 8</strong> - Protecting personal information</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 9</strong> - Data breach incident plans</p>
                                                </li>
                                                <li>
                                                    <p><strong>Module 10</strong> - Monitoring and auditing program
                                                        performance</p>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <ul class="liststar">
                                                ...
                                                <li>Ensure data subject rights and develop and implement privacy
                                                    training</li>
                                                <li>Protect personal information</li>
                                                <li>Respond to data security incident or breach</li>
                                                <li>Monitor, measure, analyze and audit performance of the privacy
                                                    program</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>
                                                    <p><strong>Number of Questions:</strong> 90 out of which 70 are
                                                        scored</p>
                                                </li>
                                                <li>
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                            <div class="col-12 available-batch">
                                <h2 class="text-center text-md-start">CIPM Training Calendar</h2>
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                            <div>
                                <img src="assets/images/form-banner.webp" width="357" height="204" alt="CIPM Training"
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="CIPM Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Immerse in <strong>scenario-based learning</strong> across all CIPM domains</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container-fluid container-lg">
                <div class="row g-4 justify-content-center">
                    <div class="col-12">
                        <h2 class="text-center">Benefits Of CIPM Certification</h2>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-12 f-nunito fs-18 fw-bold text-dark text-center">
                        Average salary range for different CIPM profiles
                    </div>
                        ...
                        <div class="accordion d-flex flex-column gap-4">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                <button
                                    ...
                                    <span>What is CIPM?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    An enterprise-wide privacy programme can be established, maintained, and managed
                                    throughout its entire lifecycle with the help of the Certified Information Privacy
                                    Manager (CIPM) credential, which provides privacy and data protection professionals
                                    with all the tools they need. CIPMs are aware of privacy laws and how to apply them
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>How many questions are there in the CIPM exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                ...
                                <div class="accordion-body">
                                    <p>The number of questions that are successfully answered determines the exam score.
                                    </p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Can you tell me how many questions I correctly answered?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Why should you take the CIPM exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
