...
<body>
    ...
    $api_id = 30768; // Define the API ID
    ...
    <main>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">Mastering Cloud Security</div>
                            <h1>Certified Cloud Security Professional</h1>
            ...
            <div class="container-fluid container-lg">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                    ...
                                    <img src="assets/images/highlight-icon/ccsp.svg" width="42" height="42" alt="">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h2 class="text-center text-md-start">CCSP - An Overview</h2>
                                <p class="my-3">
                            ...
                            <div class="col-12 mt-4">
                                <div class="accordion d-flex flex-column gap-4">
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>
                                                    <p><strong>CCSP Domain 3:</strong> Cloud Platform &amp;
                                                        Infrastructure
                                                        Security (17%)</p>
                                                </li>
                                                <li>
                                                    <p><strong>CCSP Domain 4:</strong> Cloud Application Security (17%)
                                                    </p>
                                                </li>
                                                <li>
                                                    <p><strong>CCSP Domain 5:</strong> Cloud Security Operations (16%)
                                                    </p>
                                                </li>
                                                <li>
                                                    <p><strong>CCSP Domain 6:</strong> Legal, Risk and Compliance (13%)
                                                    </p>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>Secure cloud-based applications, including software as a service
                                                    (SaaS)
                                                    and platform as a service (PaaS).</li>
                                                <li>Understand the legal and compliance aspects of cloud security,
                                                    including
                                                ...
                                                <li>Understand the unique security challenges and considerations in
                                                    cloud
                                                    environments.</li>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>
                                                    <p>Language: <strong>English, Chinese, Japanese and German</strong>
                                                    </p>
                                                </li>
                                                <li>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <p>
                                                ...
                                                working experience in information security and CCSP CBK domains. All
                                                those who fail to fulfill the eligibility criteria can take the exam to
                                                become an associate of (ISC)2 and can start working towards getting the
                                                experience to get the desired certification.
                                            </p>
                                            <strong class="my-2">Note:</strong>
                                            <ul class="liststar">
                                                <li>
                                                    CCSP® is a registered mark of The International Information Systems
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <p>This CCSP training is suitable for experienced IT personnel who are
                                                involved with:</p>
                                            <ul class="liststar">
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                            <div class="col-12 available-batch">
                                <h2 class="text-center text-md-start">CCSP Training Calendar</h2>
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                            <div>
                                <img src="assets/images/form-banner.webp" width="357" height="204" alt="CCSP Training"
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="CCSP Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/parag-kulkarni-story.png" width="896"
                                        height="462" alt="CCSP Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
            ...
            <div class="container-fluid container-lg">
                ...
                <div class="d-flex flex-lg-nowrap flex-wrap justify-content-center gap-4 my-4">
                    ...
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        <img src="assets/images/benifits/cybersecurity-expert.svg" width="24" height="24"
                            alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                        <p class="mb-0">Earn the status of a Cloud Security expert</p>
                    </div>
                    <!--/ col start /-->
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                ...
                <div class="row g-4">
                    <div class="col-12 f-nunito fs-18 fw-bold text-dark text-center">
                        Average salary range for different CCSP profiles
                    </div>
                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide gladiators-item">
                                    ...
                                    <p class="desc">
                                        Sujay was an excellent instructor with a clear and structured teaching approach.
                                        Despite the holiday break being a slight distraction, he ensured we reviewed the
                                        key concepts thoroughly. His ability to simplify complex topics made the
                                        learning process smooth. This course provided valuable insights into CCSP
                                        principles, and I appreciate the effort put into making the training engaging
                                        and informative.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    ...
                                    <p class="desc">
                                        The CCSP training was outstanding in every aspect. The follow-ups, study
                                        materials, and instructor support were excellent, ensuring a smooth learning
                                        experience. The well-structured content covered all critical cloud security
                                        concepts, making it an ideal course for professionals looking to enhance their
                                        expertise. Highly recommended for anyone pursuing CCSP certification!
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    ...
                                    <p class="desc">
                                        This training was instrumental in helping me grasp CCSP concepts. Sujay did an
                                        excellent job of explaining each topic at a steady pace, ensuring clarity at
                                        every step. His use of real-world examples greatly enhanced understanding,
                                        making the learning process more engaging. I appreciate the structured approach,
                                        which made it easier to absorb and retain key concepts.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    ...
                                    <p class="desc">
                                        The instructor was excellent and provided detailed explanations throughout the
                                        CCSP course. His interactive teaching style and expertise made complex topics
                                        easier to understand. I would highly recommend this training to other
                                        professionals looking to build their cloud security knowledge and prepare for
                                        CCSP certification.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    ...
                                    <p class="desc">
                                        The teaching approach was highly effective, with clear explanations and an
                                        organized structure that made CCSP concepts easy to understand. The interactive
                                        sessions helped reinforce key topics, making the learning experience smooth and
                                        engaging. This course is highly recommended for anyone looking to strengthen
                        ...
                        <div class="accordion d-flex flex-column gap-4">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                ...
                                <div class="accordion-body">
                                    ...
                                    (ISC) ² and Cloud Security Alliance (CSA) created this certification to address all
                                    the challenges and issues of cloud computing today.
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Is there any change in the CCSP domain weightage?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>The last changes were made on August 1, 2022; according to which the domains weightage is:</p>
                                    <ul class="liststar">
                                        <li>
                                            <p><strong>Domain 1: </strong>Cloud Concepts, Architecture, and Design (17%)
                                            </p>
                                        </li>
                                        <li>
                                            <p><strong>Domain 2: </strong>Cloud Data Security (20%)</p>
                                        </li>
                                        <li>
                                            <p><strong>Domain 3: </strong>Cloud Platform &amp; Infrastructure
                                                Security(17%)</p>
                                        </li>
                                        <li>
                                            <p><strong>Domain 4: </strong>Cloud Application Security (17%)</p>
                                        </li>
                                        <li>
                                            <p><strong>Domain 5: </strong>Cloud Security Operations (16%)</p>
                                        </li>
                                        <li>
                                            <p><strong>Domain 6: </strong>Legal, Risk and Compliance (13%)</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Why have the domains for (ISC)² credential exams changed?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>Domains have changed to make the knowledge, skills, and abilities relevant in the
                                        current situation.</p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Who should enroll in CCSP?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                                        ...
                                        (ISC)2 CCSP Common Body of Knowledge’s six domains (CBK).
                                    </p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>In which language is CCSP updated exam available?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>CCSP updated exam is available in English and Japanese language.</p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Is Infosec Train aligned with the updated CCSP Course?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Does CCSP certification have an expiration date?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Is CCSP certification well-recognized?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                                        Information security certificates such as the SSCP, CCSP, and CISSP are
                                        well-respected and may help employees advance in their careers.
                                    </p>
                                </div>
                            </div>
                        </div>
