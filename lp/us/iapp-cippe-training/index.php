                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/female-avatar.png"
                                                    alt="CIPP/E Words Have Power" width="250" height="250">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Sonia Ogunbajo</h3>
                                                <span>United Kingdom</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The CIPP/E training session was excellent and highly engaging. The course
                                        material was well-structured, making complex concepts easier to grasp. The
                                        interactive approach ensured a smooth learning experience, and I thoroughly
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Bansidhar Chakkaravarthy</h3>
                                                <span>Switzerland</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The CIPP/E course was highly informative and well-organized. It covered
                                        essential topics in a way that was easy to understand. I learned a lot and
                                        gained valuable insights that will help me in my professional journey.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Maithreyi Budanur Siddaramaiah</h3>
                                                <span>Ireland</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="desc">
                                        The instructor ensured that every concept was crystal clear, providing
                                        individual attention and addressing doubts effectively. The well-structured
                                        approach made learning smooth, and I feel confident about passing the CIPP/E
                                ...
                                <div class="swiper-slide gladiators-item">
                                    ...
                                    <p class="desc">
                                        The learning experience was fantastic, with well-explained concepts and an
                                        interactive approach that made the sessions engaging. The course provided
                                        valuable insights into CIPP/E, making it an essential program for anyone in
                                        privacy compliance.
                                    </p>
                                </div>
                            </div>
