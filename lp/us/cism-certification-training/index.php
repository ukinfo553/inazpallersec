...
<body>
    ...
    $api_id = 30770; // Define the API ID
    ...
    <main>
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="fs-28 f-roboto text-dark fw-bold">Master the World of Enterprise Security</div>
            ...
            <div class="container-fluid container-lg">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <h2 class="text-center text-md-start">CISM - An Overview</h2>
                                <p class="my-3">
                                    The Certified Information Security Manager (CISM) certification is a globally
                                    ...
                                    management, governance, incident response, and security management.
                                </p>
                                <p>
                                    Our certification-focused CISM training course is designed to empower learners with
                                    all necessary knowledge and techniques to ace the CISM certification. The objective
                                    of this CISM certification training program is to prepare participants with the
                                    right managerial level skills required to handle an organization’s enterprise IT
                                    environment by employing globally recognised practices and standards.
                                </p>
                            </div>
                            <div class="col-12 mt-4">
                                <div class="accordion d-flex flex-column gap-4">
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                <li>Develop and sustain a structure for overseeing information security
                                                    and
                                                ...
                                                <li>Establish and oversee an Information Security Program (ISP) that
                                                    ...
                                                    characteristics.</li>
                                                <li>Effectively control information-related risks within acceptable
                                                    levels,
                                                    aligned with the organization's risk tolerance, to achieve its goals
                                                    and
                                                    objectives.</li>
                                                <li>Attain comprehensive knowledge across the four domains specified by
                                                    the
                                                    Certified Information Security Manager (CISM) certification.</li>
                                                <li>Assess the efficiency of the information security program in
                                                    alignment
                                                    with the organization's strategic objectives.</li>
                                                <li>Attain an in-depth comprehension of the framework governing
                                                    information
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <ul class="liststar">
                                                ...
                                                <li>
                                                    <p><strong>Exam language</strong>: English, Japanese, Korean,
                                                        Spanish
                                                    </p>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                        ...
                                        <div class="accordion-body">
                                            <p>At least five years of information security work experience and at least
                                                three years of work experience in three or more job practices analysis
                                                areas of information security management. Work experience must be
                                                achieved within 10 years of applying for certification or within 5 years
                                                of passing the exam.</p>
                                            <p>The following security-related certifications and management experience
                                                in information systems can be used to replace the required amount of
                                                information security job experience.</p><br />
                                            ...
                                            <ul class="liststar">
                                                ...
                                                <li>Certified Information Systems Security Professional (CISSP) in good
                                                    standing</li>
                                                <li>Post-graduate degree in information security or a related field
                                                    (e.g.,
                        ...
                        <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                            <div class="col-12 available-batch">
                                <h2 class="text-center text-md-start">CISM Training Calendar</h2>
                                <div class="item mt-4">
                                    <div class="item-body">
                                        <table>
                                            <thead>
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                            <div>
                                <img src="assets/images/form-banner.webp" width="357" height="204" alt="CISM Training"
                ...
                <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                    ...
                    <div class="col-lg-8 col-md-6">
                        <img src="assets/images/corporate-training.webp" width="556" height="258"
                            alt="CISM Corporate Training" class="d-block ms-auto img-fluid">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="swiper myAdvisor">
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                            CISSP | CISM | CCSK | ISO 27001 | AWS
                            </div>
                            <div class="summary">
                                A cybersecurity trainer with over 19 years of experience in the field,
                        ...
                        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Anand.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Harshit-Mathur.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Jaikishan-Shah.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide modal-btn-video">
                                    <img src="assets/images/success-story/Sanjay-Khiani.webp" width="896" height="462"
                                        alt="Success Story" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div thumbsSlider="" class="swiper mySwiper3" style="width: 100%;">
                            <div class="swiper-wrapper justify-content-between">
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/anand1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Harshit-mathur1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Jaikishan-sah1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                                <div class="swiper-slide swiper-slide-thumb">
                                    <img src="assets/images/success-story/Sanjay-Khiani1.webp" width="192" height="200"
                                        alt="Success Story" />
                                </div>
                            </div>
                            <div class="d-none d-md-flex justify-content-center align-items-center navigation">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container-fluid container-lg">
                <div class="row g-4 justify-content-center">
                    <div class="col-12">
                        <h2 class="text-center">Benefits Of CISM Certification</h2>
                    </div>
                </div>
                <div class="d-flex flex-lg-nowrap flex-wrap justify-content-center gap-4 my-4">
                    ...
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        <img src="assets/images/benifits/cybersecurity-expert.svg" width="24" height="24"
                            alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                        <p class="mb-0">Earn the status of Information Security expert</p>
                    </div>
                    <!--/ col start /-->
                    <div class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                ...
                <div class="row g-4">
                    <div class="col-12 f-nunito fs-18 fw-bold text-dark text-center">
                        Average salary range for different CISM profiles
                    </div>
                        ...
                        <div class="swiper myGladiators">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/male-avatar.png"
                                                    alt="Farook Mohamed Salim" width="250" height="250">
                                            </div>
                                    ...
                                    <p class="desc">
                                        The CISM course was an excellent blend of theory and practical applications. The
                                        instructor broke down complex topics into simple explanations, making the
                                        learning process smooth and efficient. The interactive discussions were highly
                                        beneficial, helping me grasp key security management concepts effectively.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/male-avatar.png" width="250"
                                                    height="250" alt="Shuhaib Abubacker">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Nittu Mathew Jacob
                                    ...
                                    <p class="desc">
                                        The training was well-paced, covering CISM concepts thoroughly. Discussions with
                                        peers and the instructor helped me understand different perspectives on IT
                                        security management. The post-session Q&A provided great insights into ISACA's
                                        expectations, which was extremely useful. Engaging discussions and real-life
                                        case studies made the learning experience practical and relevant. This course is
                                        ideal for professionals preparing for CISM certification.
                                    </p>
                                </div>
                                <!--/ col start /-->
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/male-avatar.png" width="250"
                                                    height="250" alt="Nahyan Almheiri">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>
                                                    Vidyut Bharadwaj Ammanamanchi
                                                </h3>
                                                <span>Australia</span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="desc">
                                        This CISM course was incredibly insightful, with the trainer explaining all
                                        topics in detail. The real-world examples made complex concepts easy to grasp,
                                        and the interactive discussions helped reinforce learning. The course structure
                                        ensured we covered all key areas, making it an excellent preparation for
                                        certification. I highly recommend this training to anyone pursuing CISM, as it
                                        provides a strong foundation in security governance, risk management, and
                                        compliance.
                                    </p>
                                </div>
                                ...
                                <div class="swiper-slide gladiators-item">
                                    <div class="profile">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/testimonial/female-avatar.png" width="250"
                                                    height="250" alt="Jacob Joseph">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h3>Swati Saha</h3>
                                                <span>Canada</span>
                                    ...
                                    <p class="desc">
                                        My learning journey with InfosecTrain was truly enriching. The trainer was
                                        knowledgeable, responsive, and approachable, ensuring an interactive experience.
                                        The well-structured course covered all key CISM topics with clarity. Real-world
                                        discussions and practical examples made the training highly valuable. I
                                        appreciate the detailed guidance, which helped me grasp security governance and
                                        risk management concepts efficiently. The overall experience exceeded my
                                        expectations, and I highly recommend this course to professionals looking to
                                        enhance their expertise in cybersecurity management.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion d-flex flex-column gap-4">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden open">
                                <button
                                    ...
                                    <span>How long is the CISM Exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    The CISM examination is a four-hour (240 minutes) exam consisting of 150 multiple
                                    choice questions.
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Where can I take the CISM Exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    ...
                                    <p>Please visit: <a href="https://www.isaca.org/credentialing/cism/cism-exam"
                                            target="_blank"><strong>click here</strong></a>
                                        to search the
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Can I review answers before the end of the test?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p><strong>Yes.</strong> Answers can reviewed.</p>
                                    <p>Flag questions you want to review before your exam time is over.</p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What are the eligibility requirements for CISM Certification?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
                                    ...
                                    <p>For more information please visit: <a
                                            ...
                                            target="_blank">https://www.isaca.org/credentialing/cism</a></p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What qualifications are required to earn the CISM Certification?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Who is eligible to become CISM Certified and what makes CISM unique?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                                        CISM certification is a unique management-focused certification. It has been
                                        designed is for the individual who manages, designs, oversees and assesses an
                                        enterprise's information security. it validates your managerial, designing,
                                        overseeing skills and expertise. It brings the best opportunities for anyone in
                                        the infosec with an interest in the managerial aspects of information security,
                                        in contrast to the technical aspects. Any professional with the required
                                        experience can apply for the certification.
                                    </p>
                                </div>
                            </div>
                            <!--accordion-item start-->
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>How is the CISM exam scored?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <p>
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>Are there any fees to apply for CISM Certification?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
                                        <li>A $50 application processing fee is required for all submissions.</li>
                                        <li>The application fee is a one-time, non-refundable payment.</li>
                                    </ul>
                                    <p>
                                        Payment can be made on <a
                                            href="https://www.isaca.org/credentialing/cism/get-cism-certified"
                            ...
                            <div class="accordion-item border-grey w-100 rounded-4 overflow-hidden">
                                <button
                                    ...
                                    <span>What is the best way to prepare for the exam?</span>
                                    <span class="arrow"></span>
                                </button>
                                <div class="accordion-body">
                                    <ul class="liststar">
