...
<html lang="en">
    ...
    ?> -->
                    ...
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-7">
                            <div class="d-flex flex-column gap-3">
                                <div class="fs-28 f-roboto text-dark fw-bold">Threat Hunting With Digital Forensics &
                                    Incident Response</div>
                                <h1>Advanced Cyber Threat Hunting and DFIR Training</h1>
                ...
                <div class="container-fluid container-lg">
                    <div class="row">
                        <div class="col-lg-8 col-md-7">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                        ...
                                        <img src="assets/images/highlight-icon/protection.svg" width="42" height="42"
                                            alt="">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                        ...
                                        <img src="assets/images/highlight-icon/video-recording.svg" width="42"
                                            height="42" alt="">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                        ...
                                        <img src="assets/images/highlight-icon/interview.svg" width="42" height="42"
                                            alt="">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                        style="background: var(--acent-red);">
                                        <img src="assets/images/highlight-icon/certified-trainners.svg" width="42"
                                            height="42" alt="">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                        style="background: var(--acent-orange);">
                                        <img src="assets/images/highlight-icon/learning.svg" width="42" height="42"
                                            alt="">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="h-100 d-flex flex-column gap-3 p-3 rounded-4"
                                        style="background: var(--acent-yellow);">
                                        <img src="assets/images/highlight-icon/cpe-certificate.svg" width="42"
                                            height="42" alt="">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <h2 class="text-center text-md-start">Advanced Threat Hunting Training - An Overview
                                    </h2>
                                    <p class="my-3">
                            ...
                            <div class="row g-4 mt-4 calendar-upcoming-batches d-block" id="training-calendar">
                                <div class="col-12 available-batch">
                                    <h2 class="text-center text-md-start">Advanced Threat Hunting Training Calendar</h2>
                                    <div class="item mt-4">
                                        <div class="item-body">
                                            <table>
                                                <thead>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="bg-dark rounded-4 p-3">
                                        <h3 class="f-nunito fs-18 text-white text-center mb-3 fw-bold">Can't Find a
                                            Suitable
        ...
        top: 100px;margin-top: -30rem;box-shadow: var(--box-shadow);">
                                <div>
                                    <img src="assets/images/form-banner.webp" width="357" height="204"
                                        alt="Advanced Threat Hunting Training Training" class="w-100 h-auto d-block">
                                </div>
                ...
                <div class="container-fluid container-lg">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="h-100 d-flex flex-column align-items-center gap-3 border-grey rounded-4 p-4"
                                style="background: var(--acent-red);">
                                <img src="assets/images/online-training.png" width="70" height="70"
                                    alt="Online Training" class="d-block">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="h-100 d-flex flex-column align-items-center gap-3 border-grey rounded-4 p-4"
                                ...
                                <div class="item-footer">
                                    <button class="button modal-btn" modal-title="CORPORATE TRAINING">CONTACT
                                        US</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-4 align-items-center rounded-4 m-0" style="background: var(--acent-orange);">
                        <div class="col-lg-4 col-md-6 pt-4 pt-md-0 ps-md-4">
                            <div class="d-flex flex-column align-items-center align-items-md-start gap-3">
                                <h2>Advanced Threat Hunting Corporate Training</h2>
                                <p>Upskill Your Team on Advanced Threat Hunting</p>
                        ...
                        <div class="col-lg-8 col-md-6">
                            <img src="assets/images/corporate-training.webp" width="556" height="258"
                                alt="Advanced Threat Hunting Training Corporate Training"
                                class="d-block ms-auto img-fluid">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="benefits-sec" id="benefits">
                <div class="container-fluid container-lg">
                    <div class="row g-4 justify-content-center">
                        <div class="col-12">
                            <h2 class="text-center">Benefits of Advanced Threat Hunting Training</h2>
                        </div>
                    </div>
                    <div class="d-flex flex-lg-nowrap flex-wrap justify-content-center gap-4 my-4">
                        <!--/ col start /-->
                        <div
                            class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                        ...
                        <div
                            ...
                            <img src="assets/images/benifits/cybersecurity-expert.svg" width="24" height="24"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p class="mb-0">Earn the status of a Threat Hunting expert</p>
                        </div>
                        <!--/ col start /-->
                        <div
                            class="benefits-item text-center d-flex align-items-center flex-column gap-3 p-3 rounded-4">
                    ...
                    <div class="row g-4">
                        <div class="col-12 f-nunito fs-18 fw-bold text-dark text-center">
                            Average Salary Range for Threat Hunting Profiles
                        </div>

                        <div class="col-lg-6 col-md-6">
                            <img src="assets/images/benifits/benefits.webp" alt="Course Benefits" width="563"
                                height="264" class="d-block w-100 h-auto m-auto rounded-4">
                        </div>
                            ...
                            <div class="swiper myGladiators">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide gladiators-item">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/testimonial/partab-hirani.png"
                                                        alt="Partab Hirani" width="250" height="250" loading="lazy">
                                                </div>
                                        ...
                                        <p class="desc">
                                            I'm very satisfied with all aspects of the training. The mentor is a true
                                            expert
                                    ...
                                    <div class="swiper-slide gladiators-item">
                                        <div class="profile">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/testimonial/Yash-Kanaiya.png"
                                                        alt="Yash Kanaiya" width="250" height="250" loading="lazy">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h3>Yash Kanaiya</h3>
                                        ...
                                        <p class="desc">
                                            ...
                                            student improvement, and their approach truly helped elevate my
                                            understanding.
                                        </p>
                                    </div>
                                    ...
                                    <div class="swiper-slide gladiators-item">
                                        <div class="profile">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/testimonial/Naveed-Saghiruddin.png"
                                                        alt="Naveed Saghiruddin" width="250" height="250"
                                                        loading="lazy">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <p class="desc">
                                            The training was well-organized and comprehensive. The instructor explained
                                            each
                                    ...
                                    <div class="swiper-slide gladiators-item">
                                        <div class="profile">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/images/testimonial/Vivek-Srivastava.png"
                                                        alt="Vivek Srivastava" width="250" height="250" loading="lazy">
                                                </div>
                                                <div class="flex-grow-1">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex flex-column gap-4">
                                ...
                                <form method="post" class="ajax-form d-flex align-items-start flex-column gap-3">
                                    ...
                                    <input type="number" name="me_phone" class="me_phone form-control"
                                        placeholder="Mobile">
