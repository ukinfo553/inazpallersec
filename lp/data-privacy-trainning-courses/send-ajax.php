            ...
            <td style="padding: 20px 0 30px 0;" align="center">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                ...
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/the-role-of-biometrics-in-data-security-and-privacy/" target="_blank">The Role of Biometrics in Data Security and Privacy</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/data-privacy-in-the-quantum-computing-era/" target="_blank">Data Privacy in the Quantum Computing Era</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/data-security-challenges-in-the-cloud-environment/" target="_blank">Data Security Challenges in the Cloud Environment</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/qEZtQZ5qxZ0?si=nFylB99UKrS64a2n">Introduction to Data Privacy</a></li>
