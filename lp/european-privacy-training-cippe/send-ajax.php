...
$email_subject = "European Privacy Training CIPPE Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/all-about-iapp-cippe-cipm-and-cipt-training/"> All About IAPPs CIPP/E, CIPM, and CIPT Training Course from InfosecTrain</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/pci-dss-compliance-in-the-cloud/">PCI-DSS Compliance in the Cloud</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-interview-questions-for-data-privacy-engineer/">Top interview questions for Data Privacy Engineer</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/data-protection-vs-data-security/">Data Protection vs. Data Security</a></li>
							</ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=vhQYtAvp3pU">European Data Privacy & Preparation for Certifications | CIPP/E Prep</a></li>
							</ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/certified-information-privacy-manager-cipm-training/">Certified Information Privacy Manager (CIPM)</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/certified-information-privacy-technologist-cipt-training/">Certified Information Privacy Technologist (CIPT)</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cdpse-certification-training/">Certified Data Privacy Solutions Engineer (CDPSE)</a></li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/data-protection-officer-training/">Data Protection Officer (DPO)</a></li>
							</ul>
						</td>
					</tr>
