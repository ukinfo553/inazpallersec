...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "DevSecOps Practical New LP";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-become-a-devsecops-engineer/" target="_blank">How to Become a DevSecOps Engineer in 2024?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/introduction-to-devsecops-maturity-model/" target="_blank">Introduction to DevSecOps Maturity Model</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/is-a-devsecops-career-right-for-you-in-2024/" target="_blank">Is a DevSecOps Career Right for You in 2024?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/emerging-trends-in-devsecops-tools/" target="_blank">Emerging Trends in DevSecOps Tools in 2024</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/KbmmYOhL4Jg?si=_7cVv8Gl2RmEVRnz">What is DevSecOps</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/EUQIynVO_fE?si=3rEkC96MvrJtuGbs">Introduction to DevSecOps</a></li>
                        </ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/aws-combo-course-training/">AWS Combo (Architect Associate + Security Speciality)</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/azure-security-combo-training/">Azure Administrator & Security Online Training Course | (AZ-104 + AZ-500) Combo</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/ccsp-certification-training/">CCSP Training & Certification</a>
                                </li>
                                <li>
