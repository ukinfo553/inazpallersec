      ...
      <div class="col-12 col-md-6 col-lg-6 col-xl-8">
        <div class="left_banner">
            <div class="b_test_box">
                ...
                <h1 class="e_hacker">
				<a href="#" class="bannerf_a">Security+ SYO-601/701 </a></h1>
                <h2 class="e_council">
        ...
        <div class="content" aria-hidden="false">
         <div  class="tab_content">
            <img src="assets/img_2/camptia.png" align="right"  style="width:120px;" class="d-inline-block ml-3">
                       <p>
This Comptia security+ sy0 701 course highlights the basic knowledge needed to perform the security functions in IT security. It focuses on the practical skillset required to solve a variety of problems and tackle issues. The course covers the latest updates and market trends on risk management and mitigation, how to respond to threats and treat them, and various auditing and penetration testing opportunities.</p>
<p>
...
<section id="coursess22">
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">Following Self-Paced course <span class="text-danger">ABSOLUTELY FREE</span>
        </h2>
      </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mt-lg-0 mt-4">
        <div class="certification_box2" style="height:200px !important">
    ...
    <div class="col-12">
        <div class="advisor_box_con">
            <div class="advisor_box">
                ...
                <img src="https://www.infosectrain.com/wp-content/uploads/2021/06/Yogender.png" width="80" />
                <p class="pt20">
                ...
                <h4 class="adv-h">6+ Years Of Experience</h4>
                <p class="adv-p">Information Security Consultant and Trainer</p>
            </div>
            <div class="advisor_box">
                <img src="https://www.infosectrain.com/wp-content/uploads/2020/12/Sanyam.png" width="80" />
                <p class="pt20">
                ...
                <h4 class="adv-h">9+ Years Of Experience</h4>
                <p class="adv-p">CEH | CHFI | CTIA | CCISO | CHFI | CND | CSA | Sec+ | Pentest+ | CySA+ | AWS Sec | AWS Architect</p>
            </div>
            <div class="advisor_box">
                <img src="https://www.infosectrain.com/wp-content/uploads/2021/02/ashish.png" width="80" />
                <p class="pt20">
                ...
                <h4 class="adv-h">10+ Years Of Experience</h4>
...
<section id="coursess22">
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">Benefits of Being CompTIA Security+
        </h2>
      </div>
    </div>
...
<section id="courses" class="section">
    <div class="container">
        ...
        <div class="row mt-4 wow fadeInUp">
                ...
                <div class="c_box">
                    <a href="https://www.infosectrain.com/pages/lp/network-security-training/" class="link_box rounded" target="_blank">
					 <img src="assets/img_2/NTS.svg" />
                        <span>Network Security  <br />Training</span>                    </a>
                                 </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 mt-4 mt-lg-0">
                <div class="c_box">
                    <a href="https://www.infosectrain.com/pages/lp/advance-soc-analyst-expert-training/" class="link_box" target="_blank">
...
<section id="footr_last" class="section bg-dark_b button_transparent active py-2">
    <div class="container">
        <div class="row text-white justify-content-md-center align-items-center wow fadeInUp">
           <div class="col-3 col-lg-3 col-md-4"><a href="https://api.whatsapp.com/send?phone=918767256840" target="_blank">
            <img src="assets/img_2/whats2.png"><span>+91 8767256840</span></a></div>
...
<li><a href="https://www.infosectrain.com/contact-us/" class="text-white" target="_blank">Contact us</a></li>
          ...
          <p class="foot_p"><a href="tel:+16572211127" class="text-white"><img src="assets/img_2/call.svg" /> +1 657-221-1127 (USA)</a></p>
