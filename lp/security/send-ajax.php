...
$email_subject = "New Enquiry from CompTIA Security+  Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a	style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/comptia-security-sy0-601-domain-1-attacks-threats-and-vulnerabilities/" target="_blank">Domain 1: Attacks, Threats, and Vulnerabilities  </a></li>
								<li><a  style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/comptia-security-sy0-601-domain-2-architecture-and-design/" target="_blank">Domain 2: Architecture and Design  </a></li>
								<li><a  style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/comptia-security-sy0-601-domain-3-implementation/" target="_blank">Domain 3: Implementation </a></li>
								<li><a 	style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/how-to-prepare-for-comptia-security-sy0-601-examination/" target="_blank">How to Prepare for CompTIA Security+ SY0-601 Examination? </a> </li>
							</ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" target="_blank" href="https://www.youtube.com/watch?v=6HwWSujsv3I">Day 1 - Security+ Boot camp</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" target="_blank" href="https://www.youtube.com/watch?v=sYNNNkSu7kQ">Day 2 - Security+ Boot camp </a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" target="_blank" href="https://www.youtube.com/watch?v=Edosrg0uL4s">How to Prepare CompTIA Security+ 601</a> </li>
								<li><a style="font-size: 12px;text-decoration: none;color: #414547;" target="_blank" href="https://www.youtube.com/watch?v=qA48Ez3SYwA">Benefits of CompTIA Security+ SYO-601?</a> </li>
							</ul>
						</td>
					</tr>
					<tr>
