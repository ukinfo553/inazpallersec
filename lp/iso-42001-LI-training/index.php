...
$courseID = 44416;  // Change this to the specific course ID for different pages
...
<html lang="en">
    ...
    <head>
        ...
        <title>ISO/IEC 42001:2023 Lead Implementer Training and Certification</title>
        ...
        <main>
                ...
                <div class="container">
                    <div class="row align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="item">
                                ...
                                <div class="d-flex flex-row banner-highlights">
                                    <div>
                                        <span>90% Increase in 42001:2023</span>
                                        <p>Lead Implementer-related roles</p>
                                    </div>
                                    <div>
                                        <span>$147,784</span>
                                        <p>Median Salary of AI Risk Manager</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-5 col-md-6 d-none d-md-block">
                            <div class="item">
                                <img src="assets/images/ISO-42001-BANNER.webp" fetchPriority="high"
                                    alt="ISO/IEC 42001:2023 Lead Implementer by InfosecTrain" width="400" height="400">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-8 col-md-6">
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/time.svg"
                                            alt="ISO/IEC 42001:2023 Lead Implementer Course Highlights" width="45"
                                            height="45">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    <h2>ISO/IEC 42001:2023 Lead Implementer Training - An Overview</h2>
                                    <p>Artificial Intelligence (AI) is transforming how organizations operate, but it
                                        also brings challenges around ethics, transparency, and security. ISO/IEC
                                        42001:2023 is the first global standard for establishing and managing Artificial
                                        Intelligence Management Systems (AIMS), ensuring AI is used responsibly and
                                        effectively. InfosecTrain's ISO/IEC 42001:2023 Lead Implementer Training equips
                                        you with the knowledge and practical skills to design, implement, and maintain
                                        an AIMS aligned with the standard. Through scenario-driven learning and
                                        real-world case studies, you'll learn to build robust processes and controls
                                        that promote ethical, secure, and compliant AI use, enabling you to lead AI
                                        adoption with confidence.</p>
                                </div>
            ...
            <?php if (!empty($courseID)): ?>
                <section class="training-calendar" id="training-calendar">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h2>ISO/IEC 42001:2023 Lead Implementer Training Calendar</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-2 d-none d-lg-block">
                                <img src="assets/images/training-calendar.webp" width="132" height="128"
                                    alt="ISO/IEC 42001:2023 Lead Implementer" class="img-fluid">
                            </div>
                            ...
                            <a href="#" class="modal-btn" title="Corparate Training">
                                <picture>
                                    <source media="(min-width:768px)" width="1400" height="420"
                                        srcset="assets/images/ISO-42001-corporate-training-web.png">
                                    <img src="assets/images/ISO-42001-corporate-training-mob.png" width="364"
                                        height="301" alt="ISO/IEC 42001:2023 Lead Implementer"
                    ...
                    <div class="swiper myAdvisor">
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    Rajesh is a seasoned Information Security Analyst and ISO Management Systems Trainer
                                    with 25+ years of cross-functional experience in risk management, auditing, ISMS,
                                    QMS, ITSM, and business continuity. He specializes in conducting CISA prep, ISO
                                    implementation/audits, and operational excellence programs. Rajesh blends technical
                                    depth with practical insight, delivering interactive training aligned with global
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/assessment-practice.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Gain hands-on AI risk management experience</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Focus on Responsible AI, Risk, and Compliance frameworks</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="item">
                                <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                    alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                                <p>Understand AI transparency, accountability, and compliance requirements</p>
                            </div>
                        </div>
                        <!--/ col start /-->
                        <div class="col-lg-3 col-md-4 col-6">
            ...
            <section class="benefits-sec" id="benefits">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2>Benefits of ISO/IEC 42001:2023 Lead Implementer Training</h2>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center benefits-row-two">
                            ...
                            <div class="d-flex align-items-center benifits-item">
                                <div class="flex-shrink-0">
                                    <img src="assets/images/benifits/global-recognition.svg" width="22" height="22"
                                        alt="Benefits of ISO/IEC 42001:2023 Lead Implementer">
                                </div>
                        ...
                        <div class="col-md-8">
                            <div class="benifits-item-two">
                                <h3>Average Salary Range for 42001:2023 Lead Implementer-Related Roles</h3>
                                <picture>
                                    <source media="(min-width:768px)" width="1472" height="486"
                                        srcset="assets/images/benifits/benefits-ISO-42001-desktop.png">
                                    <img src="assets/images/benifits/benefits-ISO-42001-mobile.png" width="640"
                                        height="473" alt="Benefits of ISO/IEC 42001:2023 Lead Implementer">
                                </picture>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="overlay" id="overlay">
                                        <div class="play-button" onClick="playVideo()" id="playButton">
                                            <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/home/play-button.svg"
                                                alt="ISO/IEC 42001:2023 Lead Implementer Success Story" width="150"
                                                height="150">
                                        </div>
                                    </div>
