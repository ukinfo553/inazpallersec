        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-6 col-lg-2 cl-xl-3">
                    <a href="https://www.infosectrain.com/courses/AWS Combo-certification-online-training/">
                ...
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            ...
                            <h1>AWS Architect Associate + <br> Security Speciality</h1>
                            <p><strong>$130,000</strong> Avg Salary of Cloud Administrators</p>
                            ...
                            <img src="assets/images/review-mob-img.png" alt="AWS Combo Course Review" width="636" height="34"
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/banner.webp" fetchPriority="high"
                                alt="AWS Combo by InfosecTrain" width="800" height="521">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/combo-course.svg" alt="AWS Combo Course Highlights"
                                        width="45" height="45">
                                    <p>Combo Course to Master AWS </p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/video-recording.svg" alt="AWS Combo Course Highlights"
                                        width="45" height="45">
                                ...
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                                    <img src="assets/images/highlight-icon/learning.svg" alt="AWS Combo Course Highlights"
                                        width="45" height="45">
                            ...
                            <div class="item-footer">
                                <img src="assets/images/highlight-icon/Satisfaction-Guaranteed.webp" width="300" height="146"
                                    alt="AWS Combo Course Highlights">
                            </div>
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                ...
                                <p>This program has been specifically developed to provide you with a comprehensive knowledge of the AWS Security Architecture. It aims to empower you with the skills necessary to design, deploy, and manage security infrastructure on the AWS Cloud Platform. Starting from the basics of cloud computing, the program covers the essential AWS services architecture, particularly AWS Security.</p>
                            </div>
                            <div class="faq-wrapper">
                                ...
                                <div class="faq-item active open">
                                    ...
                                    <div class="faq-content">
                                        <p>AWS Architect - Associate (SAA-C03)</p>
                                        <ul>
                                        ...
                                        <p>AWS Certified Security - Specialty (SCS-C02)</p>
                                        <ul>
                                            <li>Threat Detection and Incident Response</li>
                                            <li>2: Security Logging and Monitoring</li>
                                            <li>3: Infrastructure Security</li>
                                            <li>4: Identity and Access Management</li>
                                            <li>5: Data Protection</li>
                                            <li>6: Management and Security Governance</li>
                                        </ul>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>Understand the security controls for AWS environments and workloads.</li>
                                            <li>Understand security logging and monitoring capabilities.</li>
                                            <li>Able to design and implement Identity and Access Management architecture.</li>
                                            ...
                                            <li>Learn the authentication of technical expertise to design, deploy and operate AWS applications.</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--/ faq item /-->
                                <div class="faq-item">
                                    <h3 class="faq-title"><span class="title">Exam Details</span><span
                                            class="right-icon"></span></h3>
                                    <div class="faq-content">
                                        <P>Since this is a combo course, there will be two different exams for AWS Certified Solutions Architect- Associate and AWS Certified Security – Specialty.</P>
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td width="150"><strong>Certification Name</strong></td>
                                                    <td width="330"><strong>AWS Certified Solutions Architect- Associate (SAA-C03) </strong></td>
                                                    <td width="260"><strong>AWS Certified Security - Specialty (SCS-C02)</strong></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="150">English, French, German, Italian, Japanese, Korean, Portuguese, and Simplified Chinese</td>
                                                    <td width="400">English, French, German, Italian, Japanese, Korean, Portuguese, Simplified Chinese, and Spanish.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            ...
                                            <li>3+ years of IT experience in job roles related to System Administration, Security, Network Administrators, Operations/DevOps Engineers, etc.</li>
                                            <li>Basic understanding of Virtualization fundamentals and Virtualization concepts</li>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-content">
                                        <ul>
                                            <li>Candidates with an understanding of IT security and Cybersecurity concepts.</li>
                                            ...
                                            <li>Anyone interested in gaining the AWS Security Specialty Certification.</li>
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            <div class="profile-desc">
                                ...
                                <p>Cloud Audit | CCSP | CCSK | CCAK | AWS CS-S | AWS CAN-S | AWS CSA-P | AWS CDE-P | MCT | CCAK | Azure Adv. Architect & Security | GCP PCA | GCP PCSE | CEH | RHCE</p>
                            </div>
                        </div>
                        <!--/ col end /-->
                        <!--/ col start /-->
        ...
        <section class="gladiators" id="reviews">
            <div class="container">
                ...
                <div class="swiper myGladiators">
                  ...
                  I enjoyed every bit of my training with InfosecTrain. The trainer was able to break to course down very well for easy understanding. I will definitely take another course from InfosecTrain.
                     ...
                     Jude Sarfo Debrah
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">The trainer’s mentorship in the AWS Security Specialty class was outstanding. Expert guidance, timely responses, and a deep understanding of the subject made the course highly beneficial.</p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">The AWS training session was excellent! I liked how you tailored the information to our particular requirements and offered useful advice and tactics that we could use right away in our work.</p>
                  ...
                  The trainer has been wonderful and made the learning process very easy. He emphasized on labs and covered all the topics even if he had to give extra time. Overall a great learning experience.
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div
                        ...
                        <div class="success-item">
                            <img src="assets/images/certificate.png" alt="AWS Combo ertificate" class="d-block m-auto img-fluid">
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="faq-wrapper">
                            <!--/ faq item /-->
                            <div class="faq-item active open">
                                <h3 class="faq-title"><span class="title">What are the prerequisites for the AWS Combo training course?</span><span
                                        class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>The prerequisites for the AWS Combo training course typically include:</p>
                                    <ul>
                                        <li>Knowledge of IT/Cyber Security Concepts</li>
                                        <li>More than a year of experience in IT security domains, preferably in job roles related to System Administration, Security, Network Administrators, Operations/DevOps Engineers, etc.</li>
                                        <li>Basic understanding of Virtualization fundamentals and Virtualization concepts</li>
                                        <li>Basic understanding of networking and OS concepts</li>
                                    </ul>
                                </div>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How long does the training course typically last?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>The AWS Combo training course is structured to be completed within a duration of approximately 60 hours.</p>
                                </div>
                            </div>
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Will I receive any certification upon completing the AWS Combo training course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Yes, upon completing the AWS Combo training course and clearing the certification exam, participants will receive certifications for both the Architect Associate and Security Specialty modules.</p>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the key topics covered in the Architect Associate module?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">What are the key topics covered in the Security Specialty module?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">Are there any hands-on exercises or labs included in the training course?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
                                    <p>Yes, along with the right kind of theoretical knowledge to achieve the certification, you will also receive hands-on experience working with cloud computing during this AWS combo training.</p>
                            ...
                            <!--/ faq item /-->
                            <div class="faq-item">
                                <h3 class="faq-title"><span class="title">How does this training course prepare participants for the AWS Architect Associate and Security Specialty exams?</span><span class="right-icon"></span></h3>
                                <div class="faq-content">
