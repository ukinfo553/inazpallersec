...
.counter_wrap{ opacity: 0; display: none;
 ...
 .offer_on .counter_wrap { background: #0a1b2a; float: left; width: 100%; text-align: center; height: 42px; line-height:38px;position: absolute; color: #fff;position: fixed;   z-index: 10000000;
    left: 0;
    top: 0;
...
.counter_wrap strong{ font-size: 20px; color: #f7ff1f; }
 ...
 .offer_head{font-weight: 600;}
 .divider{     width: 50px;    display: inline-block; }
</style> 
<div class="counter_wrap    "> <img src="https://www.infosectrain.com/wp-content/themes/Divi/images/gift3.png" />  <span class="offer_head">  Ramadan Offer - </span> <strong class="upto_50">upto 50% Off</strong> on our combo courses   <span class="divider">|</span>   OFFER ENDING In :<span id="countdown" data-time="Jun 04, 2019 23:59:00">

<span class="years dig"></span> <span class="me_y text">Y</span> 
    <span class="days dig"></span> <span class="me_d text">D</span> 
    <span class="hours dig"></span> <span class="me_h text">H</span>
    <span class="mins dig"></span> <span class="me_m text">M</span> 
    <span class="secs dig"></span> <span class="me_s text">S</span>
 
  </span>  <a href="#" class="grab_now">Grab Now</a>   <img src="https://www.infosectrain.com/wp-content/themes/Divi/images/gift4.png" />
<a class="close_counter" href="javascript:void(0)"  title="Close" >X</a>
</div> 
...
.pop_img{ background: url('https://www.infosectrain.com/wp-content/themes/Divi/images/popup3.jpg');
...
<div class="img_content"><!-- <h2 class="visible-mobile">Black Friday Offer</h2>-->
...
<strong>USD 899  </strong>
</li>
<li> <p class=" text-center">CEH + CYSA </p> 
<strong> USD 799</strong></li>

<li> <p class=" text-center">  CEH + CTIA</p>
<strong>USD 999  </strong></li>


<li> <p class=" text-center">CISSP + CISM </p>
<strong>USD 899  </strong></li>


<li> <p class=" text-center">CISSP + CCSP</p>
<strong>USD 899  </strong></li>


<li> <p class=" text-center">CISSP + CISA</p>
<strong>USD  899   </strong></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-6 col-lg-5">
        <h1 class="  heading1 " >CISSP</strong></h1>
        <p class="text-white p pb-0" >Instructor-Led Classroom & Online Training
          <span class="hr"></span></p>
         
         <div class="rows"   ><div class="testie_head" > <img src="<?php echo BASE_URL;?>assets/images/prabh2.png" class="d-inline img-v users" alt="Prabh Nair"> <a traget="_blank" href="https://www.linkedin.com/in/pcissp/" target="_blank"><i class="fa fa-linkedin"></i></a>  </div>
         <div class="ins_details  fadeInRight " > <div class="ins_head"><span>Instructor :</span> </div>
         <div class="ins_head"><span><strong>Prabh Nair</strong></span></div> 
                <p>  CISSP | CCSP | CISM |  CISA | CRISC</p></div></div>

      <p class="text-white text-left mt-2   " >  Certified security specialist having several years of experience in information security across all domains including application security, vulnerability assessment, ethical hacking, penetration testing, extensive security solutions, governance, risk & compliance and many more.</p>


<a href="CISSP_Certified_Trainers_profile.pdf" class="btn btn-profile   " target="_blank">  <img class="  d-inline-block align-middle"  src="<?php echo BASE_URL; ?>assets/images/pdf.png"  > PROFILE</a>
      </div>
     
      <div class="col-xs-12 col-md-6 col-lg-5 offset-lg-2">
        <div class="cir_head  fadeInRight " id="free_demo">
...
<div class="hide rows  mt-2" id="demo_form_output">  </div>
  ...
  <option selected="selected" value=" ">Your Country*</option>
    ...
    <option value="Other">Other</option>
                ...
                <button type="submit" name="me_submited" id="me_submited" value="submited" class="form-control btn btn-primary btn_submit  ">Reserve your seat Now</button> <div class="loading_w hide" id="loading_w"><img src="<?php echo BASE_URL; ?>assets/images/loader.gif"/></div>
...
<section class="container-fluid home_testimonials b3" id="reviews">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="head-home wow  fadeInDown "> Words of Praise<span><i></i></span></h2>
      </div>
    </div>
    ...
    <div class="item"  >
      ...
      <div class="item" >
        <div class="card">
          ...
          <p> <img src="<?php echo BASE_URL; ?>assets/images/cot.png" class="d-inline img-v  " alt="cot"> I want to express my deepest gratitude for Prabh Nair who helped me to pass CISSP exam. Prabh went the extra mile to assist me, and I have gained a significant benefit because of his knowledge and skills in Information Security. </p>
        </div>
      </div>
      <div class="item" >
        <div class="card">
          ...
          <p> <img src="<?php echo BASE_URL; ?>assets/images/cot.png" class="d-inline img-v  " alt="cot"> I would like to thank Prabh Nair for the enhanced training provided for my CISSP preparation.He has extensive knowledge in this topic a constant motivator and a brilliant person. </p>
        </div>
      </div>
      <div class="item"  >
        <div class="card">
          <h3 class="head_name">Fahim Asey <span>Network & Information Security Analyst </span></h3>
          <div class="testie_head"> <img src="<?php echo BASE_URL; ?>assets/images/fahim-asey.jpg" class="d-inline img-v users" alt="waypoint"> <a target="_blank" href="https://www.linkedin.com/in/fahim-asey-11275648/"><i class="fa fa-linkedin"  ></i></a> <img src="<?php echo BASE_URL; ?>assets/images/star5.png" class="d-inline img-v  " alt="star5"></div>
          <p> <img src="<?php echo BASE_URL; ?>assets/images/cot.png" class="d-inline img-v  " alt="cot"> I had the opportunity to take up my journey of becoming CISSP with Prahb Nair, a well-known Cybersecurity instructor, and a multi-talent information security architect. With his help and dedications, today I was able to crack the world most difficult exam, and successfully passed the CISSP test. </p>
        </div>
      </div>
      <div class="item">
        <div class="card">
          ...
          <div class="testie_head"> <img src="<?php echo BASE_URL; ?>assets/images/mohammed.jpg" class="d-inline img-v users" alt="waypoint"> <a target="_blank" href="https://www.linkedin.com/in/mohammed-islam-cissp-ccnp-ceh-74b09335/"><i class="fa fa-linkedin"  ></i></a> <img src="<?php echo BASE_URL; ?>assets/images/star5.png" class="d-inline img-v  " alt="star5"></div>
          <p> <img src="<?php echo BASE_URL; ?>assets/images/cot.png" class="d-inline img-v  " alt="cot"> I took class with Infosec. He is a very good Security expert and has lots of industry & training experience. He is very punctual about the class timing and explained everything and put extra time if some for slow students. </p>
        </div>
      </div>
      <div class="item">
        <div class="card">
          <h3 class="head_name">Shailesh Vishwakarma <span>   
          CSOC Monitoring in Deloitte, India</span></h3>
          ...
          <p> <img src="<?php echo BASE_URL; ?>assets/images/cot.png" class="d-inline img-v  " alt="cot"> I want to express my deepest gratitude for trainer who helped me to pass my exam. Trainer went the extra mile to assist me, and I have gained a significant benefit because of his knowledge and skills in Information...<br><br>
</p>
        </div>
      </div>
      <div class="item">
      ...
      <div class="item">
        <div class="card">
          ...
          <p> <img src="<?php echo BASE_URL; ?>assets/images/cot.png" class="d-inline img-v  " alt="cot">
           The way he teaches, the way he clears concepts.. you can feel the difference. Trainer dropped down to my level of understanding and then pulled me up! That is not what a “just teacher” does. Trainer never showed...<br> 
</p>
        </div>
      </div>
    </div>
...
<section class="container-fluid   bg2">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="head-home fadeInDown   " id="overview"  > CISSP Training Includes <span><i></i></span></h2>
      </div>
    </div>
    <div class="row " >
      ...
      <div class="col-md-3"> <span class="learning_mode wow   "  data-wow-duration="3s"> <img src="<?php echo BASE_URL; ?>assets/images/certification3.png"  >Certification  Exam</span> </div>
      <div class="col-md-3"> <span class="learning_mode wow   "  data-wow-duration="4s"> <img src="<?php echo BASE_URL; ?>assets/images/certification4.png"  > Course Completion  Certificate</span> </div>
    </div>
  </div>
</section>
<section class="container-fluid   bg2 course_wrap">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="head-home"  > CISSP Course Content / Exam(s) <span><i></i></span></h2>
      </div>
    </div>
...
<div class="tabs new_tab ">
        <ul class="tab-links">
          <li class="active"><a href="#tab1">  About CISSP</a></li>
          <li><a href="#tab2">Course Content  </a></li>
          <li><a href="#tab3">Who Should Attend </a></li>
          <li><a href="#tab4">Pre-Requisite </a></li>
          <li><a href="#tab5">Exam Information </a></li>
        </ul>
        <div class="tab-content course_details">
          <div id="tab1" class="tab active">
            <h3 class="tab_head"  >About CISSP</h3> 
...
<p>It is approved by the U.S. Department of Defense (DoD) in both their Information Assurance Technical (IAT) and Managerial (IAM) categories.</p>
 <strong>Package inclusive of:</strong>  
       <ul> 
<li>Free demo session   </li>
<li>Instructor led live training    </li>
<li>(ISC)² CBK 2018 based exam notes    </li>
<li>Practice Tests    </li>
<li>Course completion certificate    </li>
<li>Support after the training   </li>
<li>Assessment during Training    </li>
<li>Mind mapping</li></ul> 
      </div> <div class="col-md-3 ">
              <img src="assets/images/ceh.jpg" align="right" class="d-inline-block ml-3 img-fluid">
          </div></div>
                       </div>
...
<li>Network Architect</li>
          ...
          <div id="tab4" class="tab "><h3 class="tab_head">Pre-Requisite</h3>
            <div class="tab_content"><p>To apply for the CISSP course certification, you need to:</p>
...
<li>One-year experience waiver can be earned with a 4-year college degree, or regional equivalent or additional credential from the (ISC)² approved list</li></ul>
          ...
          <div id="tab5" class="tab ">
            ...
            <div class="tab_content"> 
<ul><li>Duration : <strong>3 Hours</strong></li><li>Number of questions: <strong>150</strong></li><li>Question format: <strong>Multiple Choice</strong></li><li>Passing marks: <strong>700 out of 1000</strong></li><li>Exam language: <strong>English, French, German, Brazilian, Portuguese, Spanish, Japanese, Simplified Chinese, Korean, Visually Impaired</strong></li><li>Delivery Method: <strong>CAT</strong></li></ul>
...
<section class="container-fluid   bg2 " >
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="head-home" id="trainers"  >CISSP Classroom Training Calendar <span><i></i></span></h2>
      </div>
    </div>
...
<div class="rows" id="training-calendar" >
  ...
  <thead>
    ...
    <td>CISSP  Classroom Training</td>
     <td >5 days</td>
    ...
    <td >16 Aug 2019</td>
     <td >09:00 (IST) - 18:00 (IST)</td>

<td bgcolor="#ffb6c7"><font color="green"><strong>  [ OPEN ]</strong></font></td>
    <!--<td bgcolor="#ffb6c7"><font color="red"><strong>  [ Close ]</strong></font></td>
                                    <td ><button href="#free_demo" class="btn-danger btn href_toscroll" disabled>Enroll Now</button></td>-->
<td ><a href="#free_demo" class="btn-danger btn href_toscroll">Enroll Now</a></td>
  </tr>
...
<section class="container-fluid   bg2 " >
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="head-home" id="trainers"  >CISSP Instructor-Led  Online Training   Calendar <span><i></i></span></h2>
      </div>
    </div>
 ...
 <td bgcolor="#ffb6c7"><font color="red"><strong>  [ Close ]</strong></font></td>
    ...
    <div class="row" id="infosectrain">
      <div class="col-md-12 mt-3">
        <h2 class="head-home"  > Why Infosec Train <span><i></i></span></h2>
      </div>
    </div>
    <div class="row mb-5" >
      <div class="col-md-3"> <span class="learning_mode"  > <img src="<?php echo BASE_URL; ?>assets/images/industry.png"  > Learn from Industry Experts</span> </div>
      <div class="col-md-3"> <span class="learning_mode" > <img src="<?php echo BASE_URL; ?>assets/images/support.png"  > Post Training Support</span> </div>
      <div class="col-md-3"> <span class="learning_mode"  data-wow-duration="3s"> <img src="<?php echo BASE_URL; ?>assets/images/programs.png"  > Certification Focused Programs</span> </div>
      <div class="col-md-3"> <span class="learning_mode"  data-wow-duration="4s"> <img src="<?php echo BASE_URL; ?>assets/images/flexible-schedule.png"  > Flexible Schedule</span> </div>
    </div>
  </div>
</section>
...
<section class="container-fluid   bg2 " >
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="head-home" id="trainers"  >Other Popular Courses<span><i></i></span></h2>
      </div>
    </div>
...
<img src="https://www.infosectrain.com/wp-content/uploads/2018/12/cisa.png">
...
<div class="col-md-3"> <div class="c_wrapper"><a href="#">
<img src="https://www.infosectrain.com/wp-content/themes/Divi/images/corporate/cism.png">
...
<div class="col-md-3"> <div class="c_wrapper"><a href="#">
<img src="https://www.infosectrain.com/wp-content/themes/Divi/images/corporate/ceh.png">
<div class="c_name">CEH (v10) - Certified Ethical Hacker  </div>
</a><a href="https://www.infosectrain.com/pages/lp/ceh/" target="_blank" class="s_demo"><i>Explore More</i></a></div> </div>
<div class="col-md-3"> <div class="c_wrapper"><a href="#">
<img src="https://www.infosectrain.com/wp-content/themes/Divi/images/corporate/security.png">
...
<section class="container-fluid   bg2">
  <div class="container">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-3"> <a href="" class="learning_mode wow   "  data-wow-duration="3s"> <img src="<?php echo BASE_URL; ?>assets/images/on-demand.png"  > On-Demand </a> </div>
      <div class="col-md-3"> <a href="" class="learning_mode wow   "  data-wow-duration="4s"> <img src="<?php echo BASE_URL; ?>assets/images/onsite.png"  > Onsite </a> </div>
    </div>
  </div>
</section>
<?php include('include/footer.php');?>
<script src="https://www.infosectrain.com/wp-content/themes/Divi/js/countdown.js"></script>
