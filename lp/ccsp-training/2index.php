      ...
      <nav class="navbar navbar-expand-lg navbar-dark p-0">
                        ...
                        <div class="collapse navbar-collapse" id="nav_btn">
                            <ul class="navbar-nav ml-auto text-uppercase">
                                ...
                                <li class="nav-item"><a class="nav-link href_toscroll" href="#benefit">Course Benefits</a></li>
      ...
      <div class="col-12 col-md-6 col-lg-6 col-xl-8">
        <div class="left_banner">
            <div class="b_test_box">
                <h1 class="b_com">Kickstart a wonderful career in cloud security <br>and benefit from<strong> upto 50% higher salaries</strong></h1>
                <h1 class="e_hacker">Certified Cloud <br>Security Professional</h1>
...
<section id="coursecontent">
    <div class="container">
        <div class="row">
            <div class="col-12">               
               <h2 class="package-heading">CCSP Certification Includes</h2>
            </div>
        </div>
        ...
        <div class="row">
          <div class="col-12 col-lg-6">
              ...
              <img src="assets/img_2/CCSP-landing.png" width="100%" alt="" class="">
          ...
          <div class="col-12 col-lg-6 mt-lg-0 mt-4">
			...
			<div class="certification_box">
                        ...
                        <p class="adv-p">Official & Structured <br>Courseware</p>
            </div>
			</div>
			...
			<div class="certification_box">
                        ...
                        <p class="adv-p">Certification<br> Exam</p>
            </div>
			</div>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Course Overview</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Course Content</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Course Objectives</a>
  </li>
    <li class="nav-item">
...
<div class="tab-content" id="myTabContent">
  ...
  <div  class="tab_content"> 
            <img src="assets/img_2/ccsp.jpg" align="right" class="d-inline-block ml-3">
                       <p>In this constantly evolving and not to forget extremely competing world of cloud, one faces unique security challenges on almost day-to-day basis with regards to unaccustomed threats to sensitive data or a less equipped internal team.</p><p>CCSP certification&nbsp;course at InfosecTrain targets to pass on the&nbsp;understanding of information, cyber, software and cloud computing infrastructure security. Explaining the cloud computing concepts, cloud reference architecture, cloud computing security concepts and cloud services are the focus area of the Certified Cloud Security Professional&nbsp;course delivery.</p><p>Therefore, an earned CCSP certification helps you prove to yourself and your employers about the in-depth knowledge, understanding and hands on experience that you have achieved with cloud security architecture, design, operations and service orchestration.</p>
  ...
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
   ...
   <div  class="tab_content"> <ul class="ulclass"><li><strong>Domain 1.</strong> Cloud Concepts, Architecture  and Design <strong>(17%)</strong></li>
  <li><strong>Domain 2.</strong> Cloud Data Security <strong>(19%)</strong></li>
  <li><strong>Domain 3.</strong> Cloud Platform &amp;  Infrastructure Security <strong>(17%)</strong></li>
  <li><strong>Domain 4.</strong> Cloud Application Security <strong>(17%)</strong></li>
  <li><strong>Domain 5.</strong> Cloud Security Operations <strong>(17%)</strong></li>
  <li><strong>Domain   6.</strong> Legal, Risk and Compliance <strong>(13%)</strong></li>
  </ul></div>
   <!------------------------------------------>
  </div>
  ...
  <!-- <h3 class="tab_head">Course Objectives </h3>-->
         <div  class="tab_content"> <p>After completing this course, you will be able to:</p>
<ul class="ulclass">
...
<div class="tab_content"><p>This CCSP training is suitable for experienced IT personnel who are involved with:</p>
<ul class="ulclass">
<li>Information security</li><li>Risk and compliance</li><li>Security engineering</li><li>Governance</li><li>IT auditing or IT architecture</li></ul></div>
    <!------------------------------------------>
   </div>
 ...
 <!--  <h3 class="tab_head">Exam Information</h3>-->
            <div class="tab_content"> 
			<ul class="ulclass"><li><strong>Duration</strong> : 3 Hours</li>
			<li><strong>Number of questions:</strong> 125</li>
			<li><strong>Question format:</strong> Multiple Choice</li>
			<li><strong>Passing marks:</strong> 700 out of 1000</li>
			<li><strong>Exam language:</strong> English, French, German, Brazilian, Portuguese, Spanish, Japanese, Simplified Chinese, Korean, Visually Impaired</li></ul></div> 
    <!------------------------------------------>
   </div>
...
<section id="benefit">
  <div  class="container" id="benefits">
        <div class="row">
            <div class="col-12">
               <h2 class="package-heading">CCSP Course Benefits</h2>
            </div>
        </div>
...
<div class="row">
  ...
  <div class="row text-center"> 
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0"><img src="assets/img_2/NoPath2x.png" alt="" class="img-fluid mb-3 anal"></div>
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0"><img src="assets/img_2/NoPath2_sx.png" alt="" class="anal img-fluid "></div>
   </div>
    </div>
    <div class="tab-pane fade" id="cybersecurity" role="tabpanel" aria-labelledby="Cybersecurity">
    <div class="row text-center"> 
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0"><img src="assets/img_2/NoPath2x.png" alt="" class="anal img-fluid mb-3"></div>
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0 "><img src="assets/img_2/NoPath2_sx.png" alt="" class="anal img-fluid"></div>
   </div>
...
<section id="table_section">
   ...
   <div class="table-responsive ">   <table  class="tablepress table table-striped table-bordered table_training " style="overflow: hidden;">
     <thead class="row-hover">
       <tr class="row-1">
         <th class="column-0" data-label="Course Name" width="250">Course Name</th>
         <th class="column-1" data-label="Start Date">Start Date</th>
         <th class="column-2" data-label="Start/End Time"> End Date</th>
         <th class="column-3" data-label="Start/End Time">Start/End Time</th>
         <th class="column-4" data-label="Batch Type">Batch Type</th>
         <th class="column-5" data-label="Training Mode  ">Training Mode </th>
         <th colspan="2" class="column-6" data-label="Batch Status">Batch Status</th>
         </tr>
   </thead>
         <tbody class="row-hover">   
         <tr class="row-2">      
         <td class="column-0" data-label="Course Name">CCSP</td>
         <td class="column-1" data-label="Start Date">28 Aug 2021</td>
         <td class="column-2" data-label="End Date">03 Oct 2021</td>
         <td class="column-3" data-label="Start/End Time"> 19:00   - 23:00  (IST)</td>
         <td class="column-4" data-label="Batch Type">Weekend</td>
         <td class="column-5" data-label="Training Mode  ">Online </td>
          <td class="column-6" data-label="Batch Status">   <font color="red"><strong> [ Close ]</strong></font> </td>
         <td> </td>
       </tr>
<tr class="row-2">      
         <td class="column-0" data-label="Course Name">CCSP</td>
         <td class="column-1" data-label="Start Date">16 Oct 2021</td>
         <td class="column-2" data-label="End Date">28 Nov 2021</td>
         <td class="column-3" data-label="Start/End Time"> 09:00   - 13:00  (IST)</td>
         <td class="column-4" data-label="Batch Type">Weekend</td>
         <td class="column-5" data-label="Training Mode  ">Online </td>
          <td class="column-6" data-label="Batch Status">
   
   <font color="green"><strong> [ Open ]</strong></font>           </td>
         <td> <a href="#free_demo" data-text="Request For Batch | Certified Cloud Security Professional (CCSP) Online Training &amp; Certification Course | 16 Oct 2021 | 28 Nov 2021 | 09:00 | 13:00 | Weekend | Online   " data-type="individual" class="btn-danger btn href_toscroll training_cal_courses  href_toscroll">Enroll</a></td>
       </tr>
     </tbody>
    ...
    <div class="row">
			...
			<div class="col-lg-3 mt-lg-0 mt-4">
				<div class="certification_box2">
							...
							<p class="adv-p"><strong>Versatile Skills</strong></p>
			...
			<div class="col-lg-3 mt-lg-0 mt-4">
				<div class="certification_box2">
							...
							<p class="adv-p">On average, (ISC)² members report earning 35% more than non-members.</p>
				</div>
			</div>
...
<section id="fastfacts_section">
  <div class="container">
    <div class="row">
      <div class="col-12 wow fadeInLeft">
        <h2 class="package-heading">Fast Facts About CCSP</h2>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
      <center>
	  <img src="assets/img_2/fast_facts_h.svg" width="100%" align="middle" class="content-desktop" style="text-align:center;">
            ...
            <div class="col-12">
                <div class="advisor_box_con">
					...
					Certified security specialist having several years of experience in information security across all domains including application security, vulnerability assessment, ethical hacking, penetration testing, extensive security solutions, governance, risk & compliance and many more.
                        ...
                        <p class="adv-p">CISSP | CCSP | CSSLP | CRISC | CISM | CISA | CGEIT</p>
                    </div>
                    <div class="advisor_box">
					<div class="box_coma">"</div>
					<p style="margin-top: -30px;">
					Krish is a senior technical consultant and passionate trainer. He has more than 15 years of experience in various IT domains including Cloud Computing, Security, Linux & Infrastructure Design. He has trained almost 400+ professionals worldwide on various IT domains.</p>
                    <h4 class="adv-h">Krish</h4>
                    <p class="adv-p">CCSP | MCT | Azure Sec | Azure Admin | AWS Sec | MCTS | MCSA</p>
                    </div>
                    <div class="advisor_box">
					<div class="box_coma">"</div>
					<p style="margin-top: -30px;">
					Prashant is an adept professional in Information Security with more than 1 0 years of experience. He has experience of assessing security for versatile domains like financial institutes and in client-based industries.<br /></p>
                    <h4 class="adv-h">Prashant</h4>
                    <p class="adv-p">CCSP | CISSP</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/Shiv_Kumar.png" alt=""  class="p_image">
					...
					My Trainer is an exceptional trainer I have seen in Information Security Getting trained for course under him was the right decision made He is very patient and hardworking trainer who delivers security concepts...
                        ...
                        <h4 class="adv-ho">Shiv Kumar</h4>
                        <p class="adv-p">CCSP | INDIA</p>
                    </div>
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/JineshRajan.png" alt="" class="p_image">
                          </div>
					<p style="">
					I tcok class with Infosec. He is a very good Security expert and has lots of industry & training He is very punctual about the class timing and explained everything and put extra time if some for slow students.
                        ...
                        <h4 class="adv-ho">Jinesh Rajan</h4>
                        <p class="adv-p">CCSP | India</p>
                    </div>
					...
					<div class="advisor_box">
					 <div class="prof-img">
                            <img src="assets/img_2/LijoThottan.png" alt="" class="p_image">
					...
					The way he teaches. the way he clears concepts you can feel the difference. The trainer dropped down to my level of understanding and then pulled me up! That is not what a just teacher" does Trainer never showed
                        ...
                        <h4 class="adv-ho">Lijo Thottan</h4>
                        <p class="adv-p">CCSP | UAE</p>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row mt-4 wow fadeInUp">
            <div class="col-md-6 col-lg-3">
                <div class="c_box">
                    <a href="https://www.infosectrain.com/pages/lp/cisa/" class="link_box">
...
<p>� 2020- Infosec Train. All Rights Reserved. </p>

</div>   <div class="col-xs-12 col-md-3">
 <h3>Quick Contact    </h3>
 
     <div class="list_quick"><a href="https://api.whatsapp.com/send?phone=918767256840" target="_blank"><img src="https://www.infosectrain.com/pages/lp/soc-expert/assets/images/whats2.png"  class="d-inline img-v " > <span>+91-87672-56840</span></a><br>
       
             <a href="tel:+91-8767256840"><img src="assets/img/phone.png" class="d-inline img-v"> <span>+91-87672-56840</span> </a><br>
             <a href="tel:+1 657-207-1466"><img src="assets/img/phone.png" class="d-inline img-v"> <span>+1 657-207-1466</span> </a><br>
           
            <a href="mailto:sales@infosectrain.com"><img src="assets/img/email.png" class="d-inline img-v mr-2"> <span> sales@infosectrain.com</span></a></div>
...
<div class="social ">
          ...
          <p>99 Wall Street #599 New York,<br> NY 10005, United States </p>
          <div class="list_quick"> <a href="tel:+1 657-207-1466"><img src="assets/img/phone.png" class="d-inline 2img-v"><span> +1 657-207-1466</span></a></div>
