      ...
      <div class="col-12 col-md-6 col-lg-6 col-xl-8">
        <div class="left_banner">
            <div class="b_test_box">
                <h1 class="b_com">Cloud computing is estimated to grow at a rate of <strong>6.5 times</strong> <br>annually and its demand will grow by <strong>24% through 2021</strong></h1>
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-lg-6">
              ...
              <img src="assets/img_2/CCSP-landing.webp" width="100%" alt="" class="">
          ...
          <div class="col-12 col-lg-6 mt-lg-0 mt-4">
			...
			<div class="certification_box">
                        ...
                        <p class="adv-p">48 hours of instructor <br />led training</p>
            </div>
			</div>
...
<div class="tab-content" id="myTabContent">
 ...
 <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/InfosecTrain_Certified_Cloud_Security_Professional_CCSP_Course_Content.pdf" target="_blank" class="btn btn-outline-primary float-left f20"> <img src="https://www.infosectrain.com/wp-content/themes/Divi/assets/images/download.png"> Download Syllabus </a>
</div>
   <!------------------------------------------>
  </div>
...
<div class="row">
  ...
  <div class="row text-center"> 
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0"><img src="assets/img_2/NoPath2x.webp" alt="" class="img-fluid mb-3 anal"></div>
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0"><img src="assets/img_2/NoPath2_sx.webp" alt="" class="anal img-fluid "></div>
   </div>
    </div>
    <div class="tab-pane fade" id="cybersecurity" role="tabpanel" aria-labelledby="Cybersecurity">
    <div class="row text-center"> 
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0"><img src="assets/img_2/NoPath2x.webp" alt="" class="anal img-fluid mb-3"></div>
    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0 "><img src="assets/img_2/NoPath2_sx.webp" alt="" class="anal img-fluid"></div>
   </div>
                ...
                <div class="advisor_box_con">
					...
					<p class="course_h">
					 Certified Security specialist having several years of experience in Information Security across all domains including application security, vulnerability assessment, ethical hacking, pen testing and IT risk and compliance and more
                        ...
                        <p class="adv-p">CISSP, CCSP, CSSLP, CRISC, CISM, CISA, CGEIT
CISSP | CCSP | CSSLP | CRISC | CISM |  CISA | CGEIT</p>
                    </div>
                    <div class="advisor_box">
					<div class="box_coma">"</div>
					<p class="course_h">
                    ...
                    <h4 class="adv-h" style="">Krish</h4>
                    <p class="adv-p">CCSP | CCSK | AWS-Sec | AWS CSA-P | MCT | Azure Sec | CEH | MCTS</p>
                    </div>
                    <div class="advisor_box">
					<div class="box_coma">"</div>
					<p class="course_h">
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/Shiv_Kumar.webp" alt=""  class="p_image">
                            
                    </div>
					<p style="">
					CCSP training by Instructor was really helpful to understand the cloud concepts, it was made easier during the training with the help of examples.
					</p>
                        <h4 class="adv-ho">Shiv Kumar</h4>
                        <p class="adv-p">CCSP </p>
                    </div>
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/JineshRajan.webp" alt="" class="p_image">
                          </div>
					<p style="">
				Was great session from Instructor, he is really knowledgeable and passionate about teaching
					</p>
					...
					<div class="advisor_box">
					 <div class="prof-img">
                            <img src="assets/img_2/arpita.webp" alt="" class="p_image">
                           
                          </div>
					<p style="">
					Instructor is very good exposure in cloud enviroment he gave us a clear under understanding in each topic.
					</p>
                        <h4 class="adv-ho">Arpita Agrawal</h4>
                        <p class="adv-p">CCSP  </p>
                    </div>
          ...
          <div class="advisor_box">
           <div class="prof-img">
                            <img src="assets/img_2/dipen.webp" alt="" class="p_image">
                           
                          </div>
          <p style="">
         It was an awesome experience. The trainer is knowledgeable in his area.
          </p>
                        <h4 class="adv-ho">Dipen Das</h4>
                        <p class="adv-p">CCSP  </p>
                    </div>
