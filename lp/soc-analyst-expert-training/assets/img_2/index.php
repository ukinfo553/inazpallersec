      ...
      <nav class="navbar navbar-expand-lg navbar-dark p-0">
                        ...
                        <div class="collapse navbar-collapse" id="nav_btn">
                            <ul class="navbar-nav ml-auto text-uppercase">
                                ...
                                <li class="nav-item active"><a class="nav-link href_toscroll" href="#socanalyst">Course Content</a></li>                                
...
#learmode .certification_box3 .adv-p1 { text-align: center; font:normal normal 16px Poppins; color: #989696;min-height: 130px;}
...
#learmode .certification_box3 {background-color: #F4F3F3;box-shadow: 0px 9px 16px #0000001A;border-radius: 24px; padding: 40px;border: 2px solid #DEDEDE;transition: all .3s; margin-bottom: 35px;text-align: center;margin-left: 20px;margin-right: 20px;min-height: 450px;}
    ...
    <div class="container" id="benefits">
        <div class="row">
            <div class="col-12">
             ...
             <div class="col content-desktop" ><img src="assets/img_2/tool1.png" style="width:100%;"></div>
             <div class="col content-desktop"><img src="assets/img_2/tool2.png" style="width:100%;"></div>
             <div class="col content-desktop"><img src="assets/img_2/tool3.png" style="width:100%;"></div>
             <div class="col content-desktop"><img src="assets/img_2/tool4.png" style="width:100%;"></div>
             <div class="col content-desktop"><img src="assets/img_2/tool5.png" style="width:100%;"></div>
             <div class="col content-desktop"><img src="assets/img_2/tool6.png" style="width:100%;"></div>
             <div class="col content-desktop"><img src="assets/img_2/tool7.png" style="width:100%;"></div>
             <div class="col content-desktop"><img src="assets/img_2/tool8.png" style="width:100%;"></div>
...
<section id="learmode">
  ...
  <g id="Group_11940" data-name="Group 11940" transform="translate(468 44.25)">
    ...
    <path id="Path_26019" data-name="Path 26019" d="M-282.419,202.568a3.305,3.305,0,0,1-3.186-3.122,3.426,3.426,0,0,1,3.366-3.382,3.221,3.221,0,0,1,3.152,3.258A3.329,3.329,0,0,1-282.419,202.568Z" transform="translate(-122.673 -161.628)" class="so2"/>
                            ...
                            <a href="#free_demo" class="btn ler-btn btn-center href_toscroll" data-target="#get_started">GET STARTED</a>
				</div>
         </div>  
  ...
  <g id="Group_11939" data-name="Group 11939" transform="translate(482.25 74.25)">
    ...
    <path id="Path_26011" data-name="Path 26011" d="M-308.3,67.422c0-2.419-.079-4.841.046-7.253A3.542,3.542,0,0,1-307.245,58c.7-.676,1.6-.263,2.365.245,3.678,2.458,7.369,4.9,11.039,7.365,1.735,1.167,1.751,2.647.033,3.8-3.7,2.5-7.4,4.994-11.168,7.391a2.633,2.633,0,0,1-2.23.227,2.692,2.692,0,0,1-1.046-1.987C-308.374,72.508-308.3,69.963-308.3,67.422Zm4.025-4.035v8.273l6.207-4.14Z" transform="translate(-116.857 -88.616)" class="so2"/>
                            ...
                            <a href="#free_demo" class="btn ler-btn btn-center mt-4 href_toscroll" data-target="#enroll_now">ENROLL NOW</a>
				</div>
         </div>
  ...
  <g id="Group_11943" data-name="Group 11943" transform="translate(510 77.226)">
    ...
    <path id="Path_26029" data-name="Path 26029" d="M-338.641,105.237a6.656,6.656,0,0,1-4.105-1.795,2.058,2.058,0,0,1-.388-2.935,2.051,2.051,0,0,1,2.942-.3c1.848,1.228,2.756,1.225,4.632-.014a2.057,2.057,0,0,1,2.942.324,2.116,2.116,0,0,1-.419,2.943C-334.229,104.582-335.96,105.221-338.641,105.237Z" transform="translate(-105.208 -111.873)" class="so2"/>
                            ...
                            <a href="#free_demo" class="btn ler-btn btn-center href_toscroll" data-target="#contact_us">CONTACT US</a>
				</div>
         </div>    
                	...
                	<div class="row">
  						<div class="col-md-7 soc_trainer_bg">
                           <div class="soc_trainerdetail">
                                ...
                                <ul>
                                <li>Delivered more than 150 training programs yearly, with 3000+ students overall.</li>
                                <li>Excellent track record on exam success rate for students.</li>
                                <li>Performed Internal and External Vulnerability Assessment & Penetration Test.</li>
                                </ul>
                           </div>      
  						</div>
...
<section id="profile_card">
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<div class="prof-img">
                            <img src="https://www.infosectrain.com/wp-content/uploads/2020/12/raman.s.g-150x150.jpg" alt=""  class="p_image">                    </div>
					<p class="wordof_p">
    ...
    I liked the in-depth knowledge about the subject of the trainer, good explanation, highlighting essential things! Instructor allowed plenty of time for discussion and allowing us to ask questions. It was well delivered.  
                        ...
                        <h4 class="adv-ho"> Shiva Raman Garimela </h4>
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="https://www.infosectrain.com/wp-content/uploads/2020/12/kamalpasha-150x150.jpg" alt="" class="p_image">                          </div>
					<p class="wordof_p">
					 
    Highly satisfied with the content as well as the knowledge shared during the course.  
					</p>
                        <h4 class="adv-ho"> Kamal Pasha </h4>
					...
					<div class="advisor_box">
					 <div class="prof-img">
                            <img src="https://www.infosectrain.com/wp-content/uploads/2020/12/ajithd272-150x150.jpg" alt="" class="p_image">                          </div>
					<p class="wordof_p">
					 
    I got the best trainer, who taught us everything about the subject as well as, gave more knowledge beside the subject.  
					</p>
                        <h4 class="adv-ho">Ajith R Dsouza </h4>
