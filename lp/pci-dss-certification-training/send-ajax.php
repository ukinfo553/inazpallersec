                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/pci-dss-implementer-interview-questions/" target="_blank">PCI-DSS Implementer Interview Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/pci-dss-scenario-based-interview-questions/" target="_blank">PCI DSS Scenario-Based Interview Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/requirements-and-controls-of-the-pci-dss-standard/" target="_blank">Requirements and Controls of the PCI-DSS Standard</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-5-data-privacy-laws/" target="_blank">Top 5 Data Privacy Laws</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/1oqM3utqiog?si=ya257yJp3IdDzv6K">Introduction to PCI-DSS</a></li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://youtu.be/0FMjKg7pNpA?si=824Ii3jJM8ZYSFJJ">PCI-DSS Compliance Roadmap</a></li>
                        </ul>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
							<ul>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/sailpoint-training/">Sailpoint IdentityIQ Implementation Training</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cissp-certification-training/"> CISSP Certification Training 2024</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/cism-certification-training/">CISM Certification Training</a>
                                </li>
                                <li>
                                    <a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/courses/ccsp-certification-training/">CCSP Certification Training</a>
                                </li>
                            </ul>
