...
$courseID = 30835;  // Change this to the specific course ID for different pages
                            ...
                            <form method="post" action="" onSubmit="return val_demo_request(this.form);"
                                ...
                                <div class="loading_w hide" id="loading_w">
                                    <img src="<?php echo BASE_URL; ?>assets/images/loader.gif" loading="lazy"
                                        class="d-block" style="margin: 1rem auto 0;">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                CIPP/E | CISSP | Ex PCI QSA | Ex PCI QPA | Ex PCI SSA | ISO 27001 LA | ISO 27001 LI
                            </div>
                            <div class="summary">
                                Akshay is a seasoned Information Security professional with over 10 years of experience, specializing in PCI standards, ISO frameworks, data privacy, and regulatory compliance. As a Principal Architect, he brings technical depth and strategic vision to security architecture, risk assessments, and privacy programs. Akshay holds certifications such as CIPP/E, CISSP, ISO 27001 LA, and has previously served as a PCI QSA, QPA, and SSA. His expertise spans BFSI, E-commerce, IT/ITES, and more, with a proven track record in presales, audits, and consulting.
                            </div>
                        </div>
                        <!--/ col start /-->
                ...
                <div class="swiper myGladiators">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The company has excellent teachers that have practical experience in the market, and
                                this really helps the students to understand more because the teachers are teaching what
                                is available in the market. The Course will help me to develop my career in the payment
                                industry ecosystem and also to understand the risks associated with payment systems.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                I gained good knowledge from the PCI-DSS training workshop that I attended at
                                InfosecTrain. It was by far one of the most nicely trained courses. The trainer was very
                                knowledgeable about the subject. Thanks a ton!
                            </p>
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The PCI-DSS training at InfosecTrain was really good and introspective. The trainer was
                                good at explaining the course and he made it easily understandable.
                            </p>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <p class="desc">
                                The PCI-DSS training was really good. The trainer was very cooperative and resolved all
                                of our queries in a great way.
                            </p>
                    ...
                    <div class="col-md-6">
                        <div class="item-two">
                            ...
                            <div class="loading_w hide" id="loading_w_footer"><img
                                    src="<?php echo BASE_URL; ?>assets/images/loader.gif" class="d-block mx-auto mt-2"
                                    style="
    margin: 1rem auto 0;
" />
                            </div>
