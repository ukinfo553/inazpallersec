...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "New Enquiry from Advanced in AI Audit (AAIA) Certification Training Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/ai-auditing-tools-and-techniques/" target="_blank">AI Auditing Tools and Techniques</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/types-of-ai-controls/" target="_blank">Types of AI Controls</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/change-management-in-ai/" target="_blank">Change Management in AI</a></li>
                    ...
                    <tr>                        <td style="color: #414547; padding-left: 24px;padding-top:10px;font-family: Arial, Helvetica, sans-serif;font-size: 18px;">
                        ...
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/cisa-certification-training/"  target="_blank"> CISA Certification Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/aigp-training/"  target="_blank"> IAPP AIGP Certification Training</a> </li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/isaca-advanced-in-ai-security-management-aaism-certification-training/"  target="_blank"> Advanced in AI Security Management (AAISM) Certification Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/iso-iec-42001-lead-auditor-training/"  target="_blank"> ISO/IEC 42001:2023 Lead Auditor Training</a> </li>
                        </ul>                        </td>
                    </tr>
                    ' . $email_footer . '
                </table>
