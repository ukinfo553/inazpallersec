  ...
  <div class="container py-2">
      <nav class="navbar navbar-expand-lg navbar-dark p-0">
                        <a class="navbar-brand" href="https://www.infosectrain.com" alt="infosectrain">
                          <img src="assets/img/logo_1.png"></a>
      ...
      <div class="col-12 col-md-6 col-lg-6 col-xl-7">
        <div class="left_banner">
            <div class="b_test_box">
                ...
                <h1 class="e_hacker"><font class="topline">CISM Exam PREP </font> <br> Online Training </h1>
                <h2 class="e_council">
                <ul>
                ...
                <img src="assets/img_2/cism-accredited-training-provider.png" class="d-block mb-5"/>
                <div class="price_col">
...
<section id="coursecontent" class="py-5">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="package-heading">CISM Training Package Includes </h2>
      </div>
    </div>
      ...
      <section id="section1" role="tabpanel" aria-labelledby="tab1" class="tabs-panel js-tabs-panel" tabindex="0">
        ...
        <div class="content" aria-hidden="false">
         <div  class="tab_content">
            <img src="assets/img_2/isaca.png" align="right" alt="isaca|cism" class="d-inline-block ml-3 mb-3 img-fluid">
            <p>
...
<li>Information Security Incident Management</li>
        ...
        <div class="content" aria-hidden="true">
         <div class="tab_content">
            ...
            <li><strong>Passing marks</strong> : 450 out of 800</li>
            <li><strong>Exam language </strong>: English, Japanese, Korean, Spanish</li>
          </ul>
        </div>
        </div>
      </section>
      ...
      <div class="container">
        <div class="row justify-content-center position-relative" style="box-shadow: 0 2px 8px 0 rgb(0 0 0 / 10%);background:#fff;border-radius:10px;">
          <div class="col-md-12 text-center py-4 text-white syllabusD">
                <h2>Become an expert in CISM</h2>
                ...
                <div class="d-flex flex-wrap justify-content-center">
                  ...
                  <a href="https://www.infosectrain.com/wp-content/uploads/2018/12/CISM_Training_v2_Course_content.pdf" target="_blank">Download Syllabus </a>
                </div>
            </div>
          </div>
      </div>
...
<section id="benefit">
  <div  class="container" id="benefits">
        <div class="row">
            <div class="col-12">
               <h2 class="package-heading">CISM Designation & Job Roles</h2>
            </div>
        </div>
          ...
          <div class="col-12 py-4 mt-4" style="background:#fff; box-shadow: 0 2px 11px 0 rgba(0, 0, 0, .11);border-radius:10px;">
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="audit" role="tabpanel" aria-labelledby="Audit">
                  <div class="row justify-content-center">
                    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0 text-center">
                      <img src="assets/img_2/imz.jpg" alt="cism Annual Salary" class="img-fluid mb-4 d-block mx-auto">
                      <strong>Annual Salary</strong>
                    </div>
                    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0 text-center">
                      <img src="assets/img_2/cism-systems-analyst-c.png" alt="cism Hiring Companies" class="img-fluid mb-4 d-block mx-auto">
                ...
                <div class="tab-pane fade" id="cybersecurity" role="tabpanel" aria-labelledby="Cybersecurity">
                  <div class="row text-center">
                    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0">
                      <img src="assets/img_2/Cybersecurity-Engineer.jpg" alt="cism Annual Salary" class="img-fluid mb-4 d-block mx-auto">
                      <strong>Annual Salary</strong>
                    </div>
                    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0 ">
                      <img src="assets/img_2/cism-security-manager-c.png" alt="cism Hiring Companies" class="img-fluid mb-4 d-block mx-auto">
                      <strong>Hiring Companies</strong>
                    </div>
                  </div>
                </div>
                <div class="tab-pane fade" id="internal" role="tabpanel" aria-labelledby="Internal">
                  <div class="row text-center">
                    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0">
                      <img src="assets/img_2/Internal-Auditor.jpg" alt="cism Annual Salary" class="img-fluid mb-4 d-block mx-auto">
                      <strong>Annual Salary</strong>
                    </div>
                    <div class="col-md-6 mt-4 mt-md-0 pb-3 pb-md-0">
                      <img src="assets/img_2/cism-product-manager-c.png" width="300" alt="cism Hiring Companies" class="img-fluid mb-4 d-block mx-auto">
                      <strong>Hiring Companies</strong>
                    </div>
                  </div>
                </div>
    ...
    <div class="row">
		    ...
		    <div class="col-lg-4 col-md-6 mt-4">
                ...
                <g transform="translate(-225 -2881)"><rect class="a" width="43" height="43" transform="translate(225 2881)"/><g transform="translate(228.65 2887.702)"><path class="b" d="M495.135,651.5h8.634a3.908,3.908,0,0,1,2.781,1.157,3.852,3.852,0,0,1,1.162,2.788v.2h4.7a4.7,4.7,0,0,1,4.694,4.7v16.28a4.692,4.692,0,0,1-4.694,4.675H486.44a4.7,4.7,0,0,1-4.69-4.675v-16.28a4.7,4.7,0,0,1,4.69-4.7h4.7V655.5a3.994,3.994,0,0,1,1.171-2.823h0a3.986,3.986,0,0,1,2.828-1.177Zm8.634,2.5h-8.634a1.463,1.463,0,0,0-1.052.451h0a1.459,1.459,0,0,0-.454,1.047v.146h11.588v-.2a1.449,1.449,0,0,0-.437-1.017,1.4,1.4,0,0,0-1.012-.425Z" transform="translate(-481.75 -651.502)"/></g></g>
							...
							<p class="adv-p">Become a trusted expert with in-depth Information Security Management Expertise</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 mt-4">
				<div class="certification_box2">
							...
							<p class="adv-p">Validate your credentials</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 mt-4">
				<div class="certification_box2">
							...
							<p class="adv-p">Prove your ability to stay ahead of ever changing risks</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 mt-4">
				<div class="certification_box2">
							...
							<p class="adv-p">Get recognized globally as one of the best in your field</p>
...
<section id="fastfacts_section">
  <div class="container">
    ...
    <div class="col-md-12">
      <center>
	      <img src="https://www.infosectrain.com/wp-content/uploads/2022/04/CISM-scaled.jpg" alt="CISM Domains" width="100%" align="middle" class="content-desktop" style="text-align:center;">
	    </center>
        ...
        <div class="row">
            <div class="col-12">
                <div class="advisor_box_con">
                    ...
                    <p class="adv-p">CISSP | CISM | CCSP | CISA | CRISC | CASP | MCA | CGEIT | PMP</p>
					          <p class="course_h">
					            An IT leader with almost 2 decades of experience in multiple industries, I have conducted over 500 training sessions to over 10000+ participants. Some of the courses that I have taught over the years: CISSP, CCSP, CISM, cism, CGEIT, CCSK, CompTIA Security+, CySA+...
                    </p>
                    </div>
                    <div class="advisor_box">
					<!-- <div class="box_coma">"</div> -->
                    ...
                    <p class="adv-p">CISA | CISM | ISO | ITIL | Six Sigma</p>
					          <p class="course_h">
                      Santosh has Overall 14+ years of experience in Cyber Security Consulting. He has worked in the IT Industry with focus on Cyber Security, Information Security, Data Privacy, Auditing, and consulting. In the last 4 years, he has been actively involved in mentoring and training students for CISM and other ISACA courses.
                    </p>
                    </div>
                </div>
            </div>
...
<section id="profile_card">
    <div class="container" id="reviews">
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile_card_carousel owl-carousel owl-theme wow fadeInUp">
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/lobo.jpg" alt="Conrad Lobo"  class="p_image">

                    </div>
                    <h4 class="adv-ho">Conrad Lobo</h4>
                    <p style="">
                      Instructor was very approachable and indeed knowledgeable on the subject. Every class was conducted with a interactive concept wherein every participant voluntarily participated.
                    </p>
					...
					<div class="advisor_box">
					<div class="prof-img">
                            <img src="assets/img_2/farooq.jpg" alt="Farooq Babu A" class="p_image">
                          </div>
                          <h4 class="adv-ho"> Farooq Babu A</h4>
					<p style="">
          The overall training experience has been amazing. The CISM syllabus is very smartly integrated  into the concepts which is easy to understand and comprehend. Explanations and examples were perfectly charted by trainer which helps to co-relate with the topics discussed.
          </p>
        ...
        <div class="item card">
          <div class="advisor_box">
           <div class="prof-img">
                <img src="assets/img_2/ibrahim.jpg" alt="Ibrahim Shariff" class="p_image">
            </div>
            <h4 class="adv-ho"> Ibrahim Shariff</h4>
          <p style="">
          Thanks InfosecTrain team for providing this wonderful platform and catering these trainings. CISM program was really helpful and the trainer was awesome.
          </p>
...
<section id="courses" class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="wow fadeInDown text-left mb-3 mb-md-4">Related Courses</h1>
            </div>
        </div>
