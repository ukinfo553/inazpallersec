...
$email_subject = "New Enquiry from Cloud Security Audit Masterclass Page";

$user_subject = "Ready to attend the Cloud Security Audit Masterclass? Stay Tuned!";
...
return array($result,$last);
 ...
 $data = array(
    ...
    'page_type' => 'Cloud Audit Masterclass',
