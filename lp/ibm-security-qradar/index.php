...
<head>
<meta charset="utf-8">
<meta name="description" content=" Security QRadar SIEM Training ">
<meta name="author" content="Infosec Train">
<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
<title>QRadar SIEM Training</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-12 text-center">
        <h1 class="  heading1 mt-4  text-white  wow  fadeInLeft animated" data-wow-duration="1s" >QRadar SIEM Security Training <br><br>
         </h1>
         
        
      <p class="text-white text-center f18">32 hrs of instructor-led training | Certified instructors <br>
               </p>
...
<div class="container">
  <div class="row">
    <div class="col-md-10 offset-md-1">
      <h2 class="head-home wow  "  > QRadar SIEM Security Training  Course Content </h2>
      <p class="lead text-center f22"><strong>This  QRadar SIEM Security Training has been designed by our experts to help you in learning how to administer, tune, and manage QRadar SIEM Security. </strong></p>
    </div>
  </div>
    ...
    <div class="col-md-12 ">
      <div class="card p-3 ">
        <div class="tabs new_tab ">
          <ul class="tab-links">
            <li class="active"><a href="#tab1"> About the QRadar</a></li>
          ...
          <div class="tab-content course_details">
            <div id="tab1" class="tab active">
               <h3 class="tab_head">  About the QRadar</h3>
              <div class="tab_content">
                <p> QRadar Training will help you to enhance your knowledge in the  QRadar SIEM solution. During this course, a holistic view of the basic concepts of QRadar and its architecture is given so that participants can better understand the workings of the SIEM solution. Our  Qradar SIEM Online Training tries to give you an admin perspective of the course which will help you keep your environment up to date as SOC admin. Few important skills you will learn during QRadar SIEM Certification Course are:</p>
<ul>
<li>To perform the regular tasks of a SIEM admin, which includes managing the users and the user profiles, configuring on all sources, managing reference sets, etc.</li>

<li>Tuning and optimising QRadar, including the creation of rules, creation of custom reports, creation of custom properties, etc.</li>
<li>Troubleshooting techniques in QRadar</li>
</ul>
 </p>
              </div>
            </div>
            ...
            <div id="tab3" class="tab ">
              ...
              <div class="tab_content">
                <h3 class="head m-0">QRadar SIEM Security Training  Course Content Details </h3>
                
<p><strong>Introduction to SOC </strong></p>
<ul>
  <li>Building a successful SOC</li>
  <li>Functions of SOC</li>
  <li>Heart of SOC- SIEM</li>
  <li>Gartner’s magic quadrant</li>
</ul>
<p><strong>Introduction to Qradar </strong></p>
<ul>
  <li> QRadar SIEM component architecture and data flows</li>
  <li>Using the QRadar SIEM User Interface</li>
</ul>
<p><strong>Working with logs</strong></p>
<ul>
  <li>Working with offense triggered by events</li>
  <li>Working with offense triggered by flows</li>
  <li>Working with events of an offense</li>
</ul>
<p><strong>Monitoring</strong></p>
<ul>
  <li>Monitor QRadar Notifications and error messages.</li>
  <li>Monitor QRadar performance</li>
  <li>Review and interpret system monitoring dashboards.</li>
  <li>Investigate suspected attacks and policy breaches</li>
  <li>Search, filter, group, and analyze security data</li>
</ul>
<p><strong>Intercept</strong></p>
<ul>
  <li>Investigate the vulnerabilities and services of assets</li>
  <li>Investigate events and flows</li>
  <li>Use index management</li>
  <li>Index and Aggregated Data Management</li>
  <li>Use AQL for advanced searches</li>
  <li>Creating Alerts for intrusions</li>
  <li>Explain error messages and notifications.</li>
  <li>Analyze a Real-World Scenario.</li>
  <li>Creating Reports</li>
  <li>Case Studies</li>
</ul>
<p><strong>Advanced Topics</strong></p>
<ul>
  <li>Creating log source types</li>
  <li>Leveraging reference data collections</li>
  <li>Developing custom rules</li>
  <li>Creating Custom Action Scripts</li>
  <li>Developing Anomaly Detection Rules</li>
</ul>
...
<p>is helpful to understand and practice the course.</p>
              </div>
            </div>
...
<li>Security Technical Architects</li>
<li>Offense Managers</li>
<li>Network Administrators</li>
<li>System Administrators</li>
</ul>
<p>and interested in achieving Qradar SIEM Certification for a brighter future in this domain,  QRadar SIEM Training will be beneficial for you.</p>
            </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12" id="training-calendar">
        <h2 class="head-home wow  fadeInDown animated  text-white" id="trainers"  data-wow-duration="1s">QRadar SIEM Security TRAINING CALENDAR </h2>
      </div>
    </div>
...
<div class="row">
      <div class="col-md-12">
          <?php
$url = "https://www.infosectrain.com/api/32209/href_toscroll/free_demo";
...
<section class="container-fluid  section  bg5 ">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="head-home wow  fadeInDown animated  text-white"  data-wow-duration="1s"> QRadar SIEM Security  Highlights </h2>
      </div>
    </div>
    <div class="row " >
      <div class="col-md"> <span class="learning_mode5"> Learn to master the heart of the SOC</span> </div>
       <div class="col-md"> <span class="learning_mode5">Rock the SOC with Qradar</span> </div>
      <div class="col-md"> <span class="learning_mode5"> Bring out the best SOC analyst in you</span> </div>
       <div class="col-md"> <span class="learning_mode5"> Put your best foot forward with Qradar</span> </div>
       <div class="col-md"> <span class="learning_mode5"> Qradar training:
Enabling you to find the unknowns</span> </div>
    </div>
  </div>
</section>
    ...
    <div id="home_testimonials" class="owl-carousel owl-theme owl-loaded owl-drag" >
      ...
      <div class="item wow  fadeInUp animated"  data-wow-duration="2s">
        <div class="card">
          ...
          <div class="testie_head"> <img src="<?php echo BASE_URL; ?>assets/images/naveen.jpg" class="d-inline img-v users" alt="waypoint">  <img src="<?php echo BASE_URL; ?>assets/images/star5.png" class="d-inline img-v  " alt="star5"></div>
      ...
      <div class="item wow  fadeInUp animated"  data-wow-duration="3s">
        <div class="card card1">
          ...
          <div class="testie_head"> <img src="<?php echo BASE_URL; ?>assets/images/Sudha.jpg" class="d-inline img-v users" alt="waypoint">  <img src="<?php echo BASE_URL; ?>assets/images/star5.png" class="d-inline img-v  " alt="star5"></div>
