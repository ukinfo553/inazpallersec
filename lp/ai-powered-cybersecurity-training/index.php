...
$courseID = 45772;  // Change this to the specific course ID for different pages
...
<head>
    ...
    <title>AI-Powered Cybersecurity Training</title>
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center flex-column-reverse flex-md-row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="item">
                            <h3 class="d-none d-lg-block">Become an AI-Powered Cybersecurity Specialist</h3>
                            <h1>AI-Powered Cybersecurity Training Course</h1>
                            <!-- <h3>Prepare For CISSP Exam</h3> -->
                            <div class="d-flex flex-row banner-highlights">
                                <div>
                                    <span>77% Increase</span>
                                    <p>in AI Cybersecurity Jobs</p>
                                </div>
                                <div>
                                    <span>$350,048</span>
                                    <p>Median Salary of Chief AI Security Officer</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-6 d-none d-md-block">
                        <div class="item">
                            <img src="assets/images/AI-Powered Cybersecurity Training Course-BANNER.png" fetchPriority="high"
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="highlights-sec">
                            ...
                            <div class="highlights-body">
                                ...
                                <div class="col-highlights">
                                    ...
                                    <p>40-Hour of Instructor-led Training</p>
                                </div>
                                <!--<[ highlights item start ]>-->
                                <div class="col-highlights">
                        ...
                        <div class="course-details">
                            <div class="course-overview">
                                <h2>AI-Powered Cybersecurity Training Course- An Overview</h2>
                                <p>InfosecTrain’s AI-Powered Cybersecurity Training Course is a comprehensive program tailored to meet the demands of today’s rapidly evolving digital landscape. The course delves into integrating Artificial Intelligence with cybersecurity, providing participants with advanced skills to detect, analyze, and counter cyber threats efficiently. The course covers the fundamental concepts of Python programming, which is crucial for participants to learn and apply due to its relevance and versatility in AI and cybersecurity.</p>
        ...
        <section class="training-calendar" id="training-calendar">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>AI-Powered Cybersecurity Training Calendar</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="#" class="modal-btn" title="Corparate Training">
                            <picture>
                                <source media="(min-width:768px)" width="1400" height="420"
                                    srcset="assets/images/AWAPT-corporate-training-web.png">
                                <img src="assets/images/AWAPT-corporate-training-mob.png" width="364" height="301"
                    ...
                    <div class="swiper-wrapper justify-content-md-center">
                        ...
                        <div class="swiper-slide item">
                            ...
                            <div class="designation">
                                Information Security | Cloud Security | Data Security | Azure | Consultant & Trainer
                            </div>
                            <div class="summary">

                                    Avnish is an experienced Information security & Cloud Security Consultant and Trainer with over 7 years of expertise, specializing in cloud security, cybersecurity and migration on AWS and Microsoft Azure. He has delivered tailored training globally across various sectors, equipping professionals with practical cloud security and cybersecurity skills.
                            </div>
                        </div>
                        <!--/ col end /-->
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/cippe-domains.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Focus on Adversarial <strong>AI and AI Security</strong></p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/certificate.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>AI Security and <strong>Governance-Centric Curriculum</strong></p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="item">
                            <img src="assets/images/why-choose/course-curriculum.png" width="45" height="45"
                                alt="InfosecTrain - Your Trusted Cybersecurity Training Partner">
                            <p>Hands-on <strong>AI Tools</strong> for Real Cyber Threats</p>
                        </div>
                    </div>
                    <!--/ col start /-->
                    <div class="col-lg-3 col-md-4 col-6">
        ...
        <section class="benefits-sec" id="benefits">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>Benefits of  AI-Powered Cybersecurity Training</h2>
                    </div>
                </div>
                ...
                <div class="row align-items-center benefits-row-two">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center benifits-item">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p>Earn the status of AI cybersecurity expert</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center benifits-item">
                            <div class="flex-shrink-0">
                    ...
                    <div class="col-md-8">
                        <div class="benifits-item-two">
                            <h3>Average Salary Range for AI Cybersecurity Roles</h3>
                            <picture>
                                <source media="(min-width:768px)" width="1472" height="486"
                                    srcset="assets/images/benifits/benefits-AI-Powered-cybersecurity-desktop.png">
                                <img src="assets/images/benifits/benefits-AI-Powered-cybersecurity-mobile.png" width="640" height="473"
                                    alt="Benefits of AI-Powered Cybersecurity  Certification">
                            </picture>
                        </div>
                    </div>
                        ...
                        <div class="swiper-slide gladiators-item">
                            ...
                            <div class="profile">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="https://www.infosectrain.com/wp-content/uploads/2024/07/male-avatar-150x150.png"
                                            alt="Praveen Vasudevan Chandrika" width="250" height="250">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h3>Praveen Vasudevan Chandrika</h3>
                                        <span>UAE</span>
                                    </div>
                                </div>
                            </div>
