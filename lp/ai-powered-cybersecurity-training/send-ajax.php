                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/evolution-and-future-of-ai/" target="_blank">Evolution and Future of AI</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/introduction-to-generative-ai-the-future-of-intelligent-creation/" target="_blank">Introduction to Generative AI: The Future of Intelligent Creation</a></li>                            </ul>
                        </td>                    </tr>
                    <tr>                        <td style="color: #414547; padding-left: 24px;padding-top:10px;font-family: Arial, Helvetica, sans-serif;font-size: 18px;">
                        ...
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">                        <ul>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/certified-ethical-hacker-ceh-training/"  target="_blank"> CEH v13 AI Certification Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/splunk-training/"  target="_blank"> Splunk Practical Approach Training</a> </li>
                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/comptia-security/"  target="_blank"> CompTIA Security+ (Plus) Certification Training</a> </li>                            <li><a style="font-size: 12px;text-decoration: none;color: #414547;" https://www.infosectrain.com/courses/advanced-threat-hunting-and-digital-forensics-and-incident-response-training/"  target="_blank"> Advanced Cyber Threat Hunting and DFIR Training</a> </li>
                        </ul>                        </td>
                    </tr>
                    ' . $email_footer . '
                </table>
