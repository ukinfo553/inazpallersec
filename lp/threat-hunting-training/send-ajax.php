...
if (isset($_POST['me_submited'])) {
    ...
    $email_subject = "Threat Hunting Professional Landing Page";
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="700px" style="background: #f8f8f8;">
                    ...
                    <tr>
                        <td style="padding-left: 24px; padding-right: 24px; text-align: left;font-family: Arial, Helvetica, sans-serif;">
                            <ul>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-threat-hunting-scenario-based-interview-questions/" target="_blank">Threat Hunting Scenario-Based Interview Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/top-threat-hunting-interview-questions/" target="_blank">Top Threat Hunting Interview Questions</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/why-choose-advanced-threat-hunting-dfir-training-course-with-infosectrain/" target="_blank">Why Choose Threat Hunting & DFIR Training with InfosecTrain?</a></li>
                                <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.infosectrain.com/blog/open-source-threat-intelligence-benefits-and-challenges/" target="_blank">Open Source Threat Intelligence: Benefits and Challenges</a></li>
                            </ul>
                        </td>
                    </tr>
					<tr>
					...
					<tr>
                        ...
                        <ul>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=R4JpagLDD8U">What is Cyber Threat Hunting and DFIR?</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=dOTURIFHG7Q">Threat Hunting Techniques</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=y-kFlJ9-eaw">Threat Hunting  Techniques, Tools, and Tips for Beginners</a></li>
                        <li><a style="font-size: 12px;text-decoration: none;color: #414547;" href="https://www.youtube.com/watch?v=wYaB-aj81PY">5 Reason to Learn Threat Hunting</a></li>
                    </ul>
						</td>
					</tr>
					<tr>
...
';
    ...
    $data = array(
        'site_name' => 'lp',
        'page_type' => 'Threat Hunting Professional',
        'name' => $me_name,
        'email' => $me_email,
        'phone' => $me_phone,
