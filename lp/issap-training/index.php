...
$courseID = 30769;  // Change this to the specific course ID for different pages
                        ...
                        <div class="col-lg-7">
                            <div class="item">
                                ...
                                <img src="assets/images/review-mob-img.png"
                                    alt="Information Systems Security Architecture Professional (ISSAP) Course Review"
                        ...
                        <div class="col-lg-5 col-md-6 d-none d-lg-block">
                            <div class="item">
                                <img src="assets/images/banner-img.webp" fetchPriority="high"
                                    alt="Information Systems Security Architecture Professional (ISSAP) by InfosecTrain"
                                ...
                                <div class="highlights-body">
                                    ...
                                    <div class="col-highlights">
                                        <img src="assets/images/highlight-icon/time.svg"
                                            alt="Information Systems Security Architecture Professional (ISSAP) Training Course Highlights"
                                            width="45" height="45">
                            ...
                            <div class="course-details">
                                <div class="course-overview">
                                    ...
                                    <p>
                                        ...
                                        expertise in security architecture. Covering key topics like security
                                        frameworks,
                                    ...
                                    <p>
                                        ...
                                        step for those aiming to advance their careers in information security
                                        architecture.
                                    </p>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 d-none d-lg-block">
                            <img src="assets/images/training-calendar.png" width="132" height="128"
                                alt="Information Systems Security Architecture Professional (ISSAP) Training Calendar"
                                class="img-fluid">
                        </div>
                    ...
                    <div class="swiper myAdvisor">
                        <div class="swiper-wrapper justify-content-md-center">
                            ...
                            <div class="swiper-slide item">
                                ...
                                <div class="summary">
                                    With more than 16 years of experience, Mani specializes in ISMS, Risk Management,
                                    and
                                    GRC compliance domains.
                                    He is adept at IBM Security Guardium Administration, IT Governance, Enterprise
                                    Security,
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    ...
                                    organized manner. The trainer's method of teaching the ISSAP course content was
                                    great.
                                    Sharing real-world scenarios as examples gave a clear picture of the concepts.
                                    Thanks
                                    again!
                                </p>
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    An excellent experience with engaging content! The ISSAP certification course
                                    offered
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    Overall the ISSAP certification training was good. Trainer was well prepared with
                                    the
                            ...
                            <div class="swiper-slide gladiators-item">
                                ...
                                <p class="desc">
                                    The effort in teaching the concepts was commendable. Thank you, InfosecTrain, for
                                    your
                            ...
                            <div class="faq-wrapper">
                                ...
                                <?php
                                    foreach (array_values($filteredFaq) as $index => $question) {
                                        ...
                                        echo htmlspecialchars($question['ans']);
                                        echo '    </div>';
                                        echo '</div>';
                                    }
                                    ?>
                        ...
                        <div class="col-md-6">
                            <div class="item-two">
                                ...
                                <form method="post" action="" onSubmit="return val_demo_request_footer(this.form);"
                                    ...
                                    <input type="hidden" value="Need Help Reach Us" id="me_others_footer"
                                        name="me_others">
